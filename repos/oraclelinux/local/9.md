...
- Created: `2022-11-04T23:32:27.85135749Z`
...
### `rpm` package: `python3-3.9.10-3.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url python3-3.9.10-3.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.10-3.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.10-3.el9_0.src.rpm
```
...
### `rpm` package: `python3-libs-3.9.10-3.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libs-3.9.10-3.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/python3.9-3.9.10-3.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/python3.9-3.9.10-3.el9_0.src.rpm
```
...
### `rpm` package: `python3-rpm-4.16.1.3-12.0.1.el9_0.1.x86_64`
...
```console
$ dnf --quiet download --source --url python3-rpm-4.16.1.3-12.0.1.el9_0.1
...
### `rpm` package: `rpm-build-libs-4.16.1.3-12.0.1.el9_0.1.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-build-libs-4.16.1.3-12.0.1.el9_0.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.1.src.rpm
```
...
### `rpm` package: `rpm-sign-libs-4.16.1.3-12.0.1.el9_0.1.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-sign-libs-4.16.1.3-12.0.1.el9_0.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.1.src.rpm
```
