...
- Created: `2020-03-10T02:20:28.846338747Z`
...
### `rpm` package: `libgudev1-219-67.0.5.el7_7.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libgudev1-219-67.0.5.el7_7.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-67.0.5.el7_7.3.src.rpm
```
...
### `rpm` package: `systemd-219-67.0.5.el7_7.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls systemd-219-67.0.5.el7_7.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-67.0.5.el7_7.3.src.rpm
```

### `rpm` package: `systemd-libs-219-67.0.5.el7_7.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls systemd-libs-219-67.0.5.el7_7.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-67.0.5.el7_7.3.src.rpm
```
