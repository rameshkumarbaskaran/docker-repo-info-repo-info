...
- Created: `2022-08-24T19:35:32.687371446Z`
...
### `rpm` package: `libgudev1-219-78.0.9.el7_9.5.x86_64`
...
```console
$ dnf --quiet download --source --url libgudev1-219-78.0.9.el7_9.5
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/systemd-219-78.0.9.el7_9.5.src.rpm
```
...
### `rpm` package: `systemd-219-78.0.9.el7_9.5.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-219-78.0.9.el7_9.5
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/systemd-219-78.0.9.el7_9.5.src.rpm
```

### `rpm` package: `systemd-libs-219-78.0.9.el7_9.5.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-219-78.0.9.el7_9.5
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/systemd-219-78.0.9.el7_9.5.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/tzdata-2022c-1.el7.src.rpm
```
