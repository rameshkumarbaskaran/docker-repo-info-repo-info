...
- Created: `2022-06-16T01:20:10.21460965Z`
- Virtual Size: ~ 253.03 Mb  
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/bind-9.11.4-26.P2.el7_9.9.src.rpm
```
...
### `rpm` package: `kpartx-0.4.9-135.0.1.el7_9.x86_64`
...
```console
$ dnf --quiet download --source --url kpartx-0.4.9-135.0.1.el7_9
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/device-mapper-multipath-0.4.9-135.0.1.el7_9.src.rpm
```
...
### `rpm` package: `libgudev1-219-78.0.7.el7_9.5.x86_64`
...
```console
$ dnf --quiet download --source --url libgudev1-219-78.0.7.el7_9.5
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/systemd-219-78.0.7.el7_9.5.src.rpm
```
...
### `rpm` package: `systemd-219-78.0.7.el7_9.5.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-219-78.0.7.el7_9.5
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/systemd-219-78.0.7.el7_9.5.src.rpm
```

### `rpm` package: `systemd-libs-219-78.0.7.el7_9.5.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-219-78.0.7.el7_9.5
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/systemd-219-78.0.7.el7_9.5.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/tzdata-2022a-1.el7.src.rpm
```
