...
- Created: `2023-06-14T07:21:26.784519436Z`
- Virtual Size: ~ 260.56 Mb  
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/bind-9.11.4-26.P2.el7_9.13.src.rpm
```
...
### `rpm` package: `rhn-check-2.0.2-24.0.9.el7.x86_64`
...
```console
$ dnf --quiet download --source --url rhn-check-2.0.2-24.0.9.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/rhn-client-tools-2.0.2-24.0.9.el7.src.rpm
```

### `rpm` package: `rhn-client-tools-2.0.2-24.0.9.el7.x86_64`
...
```console
$ dnf --quiet download --source --url rhn-client-tools-2.0.2-24.0.9.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/rhn-client-tools-2.0.2-24.0.9.el7.src.rpm
```

### `rpm` package: `rhn-setup-2.0.2-24.0.9.el7.x86_64`
...
```console
$ dnf --quiet download --source --url rhn-setup-2.0.2-24.0.9.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/rhn-client-tools-2.0.2-24.0.9.el7.src.rpm
```
