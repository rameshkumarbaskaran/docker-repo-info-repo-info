...
- Created: `2023-11-14T18:20:47.708743965Z`
- Virtual Size: ~ 260.61 Mb  
...
### `rpm` package: `bind-export-libs-9.11.4-26.P2.el7_9.15.x86_64`
...
```console
$ dnf --quiet download --source --url bind-export-libs-9.11.4-26.P2.el7_9.15
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/bind-9.11.4-26.P2.el7_9.15.src.rpm
```
...
### `rpm` package: `dhclient-4.2.5-83.0.3.el7_9.1.x86_64`
...
```console
$ dnf --quiet download --source --url dhclient-4.2.5-83.0.3.el7_9.1
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/dhcp-4.2.5-83.0.3.el7_9.1.src.rpm
```

### `rpm` package: `dhcp-common-4.2.5-83.0.3.el7_9.1.x86_64`
...
```console
$ dnf --quiet download --source --url dhcp-common-4.2.5-83.0.3.el7_9.1
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/dhcp-4.2.5-83.0.3.el7_9.1.src.rpm
```

### `rpm` package: `dhcp-libs-4.2.5-83.0.3.el7_9.1.x86_64`
...
```console
$ dnf --quiet download --source --url dhcp-libs-4.2.5-83.0.3.el7_9.1
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/dhcp-4.2.5-83.0.3.el7_9.1.src.rpm
```
...
### `rpm` package: `libgudev1-219-78.0.10.el7_9.7.x86_64`
...
```console
$ dnf --quiet download --source --url libgudev1-219-78.0.10.el7_9.7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/systemd-219-78.0.10.el7_9.7.src.rpm
```
...
### `rpm` package: `openssh-7.4p1-23.0.1.el7_9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-7.4p1-23.0.1.el7_9
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/openssh-7.4p1-23.0.1.el7_9.src.rpm
```

### `rpm` package: `openssh-clients-7.4p1-23.0.1.el7_9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-clients-7.4p1-23.0.1.el7_9
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/openssh-7.4p1-23.0.1.el7_9.src.rpm
```

### `rpm` package: `openssh-server-7.4p1-23.0.1.el7_9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-7.4p1-23.0.1.el7_9
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/openssh-7.4p1-23.0.1.el7_9.src.rpm
```
...
### `rpm` package: `rhn-check-2.0.2-24.0.11.el7.x86_64`
...
```console
$ dnf --quiet download --source --url rhn-check-2.0.2-24.0.11.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/rhn-client-tools-2.0.2-24.0.11.el7.src.rpm
```

### `rpm` package: `rhn-client-tools-2.0.2-24.0.11.el7.x86_64`
...
```console
$ dnf --quiet download --source --url rhn-client-tools-2.0.2-24.0.11.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/rhn-client-tools-2.0.2-24.0.11.el7.src.rpm
```

### `rpm` package: `rhn-setup-2.0.2-24.0.11.el7.x86_64`
...
```console
$ dnf --quiet download --source --url rhn-setup-2.0.2-24.0.11.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/rhn-client-tools-2.0.2-24.0.11.el7.src.rpm
```

### `rpm` package: `rhnlib-2.5.65-8.0.5.el7.noarch`
...
```console
$ dnf --quiet download --source --url rhnlib-2.5.65-8.0.5.el7.noarch
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/rhnlib-2.5.65-8.0.5.el7.src.rpm
```
...
### `rpm` package: `rsyslog-8.24.0-57.0.3.el7_9.3.x86_64`
...
```console
$ dnf --quiet download --source --url rsyslog-8.24.0-57.0.3.el7_9.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/rsyslog-8.24.0-57.0.3.el7_9.3.src.rpm
```
...
### `rpm` package: `systemd-219-78.0.10.el7_9.7.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-219-78.0.10.el7_9.7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/systemd-219-78.0.10.el7_9.7.src.rpm
```

### `rpm` package: `systemd-libs-219-78.0.10.el7_9.7.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-219-78.0.10.el7_9.7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/systemd-219-78.0.10.el7_9.7.src.rpm
```
