...
- Created: `2022-05-19T18:21:05.061665321Z`
...
### `rpm` package: `rsyslog-8.24.0-57.0.1.el7_9.2.x86_64`
...
```console
$ dnf --quiet download --source --url rsyslog-8.24.0-57.0.1.el7_9.2
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64/getPackageSource/rsyslog-8.24.0-57.0.1.el7_9.2.src.rpm
```
