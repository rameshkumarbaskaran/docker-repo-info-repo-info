...
### `rpm` package: `coreutils-single-8.32-31.0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url coreutils-single-8.32-31.0.1.el9
...
### `rpm` package: `glibc-minimal-langpack-2.34-28.0.1.el9_0.2.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-minimal-langpack-2.34-28.0.1.el9_0.2
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/glibc-2.34-28.0.1.el9_0.2.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/glibc-2.34-28.0.1.el9_0.2.src.rpm
```
...
### `rpm` package: `rpm-4.16.1.3-12.0.1.el9_0.1.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-4.16.1.3-12.0.1.el9_0.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.1.src.rpm
```

### `rpm` package: `rpm-libs-4.16.1.3-12.0.1.el9_0.1.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-libs-4.16.1.3-12.0.1.el9_0.1
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.1.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/rpm-4.16.1.3-12.0.1.el9_0.1.src.rpm
```
...
### `rpm` package: `zlib-1.2.11-32.el9_0.x86_64`
...
```console
$ dnf --quiet download --source --url zlib-1.2.11-32.el9_0
https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64/getPackageSource/zlib-1.2.11-32.el9_0.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL9/appstream/x86_64/getPackageSource/zlib-1.2.11-32.el9_0.src.rpm
```
