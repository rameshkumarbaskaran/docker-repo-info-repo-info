...
- Created: `2022-05-31T05:19:56.764943231Z`
...
### `rpm` package: `vim-minimal-8.2.2637-15.el9.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-15.el9
http://repo.almalinux.org/vault/9/BaseOS/Source/Packages/vim-8.2.2637-15.el9.src.rpm
```

### `rpm` package: `xz-5.2.5-7.el9.x86_64`
...
```console
$ dnf --quiet download --source --url xz-5.2.5-7.el9
