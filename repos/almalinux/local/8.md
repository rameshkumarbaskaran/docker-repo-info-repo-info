...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/binutils-2.30-113.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/cryptsetup-2.3.7-2.el8.src.rpm
```
...
### `rpm` package: `dbus-1.12.8-18.el8_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url dbus-1.12.8-18.el8_6.1
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/dbus-1.12.8-18.el8_6.1.src.rpm
```

### `rpm` package: `dbus-common-1.12.8-18.el8_6.1.noarch`
...
```console
$ dnf --quiet download --source --url dbus-common-1.12.8-18.el8_6.1.noarch
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/dbus-1.12.8-18.el8_6.1.src.rpm
```

### `rpm` package: `dbus-daemon-1.12.8-18.el8_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url dbus-daemon-1.12.8-18.el8_6.1
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/dbus-1.12.8-18.el8_6.1.src.rpm
```

### `rpm` package: `dbus-libs-1.12.8-18.el8_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url dbus-libs-1.12.8-18.el8_6.1
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/dbus-1.12.8-18.el8_6.1.src.rpm
```

### `rpm` package: `dbus-tools-1.12.8-18.el8_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url dbus-tools-1.12.8-18.el8_6.1
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/dbus-1.12.8-18.el8_6.1.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/lvm2-2.03.14-3.el8_6.2.src.rpm
```
...
### `rpm` package: `dnf-4.7.0-8.el8.alma.noarch`
...
```console
$ dnf --quiet download --source --url dnf-4.7.0-8.el8.alma.noarch
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/dnf-4.7.0-8.el8.alma.src.rpm
```

### `rpm` package: `dnf-data-4.7.0-8.el8.alma.noarch`
...
```console
$ dnf --quiet download --source --url dnf-data-4.7.0-8.el8.alma.noarch
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/dnf-4.7.0-8.el8.alma.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/expat-2.2.5-8.el8_6.2.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/gzip-1.9-13.el8_5.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/iputils-20180629-9.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/kmod-25-19.el8.src.rpm
```
...
### `rpm` package: `libcurl-minimal-7.61.1-22.el8_6.4.x86_64`
...
```console
$ dnf --quiet download --source --url libcurl-minimal-7.61.1-22.el8_6.4
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/curl-7.61.1-22.el8_6.4.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/libseccomp-2.5.2-1.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/libsemanage-2.9-8.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/libtirpc-1.1.4-6.el8.src.rpm
```
...
### `rpm` package: `python3-dnf-4.7.0-8.el8.alma.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-4.7.0-8.el8.alma.noarch
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/dnf-4.7.0-8.el8.alma.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/python-pip-9.0.3-22.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/shadow-utils-4.6-16.el8.src.rpm
```
...
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/vim-8.0.1763-19.el8_6.4.src.rpm
```
...
### `rpm` package: `yum-4.7.0-8.el8.alma.noarch`
...
```console
$ dnf --quiet download --source --url yum-4.7.0-8.el8.alma.noarch
http://repo.almalinux.org/vault/8/BaseOS/Source/Packages/dnf-4.7.0-8.el8.alma.src.rpm
```
