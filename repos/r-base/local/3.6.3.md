...
- Created: `2020-04-23T01:18:14.894909755Z`
- Virtual Size: ~ 682.02 Mb  
...
### `dpkg` source package: `binutils=2.34-6`

Binary Packages:

- `binutils=2.34-6`
- `binutils-common:amd64=2.34-6`
- `binutils-x86-64-linux-gnu=2.34-6`
- `libbinutils:amd64=2.34-6`
- `libctf-nobfd0:amd64=2.34-6`
- `libctf0:amd64=2.34-6`
...
```console
$ apt-get source -qq --print-uris binutils=2.34-6
'http://http.debian.net/debian/pool/main/b/binutils/binutils_2.34-6.dsc' binutils_2.34-6.dsc 11244 SHA256:1d3fda7ac74ad6c96a477773121c7827bd7db12c5b1dab4becc612fa8e75075e
'http://http.debian.net/debian/pool/main/b/binutils/binutils_2.34.orig.tar.xz' binutils_2.34.orig.tar.xz 23144772 SHA256:bc79b3cf950e1601257c0056315b5aa2dc073ebec9c2dba292b6ff30eaeb0899
'http://http.debian.net/debian/pool/main/b/binutils/binutils_2.34-6.debian.tar.xz' binutils_2.34-6.debian.tar.xz 146888 SHA256:7fd392a2d6ca4155b7f7b83f57ed76887c891558120985a71b93ec9b5f374f39
```
...
'http://deb.debian.org/debian/pool/main/b/boot/boot_1.3-24-2.dsc' boot_1.3-24-2.dsc 1796 SHA256:78f525a7cd08f26eb32659ec43e3d59f0d0147d4ccbb1cb1e2a0bbe9c641ddbd
'http://deb.debian.org/debian/pool/main/b/boot/boot_1.3-24.orig.tar.gz' boot_1.3-24.orig.tar.gz 232298 SHA256:89d4596d4a1287155597257372a872b04fbd406cd23fd8436f8e56394ba1607b
'http://deb.debian.org/debian/pool/main/b/boot/boot_1.3-24-2.debian.tar.xz' boot_1.3-24-2.debian.tar.xz 5176 SHA256:5a7df551f0d8d31f47b56932b0917b02b18763005e24ee54d1416e2cadaaac90
```

Other potentially useful URLs:

- https://sources.debian.net/src/boot/1.3-24-2/ (for browsing the source)
- https://sources.debian.net/src/boot/1.3-24-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/boot/1.3-24-2/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `brotli=1.0.7-6`

Binary Packages:

- `libbrotli1:amd64=1.0.7-6+b1`
...
```console
$ apt-get source -qq --print-uris ed=1.16-1
'http://deb.debian.org/debian/pool/main/e/ed/ed_1.16-1.dsc' ed_1.16-1.dsc 1818 SHA256:0aa9d2bb1f14597b4203e9023e749dc6de8d9eabb307490c309c011193408ce8
'http://deb.debian.org/debian/pool/main/e/ed/ed_1.16.orig.tar.gz' ed_1.16.orig.tar.gz 90516 SHA256:e250555dcffb762e08002aa5fa014ebe0a94005b1d9387ad6d9bf6c5c3a19f29
'http://deb.debian.org/debian/pool/main/e/ed/ed_1.16-1.debian.tar.xz' ed_1.16-1.debian.tar.xz 8428 SHA256:fae18a7fd1224c0f60880e455afe432adbcefcc8a0e3b42193c89a35d93f1351
```

Other potentially useful URLs:

- https://sources.debian.net/src/ed/1.16-1/ (for browsing the source)
- https://sources.debian.net/src/ed/1.16-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/ed/1.16-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `fontconfig=2.13.1-4`

Binary Packages:

- `fontconfig=2.13.1-4`
- `fontconfig-config=2.13.1-4`
- `libfontconfig1:amd64=2.13.1-4`
...
```console
$ apt-get source -qq --print-uris foreign=0.8.76-1
'http://deb.debian.org/debian/pool/main/f/foreign/foreign_0.8.76-1.dsc' foreign_0.8.76-1.dsc 1832 SHA256:ecd17c3c80189ef62a7e1cbfde152491ec33aba71f4845c7538ceb7b943ac419
'http://deb.debian.org/debian/pool/main/f/foreign/foreign_0.8.76.orig.tar.gz' foreign_0.8.76.orig.tar.gz 346869 SHA256:052e580bc1e1334b41e7d693df341858395e72488d9c4b3ed8968bf04317ddfc
'http://deb.debian.org/debian/pool/main/f/foreign/foreign_0.8.76-1.debian.tar.xz' foreign_0.8.76-1.debian.tar.xz 4196 SHA256:36b63b4bd041cb30ef48eca433aa5941c5b342da3aa73c4717f76547a79a2d90
```

Other potentially useful URLs:

- https://sources.debian.net/src/foreign/0.8.76-1/ (for browsing the source)
- https://sources.debian.net/src/foreign/0.8.76-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/foreign/0.8.76-1/ (for access to the source package after it no longer exists in the archive)
...
- `libatomic1:amd64=10-20200418-1`
- `libcc1-0:amd64=10-20200418-1`
- `libgcc-s1:amd64=10-20200418-1`
- `libgfortran5:amd64=10-20200418-1`
- `libgomp1:amd64=10-20200418-1`
- `libitm1:amd64=10-20200418-1`
- `liblsan0:amd64=10-20200418-1`
- `libquadmath0:amd64=10-20200418-1`
- `libstdc++6:amd64=10-20200418-1`
- `libtsan0:amd64=10-20200418-1`
- `libubsan1:amd64=10-20200418-1`
...
- `gfortran-9=9.3.0-10`
- `libasan5:amd64=9.3.0-10`
- `libgcc-9-dev:amd64=9.3.0-10`
- `libgfortran-9-dev:amd64=9.3.0-10`
- `libstdc++-9-dev:amd64=9.3.0-10`
...
```console
$ apt-get source -qq --print-uris glib2.0=2.64.2-1
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.64.2-1.dsc' glib2.0_2.64.2-1.dsc 3243 SHA256:5029a24aba41b0322fffbecf4acf9a704cf223512b7f4771b9618bbb07b43572
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.64.2.orig.tar.xz' glib2.0_2.64.2.orig.tar.xz 4760436 SHA256:9a2f21ed8f13b9303399de13a0252b7cbcede593d26971378ec6cb90e87f2277
'http://deb.debian.org/debian/pool/main/g/glib2.0/glib2.0_2.64.2-1.debian.tar.xz' glib2.0_2.64.2-1.debian.tar.xz 91816 SHA256:050e5763ca6f0bc7cf405738eff870b25b64bb75e4aac9aa5f2f2f3f9d4f43cb
```

Other potentially useful URLs:

- https://sources.debian.net/src/glib2.0/2.64.2-1/ (for browsing the source)
- https://sources.debian.net/src/glib2.0/2.64.2-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/glib2.0/2.64.2-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `icu=63.2-3`

Binary Packages:

- `icu-devtools=63.2-3`
- `libicu-dev:amd64=63.2-3`
- `libicu63:amd64=63.2-3`
...
```console
$ apt-get source -qq --print-uris icu=63.2-3
'http://deb.debian.org/debian/pool/main/i/icu/icu_63.2-3.dsc' icu_63.2-3.dsc 1965 SHA256:7dc78f17c16387df8290f23bfd811faea030c21155d28ab460e429c581a41773
...
'http://deb.debian.org/debian/pool/main/i/icu/icu_63.2-3.debian.tar.xz' icu_63.2-3.debian.tar.xz 35520 SHA256:06b5b42f146a7cf39145db0b6582a108f1a8192326128f97a1181e726032ea2c
```

Other potentially useful URLs:

- https://sources.debian.net/src/icu/63.2-3/ (for browsing the source)
- https://sources.debian.net/src/icu/63.2-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/icu/63.2-3/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `krb5=1.17-7`

Binary Packages:

- `libgssapi-krb5-2:amd64=1.17-7`
- `libk5crypto3:amd64=1.17-7`
- `libkrb5-3:amd64=1.17-7`
- `libkrb5support0:amd64=1.17-7`
...
### `dpkg` source package: `lapack=3.9.0-2`

Binary Packages:

- `libblas-dev:amd64=3.9.0-2`
- `libblas3:amd64=3.9.0-2`
- `liblapack-dev:amd64=3.9.0-2`
- `liblapack3:amd64=3.9.0-2`
...
```console
$ apt-get source -qq --print-uris lapack=3.9.0-2
'http://deb.debian.org/debian/pool/main/l/lapack/lapack_3.9.0-2.dsc' lapack_3.9.0-2.dsc 3386 SHA256:7698bb19da521cdaca98525a3dc3f2ea91a03494d11acef42ef82546dbf21dbe
...
'http://deb.debian.org/debian/pool/main/l/lapack/lapack_3.9.0-2.debian.tar.xz' lapack_3.9.0-2.debian.tar.xz 27856 SHA256:1cfc61321308e50a328eb9ef1f0d1041f2ef1e7b625a769a50ade750634274e1
```

Other potentially useful URLs:

- https://sources.debian.net/src/lapack/3.9.0-2/ (for browsing the source)
- https://sources.debian.net/src/lapack/3.9.0-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/lapack/3.9.0-2/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `lattice=0.20-41-1`

Binary Packages:

- `r-cran-lattice=0.20-41-1`
...
### `dpkg` source package: `libcap2=1:2.33-1`

Binary Packages:

- `libcap2:amd64=1:2.33-1`
- `libcap2-bin=1:2.33-1`
...
```console
$ apt-get source -qq --print-uris libcap2=1:2.33-1
'http://deb.debian.org/debian/pool/main/libc/libcap2/libcap2_2.33-1.dsc' libcap2_2.33-1.dsc 2200 SHA256:39901204f7ada8dc1b28c4ac17175550ea9d1b41badc93c501a98a575c720ce1
'http://deb.debian.org/debian/pool/main/libc/libcap2/libcap2_2.33.orig.tar.xz' libcap2_2.33.orig.tar.xz 111280 SHA256:08edeaba2757021aeec45c4eeec52566675e0e0f5d4f057284d729e04f2643d6
'http://deb.debian.org/debian/pool/main/libc/libcap2/libcap2_2.33-1.debian.tar.xz' libcap2_2.33-1.debian.tar.xz 28044 SHA256:cd9365d5ac5f587dd0cb5bd492da6de49ea2b6f82f1de208e200d82b4e986c69
```

Other potentially useful URLs:

- https://sources.debian.net/src/libcap2/1:2.33-1/ (for browsing the source)
- https://sources.debian.net/src/libcap2/1:2.33-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libcap2/1:2.33-1/ (for access to the source package after it no longer exists in the archive)
...
```console
$ apt-get source -qq --print-uris libpsl=0.21.0-1
'http://deb.debian.org/debian/pool/main/libp/libpsl/libpsl_0.21.0-1.dsc' libpsl_0.21.0-1.dsc 1645 SHA256:00a29e0453d3bd8e57b7d414ea5f10e00b2b276ad8d988b33a6e37ef7b5081dc
...
'http://deb.debian.org/debian/pool/main/libp/libpsl/libpsl_0.21.0-1.debian.tar.xz' libpsl_0.21.0-1.debian.tar.xz 12344 SHA256:48ecfbcf5d54c15855c5e119bc200a904b5bdc134d2db18fea248a490587ac39
```

Other potentially useful URLs:

- https://sources.debian.net/src/libpsl/0.21.0-1/ (for browsing the source)
- https://sources.debian.net/src/libpsl/0.21.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libpsl/0.21.0-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libx11=2:1.6.9-2`

Binary Packages:

- `libx11-6:amd64=2:1.6.9-2`
...
```console
$ apt-get source -qq --print-uris libx11=2:1.6.9-2
'http://deb.debian.org/debian/pool/main/libx/libx11/libx11_1.6.9-2.dsc' libx11_1.6.9-2.dsc 2535 SHA256:46e16944ffafe4473cdafe2f391e96524a0372c2a750dfe347d417014c7ae272
'http://deb.debian.org/debian/pool/main/libx/libx11/libx11_1.6.9.orig.tar.gz' libx11_1.6.9.orig.tar.gz 2994329 SHA256:b8c0930a9b25de15f3d773288cacd5e2f0a4158e194935615c52aeceafd1107b
'http://deb.debian.org/debian/pool/main/libx/libx11/libx11_1.6.9.orig.tar.gz.asc' libx11_1.6.9.orig.tar.gz.asc 659 SHA256:5dca08f1a18bcfd9aabbb9b61c78948180db4e0a3e6710df695a48badb1ea8df
'http://deb.debian.org/debian/pool/main/libx/libx11/libx11_1.6.9-2.diff.gz' libx11_1.6.9-2.diff.gz 60488 SHA256:96f9ff3a15f70c642fbf601c0dc0690d3ea75da05bf71ffd6effa8a32f0bfcd0
```

Other potentially useful URLs:

- https://sources.debian.net/src/libx11/2:1.6.9-2/ (for browsing the source)
- https://sources.debian.net/src/libx11/2:1.6.9-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libx11/2:1.6.9-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `linux=5.5.17-1`

Binary Packages:

- `linux-libc-dev:amd64=5.5.17-1`
...
```console
$ apt-get source -qq --print-uris linux=5.5.17-1
'http://deb.debian.org/debian/pool/main/l/linux/linux_5.5.17-1.dsc' linux_5.5.17-1.dsc 198041 SHA256:1c5c7938ae24f403ad138276e9d578b3350b7200e1d4946c738d8b5e9a4bbb14
'http://deb.debian.org/debian/pool/main/l/linux/linux_5.5.17.orig.tar.xz' linux_5.5.17.orig.tar.xz 115227304 SHA256:96ce0f8939a0313167ca4c272748b8ef4390174185614f4f2da0eecbf4d3ccd3
'http://deb.debian.org/debian/pool/main/l/linux/linux_5.5.17-1.debian.tar.xz' linux_5.5.17-1.debian.tar.xz 1335884 SHA256:ca4518fece95ca4c11fc8f8f7f536343e423cd58c6ad63ab889593192d9b2fb5
```

Other potentially useful URLs:

- https://sources.debian.net/src/linux/5.5.17-1/ (for browsing the source)
- https://sources.debian.net/src/linux/5.5.17-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/linux/5.5.17-1/ (for access to the source package after it no longer exists in the archive)
...
```console
$ apt-get source -qq --print-uris littler=0.3.9-1
'http://deb.debian.org/debian/pool/main/l/littler/littler_0.3.9-1.dsc' littler_0.3.9-1.dsc 1889 SHA256:6633e26df66ba4b250a3ca7460133293640cdd026a1d1e831e922866ce18ce58
'http://deb.debian.org/debian/pool/main/l/littler/littler_0.3.9.orig.tar.gz' littler_0.3.9.orig.tar.gz 652684 SHA256:df776815697a2f1a7139993ef8fcf0959dfe05b46aa215162c03c9c7224006d0
'http://deb.debian.org/debian/pool/main/l/littler/littler_0.3.9-1.debian.tar.xz' littler_0.3.9-1.debian.tar.xz 6832 SHA256:77744a376bd343c66ddded7048c3c64c5281d97b096aa2f4caeda93f7fb0e50c
```

Other potentially useful URLs:

- https://sources.debian.net/src/littler/0.3.9-1/ (for browsing the source)
- https://sources.debian.net/src/littler/0.3.9-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/littler/0.3.9-1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/m/mgcv/mgcv_1.8-31-1.dsc' mgcv_1.8-31-1.dsc 1827 SHA256:8801a4b9fcd6bca31f742b258f68dc2615dc62d087744713cfd9e82fcef29580
'http://deb.debian.org/debian/pool/main/m/mgcv/mgcv_1.8-31.orig.tar.gz' mgcv_1.8-31.orig.tar.gz 936344 SHA256:736de462a0ac43a6ed38cd57dfb0ba2942c941dfbb538128782727ab7125c3c5
'http://deb.debian.org/debian/pool/main/m/mgcv/mgcv_1.8-31-1.debian.tar.xz' mgcv_1.8-31-1.debian.tar.xz 5244 SHA256:37433de7b8838591a23a171e6654f446cf2e985b426c1c3155c9c5f16dcb3528
```

Other potentially useful URLs:

- https://sources.debian.net/src/mgcv/1.8-31-1/ (for browsing the source)
- https://sources.debian.net/src/mgcv/1.8-31-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mgcv/1.8-31-1/ (for access to the source package after it no longer exists in the archive)
...
```console
$ apt-get source -qq --print-uris nlme=3.1.147-1
'http://deb.debian.org/debian/pool/main/n/nlme/nlme_3.1.147-1.dsc' nlme_3.1.147-1.dsc 1837 SHA256:2c8e93d5f3d08602fd33841e4ee048b14bf9f2b851c99b61a12bbfeca2975b1a
'http://deb.debian.org/debian/pool/main/n/nlme/nlme_3.1.147.orig.tar.gz' nlme_3.1.147.orig.tar.gz 791780 SHA256:efc8d82e5758c4696458f647f2b8bb1776fdbff6c8eaad3fe3c0573a3c1f0ce7
'http://deb.debian.org/debian/pool/main/n/nlme/nlme_3.1.147-1.debian.tar.xz' nlme_3.1.147-1.debian.tar.xz 7104 SHA256:bd702bbc48ff90320d867034063ec5ec2bd5703150006e12444e0308cd7afebd
```

Other potentially useful URLs:

- https://sources.debian.net/src/nlme/3.1.147-1/ (for browsing the source)
- https://sources.debian.net/src/nlme/3.1.147-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/nlme/3.1.147-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `openldap=2.4.49+dfsg-4`

Binary Packages:

- `libldap-2.4-2:amd64=2.4.49+dfsg-4`
...
### `dpkg` source package: `openssl=1.1.1f-1`

Binary Packages:

- `libssl1.1:amd64=1.1.1f-1`
- `openssl=1.1.1f-1`
...
- http://snapshot.debian.org/package/openssl/1.1.1f-1/
...
### `dpkg` source package: `pango1.0=1.44.7-4`

Binary Packages:

- `libpango-1.0-0:amd64=1.44.7-4`
- `libpangocairo-1.0-0:amd64=1.44.7-4`
- `libpangoft2-1.0-0:amd64=1.44.7-4`
...
'http://deb.debian.org/debian/pool/main/r/r-base/r-base_3.6.3-2.dsc' r-base_3.6.3-2.dsc 3016 SHA256:f96540215ac01bdaae294c983d031f7268641f4b760099cfb3ed5cad41860cc2
'http://deb.debian.org/debian/pool/main/r/r-base/r-base_3.6.3.orig.tar.gz' r-base_3.6.3.orig.tar.gz 33308185 SHA256:89302990d8e8add536e12125ec591d6951022cf8475861b3690bc8bf1cefaa8f
'http://deb.debian.org/debian/pool/main/r/r-base/r-base_3.6.3-2.debian.tar.xz' r-base_3.6.3-2.debian.tar.xz 96816 SHA256:217e29e1dbbca33826137673e32626f24033f39cacf7488a1e6eb6221b9cd180
```

Other potentially useful URLs:

- https://sources.debian.net/src/r-base/3.6.3-2/ (for browsing the source)
- https://sources.debian.net/src/r-base/3.6.3-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/r-base/3.6.3-2/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `r-cran-class=7.3-16-1`

Binary Packages:

- `r-cran-class=7.3-16-1`
...
'http://deb.debian.org/debian/pool/main/r/r-cran-mass/r-cran-mass_7.3-51.5-2.dsc' r-cran-mass_7.3-51.5-2.dsc 1858 SHA256:04540e4bfa2b863eb9644a75e4747964a471de9027ffb4d892df217f4bd51bea
'http://deb.debian.org/debian/pool/main/r/r-cran-mass/r-cran-mass_7.3-51.5.orig.tar.gz' r-cran-mass_7.3-51.5.orig.tar.gz 487569 SHA256:464c0615cef01820cde2bb8457e81575d6755ae9b3ac99f3bfaaac47d43d15cc
'http://deb.debian.org/debian/pool/main/r/r-cran-mass/r-cran-mass_7.3-51.5-2.debian.tar.xz' r-cran-mass_7.3-51.5-2.debian.tar.xz 6220 SHA256:1afbd96c06b933d94357375475b63136e21ab3c2326b05ff0c3b91ba268ae669
```

Other potentially useful URLs:

- https://sources.debian.net/src/r-cran-mass/7.3-51.5-2/ (for browsing the source)
- https://sources.debian.net/src/r-cran-mass/7.3-51.5-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/r-cran-mass/7.3-51.5-2/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/r/r-cran-nnet/r-cran-nnet_7.3-13-1.dsc' r-cran-nnet_7.3-13-1.dsc 1845 SHA256:e982966898b35430499029ef2c90cb9715b8b1149b6bbfb5fcd46bc9d63d5bb0
'http://deb.debian.org/debian/pool/main/r/r-cran-nnet/r-cran-nnet_7.3-13.orig.tar.gz' r-cran-nnet_7.3-13.orig.tar.gz 27820 SHA256:ae8820e292c7a413206ef82d1f41da2809c1d0e39c97f6800f9c7952599119fc
'http://deb.debian.org/debian/pool/main/r/r-cran-nnet/r-cran-nnet_7.3-13-1.debian.tar.xz' r-cran-nnet_7.3-13-1.debian.tar.xz 3124 SHA256:60439a48b59d822d147d288a3994bb81d40b33f05e8186438cef140a3c19570d
```

Other potentially useful URLs:

- https://sources.debian.net/src/r-cran-nnet/7.3-13-1/ (for browsing the source)
- https://sources.debian.net/src/r-cran-nnet/7.3-13-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/r-cran-nnet/7.3-13-1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/r/rmatrix/rmatrix_1.2-18-1.dsc' rmatrix_1.2-18-1.dsc 1864 SHA256:fb775e2cf9e29de43bcd1d25d51d145e0f3b0a5c892244aa6dc41a05fc3acc6e
'http://deb.debian.org/debian/pool/main/r/rmatrix/rmatrix_1.2-18.orig.tar.gz' rmatrix_1.2-18.orig.tar.gz 1871705 SHA256:f7ff018c2811946767ffd4c96d3987e859b82786ff72e1c211ab18bc03cb6119
'http://deb.debian.org/debian/pool/main/r/rmatrix/rmatrix_1.2-18-1.debian.tar.xz' rmatrix_1.2-18-1.debian.tar.xz 5532 SHA256:bb18abead8f1801b6032dbc8faa542ddca085294c2cb1a330a3443980128d24a
```

Other potentially useful URLs:

- https://sources.debian.net/src/rmatrix/1.2-18-1/ (for browsing the source)
- https://sources.debian.net/src/rmatrix/1.2-18-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/rmatrix/1.2-18-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `survival=3.1-12-1`

Binary Packages:

- `r-cran-survival=3.1-12-1`
...
```console
$ apt-get source -qq --print-uris survival=3.1-12-1
'http://deb.debian.org/debian/pool/main/s/survival/survival_3.1-12-1.dsc' survival_3.1-12-1.dsc 1862 SHA256:f62279876e2ff097d583464e3c5209780b8b1d486832af22c8053d55118399aa
'http://deb.debian.org/debian/pool/main/s/survival/survival_3.1-12.orig.tar.gz' survival_3.1-12.orig.tar.gz 7459188 SHA256:b62ed66eb646f3df13f7e9bf6571e3bfecae128c66491e174c8833cbef1bf21f
'http://deb.debian.org/debian/pool/main/s/survival/survival_3.1-12-1.debian.tar.xz' survival_3.1-12-1.debian.tar.xz 6000 SHA256:032f90250ac40f28f98157efe63135a3aa02d0e8ab1ae86314eaa86a0e626feb
```

Other potentially useful URLs:

- https://sources.debian.net/src/survival/3.1-12-1/ (for browsing the source)
- https://sources.debian.net/src/survival/3.1-12-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/survival/3.1-12-1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/t/tk8.6/tk8.6_8.6.10-1.dsc' tk8.6_8.6.10-1.dsc 2164 SHA256:afd5e3a9f409b9f65eae6efb81b0d2ae24300782565eddf5efdfdbc5942fa492
'http://deb.debian.org/debian/pool/main/t/tk8.6/tk8.6_8.6.10.orig.tar.gz' tk8.6_8.6.10.orig.tar.gz 4444764 SHA256:63df418a859d0a463347f95ded5cd88a3dd3aaa1ceecaeee362194bc30f3e386
'http://deb.debian.org/debian/pool/main/t/tk8.6/tk8.6_8.6.10-1.debian.tar.xz' tk8.6_8.6.10-1.debian.tar.xz 10584 SHA256:90cb9a628a75e3bf9194c2e560337e09ce212301a82545d74dda0065454bf3f9
```

Other potentially useful URLs:

- https://sources.debian.net/src/tk8.6/8.6.10-1/ (for browsing the source)
- https://sources.debian.net/src/tk8.6/8.6.10-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/tk8.6/8.6.10-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `vim=2:8.2.0439-1`

Binary Packages:

- `vim-common=2:8.2.0439-1`
- `vim-tiny=2:8.2.0439-1`
- `xxd=2:8.2.0439-1`
...
```console
$ apt-get source -qq --print-uris vim=2:8.2.0439-1
'http://deb.debian.org/debian/pool/main/v/vim/vim_8.2.0439-1.dsc' vim_8.2.0439-1.dsc 2903 SHA256:1ce65f53c06d0ecd43a083ec4b17c265d88187d8beb9f4b80b84d5ae83d070a8
'http://deb.debian.org/debian/pool/main/v/vim/vim_8.2.0439.orig.tar.gz' vim_8.2.0439.orig.tar.gz 14869883 SHA256:edec8bdced8921fa35951b60e7b0321bb4095dba2bdbcfcecf54d476f615541f
'http://deb.debian.org/debian/pool/main/v/vim/vim_8.2.0439-1.debian.tar.xz' vim_8.2.0439-1.debian.tar.xz 165588 SHA256:e28475148b8d20efa64f768e0e82a577d7b71c6c940dfee9221214652ab1028b
```

Other potentially useful URLs:

- https://sources.debian.net/src/vim/2:8.2.0439-1/ (for browsing the source)
- https://sources.debian.net/src/vim/2:8.2.0439-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/vim/2:8.2.0439-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `xdg-utils=1.1.3-2`
...
```console
$ apt-get source -qq --print-uris xdg-utils=1.1.3-2
'http://deb.debian.org/debian/pool/main/x/xdg-utils/xdg-utils_1.1.3-2.dsc' xdg-utils_1.1.3-2.dsc 2068 SHA256:e3fd139e84c182444aad7c9d515224961d19cf1961dba580aa09c3b57a0099eb
...
'http://deb.debian.org/debian/pool/main/x/xdg-utils/xdg-utils_1.1.3-2.debian.tar.xz' xdg-utils_1.1.3-2.debian.tar.xz 11680 SHA256:f8d9dcc1124b913e7b2a728c7c0312b0f92ddde9521ed67cb99f1f4e0bb01057
```

Other potentially useful URLs:

- https://sources.debian.net/src/xdg-utils/1.1.3-2/ (for browsing the source)
- https://sources.debian.net/src/xdg-utils/1.1.3-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/xdg-utils/1.1.3-2/ (for access to the source package after it no longer exists in the archive)
