...
- Created: `2023-10-13T04:47:24.874171242Z`
- Virtual Size: ~ 681.38 Mb  
...
### `dpkg` source package: `mongodb-org=6.0.11`

Binary Packages:

- `mongodb-org=6.0.11`
- `mongodb-org-database=6.0.11`
- `mongodb-org-database-tools-extra=6.0.11`
- `mongodb-org-mongos=6.0.11`
- `mongodb-org-server=6.0.11`
- `mongodb-org-shell=6.0.11`
- `mongodb-org-tools=6.0.11`
