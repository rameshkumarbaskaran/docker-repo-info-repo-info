...
- Created: `2023-11-15T05:23:07.978530284Z`
- Virtual Size: ~ 438.71 Mb  
...
### `dpkg` source package: `mongodb-database-tools=100.4.0`

Binary Packages:

- `mongodb-database-tools=100.4.0`
...
### `dpkg` source package: `mongodb-org=4.4.26~rc0`

Binary Packages:

- `mongodb-org=4.4.26~rc0`
- `mongodb-org-mongos=4.4.26~rc0`
- `mongodb-org-server=4.4.26~rc0`
- `mongodb-org-shell=4.4.26~rc0`
- `mongodb-org-tools=4.4.26~rc0`
...
### `dpkg` source package: `mongodb-org=7.0.4~rc0`

Binary Packages:

- `mongodb-org-database-tools-extra=7.0.4~rc0`
