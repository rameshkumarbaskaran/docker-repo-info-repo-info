...
- Created: `2023-02-17T23:23:04.223296755Z`
- Virtual Size: ~ 388.25 Mb  
...
### `dpkg` source package: `mongodb-org=4.2.24~rc2`

Binary Packages:

- `mongodb-org=4.2.24~rc2`
- `mongodb-org-mongos=4.2.24~rc2`
- `mongodb-org-server=4.2.24~rc2`
- `mongodb-org-shell=4.2.24~rc2`
- `mongodb-org-tools=4.2.24~rc2`
