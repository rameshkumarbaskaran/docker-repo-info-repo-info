...
### `dpkg` source package: `mongodb-org=6.0.10~rc0`

Binary Packages:

- `mongodb-org=6.0.10~rc0`
- `mongodb-org-database=6.0.10~rc0`
- `mongodb-org-database-tools-extra=6.0.10~rc0`
- `mongodb-org-mongos=6.0.10~rc0`
- `mongodb-org-server=6.0.10~rc0`
- `mongodb-org-shell=6.0.10~rc0`
- `mongodb-org-tools=6.0.10~rc0`
