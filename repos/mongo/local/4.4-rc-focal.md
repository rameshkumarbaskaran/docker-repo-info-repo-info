...
- Created: `2023-02-17T23:22:37.043193868Z`
- Virtual Size: ~ 438.39 Mb  
...
### `dpkg` source package: `mongodb-org=4.4.19~rc2`

Binary Packages:

- `mongodb-org=4.4.19~rc2`
- `mongodb-org-mongos=4.4.19~rc2`
- `mongodb-org-server=4.4.19~rc2`
- `mongodb-org-shell=4.4.19~rc2`
- `mongodb-org-tools=4.4.19~rc2`
...
### `dpkg` source package: `mongodb-org=6.0.4~rc1`

Binary Packages:

- `mongodb-org-database-tools-extra=6.0.4~rc1`
