...
- Created: `2021-07-30T02:30:08.90884474Z`
...
### `dpkg` source package: `mongodb-org=4.4.8~rc0`

Binary Packages:

- `mongodb-org=4.4.8~rc0`
- `mongodb-org-mongos=4.4.8~rc0`
- `mongodb-org-server=4.4.8~rc0`
- `mongodb-org-shell=4.4.8~rc0`
- `mongodb-org-tools=4.4.8~rc0`
...
### `dpkg` source package: `mongodb-org=5.0.2~rc0`

Binary Packages:

- `mongodb-org-database-tools-extra=5.0.2~rc0`
