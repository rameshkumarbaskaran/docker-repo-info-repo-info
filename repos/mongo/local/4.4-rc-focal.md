...
- Created: `2021-11-23T22:33:56.335973656Z`
...
### `dpkg` source package: `mongodb-org=4.4.11~rc0`

Binary Packages:

- `mongodb-org=4.4.11~rc0`
- `mongodb-org-mongos=4.4.11~rc0`
- `mongodb-org-server=4.4.11~rc0`
- `mongodb-org-shell=4.4.11~rc0`
- `mongodb-org-tools=4.4.11~rc0`
...
### `dpkg` source package: `mongodb-org=5.0.5~rc0`

Binary Packages:

- `mongodb-org-database-tools-extra=5.0.5~rc0`
