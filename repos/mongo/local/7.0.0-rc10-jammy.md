...
- Created: `2023-08-03T01:37:51.902128812Z`
- Virtual Size: ~ 719.88 Mb  
...
### `dpkg` source package: `mongodb-org=7.0.0~rc10`

Binary Packages:

- `mongodb-org=7.0.0~rc10`
- `mongodb-org-database=7.0.0~rc10`
- `mongodb-org-database-tools-extra=7.0.0~rc10`
- `mongodb-org-mongos=7.0.0~rc10`
- `mongodb-org-server=7.0.0~rc10`
- `mongodb-org-shell=7.0.0~rc10`
- `mongodb-org-tools=7.0.0~rc10`
