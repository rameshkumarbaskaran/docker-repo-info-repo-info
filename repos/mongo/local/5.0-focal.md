...
- Created: `2023-05-03T04:29:41.857140123Z`
...
### `dpkg` source package: `mongodb-org=5.0.17`

Binary Packages:

- `mongodb-org=5.0.17`
- `mongodb-org-database=5.0.17`
- `mongodb-org-database-tools-extra=5.0.17`
- `mongodb-org-mongos=5.0.17`
- `mongodb-org-server=5.0.17`
- `mongodb-org-shell=5.0.17`
- `mongodb-org-tools=5.0.17`
