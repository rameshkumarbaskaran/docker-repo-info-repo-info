...
```console
$ docker pull pypy@sha256:71f2b324b8d23f354e8a9f4d19069fd34f82cab29fdee2ab391e444564bfb5e9
```
...
### `pypy:2.7-7.3.14-slim-bookworm` - linux; amd64
...
### `pypy:2.7-7.3.14-slim-bookworm` - linux; arm64 variant v8
