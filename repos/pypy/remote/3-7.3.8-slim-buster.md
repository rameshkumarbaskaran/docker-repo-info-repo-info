...
```console
$ docker pull pypy@sha256:fa8712010bc6ef20fd0cedddd60195dfe076a4be63551ffe8477c04b8f1544e9
```
...
### `pypy:3-7.3.8-slim-buster` - linux; amd64
...
### `pypy:3-7.3.8-slim-buster` - linux; arm64 variant v8
...
### `pypy:3-7.3.8-slim-buster` - linux; 386
...
### `pypy:3-7.3.8-slim-buster` - linux; s390x
