...
```console
$ docker pull pypy@sha256:265480dd495359fd5a8305a1dc3e32dafb658a7ccb7809119e0d63d8a6ff76e9
```
...
### `pypy:3-7.3.6-buster` - linux; amd64
...
### `pypy:3-7.3.6-buster` - linux; s390x
