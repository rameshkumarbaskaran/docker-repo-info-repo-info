...
```console
$ docker pull pypy@sha256:31c17cb9a016d301844ce40903263d7e9a72a102820809de2d6c9dfca44a25d6
```
...
### `pypy:3-7.3.8-slim-bullseye` - linux; amd64
...
### `pypy:3-7.3.8-slim-bullseye` - linux; arm64 variant v8

```console
$ docker pull pypy@sha256:fc91a358ea6dc8c934f7b9cf621aa17281337c4417598ca246eb22062149d99f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **66.8 MB (66814080 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70388008c1b61d28d9ccd4032ac492167b54953debbb7992d0f10d444f758a95`
-	Default Command: `["pypy3"]`
...
### `pypy:3-7.3.8-slim-bullseye` - linux; 386
