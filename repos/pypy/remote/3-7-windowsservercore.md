...
```console
$ docker pull pypy@sha256:74463a8cdf3ed1c7d88753fbfa24ef2625d6e7e129278f14595556d8e537746f
```
...
### `pypy:3-7-windowsservercore` - windows version 10.0.17763.2183; amd64
