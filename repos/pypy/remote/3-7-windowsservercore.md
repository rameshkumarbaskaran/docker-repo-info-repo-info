...
```console
$ docker pull pypy@sha256:40dd1d0d6e2a1feda988eb94441291c552d970975854f9f2c2039c4a34568d33
```
...
### `pypy:3-7-windowsservercore` - windows version 10.0.20348.707; amd64
...
### `pypy:3-7-windowsservercore` - windows version 10.0.17763.2928; amd64
