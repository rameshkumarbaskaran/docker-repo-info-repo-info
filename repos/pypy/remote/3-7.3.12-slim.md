...
```console
$ docker pull pypy@sha256:e3028c2ddee953d8002de8f1d5939c3ce7fb3feeed2e505291f41c03a201bd2e
```
...
### `pypy:3-7.3.12-slim` - linux; amd64
...
### `pypy:3-7.3.12-slim` - linux; arm64 variant v8
