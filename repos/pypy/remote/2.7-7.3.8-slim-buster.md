...
### `pypy:2.7-7.3.8-slim-buster` - linux; amd64
...
### `pypy:2.7-7.3.8-slim-buster` - linux; arm64 variant v8
...
### `pypy:2.7-7.3.8-slim-buster` - linux; 386
...
### `pypy:2.7-7.3.8-slim-buster` - linux; s390x
