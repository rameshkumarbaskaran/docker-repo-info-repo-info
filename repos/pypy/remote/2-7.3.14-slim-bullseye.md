...
```console
$ docker pull pypy@sha256:677dcac0f9d70ec93ccac8b6b1a60433bdc15871bdcafb457b500e105e97524a
```
...
### `pypy:2-7.3.14-slim-bullseye` - linux; amd64
...
### `pypy:2-7.3.14-slim-bullseye` - linux; arm64 variant v8
