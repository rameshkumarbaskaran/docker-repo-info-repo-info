...
```console
$ docker pull pypy@sha256:1f145c0335132a673765e9241a916326da69235fc7dab4ecd59d07c6ddef711d
```
...
```console
$ docker pull pypy@sha256:6acef21ee031c3817bd742f496566660a4ce60bbd21cce07f33bbfcaba283052
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **66.8 MB (66815934 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:30044d3041c0ea4fb75cd0de02ca7814818b7df7ce926784e2ccd4db43465dea`
-	Default Command: `["pypy3"]`
