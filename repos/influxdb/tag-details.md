...
-	[`influxdb:1.8.7`](#influxdb187)
-	[`influxdb:1.8.7-alpine`](#influxdb187-alpine)
-	[`influxdb:1.8.7-data`](#influxdb187-data)
-	[`influxdb:1.8.7-data-alpine`](#influxdb187-data-alpine)
-	[`influxdb:1.8.7-meta`](#influxdb187-meta)
-	[`influxdb:1.8.7-meta-alpine`](#influxdb187-meta-alpine)
...
### `influxdb:1.8.7` - linux; arm variant v7
...
### `influxdb:1.8.7` - linux; arm64 variant v8
...
### `influxdb:1.8.7-alpine` - linux; amd64
...
### `influxdb:1.8.7-data-alpine` - linux; amd64
...
### `influxdb:1.8.7-meta` - linux; amd64
...
### `influxdb:1.8.7-meta-alpine` - linux; amd64
