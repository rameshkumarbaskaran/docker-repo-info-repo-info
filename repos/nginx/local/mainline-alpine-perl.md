...
- Created: `2020-11-25T00:31:12.558882439Z`
...
```console
nginx-module-perl-1.19.5-r1 description:
nginx Perl dynamic module

nginx-module-perl-1.19.5-r1 webpage:
http://nginx.org/

nginx-module-perl-1.19.5-r1 installed size:
163840

nginx-module-perl-1.19.5-r1 license:
2-clause BSD-like license
