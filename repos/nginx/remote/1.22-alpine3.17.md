...
### `nginx:1.22-alpine3.17` - linux; amd64
...
### `nginx:1.22-alpine3.17` - linux; arm variant v6
...
### `nginx:1.22-alpine3.17` - linux; arm variant v7
...
### `nginx:1.22-alpine3.17` - linux; ppc64le
