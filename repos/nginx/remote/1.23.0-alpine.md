...
### `nginx:1.23.0-alpine` - linux; arm variant v6
...
### `nginx:1.23.0-alpine` - linux; arm variant v7
...
### `nginx:1.23.0-alpine` - linux; arm64 variant v8
...
### `nginx:1.23.0-alpine` - linux; ppc64le
...
### `nginx:1.23.0-alpine` - linux; s390x
