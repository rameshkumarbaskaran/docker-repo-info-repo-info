...
### `nginx:alpine3.17-perl` - linux; amd64
...
### `nginx:alpine3.17-perl` - linux; arm variant v6
...
### `nginx:alpine3.17-perl` - linux; arm variant v7
...
### `nginx:alpine3.17-perl` - linux; arm64 variant v8
...
### `nginx:alpine3.17-perl` - linux; 386
...
### `nginx:alpine3.17-perl` - linux; ppc64le
...
### `nginx:alpine3.17-perl` - linux; s390x
