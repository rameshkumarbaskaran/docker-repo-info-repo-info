...
```console
$ docker pull nginx@sha256:baaaf463bcac5ca1278ec657749f350b16b6ae7964b1da9fc7cac6d87ab05121
```
...
```console
$ docker pull nginx@sha256:06c7aa6176c54be1817eca1f1ee534216e0fcec7decb1b82db40c503cc1f7b7e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.7 MB (53682319 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fd5d10c9376f26e60584571378527436b0390535c2c53a80cffa4da85d1e29a8`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
...
```console
$ docker pull nginx@sha256:9eda0134dd4d2d9777870f645c111cc4a3d37c96590e4182544f2fbf288a5aeb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.6 MB (55581453 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a18a3064fe247749cfa945481c845c9215c19d88a1fac7d005727acc6ac8a75`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["nginx","-g","daemon off;"]`
