...
```console
$ docker pull node@sha256:c5eb2ac1f0220b6b6597bb82a60ac6a32b8dfcc1287abc25a416d28ea57aec6a
```
...
### `node:14.17-stretch-slim` - linux; amd64
...
### `node:14.17-stretch-slim` - linux; arm variant v7
...
### `node:14.17-stretch-slim` - linux; arm64 variant v8
