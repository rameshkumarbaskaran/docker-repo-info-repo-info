...
```console
$ docker pull node@sha256:9eefd9e14c50786acac1efd4e96a4a08957298cd6b8e081f675adf81dad8ffaa
```
...
### `node:20.7.0-slim` - linux; arm64 variant v8
...
### `node:20.7.0-slim` - linux; ppc64le
