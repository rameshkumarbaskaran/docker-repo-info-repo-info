...
### `node:18.6.0-bullseye` - linux; amd64
...
### `node:18.6.0-bullseye` - linux; arm variant v7
...
### `node:18.6.0-bullseye` - linux; arm64 variant v8
...
### `node:18.6.0-bullseye` - linux; ppc64le
...
### `node:18.6.0-bullseye` - linux; s390x
