...
### `node:12.15-stretch` - linux; amd64
...
### `node:12.15-stretch` - linux; arm variant v7
...
### `node:12.15-stretch` - linux; arm64 variant v8
...
### `node:12.15-stretch` - linux; ppc64le
...
### `node:12.15-stretch` - linux; s390x
