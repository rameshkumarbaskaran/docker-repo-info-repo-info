...
```console
$ docker pull node@sha256:8ce46d07beb70f80f7dbd04aaaa109d9f4b45bb850fb141aa98a40efa72c046e
```
...
### `node:21.1.0-bookworm` - linux; amd64
...
### `node:21.1.0-bookworm` - linux; arm64 variant v8
...
### `node:21.1.0-bookworm` - linux; ppc64le
