...
### `node:20.0.0-alpine3.17` - linux; amd64
...
### `node:20.0.0-alpine3.17` - linux; arm variant v6
...
### `node:20.0.0-alpine3.17` - linux; arm variant v7
...
### `node:20.0.0-alpine3.17` - linux; arm64 variant v8
...
### `node:20.0.0-alpine3.17` - linux; ppc64le
...
### `node:20.0.0-alpine3.17` - linux; s390x
