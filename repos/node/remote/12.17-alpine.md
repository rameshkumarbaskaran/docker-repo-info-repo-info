...
### `node:12.17-alpine` - linux; arm variant v6
...
### `node:12.17-alpine` - linux; arm variant v7
...
### `node:12.17-alpine` - linux; arm64 variant v8
...
### `node:12.17-alpine` - linux; ppc64le
