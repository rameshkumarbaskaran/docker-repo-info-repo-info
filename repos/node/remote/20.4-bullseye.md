...
```console
$ docker pull node@sha256:749944d0ae8105c0d1b86154b9712a8170133d134038a627e77e1285c5ccc628
```
...
### `node:20.4-bullseye` - linux; arm64 variant v8
...
### `node:20.4-bullseye` - linux; ppc64le
