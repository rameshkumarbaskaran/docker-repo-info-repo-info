...
### `node:17.2.0-alpine3.14` - linux; arm variant v6
...
### `node:17.2.0-alpine3.14` - linux; arm variant v7
...
### `node:17.2.0-alpine3.14` - linux; arm64 variant v8
...
### `node:17.2.0-alpine3.14` - linux; ppc64le
...
### `node:17.2.0-alpine3.14` - linux; s390x
