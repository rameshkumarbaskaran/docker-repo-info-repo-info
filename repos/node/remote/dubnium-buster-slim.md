...
```console
$ docker pull node@sha256:adbafd5b6f314099a7beef155b2401288ba7015ef731109cc27cd5c5bf9e166e
```
...
```console
$ docker pull node@sha256:e548cd1fccac371060318f354b4c65f2625348b2799adb783675f8288c2dfffd
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.8 MB (51779488 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2efdf81a8a945e176abc960c9f858002760a18eabe9343553c2630a852591848`
