...
```console
$ docker pull node@sha256:5c2b527aeb76754d71f2cbae6572a8cbac06664806ec175fdd8b4b6c4f8a2ca1
```
...
### `node:16.13.1-buster` - linux; arm64 variant v8
...
### `node:16.13.1-buster` - linux; ppc64le
...
### `node:16.13.1-buster` - linux; s390x
