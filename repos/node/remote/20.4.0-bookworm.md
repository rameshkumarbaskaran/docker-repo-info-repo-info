...
```console
$ docker pull node@sha256:e6a27b39bbb5311bf8bd6d26dc3fba6ecbb141627f004360f23d4b105ebfde4a
```
...
### `node:20.4.0-bookworm` - linux; amd64
...
### `node:20.4.0-bookworm` - linux; arm variant v7
...
### `node:20.4.0-bookworm` - linux; arm64 variant v8
...
### `node:20.4.0-bookworm` - linux; ppc64le
