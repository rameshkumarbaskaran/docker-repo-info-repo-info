...
```console
$ docker pull node@sha256:f8f3aa912fa0d97831e5800025824c5c8dfaeb6d908cfa2813959242af9d1828
```
...
### `node:15.14.0-alpine3.10` - linux; arm64 variant v8
...
### `node:15.14.0-alpine3.10` - linux; ppc64le
