...
```console
$ docker pull node@sha256:47140affbaca79585a99baae2a177bfe6e33b598a4b91dc1918c96b47e45125f
```
...
### `node:18.17.1-bookworm` - linux; arm variant v7
...
### `node:18.17.1-bookworm` - linux; arm64 variant v8
...
### `node:18.17.1-bookworm` - linux; ppc64le
