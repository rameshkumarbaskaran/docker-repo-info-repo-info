...
### `node:12.17-alpine3.9` - linux; amd64
...
### `node:12.17-alpine3.9` - linux; arm variant v6
...
### `node:12.17-alpine3.9` - linux; arm variant v7
...
### `node:12.17-alpine3.9` - linux; arm64 variant v8
...
### `node:12.17-alpine3.9` - linux; ppc64le
...
### `node:12.17-alpine3.9` - linux; s390x
