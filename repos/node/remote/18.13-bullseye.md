...
### `node:18.13-bullseye` - linux; amd64
...
### `node:18.13-bullseye` - linux; arm variant v7
...
### `node:18.13-bullseye` - linux; arm64 variant v8
...
### `node:18.13-bullseye` - linux; ppc64le
...
### `node:18.13-bullseye` - linux; s390x
