...
```console
$ docker pull node@sha256:ad86dd7af3be903024105f532bec461522ec3efba9cec11e6d5b8ab17aba6a00
```
...
### `node:16.6.1-alpine3.11` - linux; arm variant v6
...
### `node:16.6.1-alpine3.11` - linux; arm variant v7
...
### `node:16.6.1-alpine3.11` - linux; ppc64le
...
### `node:16.6.1-alpine3.11` - linux; s390x
