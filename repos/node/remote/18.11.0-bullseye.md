...
```console
$ docker pull node@sha256:01675cd15cd96b3b1ca05ccd49f51cbedd99fd6a2635b9d23fb73f34587a3701
```
...
### `node:18.11.0-bullseye` - linux; amd64
...
### `node:18.11.0-bullseye` - linux; arm variant v7
...
### `node:18.11.0-bullseye` - linux; arm64 variant v8
...
### `node:18.11.0-bullseye` - linux; ppc64le
...
### `node:18.11.0-bullseye` - linux; s390x
