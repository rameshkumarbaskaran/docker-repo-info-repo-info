...
```console
$ docker pull node@sha256:4eb4a620e11a72ac343dbefdf5f31a57bfbc738d80d170d0ee2c6f227ca9c804
```
...
### `node:14.7.0-slim` - linux; arm variant v7
...
### `node:14.7.0-slim` - linux; arm64 variant v8
