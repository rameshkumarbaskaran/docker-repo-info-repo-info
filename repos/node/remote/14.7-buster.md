...
```console
$ docker pull node@sha256:b81666686fe000b8499f145097925a9da2bfb5cac5ab0ff97e711d9e509c143d
```
...
### `node:14.7-buster` - linux; arm64 variant v8
...
### `node:14.7-buster` - linux; ppc64le
