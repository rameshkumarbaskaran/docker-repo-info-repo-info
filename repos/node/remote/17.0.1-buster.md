...
```console
$ docker pull node@sha256:cd96f6c3f3c6b0f271e0028276a805dd1359c63a49889b26eaf3d3062403977c
```
...
### `node:17.0.1-buster` - linux; arm variant v7
...
### `node:17.0.1-buster` - linux; arm64 variant v8
...
### `node:17.0.1-buster` - linux; s390x
