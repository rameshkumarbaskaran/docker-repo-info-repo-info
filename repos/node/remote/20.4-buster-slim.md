...
```console
$ docker pull node@sha256:b7318db81ab681021d98276902fd6c8feb5a575660f88ec105c735180e25635e
```
...
### `node:20.4-buster-slim` - linux; amd64
...
### `node:20.4-buster-slim` - linux; arm64 variant v8
