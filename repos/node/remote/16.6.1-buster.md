...
```console
$ docker pull node@sha256:406da230db2b83bc0fafcc57cf39033d39f9d61b290db63dfb64e12301aa5657
```
...
### `node:16.6.1-buster` - linux; amd64
...
### `node:16.6.1-buster` - linux; arm variant v7
...
### `node:16.6.1-buster` - linux; ppc64le
...
### `node:16.6.1-buster` - linux; s390x
