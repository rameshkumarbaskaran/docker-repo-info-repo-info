...
```console
$ docker pull node@sha256:360acdb78a9bd782f93bcf243b18891157c3755311bc81e043e06c72259f8ca7
```
...
### `node:14.17.4-stretch-slim` - linux; amd64
...
### `node:14.17.4-stretch-slim` - linux; arm variant v7
