...
```console
$ docker pull node@sha256:f94d7d5e311e7b6391cf4f0fd7175ae06a85b9855ae4e0283085faae517ccf81
```
...
### `node:12.22.7-alpine3.11` - linux; amd64
...
### `node:12.22.7-alpine3.11` - linux; arm variant v6
...
### `node:12.22.7-alpine3.11` - linux; arm variant v7
...
### `node:12.22.7-alpine3.11` - linux; arm64 variant v8
...
### `node:12.22.7-alpine3.11` - linux; s390x
