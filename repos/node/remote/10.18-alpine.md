...
```console
$ docker pull node@sha256:70609cf5fa340d0df58e1b71273e3112bab468a7e3435000d144c47174aed1eb
```
...
### `node:10.18-alpine` - linux; arm variant v6
...
### `node:10.18-alpine` - linux; arm variant v7
...
### `node:10.18-alpine` - linux; arm64 variant v8
...
### `node:10.18-alpine` - linux; ppc64le
