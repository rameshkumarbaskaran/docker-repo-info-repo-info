...
```console
$ docker pull node@sha256:4bbb631bf60c6114268dc92906c41e24fa5f25a86bb7dd0ea3810119a5ed7328
```
...
### `node:16.13-buster` - linux; arm variant v7
...
### `node:16.13-buster` - linux; arm64 variant v8
...
### `node:16.13-buster` - linux; ppc64le
