...
```console
$ docker pull node@sha256:840d15a4363dcf8eb1c428c1b7015d863a99fdfa1eef1273430702aa83f5c8d8
```
...
### `node:16.13-alpine3.11` - linux; amd64
...
### `node:16.13-alpine3.11` - linux; arm variant v6
...
### `node:16.13-alpine3.11` - linux; arm64 variant v8
...
### `node:16.13-alpine3.11` - linux; s390x
