...
```console
$ docker pull node@sha256:fa46ed56ffbad9f69eb119ca9e3bbc0ffb0c473d03e6c7b3ee49096853aa0b19
```
...
### `node:14.16.1-alpine3.10` - linux; arm variant v6
...
### `node:14.16.1-alpine3.10` - linux; arm64 variant v8
...
### `node:14.16.1-alpine3.10` - linux; ppc64le
