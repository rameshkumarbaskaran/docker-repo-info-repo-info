...
```console
$ docker pull node@sha256:89b501693f9649918b2b1a0f81a44654d49a1e59e0e695c7065db13658026eaf
```
...
### `node:16.12-bullseye` - linux; arm variant v7
...
### `node:16.12-bullseye` - linux; arm64 variant v8
...
### `node:16.12-bullseye` - linux; s390x
