...
```console
$ docker pull node@sha256:b16f6f443ad0386cd0a2ceba5f38ff6e90b6052a515986a292f899ce142741f2
```
...
### `node:15.14.0-alpine3.12` - linux; amd64
...
### `node:15.14.0-alpine3.12` - linux; arm variant v6
...
### `node:15.14.0-alpine3.12` - linux; arm variant v7
...
### `node:15.14.0-alpine3.12` - linux; arm64 variant v8
...
### `node:15.14.0-alpine3.12` - linux; ppc64le
