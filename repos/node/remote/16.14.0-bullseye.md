...
```console
$ docker pull node@sha256:56a3030a46e1956a8c12725235210db2ef76c18ab5dcdaf3eab3a3fc80b447ee
```
...
### `node:16.14.0-bullseye` - linux; amd64
...
### `node:16.14.0-bullseye` - linux; arm variant v7
...
### `node:16.14.0-bullseye` - linux; arm64 variant v8
...
### `node:16.14.0-bullseye` - linux; ppc64le
...
### `node:16.14.0-bullseye` - linux; s390x
