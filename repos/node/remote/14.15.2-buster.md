...
```console
$ docker pull node@sha256:7e0190e368ae89e1c999d03adfb7e9c2a39d9c2a8243c494987238bf271945d2
```
...
### `node:14.15.2-buster` - linux; amd64
...
### `node:14.15.2-buster` - linux; arm variant v7
...
### `node:14.15.2-buster` - linux; arm64 variant v8
...
### `node:14.15.2-buster` - linux; s390x
