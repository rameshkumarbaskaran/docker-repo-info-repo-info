...
```console
$ docker pull node@sha256:ec96a49458e5a142304be3669cdd90d34d1bbb310c555c408829023bbb4c211e
```
...
### `node:12.20.2-alpine3.12` - linux; arm variant v6
...
### `node:12.20.2-alpine3.12` - linux; arm variant v7
...
### `node:12.20.2-alpine3.12` - linux; arm64 variant v8
...
### `node:12.20.2-alpine3.12` - linux; ppc64le
