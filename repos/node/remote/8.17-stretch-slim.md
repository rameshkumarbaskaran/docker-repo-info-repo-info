...
### `node:8.17-stretch-slim` - linux; amd64
...
### `node:8.17-stretch-slim` - linux; arm variant v7
...
### `node:8.17-stretch-slim` - linux; arm64 variant v8
...
### `node:8.17-stretch-slim` - linux; 386
...
### `node:8.17-stretch-slim` - linux; ppc64le
...
### `node:8.17-stretch-slim` - linux; s390x
