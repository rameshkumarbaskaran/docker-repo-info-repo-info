...
```console
$ docker pull node@sha256:26cd8ce39fa1ab18ad227b7fcff6f39442475f3aad181585cd6db961ac72a335
```
...
### `node:10.21.0-alpine` - linux; amd64
...
### `node:10.21.0-alpine` - linux; arm variant v6
...
### `node:10.21.0-alpine` - linux; arm variant v7
...
### `node:10.21.0-alpine` - linux; arm64 variant v8
...
### `node:10.21.0-alpine` - linux; s390x
