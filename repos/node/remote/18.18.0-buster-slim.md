...
```console
$ docker pull node@sha256:c8d4379f52c976a351c5e9dfa7517ecfaa7a35e1f7b18b636ba0fd380e32da99
```
...
### `node:18.18.0-buster-slim` - linux; amd64
...
### `node:18.18.0-buster-slim` - linux; arm64 variant v8
