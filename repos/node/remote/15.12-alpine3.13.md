...
### `node:15.12-alpine3.13` - linux; amd64
...
### `node:15.12-alpine3.13` - linux; arm variant v6
...
### `node:15.12-alpine3.13` - linux; arm variant v7
...
### `node:15.12-alpine3.13` - linux; arm64 variant v8
...
### `node:15.12-alpine3.13` - linux; ppc64le
...
### `node:15.12-alpine3.13` - linux; s390x
