...
```console
$ docker pull node@sha256:347e3f2e173cfdc2b2dda9f2e5ca43eea4fb470b03bc54a07c8968742e2ba337
```
...
### `node:18.7-buster` - linux; arm variant v7
...
### `node:18.7-buster` - linux; ppc64le
