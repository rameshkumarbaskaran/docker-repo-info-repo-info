...
```console
$ docker pull node@sha256:3e888384508e89b719909b97d57c58e144c3dfb607af49c0482329f6f366b371
```
...
### `node:14.17.4-alpine` - linux; amd64
...
### `node:14.17.4-alpine` - linux; arm variant v6
...
### `node:14.17.4-alpine` - linux; arm variant v7
...
### `node:14.17.4-alpine` - linux; ppc64le
...
### `node:14.17.4-alpine` - linux; s390x
