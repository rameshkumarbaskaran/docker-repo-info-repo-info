...
```console
$ docker pull node@sha256:ed1210a1230e1bef1fa2c71767629b2f50c7f402f6882d1be2c51880fe8b77f6
```
...
### `node:16.20.2-bookworm` - linux; arm variant v7
...
### `node:16.20.2-bookworm` - linux; ppc64le
