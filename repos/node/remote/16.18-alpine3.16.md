...
### `node:16.18-alpine3.16` - linux; amd64
...
### `node:16.18-alpine3.16` - linux; arm variant v6
...
### `node:16.18-alpine3.16` - linux; arm variant v7
...
### `node:16.18-alpine3.16` - linux; arm64 variant v8
...
### `node:16.18-alpine3.16` - linux; ppc64le
...
### `node:16.18-alpine3.16` - linux; s390x
