...
### `node:13.7-stretch-slim` - linux; amd64
...
### `node:13.7-stretch-slim` - linux; arm variant v7
...
### `node:13.7-stretch-slim` - linux; arm64 variant v8
...
### `node:13.7-stretch-slim` - linux; ppc64le
...
### `node:13.7-stretch-slim` - linux; s390x
