...
```console
$ docker pull node@sha256:2a638cc40312843eb47943c23dabaa35babb253bf68abcf8f43e6a32e1e5c968
```
...
### `node:14.18.3-buster` - linux; arm64 variant v8
...
### `node:14.18.3-buster` - linux; ppc64le
...
### `node:14.18.3-buster` - linux; s390x
