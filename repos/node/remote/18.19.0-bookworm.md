...
```console
$ docker pull node@sha256:7a4282663db6f22326c03618eef4320fa3cf70c5c3715546f9779858dc0ed3fd
```
...
### `node:18.19.0-bookworm` - linux; amd64
...
### `node:18.19.0-bookworm` - linux; arm variant v7
...
### `node:18.19.0-bookworm` - linux; arm64 variant v8
...
### `node:18.19.0-bookworm` - linux; ppc64le
...
### `node:18.19.0-bookworm` - linux; s390x
