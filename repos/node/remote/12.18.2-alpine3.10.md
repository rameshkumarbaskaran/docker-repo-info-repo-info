...
```console
$ docker pull node@sha256:24797dd05e07cb987638c30d92914dce994a854186e2dd2f8e54117ff46bcc70
```
...
### `node:12.18.2-alpine3.10` - linux; arm variant v7
...
### `node:12.18.2-alpine3.10` - linux; arm64 variant v8
...
### `node:12.18.2-alpine3.10` - linux; ppc64le
