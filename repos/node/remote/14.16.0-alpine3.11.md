## `node:14.16.0-alpine3.11`

```console
$ docker pull node@sha256:9c83240ee8f397f31d4d5462a1cb1e1a24139c39a4d124d81618514bd07936ec
```
...
### `node:14.16.0-alpine3.11` - linux; amd64
...
### `node:14.16.0-alpine3.11` - linux; arm variant v6
...
### `node:14.16.0-alpine3.11` - linux; arm variant v7
...
### `node:14.16.0-alpine3.11` - linux; arm64 variant v8
