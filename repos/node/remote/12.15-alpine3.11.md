...
```console
$ docker pull node@sha256:845ea0f12261c0d037ecf621e20b6d2abc5fc07fd9173aaec9a5202697af7471
```
...
### `node:12.15-alpine3.11` - linux; amd64
...
### `node:12.15-alpine3.11` - linux; arm variant v6
...
### `node:12.15-alpine3.11` - linux; arm variant v7
...
### `node:12.15-alpine3.11` - linux; arm64 variant v8
...
### `node:12.15-alpine3.11` - linux; ppc64le
...
### `node:12.15-alpine3.11` - linux; s390x
