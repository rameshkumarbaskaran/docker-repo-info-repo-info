...
### `node:14.17.5-buster` - linux; amd64
...
### `node:14.17.5-buster` - linux; arm variant v7
...
### `node:14.17.5-buster` - linux; arm64 variant v8
...
### `node:14.17.5-buster` - linux; ppc64le
...
### `node:14.17.5-buster` - linux; s390x
