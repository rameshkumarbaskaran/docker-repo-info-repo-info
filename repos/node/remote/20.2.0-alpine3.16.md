...
```console
$ docker pull node@sha256:41ae8ff51043c5e97d316d8646cceb8e8cadb788d96d598786c53d58e1de29ef
```
...
### `node:20.2.0-alpine3.16` - linux; amd64
...
### `node:20.2.0-alpine3.16` - linux; arm variant v6
...
### `node:20.2.0-alpine3.16` - linux; arm variant v7
...
### `node:20.2.0-alpine3.16` - linux; arm64 variant v8
...
### `node:20.2.0-alpine3.16` - linux; ppc64le
