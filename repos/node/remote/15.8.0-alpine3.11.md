...
```console
$ docker pull node@sha256:9f77bb5900e81c5ca9e75cce3d82c2b8b3b31e71d4a1bcc255fb1b966e0698ed
```
...
### `node:15.8.0-alpine3.11` - linux; amd64
...
### `node:15.8.0-alpine3.11` - linux; arm variant v6
...
### `node:15.8.0-alpine3.11` - linux; arm64 variant v8
...
### `node:15.8.0-alpine3.11` - linux; ppc64le
...
### `node:15.8.0-alpine3.11` - linux; s390x
