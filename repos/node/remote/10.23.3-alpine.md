...
### `node:10.23.3-alpine` - linux; amd64
...
### `node:10.23.3-alpine` - linux; arm variant v6
...
### `node:10.23.3-alpine` - linux; arm variant v7
...
### `node:10.23.3-alpine` - linux; arm64 variant v8
...
### `node:10.23.3-alpine` - linux; ppc64le
