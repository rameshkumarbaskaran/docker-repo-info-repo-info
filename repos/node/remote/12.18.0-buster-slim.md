...
```console
$ docker pull node@sha256:e67759060e26b2f1c4caae1188232f9646684832e1f71f92ad56f4ccbb1b1c0d
```
...
### `node:12.18.0-buster-slim` - linux; amd64
...
### `node:12.18.0-buster-slim` - linux; arm variant v7
...
### `node:12.18.0-buster-slim` - linux; arm64 variant v8
...
### `node:12.18.0-buster-slim` - linux; s390x
