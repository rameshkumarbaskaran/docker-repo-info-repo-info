...
```console
$ docker pull node@sha256:aa34cc857abbdcd4c909912d2f14a55314bb75f0f4055d474d8fae46cbdbc8bf
```
...
### `node:14.19.0-buster` - linux; amd64
...
### `node:14.19.0-buster` - linux; arm variant v7
...
### `node:14.19.0-buster` - linux; arm64 variant v8
...
### `node:14.19.0-buster` - linux; ppc64le
...
### `node:14.19.0-buster` - linux; s390x
