...
```console
$ docker pull node@sha256:9977af5053d4b1bf41cfb9a30e19d6c1063033cb1b675cb82063d7b1ae8dd4a3
```
...
### `node:18.10-bullseye` - linux; amd64
...
### `node:18.10-bullseye` - linux; arm64 variant v8
...
### `node:18.10-bullseye` - linux; ppc64le
