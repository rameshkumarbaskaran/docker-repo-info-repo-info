...
- Created: `2023-08-07T20:01:23.612070331Z`
- Virtual Size: ~ 458.63 Mb  
...
- Environment:
  ...
  - `ARANGO_VERSION=3.9.11`
  - `ARANGO_URL=https://download.arangodb.com/arangodb39/DEBIAN/amd64`
  - `ARANGO_PACKAGE=arangodb3_3.9.11-1_amd64.deb`
  - `ARANGO_PACKAGE_URL=https://download.arangodb.com/arangodb39/DEBIAN/amd64/arangodb3_3.9.11-1_amd64.deb`
  - `ARANGO_SIGNATURE_URL=https://download.arangodb.com/arangodb39/DEBIAN/amd64/arangodb3_3.9.11-1_amd64.deb.asc`
  - `GLIBCXX_FORCE_NEW=1`
...
```console
nghttp2-libs-1.46.0-r1 description:
Experimental HTTP/2 client, server and proxy (libraries)

nghttp2-libs-1.46.0-r1 webpage:
https://nghttp2.org

nghttp2-libs-1.46.0-r1 installed size:
156 KiB

nghttp2-libs-1.46.0-r1 license:
MIT
