...
- Created: `2023-03-22T23:21:45.899202526Z`
- Virtual Size: ~ 451.72 Mb  
...
- Environment:
  ...
  - `ARANGO_VERSION=3.9.10`
  - `ARANGO_URL=https://download.arangodb.com/arangodb39/DEBIAN/amd64`
  - `ARANGO_PACKAGE=arangodb3_3.9.10-1_amd64.deb`
  - `ARANGO_PACKAGE_URL=https://download.arangodb.com/arangodb39/DEBIAN/amd64/arangodb3_3.9.10-1_amd64.deb`
  - `ARANGO_SIGNATURE_URL=https://download.arangodb.com/arangodb39/DEBIAN/amd64/arangodb3_3.9.10-1_amd64.deb.asc`
  - `GLIBCXX_FORCE_NEW=1`
...
```console
nodejs-14.21.3-r0 description:
JavaScript runtime built on V8 engine - LTS version

nodejs-14.21.3-r0 webpage:
https://nodejs.org/

nodejs-14.21.3-r0 installed size:
35 MiB

nodejs-14.21.3-r0 license:
MIT
