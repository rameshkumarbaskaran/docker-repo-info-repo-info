...
### `wordpress:beta-5.9-beta1-php8.1-apache` - linux; arm variant v7
...
### `wordpress:beta-5.9-beta1-php8.1-apache` - linux; mips64le
...
### `wordpress:beta-5.9-beta1-php8.1-apache` - linux; ppc64le
