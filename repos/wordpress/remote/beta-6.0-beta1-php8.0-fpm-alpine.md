...
```console
$ docker pull wordpress@sha256:495b24a15688bb72a5ad36a4e01739e905f9a30fd7bc8e95003b884b536a4f3d
```
...
### `wordpress:beta-6.0-beta1-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.0-beta1-php8.0-fpm-alpine` - linux; s390x
