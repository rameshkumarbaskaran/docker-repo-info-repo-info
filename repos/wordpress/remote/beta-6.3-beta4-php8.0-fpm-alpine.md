...
```console
$ docker pull wordpress@sha256:47205354eabf3bf55aa60b768f3705a105e52100d49db61f0f98c983f00cc6bf
```
...
### `wordpress:beta-6.3-beta4-php8.0-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.3-beta4-php8.0-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.3-beta4-php8.0-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.3-beta4-php8.0-fpm-alpine` - linux; s390x
