...
```console
$ docker pull wordpress@sha256:eb5bbdf6abfba72ac593c42e81bc6d4efe7074b40bea14be2f9163972811acca
```
...
### `wordpress:beta-5.9-beta1-php7.4-fpm` - linux; amd64
...
### `wordpress:beta-5.9-beta1-php7.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.9-beta1-php7.4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-5.9-beta1-php7.4-fpm` - linux; 386
...
### `wordpress:beta-5.9-beta1-php7.4-fpm` - linux; mips64le
...
### `wordpress:beta-5.9-beta1-php7.4-fpm` - linux; ppc64le
...
### `wordpress:beta-5.9-beta1-php7.4-fpm` - linux; s390x
