...
```console
$ docker pull wordpress@sha256:1716e22a41104e74d157b0a8678dfc6b41fbea76fec67901af1e36a54f6ee08f
```
...
### `wordpress:beta-5.9.1-RC1-php7.3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-5.9.1-RC1-php7.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-5.9.1-RC1-php7.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-5.9.1-RC1-php7.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-5.9.1-RC1-php7.3-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-5.9.1-RC1-php7.3-fpm-alpine` - linux; s390x
