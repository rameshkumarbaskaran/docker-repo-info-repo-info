## `wordpress:beta-6.4-beta2-php8.0-fpm`
...
### `wordpress:beta-6.4-beta2-php8.0-fpm` - linux; amd64
...
### `wordpress:beta-6.4-beta2-php8.0-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.4-beta2-php8.0-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.4-beta2-php8.0-fpm` - linux; 386
...
### `wordpress:beta-6.4-beta2-php8.0-fpm` - linux; mips64le
