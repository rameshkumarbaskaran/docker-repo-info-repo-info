...
```console
$ docker pull wordpress@sha256:61a265e9d15bfc7560910be21f2f14c06d2152fce89341b338c23709720e9ed8
```
...
### `wordpress:beta-6.2-beta2-php8.1-apache` - linux; amd64
...
### `wordpress:beta-6.2-beta2-php8.1-apache` - linux; arm variant v5
...
### `wordpress:beta-6.2-beta2-php8.1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.2-beta2-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-beta2-php8.1-apache` - linux; 386
...
### `wordpress:beta-6.2-beta2-php8.1-apache` - linux; ppc64le
...
### `wordpress:beta-6.2-beta2-php8.1-apache` - linux; s390x
