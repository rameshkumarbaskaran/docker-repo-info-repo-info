...
```console
$ docker pull wordpress@sha256:d0bcf14e928625a3ef5f0af1c5cd8d742af78bd02446045713abd1e6cc963000
```
...
### `wordpress:beta-5.7-beta2-php7.3-fpm` - linux; amd64
...
### `wordpress:beta-5.7-beta2-php7.3-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.7-beta2-php7.3-fpm` - linux; arm variant v7
...
### `wordpress:beta-5.7-beta2-php7.3-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-5.7-beta2-php7.3-fpm` - linux; 386
...
### `wordpress:beta-5.7-beta2-php7.3-fpm` - linux; mips64le
...
### `wordpress:beta-5.7-beta2-php7.3-fpm` - linux; s390x
