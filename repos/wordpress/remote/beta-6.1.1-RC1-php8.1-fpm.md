## `wordpress:beta-6.1.1-RC1-php8.1-fpm`

```console
$ docker pull wordpress@sha256:7a1acece58d357bf0e633e3698188af35f447641cc2eecca55eb5e26bfce5c5d
```
...
### `wordpress:beta-6.1.1-RC1-php8.1-fpm` - linux; amd64
...
### `wordpress:beta-6.1.1-RC1-php8.1-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.1.1-RC1-php8.1-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.1.1-RC1-php8.1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.1.1-RC1-php8.1-fpm` - linux; 386
...
### `wordpress:beta-6.1.1-RC1-php8.1-fpm` - linux; mips64le
...
### `wordpress:beta-6.1.1-RC1-php8.1-fpm` - linux; ppc64le
...
### `wordpress:beta-6.1.1-RC1-php8.1-fpm` - linux; s390x
