...
```console
$ docker pull wordpress@sha256:a1829a3a0e6203ad86b69a099918bced95baf5d58cdc74658f27d8a188080614
```
...
### `wordpress:beta-6.1-beta3-php8.0-fpm` - linux; amd64
...
### `wordpress:beta-6.1-beta3-php8.0-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.1-beta3-php8.0-fpm` - linux; ppc64le
