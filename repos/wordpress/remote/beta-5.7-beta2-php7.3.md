## `wordpress:beta-5.7-beta2-php7.3`

```console
$ docker pull wordpress@sha256:c38834053b9ec03eee2ef06acbe83f40d6108da387ca4ba6b0e88bc201829ede
```
...
### `wordpress:beta-5.7-beta2-php7.3` - linux; amd64
...
### `wordpress:beta-5.7-beta2-php7.3` - linux; arm variant v5
...
### `wordpress:beta-5.7-beta2-php7.3` - linux; arm variant v7
...
### `wordpress:beta-5.7-beta2-php7.3` - linux; arm64 variant v8
...
### `wordpress:beta-5.7-beta2-php7.3` - linux; 386
...
### `wordpress:beta-5.7-beta2-php7.3` - linux; mips64le
...
### `wordpress:beta-5.7-beta2-php7.3` - linux; s390x
