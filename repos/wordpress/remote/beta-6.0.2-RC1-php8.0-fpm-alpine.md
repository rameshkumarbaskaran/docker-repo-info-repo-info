...
```console
$ docker pull wordpress@sha256:8344bc0aaf9d641352fa85df1ec06c7b2df7d94cbd6d0da4fa977b01699de006
```
...
### `wordpress:beta-6.0.2-RC1-php8.0-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.0.2-RC1-php8.0-fpm-alpine` - linux; arm variant v6
