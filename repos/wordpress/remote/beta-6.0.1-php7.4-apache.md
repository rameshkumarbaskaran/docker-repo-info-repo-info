...
```console
$ docker pull wordpress@sha256:c68e427e0266e96558cae927efc908a7c4b970a204bfc46ceed2d2115da2d8d5
```
...
### `wordpress:beta-6.0.1-php7.4-apache` - linux; amd64
...
### `wordpress:beta-6.0.1-php7.4-apache` - linux; arm variant v5
...
### `wordpress:beta-6.0.1-php7.4-apache` - linux; arm variant v7
...
### `wordpress:beta-6.0.1-php7.4-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.0.1-php7.4-apache` - linux; 386
...
### `wordpress:beta-6.0.1-php7.4-apache` - linux; s390x
