## `wordpress:beta-6.4-beta4-php8.0-fpm-alpine`

```console
$ docker pull wordpress@sha256:8e550d632cf41a04f00a1bd6bff36fdd8231109d85b060ec0e98c5b34b27d8ff
```
...
### `wordpress:beta-6.4-beta4-php8.0-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.4-beta4-php8.0-fpm-alpine` - linux; arm variant v7
