...
```console
$ docker pull wordpress@sha256:7dc38181e39191f036926aff1e6345e0d42ba405199ded82d3fec59faec5ec59
```
...
### `wordpress:beta-5.9.3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-5.9.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-5.9.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-5.9.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-5.9.3-fpm-alpine` - linux; 386
...
### `wordpress:beta-5.9.3-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-5.9.3-fpm-alpine` - linux; s390x
