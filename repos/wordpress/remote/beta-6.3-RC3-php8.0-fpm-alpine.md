...
```console
$ docker pull wordpress@sha256:d3ae9620f83072d25236fc7ae35ceff3fc60cdddfb9a89c0d7b23b67128759f2
```
...
### `wordpress:beta-6.3-RC3-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC3-php8.0-fpm-alpine` - linux; ppc64le
