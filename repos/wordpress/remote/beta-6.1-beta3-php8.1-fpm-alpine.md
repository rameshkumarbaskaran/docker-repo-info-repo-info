...
```console
$ docker pull wordpress@sha256:1f74454535d895fd53e4d97484ae389bd558c0d7e3bbb83a73d3b38f4220edbc
```
...
### `wordpress:beta-6.1-beta3-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.1-beta3-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.1-beta3-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.1-beta3-php8.1-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.1-beta3-php8.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.1-beta3-php8.1-fpm-alpine` - linux; s390x
