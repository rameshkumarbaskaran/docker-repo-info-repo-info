...
```console
$ docker pull wordpress@sha256:77343e89716334c69118dacc1653243d3cb38e6708de08510b6ee0a346607ace
```
...
### `wordpress:beta-6.2-beta2-php8.2-apache` - linux; amd64
...
### `wordpress:beta-6.2-beta2-php8.2-apache` - linux; arm variant v5
...
### `wordpress:beta-6.2-beta2-php8.2-apache` - linux; arm variant v7
...
### `wordpress:beta-6.2-beta2-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-beta2-php8.2-apache` - linux; 386
...
### `wordpress:beta-6.2-beta2-php8.2-apache` - linux; ppc64le
...
### `wordpress:beta-6.2-beta2-php8.2-apache` - linux; s390x
