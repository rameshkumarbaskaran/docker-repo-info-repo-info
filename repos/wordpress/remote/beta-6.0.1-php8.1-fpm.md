...
```console
$ docker pull wordpress@sha256:415e0fd3d9aa18f7487388b254061fd1d972be3b2ec72e3629619722d7c8974e
```
...
### `wordpress:beta-6.0.1-php8.1-fpm` - linux; amd64
...
### `wordpress:beta-6.0.1-php8.1-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.0.1-php8.1-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.0.1-php8.1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.0.1-php8.1-fpm` - linux; 386
...
### `wordpress:beta-6.0.1-php8.1-fpm` - linux; mips64le
...
### `wordpress:beta-6.0.1-php8.1-fpm` - linux; ppc64le
...
### `wordpress:beta-6.0.1-php8.1-fpm` - linux; s390x
