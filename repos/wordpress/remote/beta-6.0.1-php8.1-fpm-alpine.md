...
```console
$ docker pull wordpress@sha256:5e72da5524467f57522e026e91b3cbb87ad70204da60c454ee95235476926ac9
```
...
### `wordpress:beta-6.0.1-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.0.1-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.0.1-php8.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.0.1-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.0.1-php8.1-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.0.1-php8.1-fpm-alpine` - linux; s390x
