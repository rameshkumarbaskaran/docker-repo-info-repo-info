## `wordpress:5.6.1-php7.3-apache`

```console
$ docker pull wordpress@sha256:26d3313d43d07a74f1df34ccf8f772c210ddd083401fc7a0667a935d4a567732
```
...
### `wordpress:5.6.1-php7.3-apache` - linux; amd64
...
### `wordpress:5.6.1-php7.3-apache` - linux; arm variant v5
...
### `wordpress:5.6.1-php7.3-apache` - linux; arm variant v7
...
### `wordpress:5.6.1-php7.3-apache` - linux; arm64 variant v8
...
### `wordpress:5.6.1-php7.3-apache` - linux; 386
...
### `wordpress:5.6.1-php7.3-apache` - linux; mips64le
...
### `wordpress:5.6.1-php7.3-apache` - linux; ppc64le
...
### `wordpress:5.6.1-php7.3-apache` - linux; s390x
