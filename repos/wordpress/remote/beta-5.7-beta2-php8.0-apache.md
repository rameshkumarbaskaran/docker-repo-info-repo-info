...
```console
$ docker pull wordpress@sha256:0921a1fdee8dfe9ee493f516984165cafad5f06472046bb8799308645c7e3039
```
...
### `wordpress:beta-5.7-beta2-php8.0-apache` - linux; amd64
...
### `wordpress:beta-5.7-beta2-php8.0-apache` - linux; arm variant v5
...
### `wordpress:beta-5.7-beta2-php8.0-apache` - linux; arm variant v7
...
### `wordpress:beta-5.7-beta2-php8.0-apache` - linux; arm64 variant v8
...
### `wordpress:beta-5.7-beta2-php8.0-apache` - linux; 386
...
### `wordpress:beta-5.7-beta2-php8.0-apache` - linux; mips64le
...
### `wordpress:beta-5.7-beta2-php8.0-apache` - linux; s390x
