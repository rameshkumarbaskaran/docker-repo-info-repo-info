...
```console
$ docker pull wordpress@sha256:2c8f4131a58504ffcb7524439886a2d7fc1523a0baf41bad656bdc5bf3fdc8a3
```
...
### `wordpress:beta-5.7-RC2-php7.4-apache` - linux; amd64
...
### `wordpress:beta-5.7-RC2-php7.4-apache` - linux; 386
