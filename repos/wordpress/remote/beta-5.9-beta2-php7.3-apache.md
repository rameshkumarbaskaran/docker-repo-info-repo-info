...
```console
$ docker pull wordpress@sha256:2396ebb76dee183e31cdf368e1fb380b358c67fae7ae74a40bb58e5f2ab47c52
```
...
### `wordpress:beta-5.9-beta2-php7.3-apache` - linux; amd64
...
### `wordpress:beta-5.9-beta2-php7.3-apache` - linux; arm variant v5
...
### `wordpress:beta-5.9-beta2-php7.3-apache` - linux; 386
...
### `wordpress:beta-5.9-beta2-php7.3-apache` - linux; mips64le
...
### `wordpress:beta-5.9-beta2-php7.3-apache` - linux; ppc64le
...
### `wordpress:beta-5.9-beta2-php7.3-apache` - linux; s390x
