...
```console
$ docker pull wordpress@sha256:7c285e651aa2184a26544754e2241f3ea2ffd427c56ec7cb6a15b4f3f51662fc
```
...
### `wordpress:beta-5.9-RC3-php7.4` - linux; arm variant v5
...
### `wordpress:beta-5.9-RC3-php7.4` - linux; arm variant v7
...
### `wordpress:beta-5.9-RC3-php7.4` - linux; arm64 variant v8
...
### `wordpress:beta-5.9-RC3-php7.4` - linux; 386
...
### `wordpress:beta-5.9-RC3-php7.4` - linux; mips64le
...
### `wordpress:beta-5.9-RC3-php7.4` - linux; ppc64le
...
### `wordpress:beta-5.9-RC3-php7.4` - linux; s390x
