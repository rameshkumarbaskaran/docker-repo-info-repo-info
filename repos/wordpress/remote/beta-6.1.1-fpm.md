## `wordpress:beta-6.1.1-fpm`

```console
$ docker pull wordpress@sha256:7bd6f59d9127e5fb404793cce6dc34e5c7629816b45901c2ed8de2bd5cc6daab
```
...
### `wordpress:beta-6.1.1-fpm` - linux; amd64
...
### `wordpress:beta-6.1.1-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.1.1-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.1.1-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.1.1-fpm` - linux; 386
...
### `wordpress:beta-6.1.1-fpm` - linux; mips64le
...
### `wordpress:beta-6.1.1-fpm` - linux; ppc64le
...
### `wordpress:beta-6.1.1-fpm` - linux; s390x
