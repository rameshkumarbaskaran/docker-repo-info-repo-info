## `wordpress:beta-5.8-beta3-fpm-alpine`
...
### `wordpress:beta-5.8-beta3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-5.8-beta3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-5.8-beta3-fpm-alpine` - linux; 386
...
### `wordpress:beta-5.8-beta3-fpm-alpine` - linux; s390x
