...
```console
$ docker pull wordpress@sha256:6d2afd4d49623278fb455a99b950c625c2abf52a4d36075eb9cdad440de8c2a6
```
...
### `wordpress:beta-6.3-beta3-php8.0-fpm` - linux; amd64
...
### `wordpress:beta-6.3-beta3-php8.0-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.3-beta3-php8.0-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.3-beta3-php8.0-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-beta3-php8.0-fpm` - linux; 386
...
### `wordpress:beta-6.3-beta3-php8.0-fpm` - linux; mips64le
...
### `wordpress:beta-6.3-beta3-php8.0-fpm` - linux; ppc64le
...
### `wordpress:beta-6.3-beta3-php8.0-fpm` - linux; s390x
