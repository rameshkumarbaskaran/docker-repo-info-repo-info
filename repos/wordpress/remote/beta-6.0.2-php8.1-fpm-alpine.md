...
```console
$ docker pull wordpress@sha256:debeb284ce6821c3f220d2cb9a8f272ac32cc5ecf951647f403f095ea97ce7cb
```
...
### `wordpress:beta-6.0.2-php8.1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.0.2-php8.1-fpm-alpine` - linux; arm variant v6
