...
```console
$ docker pull wordpress@sha256:7e37c59dbb69157701fc63a0c1b7d0e23301887e55e0f82429461ee23fe3528a
```
...
### `wordpress:5.6.1-php8.0-fpm-alpine` - linux; amd64
...
### `wordpress:5.6.1-php8.0-fpm-alpine` - linux; arm variant v7
...
### `wordpress:5.6.1-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:5.6.1-php8.0-fpm-alpine` - linux; 386
