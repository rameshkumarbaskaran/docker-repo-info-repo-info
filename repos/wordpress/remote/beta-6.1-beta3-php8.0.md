...
```console
$ docker pull wordpress@sha256:7aaccb55fe1b192242230f97cb6ddea56f43da5fda754116272bc150fc5d63a0
```
...
### `wordpress:beta-6.1-beta3-php8.0` - linux; amd64
...
### `wordpress:beta-6.1-beta3-php8.0` - linux; arm variant v5
...
### `wordpress:beta-6.1-beta3-php8.0` - linux; arm64 variant v8
...
### `wordpress:beta-6.1-beta3-php8.0` - linux; 386
...
### `wordpress:beta-6.1-beta3-php8.0` - linux; ppc64le
...
### `wordpress:beta-6.1-beta3-php8.0` - linux; s390x
