...
```console
$ docker pull wordpress@sha256:06718b1d3e5d880ae99422c8b54a3b48b2f2551684f0dae9091a3058556fb6a9
```
...
### `wordpress:beta-6.0-beta1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.0-beta1-apache` - linux; s390x
