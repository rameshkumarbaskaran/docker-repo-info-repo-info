...
### `wordpress:6.2.1-fpm` - linux; amd64
...
### `wordpress:6.2.1-fpm` - linux; arm variant v7
...
### `wordpress:6.2.1-fpm` - linux; mips64le
...
### `wordpress:6.2.1-fpm` - linux; ppc64le
