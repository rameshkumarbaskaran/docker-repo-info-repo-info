## `wordpress:beta-6.4-beta4-php8.1-fpm-alpine`

```console
$ docker pull wordpress@sha256:4141cbd4a2abd3a96036776d774d89a0e87bc732e9655026cbc1b44e7e9ecb61
```
...
### `wordpress:beta-6.4-beta4-php8.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.4-beta4-php8.1-fpm-alpine` - linux; arm variant v7
