...
```console
$ docker pull wordpress@sha256:3f365ee8331d770534509a5715cf173bd2fdba548a53c377d7f6d64d198ef9a3
```
...
### `wordpress:beta-5.8-beta4-fpm-alpine` - linux; amd64
...
### `wordpress:beta-5.8-beta4-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-5.8-beta4-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-5.8-beta4-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-5.8-beta4-fpm-alpine` - linux; 386
...
### `wordpress:beta-5.8-beta4-fpm-alpine` - linux; s390x
