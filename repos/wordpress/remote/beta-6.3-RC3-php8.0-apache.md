...
```console
$ docker pull wordpress@sha256:555ce7edfdb4ea71144130a0ee36f969820caab847f3803aff8f402468b7648d
```
...
### `wordpress:beta-6.3-RC3-php8.0-apache` - linux; amd64
...
### `wordpress:beta-6.3-RC3-php8.0-apache` - linux; arm variant v5
...
### `wordpress:beta-6.3-RC3-php8.0-apache` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC3-php8.0-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC3-php8.0-apache` - linux; 386
...
### `wordpress:beta-6.3-RC3-php8.0-apache` - linux; mips64le
...
### `wordpress:beta-6.3-RC3-php8.0-apache` - linux; ppc64le
