...
```console
$ docker pull wordpress@sha256:5237c491fdcaeeeb0cfc7a5af4fcbef79373e667d8f9464cb6213ce779347972
```
...
### `wordpress:beta-5.9.1-RC1-php8.0-apache` - linux; amd64
...
### `wordpress:beta-5.9.1-RC1-php8.0-apache` - linux; arm variant v5
...
### `wordpress:beta-5.9.1-RC1-php8.0-apache` - linux; arm variant v7
...
### `wordpress:beta-5.9.1-RC1-php8.0-apache` - linux; arm64 variant v8
...
### `wordpress:beta-5.9.1-RC1-php8.0-apache` - linux; mips64le
...
### `wordpress:beta-5.9.1-RC1-php8.0-apache` - linux; ppc64le
...
### `wordpress:beta-5.9.1-RC1-php8.0-apache` - linux; s390x
