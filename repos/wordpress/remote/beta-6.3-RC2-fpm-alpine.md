...
```console
$ docker pull wordpress@sha256:7dcee1d47419206ff28854be0acd3ccaf116a165bd2298a66872d6d5e4c67e31
```
...
### `wordpress:beta-6.3-RC2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC2-fpm-alpine` - linux; 386
