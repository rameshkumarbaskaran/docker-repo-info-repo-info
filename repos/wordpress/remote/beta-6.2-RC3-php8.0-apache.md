## `wordpress:beta-6.2-RC3-php8.0-apache`
...
### `wordpress:beta-6.2-RC3-php8.0-apache` - linux; amd64
...
### `wordpress:beta-6.2-RC3-php8.0-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-RC3-php8.0-apache` - linux; mips64le
