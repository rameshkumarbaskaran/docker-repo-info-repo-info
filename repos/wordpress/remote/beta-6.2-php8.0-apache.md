...
```console
$ docker pull wordpress@sha256:0172c3d6104990c74f604716ee3e2cae1f5d51ebbb33867419bb52a25562f85c
```
...
### `wordpress:beta-6.2-php8.0-apache` - linux; amd64
...
### `wordpress:beta-6.2-php8.0-apache` - linux; arm variant v5
...
### `wordpress:beta-6.2-php8.0-apache` - linux; arm variant v7
...
### `wordpress:beta-6.2-php8.0-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-php8.0-apache` - linux; 386
...
### `wordpress:beta-6.2-php8.0-apache` - linux; mips64le
...
### `wordpress:beta-6.2-php8.0-apache` - linux; ppc64le
...
### `wordpress:beta-6.2-php8.0-apache` - linux; s390x
