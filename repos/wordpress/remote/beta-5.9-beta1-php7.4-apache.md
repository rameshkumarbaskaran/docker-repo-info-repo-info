...
```console
$ docker pull wordpress@sha256:0e291d269dc3bd97c47999322faedbc26d229047c834d159d41a90f2f795af30
```
...
### `wordpress:beta-5.9-beta1-php7.4-apache` - linux; amd64
...
### `wordpress:beta-5.9-beta1-php7.4-apache` - linux; arm variant v5
...
### `wordpress:beta-5.9-beta1-php7.4-apache` - linux; arm64 variant v8
...
### `wordpress:beta-5.9-beta1-php7.4-apache` - linux; 386
...
### `wordpress:beta-5.9-beta1-php7.4-apache` - linux; mips64le
...
### `wordpress:beta-5.9-beta1-php7.4-apache` - linux; ppc64le
...
### `wordpress:beta-5.9-beta1-php7.4-apache` - linux; s390x
