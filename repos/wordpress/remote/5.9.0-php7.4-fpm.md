...
```console
$ docker pull wordpress@sha256:b30ea8848acbfe06ebbbd4ed99be375f61f0187b9adb9f8077d99f5d0f86ae85
```
...
### `wordpress:5.9.0-php7.4-fpm` - linux; amd64
...
### `wordpress:5.9.0-php7.4-fpm` - linux; arm variant v7
...
### `wordpress:5.9.0-php7.4-fpm` - linux; mips64le
