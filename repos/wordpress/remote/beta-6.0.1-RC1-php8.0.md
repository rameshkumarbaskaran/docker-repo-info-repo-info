## `wordpress:beta-6.0.1-RC1-php8.0`

```console
$ docker pull wordpress@sha256:99243a325a6f06c0e7c10d582bfbb9788d6fcea4b17e5befb029e635af1686a8
```
...
### `wordpress:beta-6.0.1-RC1-php8.0` - linux; amd64
...
### `wordpress:beta-6.0.1-RC1-php8.0` - linux; arm variant v5
...
### `wordpress:beta-6.0.1-RC1-php8.0` - linux; arm variant v7
...
### `wordpress:beta-6.0.1-RC1-php8.0` - linux; arm64 variant v8
...
### `wordpress:beta-6.0.1-RC1-php8.0` - linux; 386
...
### `wordpress:beta-6.0.1-RC1-php8.0` - linux; mips64le
...
### `wordpress:beta-6.0.1-RC1-php8.0` - linux; ppc64le
...
### `wordpress:beta-6.0.1-RC1-php8.0` - linux; s390x
