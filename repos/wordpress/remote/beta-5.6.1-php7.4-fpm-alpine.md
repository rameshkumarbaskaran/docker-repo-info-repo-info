...
### `wordpress:beta-5.6.1-php7.4-fpm-alpine` - linux; amd64
...
### `wordpress:beta-5.6.1-php7.4-fpm-alpine` - linux; 386
...
### `wordpress:beta-5.6.1-php7.4-fpm-alpine` - linux; ppc64le
