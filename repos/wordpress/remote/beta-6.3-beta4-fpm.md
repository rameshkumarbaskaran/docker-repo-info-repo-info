...
### `wordpress:beta-6.3-beta4-fpm` - linux; amd64
...
### `wordpress:beta-6.3-beta4-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.3-beta4-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.3-beta4-fpm` - linux; ppc64le
...
### `wordpress:beta-6.3-beta4-fpm` - linux; s390x
