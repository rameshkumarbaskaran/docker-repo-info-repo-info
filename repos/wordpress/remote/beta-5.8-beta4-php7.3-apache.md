...
```console
$ docker pull wordpress@sha256:318a3ea26725640a710bffb67b17370cc4f502519eee4931b6219a3f49356fcb
```
...
### `wordpress:beta-5.8-beta4-php7.3-apache` - linux; amd64
...
### `wordpress:beta-5.8-beta4-php7.3-apache` - linux; arm variant v5
...
### `wordpress:beta-5.8-beta4-php7.3-apache` - linux; arm variant v7
...
### `wordpress:beta-5.8-beta4-php7.3-apache` - linux; arm64 variant v8
...
### `wordpress:beta-5.8-beta4-php7.3-apache` - linux; 386
...
### `wordpress:beta-5.8-beta4-php7.3-apache` - linux; mips64le
...
### `wordpress:beta-5.8-beta4-php7.3-apache` - linux; ppc64le
