...
```console
$ docker pull wordpress@sha256:eb2f7202c50afd752717c459cd58ed0588c0b703e87b9a048ad1a9ccfaad0cd7
```
...
### `wordpress:beta-5.9.1-RC1-php8.0-fpm` - linux; amd64
...
### `wordpress:beta-5.9.1-RC1-php8.0-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.9.1-RC1-php8.0-fpm` - linux; arm variant v7
...
### `wordpress:beta-5.9.1-RC1-php8.0-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-5.9.1-RC1-php8.0-fpm` - linux; mips64le
...
### `wordpress:beta-5.9.1-RC1-php8.0-fpm` - linux; ppc64le
...
### `wordpress:beta-5.9.1-RC1-php8.0-fpm` - linux; s390x
