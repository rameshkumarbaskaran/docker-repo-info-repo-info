...
### `wordpress:6.3.2-php8.2-apache` - linux; amd64
...
### `wordpress:6.3.2-php8.2-apache` - linux; arm64 variant v8
...
### `wordpress:6.3.2-php8.2-apache` - linux; 386
...
### `wordpress:6.3.2-php8.2-apache` - linux; mips64le
...
### `wordpress:6.3.2-php8.2-apache` - linux; s390x
