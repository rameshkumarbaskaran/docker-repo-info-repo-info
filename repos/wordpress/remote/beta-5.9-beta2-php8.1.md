...
```console
$ docker pull wordpress@sha256:89358c9a9498672bf79d6fedf5fa46284400db0bbab8994d7135fca7f32a113e
```
...
### `wordpress:beta-5.9-beta2-php8.1` - linux; amd64
...
### `wordpress:beta-5.9-beta2-php8.1` - linux; arm variant v5
...
### `wordpress:beta-5.9-beta2-php8.1` - linux; 386
...
### `wordpress:beta-5.9-beta2-php8.1` - linux; mips64le
...
### `wordpress:beta-5.9-beta2-php8.1` - linux; ppc64le
...
### `wordpress:beta-5.9-beta2-php8.1` - linux; s390x
