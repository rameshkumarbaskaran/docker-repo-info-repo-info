## `wordpress:beta-6.0.1-php8.0-fpm-alpine`

```console
$ docker pull wordpress@sha256:4c51fcee73247a4f453392476e1c19774cb956b65e16a6868bf8cb06a7004635
```
...
### `wordpress:beta-6.0.1-php8.0-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.0.1-php8.0-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.0.1-php8.0-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.0.1-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.0.1-php8.0-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.0.1-php8.0-fpm-alpine` - linux; s390x
