...
```console
$ docker pull wordpress@sha256:aec6d0251b8b5a633b2db5b5321b8373663591b828bb519e027acae637095267
```
...
### `wordpress:beta-5.9-RC3-php7.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-5.9-RC3-php7.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-5.9-RC3-php7.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-5.9-RC3-php7.3-fpm-alpine` - linux; 386
...
### `wordpress:beta-5.9-RC3-php7.3-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-5.9-RC3-php7.3-fpm-alpine` - linux; s390x
