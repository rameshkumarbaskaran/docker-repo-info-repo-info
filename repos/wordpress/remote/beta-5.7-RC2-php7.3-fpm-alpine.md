## `wordpress:beta-5.7-RC2-php7.3-fpm-alpine`

```console
$ docker pull wordpress@sha256:6c83ead2f914b45f872ead04a358ecb98e1658bfb0df97ed1ab137fc9ccdfe3a
```
...
### `wordpress:beta-5.7-RC2-php7.3-fpm-alpine` - linux; amd64
...
### `wordpress:beta-5.7-RC2-php7.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-5.7-RC2-php7.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-5.7-RC2-php7.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-5.7-RC2-php7.3-fpm-alpine` - linux; 386
...
### `wordpress:beta-5.7-RC2-php7.3-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-5.7-RC2-php7.3-fpm-alpine` - linux; s390x
