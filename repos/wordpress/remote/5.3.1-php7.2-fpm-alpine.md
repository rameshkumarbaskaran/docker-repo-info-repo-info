...
```console
$ docker pull wordpress@sha256:09d338c6db6bec187320aaf57f829d47e6b828abf3b44b904a9aa03215dde9b8
```
...
### `wordpress:5.3.1-php7.2-fpm-alpine` - linux; amd64
...
### `wordpress:5.3.1-php7.2-fpm-alpine` - linux; 386
...
### `wordpress:5.3.1-php7.2-fpm-alpine` - linux; ppc64le
