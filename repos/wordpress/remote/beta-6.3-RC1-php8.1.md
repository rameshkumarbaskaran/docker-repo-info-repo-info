...
### `wordpress:beta-6.3-RC1-php8.1` - linux; amd64
...
### `wordpress:beta-6.3-RC1-php8.1` - linux; arm variant v5
...
### `wordpress:beta-6.3-RC1-php8.1` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC1-php8.1` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC1-php8.1` - linux; 386
...
### `wordpress:beta-6.3-RC1-php8.1` - linux; mips64le
...
### `wordpress:beta-6.3-RC1-php8.1` - linux; ppc64le
...
### `wordpress:beta-6.3-RC1-php8.1` - linux; s390x
