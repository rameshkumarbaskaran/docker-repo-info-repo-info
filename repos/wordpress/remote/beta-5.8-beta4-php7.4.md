...
```console
$ docker pull wordpress@sha256:c691b75fa5d652577338cbf743a72fe6cda83a6fb5767b4f78df38f5a9edc76e
```
...
### `wordpress:beta-5.8-beta4-php7.4` - linux; amd64
...
### `wordpress:beta-5.8-beta4-php7.4` - linux; arm variant v5
...
### `wordpress:beta-5.8-beta4-php7.4` - linux; arm variant v7
...
### `wordpress:beta-5.8-beta4-php7.4` - linux; arm64 variant v8
...
### `wordpress:beta-5.8-beta4-php7.4` - linux; 386
...
### `wordpress:beta-5.8-beta4-php7.4` - linux; mips64le
...
### `wordpress:beta-5.8-beta4-php7.4` - linux; ppc64le
