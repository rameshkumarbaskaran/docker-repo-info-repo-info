...
```console
$ docker pull wordpress@sha256:22ca328fa5697841a4cf1bca640f24e17de29166236ff49c735601f788fa0f50
```
...
### `wordpress:beta-6.0-beta3-php8.0-apache` - linux; amd64
...
### `wordpress:beta-6.0-beta3-php8.0-apache` - linux; arm variant v5
...
### `wordpress:beta-6.0-beta3-php8.0-apache` - linux; arm variant v7
...
### `wordpress:beta-6.0-beta3-php8.0-apache` - linux; 386
...
### `wordpress:beta-6.0-beta3-php8.0-apache` - linux; mips64le
...
### `wordpress:beta-6.0-beta3-php8.0-apache` - linux; s390x
