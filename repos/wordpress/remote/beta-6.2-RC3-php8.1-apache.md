## `wordpress:beta-6.2-RC3-php8.1-apache`

```console
$ docker pull wordpress@sha256:9506535e149fa603e79b4b88c102834a3f47d36b0eaf5f4558fd9a732f676e62
```
...
### `wordpress:beta-6.2-RC3-php8.1-apache` - linux; amd64
...
### `wordpress:beta-6.2-RC3-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-RC3-php8.1-apache` - linux; mips64le
