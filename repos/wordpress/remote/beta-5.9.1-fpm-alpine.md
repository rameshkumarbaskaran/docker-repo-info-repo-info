...
```console
$ docker pull wordpress@sha256:217e4fd9d6ef7762adf02f202edf41766703c539a3da60a0216e93f7c0c7d279
```
...
### `wordpress:beta-5.9.1-fpm-alpine` - linux; amd64
...
### `wordpress:beta-5.9.1-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-5.9.1-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-5.9.1-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-5.9.1-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-5.9.1-fpm-alpine` - linux; s390x
