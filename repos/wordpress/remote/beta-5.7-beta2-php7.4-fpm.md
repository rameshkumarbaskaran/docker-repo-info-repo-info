## `wordpress:beta-5.7-beta2-php7.4-fpm`

```console
$ docker pull wordpress@sha256:0e8ae6132b8eba698802c459cc492cd3a990b3195ce7c640ae19081804235d2b
```
...
### `wordpress:beta-5.7-beta2-php7.4-fpm` - linux; amd64
...
### `wordpress:beta-5.7-beta2-php7.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.7-beta2-php7.4-fpm` - linux; arm variant v7
...
### `wordpress:beta-5.7-beta2-php7.4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-5.7-beta2-php7.4-fpm` - linux; 386
...
### `wordpress:beta-5.7-beta2-php7.4-fpm` - linux; mips64le
...
### `wordpress:beta-5.7-beta2-php7.4-fpm` - linux; s390x
