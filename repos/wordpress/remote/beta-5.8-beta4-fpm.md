...
```console
$ docker pull wordpress@sha256:2aa408b88ce28b467dd3a28077c24a4bc55ee38401936be95fff16ed9d0b2a18
```
...
### `wordpress:beta-5.8-beta4-fpm` - linux; amd64
...
### `wordpress:beta-5.8-beta4-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.8-beta4-fpm` - linux; arm variant v7
...
### `wordpress:beta-5.8-beta4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-5.8-beta4-fpm` - linux; 386
...
### `wordpress:beta-5.8-beta4-fpm` - linux; mips64le
...
### `wordpress:beta-5.8-beta4-fpm` - linux; ppc64le
