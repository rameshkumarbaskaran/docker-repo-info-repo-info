...
```console
$ docker pull wordpress@sha256:fa37c89ec805c67fdd87f769cb7efaf861a93beab06d3964ce5c4ad80d9abb70
```
...
### `wordpress:beta-6.0-beta3-fpm` - linux; amd64
...
### `wordpress:beta-6.0-beta3-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.0-beta3-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.0-beta3-fpm` - linux; 386
...
### `wordpress:beta-6.0-beta3-fpm` - linux; mips64le
...
### `wordpress:beta-6.0-beta3-fpm` - linux; s390x
