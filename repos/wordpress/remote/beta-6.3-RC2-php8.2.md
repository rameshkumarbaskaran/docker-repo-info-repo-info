...
```console
$ docker pull wordpress@sha256:de4edb146af21d68a9c38877a0f47bdad92dc733fd7d7165a2e211b4ade56845
```
...
### `wordpress:beta-6.3-RC2-php8.2` - linux; amd64
...
### `wordpress:beta-6.3-RC2-php8.2` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC2-php8.2` - linux; ppc64le
...
### `wordpress:beta-6.3-RC2-php8.2` - linux; s390x
