...
```console
$ docker pull wordpress@sha256:3d3e022c2405be685c4e4a23fe9782ad9c18b3dd3ede1bbb5788a4389edba859
```
...
### `wordpress:beta-5.9-beta2-fpm` - linux; amd64
...
### `wordpress:beta-5.9-beta2-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.9-beta2-fpm` - linux; 386
...
### `wordpress:beta-5.9-beta2-fpm` - linux; mips64le
...
### `wordpress:beta-5.9-beta2-fpm` - linux; ppc64le
...
### `wordpress:beta-5.9-beta2-fpm` - linux; s390x
