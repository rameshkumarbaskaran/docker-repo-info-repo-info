...
### `wordpress:6.2.0-php8.0-fpm-alpine` - linux; arm variant v6
...
### `wordpress:6.2.0-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:6.2.0-php8.0-fpm-alpine` - linux; 386
...
### `wordpress:6.2.0-php8.0-fpm-alpine` - linux; s390x
