...
```console
$ docker pull wordpress@sha256:e2d4541ec68f06701c970f7ada963d9b2663611d0a557f2ecd59ec13ced3b4a1
```
...
### `wordpress:beta-6.4-beta2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.4-beta2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:beta-6.4-beta2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.4-beta2-fpm-alpine` - linux; 386
