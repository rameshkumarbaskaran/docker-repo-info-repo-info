...
```console
$ docker pull wordpress@sha256:f36df272ae5e0fcd6db8caf877f1c3b906961bc87c088e8606d136c19a53fe0f
```
...
### `wordpress:beta-6.2-RC4-fpm` - linux; amd64
...
### `wordpress:beta-6.2-RC4-fpm` - linux; arm variant v5
...
### `wordpress:beta-6.2-RC4-fpm` - linux; arm variant v7
...
### `wordpress:beta-6.2-RC4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-RC4-fpm` - linux; 386
...
### `wordpress:beta-6.2-RC4-fpm` - linux; mips64le
...
### `wordpress:beta-6.2-RC4-fpm` - linux; ppc64le
...
### `wordpress:beta-6.2-RC4-fpm` - linux; s390x
