...
```console
$ docker pull wordpress@sha256:85db2396b356a63058e2f102ffa896e2ddd07cc43a956b80f61d4efadd51d273
```
...
### `wordpress:beta-6.0-beta3-apache` - linux; amd64
...
### `wordpress:beta-6.0-beta3-apache` - linux; arm variant v5
...
### `wordpress:beta-6.0-beta3-apache` - linux; arm variant v7
...
### `wordpress:beta-6.0-beta3-apache` - linux; 386
...
### `wordpress:beta-6.0-beta3-apache` - linux; mips64le
...
### `wordpress:beta-6.0-beta3-apache` - linux; s390x
