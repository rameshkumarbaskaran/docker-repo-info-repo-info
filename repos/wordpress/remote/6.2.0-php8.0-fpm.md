...
### `wordpress:6.2.0-php8.0-fpm` - linux; arm variant v5
...
### `wordpress:6.2.0-php8.0-fpm` - linux; arm64 variant v8
...
### `wordpress:6.2.0-php8.0-fpm` - linux; 386
...
### `wordpress:6.2.0-php8.0-fpm` - linux; s390x
