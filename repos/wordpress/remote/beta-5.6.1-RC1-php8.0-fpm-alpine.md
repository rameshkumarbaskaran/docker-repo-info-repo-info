...
```console
$ docker pull wordpress@sha256:97f4a4cbd3dd90c9d9b067b69c39ede4cb72a57e16113f3f34b2fefb7ce92035
```
...
### `wordpress:beta-5.6.1-RC1-php8.0-fpm-alpine` - linux; amd64
...
### `wordpress:beta-5.6.1-RC1-php8.0-fpm-alpine` - linux; 386
...
### `wordpress:beta-5.6.1-RC1-php8.0-fpm-alpine` - linux; ppc64le
