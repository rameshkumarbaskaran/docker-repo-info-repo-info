...
```console
$ docker pull wordpress@sha256:d1216246e54bdd205ba7eb8d970768fb129f7f12a71ee1020120eecaa54c3a9b
```
...
### `wordpress:beta-6.3-RC1-php8.2-fpm-alpine` - linux; amd64
...
### `wordpress:beta-6.3-RC1-php8.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC1-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC1-php8.2-fpm-alpine` - linux; 386
...
### `wordpress:beta-6.3-RC1-php8.2-fpm-alpine` - linux; ppc64le
...
### `wordpress:beta-6.3-RC1-php8.2-fpm-alpine` - linux; s390x
