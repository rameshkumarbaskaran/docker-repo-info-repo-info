...
### `wordpress:beta-6.2-RC5-php8.1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.2-RC5-php8.1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.2-RC5-php8.1-apache` - linux; 386
...
### `wordpress:beta-6.2-RC5-php8.1-apache` - linux; s390x
