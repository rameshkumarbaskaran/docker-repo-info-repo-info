...
### `wordpress:beta-6.3-RC1-apache` - linux; arm variant v7
...
### `wordpress:beta-6.3-RC1-apache` - linux; arm64 variant v8
...
### `wordpress:beta-6.3-RC1-apache` - linux; ppc64le
...
### `wordpress:beta-6.3-RC1-apache` - linux; s390x
