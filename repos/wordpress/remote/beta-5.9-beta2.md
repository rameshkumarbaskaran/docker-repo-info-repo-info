...
```console
$ docker pull wordpress@sha256:6d429315a7e37a7269425d737317c330921f880216740c1f0c96585dda9045a7
```
...
### `wordpress:beta-5.9-beta2` - linux; amd64
...
### `wordpress:beta-5.9-beta2` - linux; arm variant v5
...
### `wordpress:beta-5.9-beta2` - linux; 386
...
### `wordpress:beta-5.9-beta2` - linux; mips64le
...
### `wordpress:beta-5.9-beta2` - linux; ppc64le
...
### `wordpress:beta-5.9-beta2` - linux; s390x
