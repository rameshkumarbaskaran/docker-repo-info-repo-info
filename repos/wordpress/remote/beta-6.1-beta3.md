...
```console
$ docker pull wordpress@sha256:3a070f4a6b48fc7848d7982c1f8747363dc76a927fb5b48917b10314bca76c59
```
...
### `wordpress:beta-6.1-beta3` - linux; amd64
...
### `wordpress:beta-6.1-beta3` - linux; arm variant v5
...
### `wordpress:beta-6.1-beta3` - linux; arm64 variant v8
...
### `wordpress:beta-6.1-beta3` - linux; 386
...
### `wordpress:beta-6.1-beta3` - linux; ppc64le
...
### `wordpress:beta-6.1-beta3` - linux; s390x
