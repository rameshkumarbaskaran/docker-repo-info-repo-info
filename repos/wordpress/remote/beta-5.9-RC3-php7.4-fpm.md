...
```console
$ docker pull wordpress@sha256:d84968cd88d84f5e5f583d37eda0004a8965cb5f7b6bd0a4d9ae8d251af965dd
```
...
### `wordpress:beta-5.9-RC3-php7.4-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.9-RC3-php7.4-fpm` - linux; arm variant v7
...
### `wordpress:beta-5.9-RC3-php7.4-fpm` - linux; arm64 variant v8
...
### `wordpress:beta-5.9-RC3-php7.4-fpm` - linux; 386
...
### `wordpress:beta-5.9-RC3-php7.4-fpm` - linux; mips64le
...
### `wordpress:beta-5.9-RC3-php7.4-fpm` - linux; ppc64le
...
### `wordpress:beta-5.9-RC3-php7.4-fpm` - linux; s390x
