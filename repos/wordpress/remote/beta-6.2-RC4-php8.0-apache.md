...
### `wordpress:beta-6.2-RC4-php8.0-apache` - linux; amd64
...
### `wordpress:beta-6.2-RC4-php8.0-apache` - linux; 386
...
### `wordpress:beta-6.2-RC4-php8.0-apache` - linux; mips64le
...
### `wordpress:beta-6.2-RC4-php8.0-apache` - linux; ppc64le
