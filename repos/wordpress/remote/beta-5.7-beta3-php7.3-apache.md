...
```console
$ docker pull wordpress@sha256:4f5f1e9379f9ba0b0a3088706d3aceed5ca220df5f9fa9bcf00b741a36df84b6
```
...
### `wordpress:beta-5.7-beta3-php7.3-apache` - linux; amd64
...
### `wordpress:beta-5.7-beta3-php7.3-apache` - linux; arm variant v5
...
### `wordpress:beta-5.7-beta3-php7.3-apache` - linux; arm64 variant v8
...
### `wordpress:beta-5.7-beta3-php7.3-apache` - linux; 386
...
### `wordpress:beta-5.7-beta3-php7.3-apache` - linux; mips64le
...
### `wordpress:beta-5.7-beta3-php7.3-apache` - linux; s390x
