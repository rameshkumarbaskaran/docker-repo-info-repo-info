...
```console
$ docker pull wordpress@sha256:e7e571698ae6003c25ec37d0a77825a470f64845230b44d4b77648eb3b0acb20
```
...
### `wordpress:beta-5.9-beta2-php7.3-fpm` - linux; amd64
...
### `wordpress:beta-5.9-beta2-php7.3-fpm` - linux; arm variant v5
...
### `wordpress:beta-5.9-beta2-php7.3-fpm` - linux; 386
...
### `wordpress:beta-5.9-beta2-php7.3-fpm` - linux; mips64le
...
### `wordpress:beta-5.9-beta2-php7.3-fpm` - linux; ppc64le
...
### `wordpress:beta-5.9-beta2-php7.3-fpm` - linux; s390x
