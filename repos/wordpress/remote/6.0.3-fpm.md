...
### `wordpress:6.0.3-fpm` - linux; amd64
...
### `wordpress:6.0.3-fpm` - linux; arm variant v5
...
### `wordpress:6.0.3-fpm` - linux; arm variant v7
...
### `wordpress:6.0.3-fpm` - linux; arm64 variant v8
...
### `wordpress:6.0.3-fpm` - linux; mips64le
...
### `wordpress:6.0.3-fpm` - linux; ppc64le
...
### `wordpress:6.0.3-fpm` - linux; s390x
