...
- Created: `2020-12-12T01:43:27.711859005Z`
- Virtual Size: ~ 130.91 Mb  
...
```console
mariadb-client-10.4.15-r0 description:
Client for the MariaDB database

mariadb-client-10.4.15-r0 webpage:
https://www.mariadb.org/

mariadb-client-10.4.15-r0 installed size:
29753344

mariadb-client-10.4.15-r0 license:
GPL-2.0-or-later
...
```console
mariadb-common-10.4.15-r0 description:
MariaDB common files for both server and client

mariadb-common-10.4.15-r0 webpage:
https://www.mariadb.org/

mariadb-common-10.4.15-r0 installed size:
2265088

mariadb-common-10.4.15-r0 license:
GPL-2.0-or-later
...
```console
mysql-client-10.4.15-r0 description:
Dummy package for mysql-client migration

mysql-client-10.4.15-r0 webpage:
https://www.mariadb.org/

mysql-client-10.4.15-r0 installed size:
4096

mysql-client-10.4.15-r0 license:
GPL-2.0-or-later
