...
```console
$ docker pull python@sha256:c1ae33bdca2dbc6e43071465390ef4a5aec6af31ce2ef1d62a53756bef22a3ca
```
...
### `python:3.8.6-windowsservercore` - windows version 10.0.17763.1577; amd64
...
### `python:3.8.6-windowsservercore` - windows version 10.0.14393.4046; amd64
