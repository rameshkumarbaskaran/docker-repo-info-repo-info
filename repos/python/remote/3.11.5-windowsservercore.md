...
```console
$ docker pull python@sha256:d80b99d74aea127674d43c3e42d572bd2c718d6355680eeafdc1368ecb821daf
```
...
### `python:3.11.5-windowsservercore` - windows version 10.0.20348.1906; amd64
...
### `python:3.11.5-windowsservercore` - windows version 10.0.17763.4737; amd64
