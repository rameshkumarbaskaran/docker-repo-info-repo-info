...
```console
$ docker pull python@sha256:92aed0ceff029d2d916f4790d12123558ae8f5a40a114afb66b73197e3c4f4fc
```
...
### `python:3.11.1-windowsservercore` - windows version 10.0.20348.1487; amd64
...
### `python:3.11.1-windowsservercore` - windows version 10.0.17763.3887; amd64
