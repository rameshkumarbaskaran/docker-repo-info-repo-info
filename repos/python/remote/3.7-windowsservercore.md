...
```console
$ docker pull python@sha256:3119da46dceb8fb203382c76110fd9ad08fc0625bc2407c2c2a6ea61a6331124
```
...
### `python:3.7-windowsservercore` - windows version 10.0.14393.3930; amd64
...
### `python:3.7-windowsservercore` - windows version 10.0.17763.1457; amd64
