...
```console
$ docker pull python@sha256:9b6ccabea41510e4bdc3e6ac74c152aca472c518788d7d0afae2a8dc247a506e
```
...
### `python:3.10.0b1-windowsservercore-1809` - windows version 10.0.17763.1879; amd64
