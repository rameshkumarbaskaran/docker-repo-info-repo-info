...
```console
$ docker pull ruby@sha256:41c1bfa3cdcd402e676a9e0e908d56d64979f0e5b66ec052fb9deaacf629ee2a
```
...
### `ruby:2.4.10-slim` - linux; arm variant v5
