...
### `ruby:3.0.1-alpine3.12` - linux; amd64
...
### `ruby:3.0.1-alpine3.12` - linux; arm variant v6
...
### `ruby:3.0.1-alpine3.12` - linux; arm variant v7
...
### `ruby:3.0.1-alpine3.12` - linux; arm64 variant v8
...
### `ruby:3.0.1-alpine3.12` - linux; 386
...
### `ruby:3.0.1-alpine3.12` - linux; ppc64le
