...
```console
$ docker pull ruby@sha256:ba2e404940dd8b1bdcdf9add9fe7e2ec3072cb89d57082273b7d99b8d9d8ee7b
```
...
### `ruby:2.4.10-buster` - linux; arm variant v5
...
### `ruby:2.4.10-buster` - linux; s390x
