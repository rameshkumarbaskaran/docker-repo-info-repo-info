...
### `yourls:1.7.5-fpm-alpine` - linux; amd64
...
### `yourls:1.7.5-fpm-alpine` - linux; arm variant v6
...
### `yourls:1.7.5-fpm-alpine` - linux; arm variant v7
...
### `yourls:1.7.5-fpm-alpine` - linux; arm64 variant v8
...
### `yourls:1.7.5-fpm-alpine` - linux; 386
...
### `yourls:1.7.5-fpm-alpine` - linux; ppc64le
