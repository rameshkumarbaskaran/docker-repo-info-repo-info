...
- Created: `2021-03-06T00:38:59.014060453Z`
- Virtual Size: ~ 642.80 Mb  
...
- Environment:
  ...
  - `JAVA_VERSION=8u282`
  - `GOSU_VERSION=1.11`
  - `FLINK_TGZ_URL=https://www.apache.org/dyn/closer.cgi?action=download&filename=flink/flink-1.12.2/flink-1.12.2-bin-scala_2.12.tgz`
  - `FLINK_ASC_URL=https://www.apache.org/dist/flink/flink-1.12.2/flink-1.12.2-bin-scala_2.12.tgz.asc`
...
- http://snapshot.debian.org/package/openssl/1.1.1d-0+deb10u4/
