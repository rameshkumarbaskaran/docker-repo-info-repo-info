...
- Created: `2023-05-17T23:21:51.908260624Z`
- Virtual Size: ~ 150.68 Mb  
...
- Labels:
  ...
  - `org.opencontainers.image.version=1.14.7`
...
```console
curl-8.1.0-r0 description:
URL retrival utility and library

curl-8.1.0-r0 webpage:
https://curl.se/

curl-8.1.0-r0 installed size:
268 KiB

curl-8.1.0-r0 license:
MIT
...
```console
libcurl-8.1.0-r0 description:
The multiprotocol file transfer library

libcurl-8.1.0-r0 webpage:
https://curl.se/

libcurl-8.1.0-r0 installed size:
568 KiB

libcurl-8.1.0-r0 license:
MIT
