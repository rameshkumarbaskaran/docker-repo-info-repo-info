...
- Created: `2023-07-25T00:18:37.172791197Z`
...
### `rpm` package: `curl-8.1.2-2.ph4.x86_64`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `curl-libs-8.1.2-2.ph4.x86_64`
...
### `rpm` package: `libssh2-1.10.0-1.ph4.x86_64`

Licenses (from `rpm --query`): BSD

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `libxml2-2.9.12-9.ph4.x86_64`
...
### `rpm` package: `openssl-3.0.9-2.ph4.x86_64`
...
### `rpm` package: `pkg-config-0.29.2-5.ph4.x86_64`
...
### `rpm` package: `rpm-libs-4.16.1.3-17.ph4.x86_64`
