...
- Created: `2023-07-10T20:58:19.300129326Z`
...
### `rpm` package: `curl-8.1.1-2.ph4.x86_64`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `curl-libs-8.1.1-2.ph4.x86_64`
...
### `rpm` package: `openssl-3.0.9-1.ph4.x86_64`
