...
- Created: `2022-03-05T02:17:15.83716497Z`
...
### `rpm` package: `expat-2.2.9-8.ph3.x86_64`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `expat-libs-2.2.9-8.ph3.x86_64`
...
### `rpm` package: `photon-repos-3.0-6.ph3.noarch`
