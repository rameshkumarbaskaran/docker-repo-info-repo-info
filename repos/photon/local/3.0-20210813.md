...
- Created: `2021-08-14T00:20:54.066627788Z`
...
### `rpm` package: `curl-7.75.0-5.ph3.x86_64`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `curl-libs-7.75.0-5.ph3.x86_64`
...
### `rpm` package: `rpm-libs-4.14.2-14.ph3.x86_64`
