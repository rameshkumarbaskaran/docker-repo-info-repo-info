...
```console
$ docker pull julia@sha256:ebfa59bb41104232861709109dd4bf1aa91053f6b61e28c0f605231221ab30c3
```
...
### `julia:1.9-alpine3.16` - linux; amd64
...
### `julia:1.9.0-alpine3.16` - linux; amd64
