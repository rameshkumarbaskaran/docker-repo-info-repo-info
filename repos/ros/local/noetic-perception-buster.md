...
- Created: `2022-01-26T23:13:08.875372314Z`
...
### `dpkg` source package: `armadillo=1:9.200.7+dfsg-1`
...
```console
$ apt-get source -qq --print-uris armadillo=1:9.200.7+dfsg-1
'http://deb.debian.org/debian/pool/main/a/armadillo/armadillo_9.200.7%2bdfsg-1.dsc' armadillo_9.200.7+dfsg-1.dsc 2154 SHA256:b1d4d2b402fa0272f18d59daaac34df51dc2eb5d4803a64ad8467be1127bbecc
'http://deb.debian.org/debian/pool/main/a/armadillo/armadillo_9.200.7%2bdfsg.orig.tar.xz' armadillo_9.200.7+dfsg.orig.tar.xz 535500 SHA256:d0e162aa7c79bb0998f1a975824935324b09920ef97d0d6fb815d2fa05cb7b36
'http://deb.debian.org/debian/pool/main/a/armadillo/armadillo_9.200.7%2bdfsg-1.debian.tar.xz' armadillo_9.200.7+dfsg-1.debian.tar.xz 6628 SHA256:61fac2c85057d1379d8e561884d65fcd494822379300593f04077f6f67f7afa6
```

Other potentially useful URLs:

- https://sources.debian.net/src/armadillo/1:9.200.7+dfsg-1/ (for browsing the source)
- https://sources.debian.net/src/armadillo/1:9.200.7+dfsg-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/armadillo/1:9.200.7+dfsg-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `arpack=3.7.0-2`

Binary Packages:

- `libarpack2:amd64=3.7.0-2`
- `libarpack2-dev:amd64=3.7.0-2`
...
```console
$ apt-get source -qq --print-uris arpack=3.7.0-2
'http://deb.debian.org/debian/pool/main/a/arpack/arpack_3.7.0-2.dsc' arpack_3.7.0-2.dsc 2183 SHA256:07cd2bb12dd05de066093267ac1fdaa354133497c742b442142154534fb63da8
'http://deb.debian.org/debian/pool/main/a/arpack/arpack_3.7.0.orig.tar.gz' arpack_3.7.0.orig.tar.gz 989570 SHA256:972e3fc3cd0b9d6b5a737c9bf6fd07515c0d6549319d4ffb06970e64fa3cc2d6
'http://deb.debian.org/debian/pool/main/a/arpack/arpack_3.7.0-2.debian.tar.xz' arpack_3.7.0-2.debian.tar.xz 9212 SHA256:aa4522861be6464eb94bcb27f051cd93689246bfd8bf6359a43f80b4feccf159
```

Other potentially useful URLs:

- https://sources.debian.net/src/arpack/3.7.0-2/ (for browsing the source)
- https://sources.debian.net/src/arpack/3.7.0-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/arpack/3.7.0-2/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/a/automat/automat_0.6.0-1.dsc' automat_0.6.0-1.dsc 2377 SHA256:f86719efaaa6c5891615da588ea4e9db944446a2a6fc217a018fd3e1a6a560de
'http://deb.debian.org/debian/pool/main/a/automat/automat_0.6.0.orig.tar.gz' automat_0.6.0.orig.tar.gz 31767 SHA256:3c1fd04ecf08ac87b4dd3feae409542e9bf7827257097b2b6ed5692f69d6f6a8
'http://deb.debian.org/debian/pool/main/a/automat/automat_0.6.0-1.debian.tar.xz' automat_0.6.0-1.debian.tar.xz 2732 SHA256:0b94086d0bea5eefcb4bb41e90c1b08938d906dd8a567baa4b6484a3c6a01449
```

Other potentially useful URLs:

- https://sources.debian.net/src/automat/0.6.0-1/ (for browsing the source)
- https://sources.debian.net/src/automat/0.6.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/automat/0.6.0-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `charls=2.0.0+dfsg-1`

Binary Packages:

- `libcharls-dev:amd64=2.0.0+dfsg-1`
- `libcharls2:amd64=2.0.0+dfsg-1`
...
```console
$ apt-get source -qq --print-uris charls=2.0.0+dfsg-1
'http://deb.debian.org/debian/pool/main/c/charls/charls_2.0.0%2bdfsg-1.dsc' charls_2.0.0+dfsg-1.dsc 2020 SHA256:47e52faf488e03e200605c26900690987c3dc8c2a1764120f2345d15d8d03a8c
'http://deb.debian.org/debian/pool/main/c/charls/charls_2.0.0%2bdfsg.orig.tar.xz' charls_2.0.0+dfsg.orig.tar.xz 244076 SHA256:678dc217bb18648f139fdffa0bc3c3a6703ab5a65011138156b49781b3bac17e
'http://deb.debian.org/debian/pool/main/c/charls/charls_2.0.0%2bdfsg-1.debian.tar.xz' charls_2.0.0+dfsg-1.debian.tar.xz 4720 SHA256:2a56c50528111304b9ae75bf75cf4dd7a7c564ac6456cdc3d067c3ad542e4086
```

Other potentially useful URLs:

- https://sources.debian.net/src/charls/2.0.0+dfsg-1/ (for browsing the source)
- https://sources.debian.net/src/charls/2.0.0+dfsg-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/charls/2.0.0+dfsg-1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/c/crystalhd/crystalhd_0.0%7egit20110715.fdd2f19-13.dsc' crystalhd_0.0~git20110715.fdd2f19-13.dsc 2363 SHA256:c545c6e51bdd03a34a1f311eb5d52b1316ba9f365cdbba39a1b0fa413ed3df76
'http://deb.debian.org/debian/pool/main/c/crystalhd/crystalhd_0.0%7egit20110715.fdd2f19.orig.tar.gz' crystalhd_0.0~git20110715.fdd2f19.orig.tar.gz 1186072 SHA256:a1c22908b85085dcc4591bc033fe054be63eab59b7d35f0a9ab3fcb2600722b7
'http://deb.debian.org/debian/pool/main/c/crystalhd/crystalhd_0.0%7egit20110715.fdd2f19-13.debian.tar.xz' crystalhd_0.0~git20110715.fdd2f19-13.debian.tar.xz 15320 SHA256:66308990232a5a91501f5243946a95a03ef36e922f6704c18d4ea380e02ce9bb
```
...
- `libcurl4-gnutls-dev:amd64=7.64.0-4+deb10u2`
...
### `dpkg` source package: `cython=0.29.2-2`
...
```console
$ apt-get source -qq --print-uris cython=0.29.2-2
'http://deb.debian.org/debian/pool/main/c/cython/cython_0.29.2-2.dsc' cython_0.29.2-2.dsc 2517 SHA256:88f81242651a53916078bc3e179aee8f71c3a20a3816385a5b74d7f390e60006
'http://deb.debian.org/debian/pool/main/c/cython/cython_0.29.2.orig.tar.gz' cython_0.29.2.orig.tar.gz 2041500 SHA256:2ac187ff998a95abb7fae452b5178f91e1a713698c9ced89836c94e6b1d3f41e
'http://deb.debian.org/debian/pool/main/c/cython/cython_0.29.2-2.debian.tar.xz' cython_0.29.2-2.debian.tar.xz 25468 SHA256:a095c4d34e73a8e36a96236825d650dd58eedf9a2dff88df035d643252af4b53
```

Other potentially useful URLs:

- https://sources.debian.net/src/cython/0.29.2-2/ (for browsing the source)
- https://sources.debian.net/src/cython/0.29.2-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/cython/0.29.2-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `distro-info-data=0.41+deb10u4`
...
```console
$ apt-get source -qq --print-uris distro-info-data=0.41+deb10u4
'http://deb.debian.org/debian/pool/main/d/distro-info-data/distro-info-data_0.41%2bdeb10u4.dsc' distro-info-data_0.41+deb10u4.dsc 1070 SHA256:a06a76f301d12584cd8da00f63fe4ab440767e4d0188cb2fcedfa511bf2b2252
'http://deb.debian.org/debian/pool/main/d/distro-info-data/distro-info-data_0.41%2bdeb10u4.tar.xz' distro-info-data_0.41+deb10u4.tar.xz 7368 SHA256:1dccf7b8729c58c781d0931f7b8933884eaf00bb1ffcbe147b2e89c4bfaa7915
```

Other potentially useful URLs:

- https://sources.debian.net/src/distro-info-data/0.41+deb10u4/ (for browsing the source)
- https://sources.debian.net/src/distro-info-data/0.41+deb10u4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/distro-info-data/0.41+deb10u4/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `double-conversion=3.1.0-3`
...
```console
$ apt-get source -qq --print-uris double-conversion=3.1.0-3
'http://deb.debian.org/debian/pool/main/d/double-conversion/double-conversion_3.1.0-3.dsc' double-conversion_3.1.0-3.dsc 2178 SHA256:1270ad29562f39bf45f04a2c13b1fa1359c2041b8d35e44ff856b29da9573f40
'http://deb.debian.org/debian/pool/main/d/double-conversion/double-conversion_3.1.0.orig.tar.gz' double-conversion_3.1.0.orig.tar.gz 7022475 SHA256:aef5f528dab826b269b54766a4c2d179e361866c75717af529f91c56b4034665
'http://deb.debian.org/debian/pool/main/d/double-conversion/double-conversion_3.1.0-3.debian.tar.xz' double-conversion_3.1.0-3.debian.tar.xz 7396 SHA256:18bee0cb39bfc01dd66365c7c2800150f63cac0e3dcff9a925ee265004775491
```

Other potentially useful URLs:

- https://sources.debian.net/src/double-conversion/3.1.0-3/ (for browsing the source)
- https://sources.debian.net/src/double-conversion/3.1.0-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/double-conversion/3.1.0-3/ (for access to the source package after it no longer exists in the archive)
...
'http://security.debian.org/debian-security/pool/updates/main/f/ffmpeg/ffmpeg_4.1.8-0%2bdeb10u1.dsc' ffmpeg_4.1.8-0+deb10u1.dsc 5211 SHA256:72f0b6eed9bccdfe92c80f33a18fd4f4ebbea3d4b1f3ceca958687cae4f66419
'http://security.debian.org/debian-security/pool/updates/main/f/ffmpeg/ffmpeg_4.1.8.orig.tar.xz' ffmpeg_4.1.8.orig.tar.xz 8920648 SHA256:715db4b6142d0587db82ba8049e4de117f08530cca5f50f5d6490d89ea1138c4
'http://security.debian.org/debian-security/pool/updates/main/f/ffmpeg/ffmpeg_4.1.8.orig.tar.xz.asc' ffmpeg_4.1.8.orig.tar.xz.asc 520 SHA256:f36e4e41bd700d74af42932252dfc08077f511de32af9ad02dda9e0f1b198af8
'http://security.debian.org/debian-security/pool/updates/main/f/ffmpeg/ffmpeg_4.1.8-0%2bdeb10u1.debian.tar.xz' ffmpeg_4.1.8-0+deb10u1.debian.tar.xz 47964 SHA256:ec7efcade23617aa89093b6afde8f3128c8fec9e5dd4fa747669bc6f46b9ddf4
```
...
### `dpkg` source package: `flann=1.9.1+dfsg-7`

Binary Packages:

- `libflann-dev:amd64=1.9.1+dfsg-7`
- `libflann1.9:amd64=1.9.1+dfsg-7`
...
```console
$ apt-get source -qq --print-uris flann=1.9.1+dfsg-7
'http://deb.debian.org/debian/pool/main/f/flann/flann_1.9.1%2bdfsg-7.dsc' flann_1.9.1+dfsg-7.dsc 2385 SHA256:8f3f2754c864a28eb8c316079a53b1cdeba1fd788fee65734dde02e22df9a203
'http://deb.debian.org/debian/pool/main/f/flann/flann_1.9.1%2bdfsg.orig.tar.gz' flann_1.9.1+dfsg.orig.tar.gz 478803 SHA256:6cc1d97f504542b5f07c7eff46e87f5c9a67254b6d86ec500b15c1b7c51e1b61
'http://deb.debian.org/debian/pool/main/f/flann/flann_1.9.1%2bdfsg-7.debian.tar.xz' flann_1.9.1+dfsg-7.debian.tar.xz 8352 SHA256:83111da05f3193cce81a54d734b8c2919ca0c90bf2d52bfba3be848837436c60
```

Other potentially useful URLs:

- https://sources.debian.net/src/flann/1.9.1+dfsg-7/ (for browsing the source)
- https://sources.debian.net/src/flann/1.9.1+dfsg-7/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/flann/1.9.1+dfsg-7/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/f/freexl/freexl_1.0.5-3.dsc' freexl_1.0.5-3.dsc 2034 SHA256:8fae2a16bcde6e2f26209fc9a0bc1cbc97dcacd542b9047c6a78485134e52c2c
'http://deb.debian.org/debian/pool/main/f/freexl/freexl_1.0.5.orig.tar.gz' freexl_1.0.5.orig.tar.gz 938994 SHA256:3dc9b150d218b0e280a3d6a41d93c1e45f4d7155829d75f1e5bf3e0b0de6750d
'http://deb.debian.org/debian/pool/main/f/freexl/freexl_1.0.5-3.debian.tar.xz' freexl_1.0.5-3.debian.tar.xz 13040 SHA256:ab5db96c6c7e14b16439b54e353fa39b49ea4ab78c88a30335bd8411b031a830
```

Other potentially useful URLs:

- https://sources.debian.net/src/freexl/1.0.5-3/ (for browsing the source)
- https://sources.debian.net/src/freexl/1.0.5-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/freexl/1.0.5-3/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `fyba=4.1.1-6`

Binary Packages:

- `libfyba-dev:amd64=4.1.1-6`
- `libfyba0:amd64=4.1.1-6`
...
```console
$ apt-get source -qq --print-uris fyba=4.1.1-6
'http://deb.debian.org/debian/pool/main/f/fyba/fyba_4.1.1-6.dsc' fyba_4.1.1-6.dsc 2148 SHA256:e1d214b4ae3ae0e62da4e0d6774226268dc7b67abb35a9620148b54da96ff2a8
'http://deb.debian.org/debian/pool/main/f/fyba/fyba_4.1.1.orig.tar.gz' fyba_4.1.1.orig.tar.gz 500377 SHA256:99f658d52e8fd8997118bb6207b9c121500700996d9481a736683474e2534179
'http://deb.debian.org/debian/pool/main/f/fyba/fyba_4.1.1-6.debian.tar.xz' fyba_4.1.1-6.debian.tar.xz 12636 SHA256:0fcee9f74dc65d5667d778154624638488ae34e16186b2b56f6ecf854d4472a6
```

Other potentially useful URLs:

- https://sources.debian.net/src/fyba/4.1.1-6/ (for browsing the source)
- https://sources.debian.net/src/fyba/4.1.1-6/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/fyba/4.1.1-6/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `gdal=2.4.0+dfsg-1`

Binary Packages:

- `gdal-data=2.4.0+dfsg-1`
- `libgdal-dev=2.4.0+dfsg-1+b1`
- `libgdal20=2.4.0+dfsg-1+b1`
...
```console
$ apt-get source -qq --print-uris gdal=2.4.0+dfsg-1
'http://deb.debian.org/debian/pool/main/g/gdal/gdal_2.4.0%2bdfsg-1.dsc' gdal_2.4.0+dfsg-1.dsc 3449 SHA256:86d3685e4e924db8289059fee5a0896c1e07aaaf27597a15622c0c6d891cb6b0
'http://deb.debian.org/debian/pool/main/g/gdal/gdal_2.4.0%2bdfsg.orig.tar.xz' gdal_2.4.0+dfsg.orig.tar.xz 9527148 SHA256:ad90a095018fc603f2c9f445da4a858d22caa019216ece765afb165ab0991427
'http://deb.debian.org/debian/pool/main/g/gdal/gdal_2.4.0%2bdfsg-1.debian.tar.xz' gdal_2.4.0+dfsg-1.debian.tar.xz 214668 SHA256:242b536c2bf532e0788acc623c87d5028791f0b0c22dafeacdf4ee50dcba3835
```

Other potentially useful URLs:

- https://sources.debian.net/src/gdal/2.4.0+dfsg-1/ (for browsing the source)
- https://sources.debian.net/src/gdal/2.4.0+dfsg-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gdal/2.4.0+dfsg-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `gdcm=2.8.8-9`

Binary Packages:

- `libgdcm2-dev=2.8.8-9`
- `libgdcm2.8:amd64=2.8.8-9`

Licenses: (parsed from: `/usr/share/doc/libgdcm2-dev/copyright`, `/usr/share/doc/libgdcm2.8/copyright`)
...
```console
$ apt-get source -qq --print-uris gdcm=2.8.8-9
'http://deb.debian.org/debian/pool/main/g/gdcm/gdcm_2.8.8-9.dsc' gdcm_2.8.8-9.dsc 3605 SHA256:c635d2eee7e825eee05fc82ae320a5bd28ebfd34dad90e5ff53278ce4344363a
'http://deb.debian.org/debian/pool/main/g/gdcm/gdcm_2.8.8.orig.tar.bz2' gdcm_2.8.8.orig.tar.bz2 2886942 SHA256:2b090d5653368880f3c6cef2ef7eda8e0cdae3436fed18f2e442344dc0cc8ec7
'http://deb.debian.org/debian/pool/main/g/gdcm/gdcm_2.8.8-9.debian.tar.xz' gdcm_2.8.8-9.debian.tar.xz 25504 SHA256:2ab73dd4e632185a2d1436890a61bedcf6fccc02caf2a48a878888b6d1a5c754
```

Other potentially useful URLs:

- https://sources.debian.net/src/gdcm/2.8.8-9/ (for browsing the source)
- https://sources.debian.net/src/gdcm/2.8.8-9/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gdcm/2.8.8-9/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `geos=3.7.1-1`

Binary Packages:

- `libgeos-3.7.1:amd64=3.7.1-1`
- `libgeos-c1v5:amd64=3.7.1-1`
- `libgeos-dev=3.7.1-1`

Licenses: (parsed from: `/usr/share/doc/libgeos-3.7.1/copyright`, `/usr/share/doc/libgeos-c1v5/copyright`, `/usr/share/doc/libgeos-dev/copyright`)
...
```console
$ apt-get source -qq --print-uris geos=3.7.1-1
'http://deb.debian.org/debian/pool/main/g/geos/geos_3.7.1-1.dsc' geos_3.7.1-1.dsc 2278 SHA256:a0d757f461f66339bcf16e09d4c2ea5d923f2fbd9f17a3d41b58ee950af206fa
'http://deb.debian.org/debian/pool/main/g/geos/geos_3.7.1.orig.tar.bz2' geos_3.7.1.orig.tar.bz2 2055129 SHA256:0006c7b49eaed016b9c5c6f872417a7d7dc022e069ddd683335793d905a8228c
'http://deb.debian.org/debian/pool/main/g/geos/geos_3.7.1-1.debian.tar.xz' geos_3.7.1-1.debian.tar.xz 44700 SHA256:b923f4cda069ff1058b921346db52064a285c7054b3a91af3af5f6058e3de637
```

Other potentially useful URLs:

- https://sources.debian.net/src/geos/3.7.1-1/ (for browsing the source)
- https://sources.debian.net/src/geos/3.7.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/geos/3.7.1-1/ (for access to the source package after it no longer exists in the archive)
...
```console
$ apt-get source -qq --print-uris gl2ps=1.4.0+dfsg1-2
'http://deb.debian.org/debian/pool/main/g/gl2ps/gl2ps_1.4.0%2bdfsg1-2.dsc' gl2ps_1.4.0+dfsg1-2.dsc 2216 SHA256:c7c5659010f4dde95ebf3ac43eb5f85d67700241461c58c6f5114f36e0986bea
'http://deb.debian.org/debian/pool/main/g/gl2ps/gl2ps_1.4.0%2bdfsg1.orig.tar.xz' gl2ps_1.4.0+dfsg1.orig.tar.xz 59540 SHA256:7a2a914027182ccdb81284bb6fff203648df97de4ad40d51b123eeae555a887f
'http://deb.debian.org/debian/pool/main/g/gl2ps/gl2ps_1.4.0%2bdfsg1-2.debian.tar.xz' gl2ps_1.4.0+dfsg1-2.debian.tar.xz 12540 SHA256:20cdc86d30f822ee2845f96eb42616dfa9f6224e80acb35b862b17d7d483effc
```

Other potentially useful URLs:

- https://sources.debian.net/src/gl2ps/1.4.0+dfsg1-2/ (for browsing the source)
- https://sources.debian.net/src/gl2ps/1.4.0+dfsg1-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gl2ps/1.4.0+dfsg1-2/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `glew=2.1.0-4`

Binary Packages:

- `libglew-dev:amd64=2.1.0-4`
- `libglew2.1:amd64=2.1.0-4`

Licenses: (parsed from: `/usr/share/doc/libglew-dev/copyright`, `/usr/share/doc/libglew2.1/copyright`)
...
```console
$ apt-get source -qq --print-uris glew=2.1.0-4
'http://deb.debian.org/debian/pool/main/g/glew/glew_2.1.0-4.dsc' glew_2.1.0-4.dsc 2004 SHA256:3234cce98c95ceedfc20b7baec56064153fa4dd60da1aeccfe5ef39077e256a4
'http://deb.debian.org/debian/pool/main/g/glew/glew_2.1.0.orig.tar.xz' glew_2.1.0.orig.tar.xz 455944 SHA256:bf02e906252b283135406791969bbb6a2a530d685c1b9402a8c14a102b244264
'http://deb.debian.org/debian/pool/main/g/glew/glew_2.1.0-4.debian.tar.xz' glew_2.1.0-4.debian.tar.xz 27644 SHA256:000722128c96ab0e1075d16e04516ac3f93bb4b0fcc18df84a642be5592116a4
```

Other potentially useful URLs:

- https://sources.debian.net/src/glew/2.1.0-4/ (for browsing the source)
- https://sources.debian.net/src/glew/2.1.0-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/glew/2.1.0-4/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `gst-plugins-base1.0=1.14.4-2+deb10u1`
...
```console
$ apt-get source -qq --print-uris gst-plugins-base1.0=1.14.4-2+deb10u1
'http://deb.debian.org/debian/pool/main/g/gst-plugins-base1.0/gst-plugins-base1.0_1.14.4-2%2bdeb10u1.dsc' gst-plugins-base1.0_1.14.4-2+deb10u1.dsc 4278 SHA256:33bff33b05373859678d36c64b7ecb64ff99ba95497e98e95dae75f94fa8efbd
...
'http://deb.debian.org/debian/pool/main/g/gst-plugins-base1.0/gst-plugins-base1.0_1.14.4-2%2bdeb10u1.debian.tar.xz' gst-plugins-base1.0_1.14.4-2+deb10u1.debian.tar.xz 45788 SHA256:09680e228c545dd6b1b92ace5dceab53b4f33caf137699448b08dc03c712d576
```

Other potentially useful URLs:

- https://sources.debian.net/src/gst-plugins-base1.0/1.14.4-2+deb10u1/ (for browsing the source)
- https://sources.debian.net/src/gst-plugins-base1.0/1.14.4-2+deb10u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gst-plugins-base1.0/1.14.4-2+deb10u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `hdf5=1.10.4+repack-10`

Binary Packages:

- `hdf5-helpers=1.10.4+repack-10`
- `libhdf5-103:amd64=1.10.4+repack-10`
- `libhdf5-cpp-103:amd64=1.10.4+repack-10`
- `libhdf5-dev=1.10.4+repack-10`
- `libhdf5-mpi-dev=1.10.4+repack-10`
- `libhdf5-openmpi-103:amd64=1.10.4+repack-10`
- `libhdf5-openmpi-dev=1.10.4+repack-10`
...
```console
$ apt-get source -qq --print-uris hdf5=1.10.4+repack-10
'http://deb.debian.org/debian/pool/main/h/hdf5/hdf5_1.10.4%2brepack-10.dsc' hdf5_1.10.4+repack-10.dsc 2636 SHA256:dbcbb9e3a4f1355b970a94cbb05903bf667bb3fa5c65f9236cc0e4282a22743d
'http://deb.debian.org/debian/pool/main/h/hdf5/hdf5_1.10.4%2brepack.orig.tar.gz' hdf5_1.10.4+repack.orig.tar.gz 12443812 SHA256:9a7a23762a2f2dfb098bd655e1ee846d0412ec29c05e25c80e8f46b2d006e347
'http://deb.debian.org/debian/pool/main/h/hdf5/hdf5_1.10.4%2brepack-10.debian.tar.xz' hdf5_1.10.4+repack-10.debian.tar.xz 132892 SHA256:a6a3a1968317384235ac809f4b359c1b963184884782c2f47e474266a1256b82
```

Other potentially useful URLs:

- https://sources.debian.net/src/hdf5/1.10.4+repack-10/ (for browsing the source)
- https://sources.debian.net/src/hdf5/1.10.4+repack-10/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/hdf5/1.10.4+repack-10/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `hyperlink=17.3.1-2`

Binary Packages:

- `python3-hyperlink=17.3.1-2`

Licenses: (parsed from: `/usr/share/doc/python3-hyperlink/copyright`)
...
```console
$ apt-get source -qq --print-uris hyperlink=17.3.1-2
'http://deb.debian.org/debian/pool/main/h/hyperlink/hyperlink_17.3.1-2.dsc' hyperlink_17.3.1-2.dsc 2150 SHA256:fba6fa9182e908651d167f51556cbbdeef83469523c2e3c73919c009e7846980
'http://deb.debian.org/debian/pool/main/h/hyperlink/hyperlink_17.3.1.orig.tar.gz' hyperlink_17.3.1.orig.tar.gz 91359 SHA256:bc4ffdbde9bdad204d507bd8f554f16bba82dd356f6130cb16f41422909c33bc
'http://deb.debian.org/debian/pool/main/h/hyperlink/hyperlink_17.3.1-2.debian.tar.xz' hyperlink_17.3.1-2.debian.tar.xz 2080 SHA256:da018a80e89fa2d2d06819d6fd97c6bdca02839a101b712b21cc5c7e9c8b8799
```

Other potentially useful URLs:

- https://sources.debian.net/src/hyperlink/17.3.1-2/ (for browsing the source)
- https://sources.debian.net/src/hyperlink/17.3.1-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/hyperlink/17.3.1-2/ (for access to the source package after it no longer exists in the archive)
...
Licenses: (parsed from: `/usr/share/doc/python3-incremental/copyright`)
...
- `libjson-c-dev:amd64=0.12.1+ds-2+deb10u1`
...
### `dpkg` source package: `leptonlib=1.76.0-1`
...
```console
$ apt-get source -qq --print-uris leptonlib=1.76.0-1
'http://deb.debian.org/debian/pool/main/l/leptonlib/leptonlib_1.76.0-1.dsc' leptonlib_1.76.0-1.dsc 1965 SHA256:c6e78cf69f18fae4fd39838a92b5f3d6b96dee068d64186523428630b87e5049
...
'http://deb.debian.org/debian/pool/main/l/leptonlib/leptonlib_1.76.0-1.debian.tar.xz' leptonlib_1.76.0-1.debian.tar.xz 5392 SHA256:c170acfee1d09b75806ac2656db6fe9477f9a181d7e5bed72405ac531205c7fb
```

Other potentially useful URLs:

- https://sources.debian.net/src/leptonlib/1.76.0-1/ (for browsing the source)
- https://sources.debian.net/src/leptonlib/1.76.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/leptonlib/1.76.0-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `libaec=1.0.2-1`

Binary Packages:

- `libaec-dev:amd64=1.0.2-1`
- `libaec0:amd64=1.0.2-1`
...
```console
$ apt-get source -qq --print-uris libaec=1.0.2-1
'http://deb.debian.org/debian/pool/main/liba/libaec/libaec_1.0.2-1.dsc' libaec_1.0.2-1.dsc 2011 SHA256:a6181184986d07519a93f913f6ec8a7f1b18187bfe5e979f9c7dba9eb4c304de
'http://deb.debian.org/debian/pool/main/liba/libaec/libaec_1.0.2.orig.tar.xz' libaec_1.0.2.orig.tar.xz 2590916 SHA256:b1b8d7d4a0c6517790d9033e59586424f2548abcc284c78bbcaf8d6e57913b11
'http://deb.debian.org/debian/pool/main/liba/libaec/libaec_1.0.2-1.debian.tar.xz' libaec_1.0.2-1.debian.tar.xz 2011616 SHA256:5473f75fed71bf9f41e66d0257ecfaf7c5331ebf13f9f88281ca2ca96488e9b3
```

Other potentially useful URLs:

- https://sources.debian.net/src/libaec/1.0.2-1/ (for browsing the source)
- https://sources.debian.net/src/libaec/1.0.2-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libaec/1.0.2-1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/liba/libarchive/libarchive_3.3.3-4%2bdeb10u1.dsc' libarchive_3.3.3-4+deb10u1.dsc 2548 SHA256:e7d1aaa2866bb72a6c11fa3306243399d3265702a58a6e9711012bbe15d16479
...
'http://deb.debian.org/debian/pool/main/liba/libarchive/libarchive_3.3.3-4%2bdeb10u1.debian.tar.xz' libarchive_3.3.3-4+deb10u1.debian.tar.xz 19876 SHA256:fefbe7c0686d6496bb526be4c00634d2992355dfab7d9be6bb2eb53dcf1f8bc7
```
...
### `dpkg` source package: `libdap=3.20.3-1`

Binary Packages:

- `libdap-dev:amd64=3.20.3-1`
- `libdap25:amd64=3.20.3-1`
- `libdapclient6v5:amd64=3.20.3-1`
- `libdapserver7v5:amd64=3.20.3-1`
...
```console
$ apt-get source -qq --print-uris libdap=3.20.3-1
'http://deb.debian.org/debian/pool/main/libd/libdap/libdap_3.20.3-1.dsc' libdap_3.20.3-1.dsc 2329 SHA256:96497794ab6a44ad27bfdc3b5c62ed6f02d51f4c511c8aae277f1b6a6f6d913d
'http://deb.debian.org/debian/pool/main/libd/libdap/libdap_3.20.3.orig.tar.xz' libdap_3.20.3.orig.tar.xz 1500176 SHA256:cec247c5edd06c40c1fc8abc4411f01ca9e7d5304096cdfc80402ea6e17378e4
'http://deb.debian.org/debian/pool/main/libd/libdap/libdap_3.20.3-1.debian.tar.xz' libdap_3.20.3-1.debian.tar.xz 13104 SHA256:eacc6825ff52203e59df369158384b94611b967811fe4e7d86dc55474df185c6
```

Other potentially useful URLs:

- https://sources.debian.net/src/libdap/3.20.3-1/ (for browsing the source)
- https://sources.debian.net/src/libdap/3.20.3-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libdap/3.20.3-1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/libe/libepsilon/libepsilon_0.9.2%2bdfsg-4.dsc' libepsilon_0.9.2+dfsg-4.dsc 2240 SHA256:27cb8cbd991fb7c70429f666a7e3e14a225371afc4986aeabb62a6f998d0bfdd
'http://deb.debian.org/debian/pool/main/libe/libepsilon/libepsilon_0.9.2%2bdfsg.orig.tar.gz' libepsilon_0.9.2+dfsg.orig.tar.gz 2395551 SHA256:684f77097c96862571e8c5da7acfe030bb597878153bf7d56672cb93ebd83c86
'http://deb.debian.org/debian/pool/main/libe/libepsilon/libepsilon_0.9.2%2bdfsg-4.debian.tar.xz' libepsilon_0.9.2+dfsg-4.debian.tar.xz 7104 SHA256:37f09489efb316a4d800bf1411486e9c0b47b40d3cc45df87d4093e40c277a81
```

Other potentially useful URLs:

- https://sources.debian.net/src/libepsilon/0.9.2+dfsg-4/ (for browsing the source)
- https://sources.debian.net/src/libepsilon/0.9.2+dfsg-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libepsilon/0.9.2+dfsg-4/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libevdev=1.6.0+dfsg-1`
...
```console
$ apt-get source -qq --print-uris libevdev=1.6.0+dfsg-1
'http://deb.debian.org/debian/pool/main/libe/libevdev/libevdev_1.6.0%2bdfsg-1.dsc' libevdev_1.6.0+dfsg-1.dsc 2203 SHA256:0886fddbde584bc3d479bd092c2d9162c5714defbf7f74127a5596e50a07b29a
'http://deb.debian.org/debian/pool/main/libe/libevdev/libevdev_1.6.0%2bdfsg.orig.tar.xz' libevdev_1.6.0+dfsg.orig.tar.xz 307016 SHA256:4d03c8083fd11b363af912bbd66876e2743eda3447b45b9b43b6a2f0b5c932fa
'http://deb.debian.org/debian/pool/main/libe/libevdev/libevdev_1.6.0%2bdfsg-1.debian.tar.xz' libevdev_1.6.0+dfsg-1.debian.tar.xz 10836 SHA256:a7e68c44a2ea7e9eae40932e361fed2b667d0a79840dffd73edcb61bc463b8c2
```

Other potentially useful URLs:

- https://sources.debian.net/src/libevdev/1.6.0+dfsg-1/ (for browsing the source)
- https://sources.debian.net/src/libevdev/1.6.0+dfsg-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libevdev/1.6.0+dfsg-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libgeotiff-dfsg=1.4.3-1`

Binary Packages:

- `libgeotiff-dev:amd64=1.4.3-1`
- `libgeotiff2:amd64=1.4.3-1`
...
```console
$ apt-get source -qq --print-uris libgeotiff-dfsg=1.4.3-1
'http://deb.debian.org/debian/pool/main/libg/libgeotiff-dfsg/libgeotiff-dfsg_1.4.3-1.dsc' libgeotiff-dfsg_1.4.3-1.dsc 2254 SHA256:721b3ed18c41f10f6be2753ca4f6248865ee00ecc505a5cb6221ac35909e4f78
'http://deb.debian.org/debian/pool/main/libg/libgeotiff-dfsg/libgeotiff-dfsg_1.4.3.orig.tar.gz' libgeotiff-dfsg_1.4.3.orig.tar.gz 555404 SHA256:e6cde08f9b9ee4c210010b2231c536c5b92ae3b5de3f8373ece179d7e718b06d
'http://deb.debian.org/debian/pool/main/libg/libgeotiff-dfsg/libgeotiff-dfsg_1.4.3-1.debian.tar.xz' libgeotiff-dfsg_1.4.3-1.debian.tar.xz 9832 SHA256:0823e65c7d20b5440b2d14dd4b68207500430991643597ac1f6205a563ac92bb
```

Other potentially useful URLs:

- https://sources.debian.net/src/libgeotiff-dfsg/1.4.3-1/ (for browsing the source)
- https://sources.debian.net/src/libgeotiff-dfsg/1.4.3-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libgeotiff-dfsg/1.4.3-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libgphoto2=2.5.22-3`

Binary Packages:

- `libgphoto2-6:amd64=2.5.22-3`
- `libgphoto2-dev:amd64=2.5.22-3`
...
```console
$ apt-get source -qq --print-uris libgphoto2=2.5.22-3
'http://deb.debian.org/debian/pool/main/libg/libgphoto2/libgphoto2_2.5.22-3.dsc' libgphoto2_2.5.22-3.dsc 2886 SHA256:267a18997a08252a093aae02f5bc21ece67d8989fb1057b327ce92d711e9b232
'http://deb.debian.org/debian/pool/main/libg/libgphoto2/libgphoto2_2.5.22.orig.tar.bz2' libgphoto2_2.5.22.orig.tar.bz2 7169810 SHA256:15d7327aa9a986af1e1dbfd8f15ba81352b67450d30e44562ce768ff9435ce58
'http://deb.debian.org/debian/pool/main/libg/libgphoto2/libgphoto2_2.5.22.orig.tar.bz2.asc' libgphoto2_2.5.22.orig.tar.bz2.asc 833 SHA256:c56270480115e19e4d8c07d747e60fc02e6e3a19786e09f0e172c4fe23b387b0
'http://deb.debian.org/debian/pool/main/libg/libgphoto2/libgphoto2_2.5.22-3.debian.tar.xz' libgphoto2_2.5.22-3.debian.tar.xz 99164 SHA256:24b6787b45a2dbbbb29f8f0835ba555defbeb1d0b0aa0f08165e11381780a0d5
```

Other potentially useful URLs:

- https://sources.debian.net/src/libgphoto2/2.5.22-3/ (for browsing the source)
- https://sources.debian.net/src/libgphoto2/2.5.22-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libgphoto2/2.5.22-3/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/libg/libgudev/libgudev_232-2.dsc' libgudev_232-2.dsc 2305 SHA256:32a8bb891c441019d8fd0af123047ada6df1c42d0bc0363d88a6c8459f4ddd74
'http://deb.debian.org/debian/pool/main/libg/libgudev/libgudev_232.orig.tar.xz' libgudev_232.orig.tar.xz 270904 SHA256:ee4cb2b9c573cdf354f6ed744f01b111d4b5bed3503ffa956cefff50489c7860
'http://deb.debian.org/debian/pool/main/libg/libgudev/libgudev_232-2.debian.tar.xz' libgudev_232-2.debian.tar.xz 4556 SHA256:aa5e8df923bf2c78ba260b9bbb560a41f2d1528b83585379aa9965b4b8c98113
```

Other potentially useful URLs:

- https://sources.debian.net/src/libgudev/232-2/ (for browsing the source)
- https://sources.debian.net/src/libgudev/232-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libgudev/232-2/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `libhdf4=4.2.13-4`
...
```console
$ apt-get source -qq --print-uris libhdf4=4.2.13-4
'http://deb.debian.org/debian/pool/main/libh/libhdf4/libhdf4_4.2.13-4.dsc' libhdf4_4.2.13-4.dsc 2357 SHA256:bb116e2e24d27b6c413d15feea332006c474a611a7eb94d81b65e244abb86ed4
'http://deb.debian.org/debian/pool/main/libh/libhdf4/libhdf4_4.2.13.orig.tar.bz2' libhdf4_4.2.13.orig.tar.bz2 3616255 SHA256:55d3a42313bda0aba7b0463687caf819a970e0ba206f5ed2c23724f80d2ae0f3
'http://deb.debian.org/debian/pool/main/libh/libhdf4/libhdf4_4.2.13-4.debian.tar.xz' libhdf4_4.2.13-4.debian.tar.xz 72996 SHA256:5047866a22579ed1cdedc81bc3dfae8cbaef8460144bf3ae4124358189e2c63a
```

Other potentially useful URLs:

- https://sources.debian.net/src/libhdf4/4.2.13-4/ (for browsing the source)
- https://sources.debian.net/src/libhdf4/4.2.13-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libhdf4/4.2.13-4/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libinput=1.12.6-2+deb10u1`

Binary Packages:

- `libinput-bin=1.12.6-2+deb10u1`
- `libinput10:amd64=1.12.6-2+deb10u1`
...
```console
$ apt-get source -qq --print-uris libinput=1.12.6-2+deb10u1
'http://deb.debian.org/debian/pool/main/libi/libinput/libinput_1.12.6-2%2bdeb10u1.dsc' libinput_1.12.6-2+deb10u1.dsc 2825 SHA256:279969c4b9f00cdb2abbe227d397ea541064acd5fc8b621c79463026d8eac90d
'http://deb.debian.org/debian/pool/main/libi/libinput/libinput_1.12.6.orig.tar.xz' libinput_1.12.6.orig.tar.xz 518784 SHA256:12b4023a3fc683d3d8127db573bdf925a2ef366615042f69c87e57c32a50f45d
'http://deb.debian.org/debian/pool/main/libi/libinput/libinput_1.12.6.orig.tar.xz.asc' libinput_1.12.6.orig.tar.xz.asc 241 SHA256:bb0639ad11468f00bfb767d92f8280731fa63ed5ce285c15dae593aca00b97d1
'http://deb.debian.org/debian/pool/main/libi/libinput/libinput_1.12.6-2%2bdeb10u1.debian.tar.xz' libinput_1.12.6-2+deb10u1.debian.tar.xz 11716 SHA256:ebdd864be2c4905b9132f72039f3453de8195ce1b9505017fe7ae5f38c6adc24
```

Other potentially useful URLs:

- https://sources.debian.net/src/libinput/1.12.6-2+deb10u1/ (for browsing the source)
- https://sources.debian.net/src/libinput/1.12.6-2+deb10u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libinput/1.12.6-2+deb10u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libkml=1.3.0-7`

Binary Packages:

- `libkml-dev:amd64=1.3.0-7`
...
```console
$ apt-get source -qq --print-uris libkml=1.3.0-7
'http://deb.debian.org/debian/pool/main/libk/libkml/libkml_1.3.0-7.dsc' libkml_1.3.0-7.dsc 2632 SHA256:a9fbf7f013c1265bb30fa47b4dc485706999714d9f990873da5dd55d9c786ddb
...
'http://deb.debian.org/debian/pool/main/libk/libkml/libkml_1.3.0-7.debian.tar.xz' libkml_1.3.0-7.debian.tar.xz 25260 SHA256:2ccd165017d31093a64cc1860328103eb6f90186412ceb6163c5755d0ed943c6
```

Other potentially useful URLs:

- https://sources.debian.net/src/libkml/1.3.0-7/ (for browsing the source)
- https://sources.debian.net/src/libkml/1.3.0-7/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libkml/1.3.0-7/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libopenmpt=0.4.3-1+deb10u1`

Binary Packages:

- `libopenmpt0:amd64=0.4.3-1+deb10u1`
...
```console
$ apt-get source -qq --print-uris libopenmpt=0.4.3-1+deb10u1
'http://deb.debian.org/debian/pool/main/libo/libopenmpt/libopenmpt_0.4.3-1%2bdeb10u1.dsc' libopenmpt_0.4.3-1+deb10u1.dsc 2595 SHA256:d28a431ac8fa79aa2c0e2e89fd07b580f552f5ae1cf41334d35ac3ce51471bda
...
'http://deb.debian.org/debian/pool/main/libo/libopenmpt/libopenmpt_0.4.3-1%2bdeb10u1.debian.tar.xz' libopenmpt_0.4.3-1+deb10u1.debian.tar.xz 14320 SHA256:9198393186402030ab1cea0261a759a16b5448b9aaa288a134df5368ef12b63c
```

Other potentially useful URLs:

- https://sources.debian.net/src/libopenmpt/0.4.3-1+deb10u1/ (for browsing the source)
- https://sources.debian.net/src/libopenmpt/0.4.3-1+deb10u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libopenmpt/0.4.3-1+deb10u1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `libpcap=1.8.1-6`
...
```console
$ apt-get source -qq --print-uris libpcap=1.8.1-6
'http://deb.debian.org/debian/pool/main/libp/libpcap/libpcap_1.8.1-6.dsc' libpcap_1.8.1-6.dsc 2108 SHA256:527b8ae32c9671b69fbdec2e6b07aaeae82eaf595fa152bd5950a51dc6bffdb6
'http://deb.debian.org/debian/pool/main/libp/libpcap/libpcap_1.8.1.orig.tar.gz' libpcap_1.8.1.orig.tar.gz 739163 SHA256:673dbc69fdc3f5a86fb5759ab19899039a8e5e6c631749e48dcd9c6f0c83541e
'http://deb.debian.org/debian/pool/main/libp/libpcap/libpcap_1.8.1-6.debian.tar.xz' libpcap_1.8.1-6.debian.tar.xz 19168 SHA256:a8859ac1ad203ab0b22794216d41cbd657dcbd16b8a00e81b146e64fd7d50b6f
```

Other potentially useful URLs:

- https://sources.debian.net/src/libpcap/1.8.1-6/ (for browsing the source)
- https://sources.debian.net/src/libpcap/1.8.1-6/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libpcap/1.8.1-6/ (for access to the source package after it no longer exists in the archive)
...
- `libtheora-dev:amd64=1.1.1+dfsg.1-15`
...
'http://deb.debian.org/debian/pool/main/libv/libvpx/libvpx_1.7.0-3%2bdeb10u1.dsc' libvpx_1.7.0-3+deb10u1.dsc 2293 SHA256:1799371d542b9771b43f6dd373c40bdd31c8633b7fbcf68e8626ee179e29d098
...
'http://deb.debian.org/debian/pool/main/libv/libvpx/libvpx_1.7.0-3%2bdeb10u1.debian.tar.xz' libvpx_1.7.0-3+deb10u1.debian.tar.xz 13936 SHA256:758471f1ecbdded674c5780cef72f3b7ad354934909cfb39a3c37c618f33bbd6
```
...
### `dpkg` source package: `libwacom=0.32-1`
...
```console
$ apt-get source -qq --print-uris libwacom=0.32-1
'http://deb.debian.org/debian/pool/main/libw/libwacom/libwacom_0.32-1.dsc' libwacom_0.32-1.dsc 2240 SHA256:4389b98f3c7f21bffbad75133065e57c5dbc536943e183089798aadf9ce20749
'http://deb.debian.org/debian/pool/main/libw/libwacom/libwacom_0.32.orig.tar.gz' libwacom_0.32.orig.tar.gz 120925 SHA256:316ea0985260ec95884bf6c5cd3e962f344ef1d43dd3fbed6d95555fdb3e4aca
'http://deb.debian.org/debian/pool/main/libw/libwacom/libwacom_0.32-1.debian.tar.xz' libwacom_0.32-1.debian.tar.xz 4260 SHA256:acb6f60f0b5ca4e3202a79957300e253a34f22e09fcca5158630c3a8ae63f882
```

Other potentially useful URLs:

- https://sources.debian.net/src/libwacom/0.32-1/ (for browsing the source)
...
- `libzstd-dev:amd64=1.3.8+dfsg-3+deb10u2`
...
Licenses: (parsed from: `/usr/share/doc/libclang1-7/copyright`, `/usr/share/doc/libllvm7/copyright`)
...
### `dpkg` source package: `mpi4py=2.0.0-3`
...
```console
$ apt-get source -qq --print-uris mpi4py=2.0.0-3
'http://deb.debian.org/debian/pool/main/m/mpi4py/mpi4py_2.0.0-3.dsc' mpi4py_2.0.0-3.dsc 2246 SHA256:3f0dde4517694a9b1a2a18304416cffb435f0303d5471392296b0b65fa9428cb
...
'http://deb.debian.org/debian/pool/main/m/mpi4py/mpi4py_2.0.0-3.debian.tar.xz' mpi4py_2.0.0-3.debian.tar.xz 7964 SHA256:f4bb3a298473d6b96dc47eff414e94ee6fcdfd4e8cb8fc334d0060c0cb3ecc68
```

Other potentially useful URLs:

- https://sources.debian.net/src/mpi4py/2.0.0-3/ (for browsing the source)
- https://sources.debian.net/src/mpi4py/2.0.0-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mpi4py/2.0.0-3/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `netcdf-cxx-legacy=4.2-11`
...
```console
$ apt-get source -qq --print-uris netcdf-cxx-legacy=4.2-11
'http://deb.debian.org/debian/pool/main/n/netcdf-cxx-legacy/netcdf-cxx-legacy_4.2-11.dsc' netcdf-cxx-legacy_4.2-11.dsc 2236 SHA256:35fc44d6fcd50aad56ef2ff5578b6b880fedbbd321a4573ff875b3db23d6ca4e
...
'http://deb.debian.org/debian/pool/main/n/netcdf-cxx-legacy/netcdf-cxx-legacy_4.2-11.debian.tar.xz' netcdf-cxx-legacy_4.2-11.debian.tar.xz 7396 SHA256:f7a1cb3499e174344974092867a710c3af3ee099ae63f07b540a99a59e7bb799
```

Other potentially useful URLs:

- https://sources.debian.net/src/netcdf-cxx-legacy/4.2-11/ (for browsing the source)
- https://sources.debian.net/src/netcdf-cxx-legacy/4.2-11/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/netcdf-cxx-legacy/4.2-11/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `netcdf=1:4.6.2-1`
...
```console
$ apt-get source -qq --print-uris netcdf=1:4.6.2-1
'http://deb.debian.org/debian/pool/main/n/netcdf/netcdf_4.6.2-1.dsc' netcdf_4.6.2-1.dsc 2301 SHA256:5f706f8a065bf8f1177384f4554d22835cbd78659015a515ef7c3e2be7cefd19
'http://deb.debian.org/debian/pool/main/n/netcdf/netcdf_4.6.2.orig.tar.gz' netcdf_4.6.2.orig.tar.gz 18167693 SHA256:673936c76ae0c496f6dde7e077f5be480afc1e300adb2c200bf56fbe22e5a82a
'http://deb.debian.org/debian/pool/main/n/netcdf/netcdf_4.6.2-1.debian.tar.xz' netcdf_4.6.2-1.debian.tar.xz 25896 SHA256:0786535ac3249beb79f45d610d068759bccf504bd720e998846bf8b974074bc2
```

Other potentially useful URLs:

- https://sources.debian.net/src/netcdf/1:4.6.2-1/ (for browsing the source)
- https://sources.debian.net/src/netcdf/1:4.6.2-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/netcdf/1:4.6.2-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `ogdi-dfsg=3.2.1+ds-4`
...
```console
$ apt-get source -qq --print-uris ogdi-dfsg=3.2.1+ds-4
'http://deb.debian.org/debian/pool/main/o/ogdi-dfsg/ogdi-dfsg_3.2.1%2bds-4.dsc' ogdi-dfsg_3.2.1+ds-4.dsc 2149 SHA256:88055ca8e61fec673dd040c3faa1d2a1ab087aabf17fd5c5c2186c526780e411
'http://deb.debian.org/debian/pool/main/o/ogdi-dfsg/ogdi-dfsg_3.2.1%2bds.orig.tar.gz' ogdi-dfsg_3.2.1+ds.orig.tar.gz 652742 SHA256:2eab77f6965f10ff133154db28a03c061012838c2e95d8d4f07e2e5e33fbfff4
'http://deb.debian.org/debian/pool/main/o/ogdi-dfsg/ogdi-dfsg_3.2.1%2bds-4.debian.tar.xz' ogdi-dfsg_3.2.1+ds-4.debian.tar.xz 13660 SHA256:5956efd79c05b4a329f053030e3fcf1b8d4106e8575e2af07f664e08561f38e9
```

Other potentially useful URLs:

- https://sources.debian.net/src/ogdi-dfsg/3.2.1+ds-4/ (for browsing the source)
- https://sources.debian.net/src/ogdi-dfsg/3.2.1+ds-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/ogdi-dfsg/3.2.1+ds-4/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `opencv=3.2.0+dfsg-6`

Binary Packages:

- `libopencv-calib3d-dev:amd64=3.2.0+dfsg-6`
- `libopencv-calib3d3.2:amd64=3.2.0+dfsg-6`
- `libopencv-contrib-dev:amd64=3.2.0+dfsg-6`
- `libopencv-contrib3.2:amd64=3.2.0+dfsg-6`
- `libopencv-core-dev:amd64=3.2.0+dfsg-6`
- `libopencv-core3.2:amd64=3.2.0+dfsg-6`
- `libopencv-dev=3.2.0+dfsg-6`
- `libopencv-features2d-dev:amd64=3.2.0+dfsg-6`
- `libopencv-features2d3.2:amd64=3.2.0+dfsg-6`
- `libopencv-flann-dev:amd64=3.2.0+dfsg-6`
- `libopencv-flann3.2:amd64=3.2.0+dfsg-6`
- `libopencv-highgui-dev:amd64=3.2.0+dfsg-6`
- `libopencv-highgui3.2:amd64=3.2.0+dfsg-6`
- `libopencv-imgcodecs-dev:amd64=3.2.0+dfsg-6`
- `libopencv-imgcodecs3.2:amd64=3.2.0+dfsg-6`
- `libopencv-imgproc-dev:amd64=3.2.0+dfsg-6`
- `libopencv-imgproc3.2:amd64=3.2.0+dfsg-6`
- `libopencv-ml-dev:amd64=3.2.0+dfsg-6`
- `libopencv-ml3.2:amd64=3.2.0+dfsg-6`
- `libopencv-objdetect-dev:amd64=3.2.0+dfsg-6`
- `libopencv-objdetect3.2:amd64=3.2.0+dfsg-6`
- `libopencv-photo-dev:amd64=3.2.0+dfsg-6`
- `libopencv-photo3.2:amd64=3.2.0+dfsg-6`
- `libopencv-shape-dev:amd64=3.2.0+dfsg-6`
- `libopencv-shape3.2:amd64=3.2.0+dfsg-6`
- `libopencv-stitching-dev:amd64=3.2.0+dfsg-6`
- `libopencv-stitching3.2:amd64=3.2.0+dfsg-6`
- `libopencv-superres-dev:amd64=3.2.0+dfsg-6`
- `libopencv-superres3.2:amd64=3.2.0+dfsg-6`
- `libopencv-ts-dev:amd64=3.2.0+dfsg-6`
- `libopencv-video-dev:amd64=3.2.0+dfsg-6`
- `libopencv-video3.2:amd64=3.2.0+dfsg-6`
- `libopencv-videoio-dev:amd64=3.2.0+dfsg-6`
- `libopencv-videoio3.2:amd64=3.2.0+dfsg-6`
- `libopencv-videostab-dev:amd64=3.2.0+dfsg-6`
- `libopencv-videostab3.2:amd64=3.2.0+dfsg-6`
- `libopencv-viz-dev:amd64=3.2.0+dfsg-6`
- `libopencv-viz3.2:amd64=3.2.0+dfsg-6`
- `libopencv3.2-java=3.2.0+dfsg-6`
- `libopencv3.2-jni=3.2.0+dfsg-6`
- `python3-opencv=3.2.0+dfsg-6`

Licenses: (parsed from: `/usr/share/doc/libopencv-calib3d-dev/copyright`, `/usr/share/doc/libopencv-calib3d3.2/copyright`, `/usr/share/doc/libopencv-contrib-dev/copyright`, `/usr/share/doc/libopencv-contrib3.2/copyright`, `/usr/share/doc/libopencv-core-dev/copyright`, `/usr/share/doc/libopencv-core3.2/copyright`, `/usr/share/doc/libopencv-dev/copyright`, `/usr/share/doc/libopencv-features2d-dev/copyright`, `/usr/share/doc/libopencv-features2d3.2/copyright`, `/usr/share/doc/libopencv-flann-dev/copyright`, `/usr/share/doc/libopencv-flann3.2/copyright`, `/usr/share/doc/libopencv-highgui-dev/copyright`, `/usr/share/doc/libopencv-highgui3.2/copyright`, `/usr/share/doc/libopencv-imgcodecs-dev/copyright`, `/usr/share/doc/libopencv-imgcodecs3.2/copyright`, `/usr/share/doc/libopencv-imgproc-dev/copyright`, `/usr/share/doc/libopencv-imgproc3.2/copyright`, `/usr/share/doc/libopencv-ml-dev/copyright`, `/usr/share/doc/libopencv-ml3.2/copyright`, `/usr/share/doc/libopencv-objdetect-dev/copyright`, `/usr/share/doc/libopencv-objdetect3.2/copyright`, `/usr/share/doc/libopencv-photo-dev/copyright`, `/usr/share/doc/libopencv-photo3.2/copyright`, `/usr/share/doc/libopencv-shape-dev/copyright`, `/usr/share/doc/libopencv-shape3.2/copyright`, `/usr/share/doc/libopencv-stitching-dev/copyright`, `/usr/share/doc/libopencv-stitching3.2/copyright`, `/usr/share/doc/libopencv-superres-dev/copyright`, `/usr/share/doc/libopencv-superres3.2/copyright`, `/usr/share/doc/libopencv-ts-dev/copyright`, `/usr/share/doc/libopencv-video-dev/copyright`, `/usr/share/doc/libopencv-video3.2/copyright`, `/usr/share/doc/libopencv-videoio-dev/copyright`, `/usr/share/doc/libopencv-videoio3.2/copyright`, `/usr/share/doc/libopencv-videostab-dev/copyright`, `/usr/share/doc/libopencv-videostab3.2/copyright`, `/usr/share/doc/libopencv-viz-dev/copyright`, `/usr/share/doc/libopencv-viz3.2/copyright`, `/usr/share/doc/libopencv3.2-java/copyright`, `/usr/share/doc/libopencv3.2-jni/copyright`, `/usr/share/doc/python3-opencv/copyright`)
...
```console
$ apt-get source -qq --print-uris opencv=3.2.0+dfsg-6
'http://deb.debian.org/debian/pool/main/o/opencv/opencv_3.2.0%2bdfsg-6.dsc' opencv_3.2.0+dfsg-6.dsc 5847 SHA256:364f7c2196d8be003dca7ba1e3762e6100ccd69cc2b93542433a00504bc4cc45
'http://deb.debian.org/debian/pool/main/o/opencv/opencv_3.2.0%2bdfsg.orig.tar.gz' opencv_3.2.0+dfsg.orig.tar.gz 125448078 SHA256:bb4351ce2a5402a36ea880f37924f803f0cdccd0850300b1bd1336e8c5d9dfa6
'http://deb.debian.org/debian/pool/main/o/opencv/opencv_3.2.0%2bdfsg-6.debian.tar.xz' opencv_3.2.0+dfsg-6.debian.tar.xz 38760 SHA256:5ca6024cc017ce635d6e0d376dad8d3539ea6692360981aeeb50be42018884ca
```

Other potentially useful URLs:

- https://sources.debian.net/src/opencv/3.2.0+dfsg-6/ (for browsing the source)
...
### `dpkg` source package: `openni2=2.2.0.33+dfsg-11`
...
```console
$ apt-get source -qq --print-uris openni2=2.2.0.33+dfsg-11
'http://deb.debian.org/debian/pool/main/o/openni2/openni2_2.2.0.33%2bdfsg-11.dsc' openni2_2.2.0.33+dfsg-11.dsc 2331 SHA256:6c54e2e7d5d357ebfbd5031cfe502c62eeabfc4c4cd1193a57d75804871f34ae
'http://deb.debian.org/debian/pool/main/o/openni2/openni2_2.2.0.33%2bdfsg.orig.tar.gz' openni2_2.2.0.33+dfsg.orig.tar.gz 8604362 SHA256:abc17f5e30d6799200c69a52d34aefaef4fd567be7921e0cb68cae353ac4495a
'http://deb.debian.org/debian/pool/main/o/openni2/openni2_2.2.0.33%2bdfsg-11.debian.tar.xz' openni2_2.2.0.33+dfsg-11.debian.tar.xz 16244 SHA256:6d36b988ebacc43102af5f043ec5c6047536ece1e9c95bf5099e201c1c5ae849
```

Other potentially useful URLs:

- https://sources.debian.net/src/openni2/2.2.0.33+dfsg-11/ (for browsing the source)
- https://sources.debian.net/src/openni2/2.2.0.33+dfsg-11/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/openni2/2.2.0.33+dfsg-11/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `openni=1.5.4.0+dfsg-2`
...
```console
$ apt-get source -qq --print-uris openni=1.5.4.0+dfsg-2
'http://deb.debian.org/debian/pool/main/o/openni/openni_1.5.4.0%2bdfsg-2.dsc' openni_1.5.4.0+dfsg-2.dsc 2320 SHA256:74d2972502057d74070a52f44176176d911b42b96e3e54be33b1e25acae6b87e
'http://deb.debian.org/debian/pool/main/o/openni/openni_1.5.4.0%2bdfsg.orig.tar.xz' openni_1.5.4.0+dfsg.orig.tar.xz 9885380 SHA256:3e1dabf4fad5aaf67be6f4bfc161ce63b3e3a258f671ff9d65d84f5fadd3db1f
'http://deb.debian.org/debian/pool/main/o/openni/openni_1.5.4.0%2bdfsg-2.debian.tar.xz' openni_1.5.4.0+dfsg-2.debian.tar.xz 648152 SHA256:fd62f3cd5e6237988e7792786101d20fd84408d00bc627ba749166f7152bc116
```

Other potentially useful URLs:

- https://sources.debian.net/src/openni/1.5.4.0+dfsg-2/ (for browsing the source)
- https://sources.debian.net/src/openni/1.5.4.0+dfsg-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/openni/1.5.4.0+dfsg-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `pcl=1.9.1+dfsg1-10`

Binary Packages:

- `libpcl-apps1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-common1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-dev=1.9.1+dfsg1-10`
- `libpcl-features1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-filters1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-io1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-kdtree1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-keypoints1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-ml1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-octree1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-outofcore1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-people1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-recognition1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-registration1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-sample-consensus1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-search1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-segmentation1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-stereo1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-surface1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-tracking1.9:amd64=1.9.1+dfsg1-10`
- `libpcl-visualization1.9:amd64=1.9.1+dfsg1-10`

Licenses: (parsed from: `/usr/share/doc/libpcl-apps1.9/copyright`, `/usr/share/doc/libpcl-common1.9/copyright`, `/usr/share/doc/libpcl-dev/copyright`, `/usr/share/doc/libpcl-features1.9/copyright`, `/usr/share/doc/libpcl-filters1.9/copyright`, `/usr/share/doc/libpcl-io1.9/copyright`, `/usr/share/doc/libpcl-kdtree1.9/copyright`, `/usr/share/doc/libpcl-keypoints1.9/copyright`, `/usr/share/doc/libpcl-ml1.9/copyright`, `/usr/share/doc/libpcl-octree1.9/copyright`, `/usr/share/doc/libpcl-outofcore1.9/copyright`, `/usr/share/doc/libpcl-people1.9/copyright`, `/usr/share/doc/libpcl-recognition1.9/copyright`, `/usr/share/doc/libpcl-registration1.9/copyright`, `/usr/share/doc/libpcl-sample-consensus1.9/copyright`, `/usr/share/doc/libpcl-search1.9/copyright`, `/usr/share/doc/libpcl-segmentation1.9/copyright`, `/usr/share/doc/libpcl-stereo1.9/copyright`, `/usr/share/doc/libpcl-surface1.9/copyright`, `/usr/share/doc/libpcl-tracking1.9/copyright`, `/usr/share/doc/libpcl-visualization1.9/copyright`)
...
```console
$ apt-get source -qq --print-uris pcl=1.9.1+dfsg1-10
'http://deb.debian.org/debian/pool/main/p/pcl/pcl_1.9.1%2bdfsg1-10.dsc' pcl_1.9.1+dfsg1-10.dsc 3960 SHA256:b81ea1524a4ee3ce6133b16e1a0e90e6612124705c391195a5edd8b301e72627
'http://deb.debian.org/debian/pool/main/p/pcl/pcl_1.9.1%2bdfsg1.orig.tar.xz' pcl_1.9.1+dfsg1.orig.tar.xz 57706016 SHA256:453774bdcadb6773b4df310cef32daf3cb108e21bc148aca5298b11aed38a53b
'http://deb.debian.org/debian/pool/main/p/pcl/pcl_1.9.1%2bdfsg1-10.debian.tar.xz' pcl_1.9.1+dfsg1-10.debian.tar.xz 30564 SHA256:1fdf476276babeaac660acaf81a31c49941d57a0b852b32f162075a0e5736eba
```

Other potentially useful URLs:

- https://sources.debian.net/src/pcl/1.9.1+dfsg1-10/ (for browsing the source)
- https://sources.debian.net/src/pcl/1.9.1+dfsg1-10/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/pcl/1.9.1+dfsg1-10/ (for access to the source package after it no longer exists in the archive)
...
- `libpoppler-dev:amd64=0.71.0-5`
- `libpoppler-private-dev:amd64=0.71.0-5`
- `libpoppler82:amd64=0.71.0-5`

Licenses: (parsed from: `/usr/share/doc/libpoppler-dev/copyright`, `/usr/share/doc/libpoppler-private-dev/copyright`, `/usr/share/doc/libpoppler82/copyright`)
...
### `dpkg` source package: `proj=5.2.0-1`

Binary Packages:

- `libproj-dev:amd64=5.2.0-1`
- `libproj13:amd64=5.2.0-1`
- `proj-data=5.2.0-1`

Licenses: (parsed from: `/usr/share/doc/libproj-dev/copyright`, `/usr/share/doc/libproj13/copyright`, `/usr/share/doc/proj-data/copyright`)
...
```console
$ apt-get source -qq --print-uris proj=5.2.0-1
'http://deb.debian.org/debian/pool/main/p/proj/proj_5.2.0-1.dsc' proj_5.2.0-1.dsc 2217 SHA256:41edec7ff17292a9f7caa490e31ec41bc2bd8ccf75592e22a2e2887d42f1ba7b
'http://deb.debian.org/debian/pool/main/p/proj/proj_5.2.0.orig.tar.gz' proj_5.2.0.orig.tar.gz 1398188 SHA256:ef919499ffbc62a4aae2659a55e2b25ff09cccbbe230656ba71c6224056c7e60
'http://deb.debian.org/debian/pool/main/p/proj/proj_5.2.0-1.debian.tar.xz' proj_5.2.0-1.debian.tar.xz 10193688 SHA256:b2b779b0371a4dd22987f1884a1a45816435bf7a0f6b9c0d19fca1900221d55b
```

Other potentially useful URLs:

- https://sources.debian.net/src/proj/5.2.0-1/ (for browsing the source)
- https://sources.debian.net/src/proj/5.2.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/proj/5.2.0-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `py-ubjson=0.12.0-1`

Binary Packages:

- `python3-ubjson=0.12.0-1`

Licenses: (parsed from: `/usr/share/doc/python3-ubjson/copyright`)
...
```console
$ apt-get source -qq --print-uris py-ubjson=0.12.0-1
'http://deb.debian.org/debian/pool/main/p/py-ubjson/py-ubjson_0.12.0-1.dsc' py-ubjson_0.12.0-1.dsc 1829 SHA256:37c4bf25711aca136cdcdb7b91b678110fe2c3f8b17aba694bbc2ceb9a9451f5
'http://deb.debian.org/debian/pool/main/p/py-ubjson/py-ubjson_0.12.0.orig.tar.gz' py-ubjson_0.12.0.orig.tar.gz 45535 SHA256:b796cb5077a06c932f0d148f4eef4ce0f045a05cb14393177a6d034be9f8e364
'http://deb.debian.org/debian/pool/main/p/py-ubjson/py-ubjson_0.12.0-1.debian.tar.xz' py-ubjson_0.12.0-1.debian.tar.xz 4736 SHA256:95afbd11290526b67b1c4a08fc0ec83e7394c38fce239f9ff03ad1df09c5b5a6
```

Other potentially useful URLs:

- https://sources.debian.net/src/py-ubjson/0.12.0-1/ (for browsing the source)
- https://sources.debian.net/src/py-ubjson/0.12.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/py-ubjson/0.12.0-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `pyopenssl=19.0.0-1`
...
```console
$ apt-get source -qq --print-uris pyopenssl=19.0.0-1
'http://deb.debian.org/debian/pool/main/p/pyopenssl/pyopenssl_19.0.0-1.dsc' pyopenssl_19.0.0-1.dsc 2449 SHA256:5b5efcb183c1530b87b6a9f7322748faed82d7018e66065de1a446d5bbe07633
'http://deb.debian.org/debian/pool/main/p/pyopenssl/pyopenssl_19.0.0.orig.tar.xz' pyopenssl_19.0.0.orig.tar.xz 137804 SHA256:966ef1ee8e8fc9224ef4fc6adf0adfbaf42cc920f8f1ceafd4a3fc8e1214ff45
'http://deb.debian.org/debian/pool/main/p/pyopenssl/pyopenssl_19.0.0-1.debian.tar.xz' pyopenssl_19.0.0-1.debian.tar.xz 9112 SHA256:52664bf6936463c50ec2c608b63f61f674fce40e1bba4e660a44fa14ea62ebbe
```

Other potentially useful URLs:

- https://sources.debian.net/src/pyopenssl/19.0.0-1/ (for browsing the source)
- https://sources.debian.net/src/pyopenssl/19.0.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/pyopenssl/19.0.0-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `python-autobahn=17.10.1+dfsg1-3+deb10u1`

Binary Packages:

- `python3-autobahn=17.10.1+dfsg1-3+deb10u1`

Licenses: (parsed from: `/usr/share/doc/python3-autobahn/copyright`)
...
```console
$ apt-get source -qq --print-uris python-autobahn=17.10.1+dfsg1-3+deb10u1
'http://deb.debian.org/debian/pool/main/p/python-autobahn/python-autobahn_17.10.1%2bdfsg1-3%2bdeb10u1.dsc' python-autobahn_17.10.1+dfsg1-3+deb10u1.dsc 2983 SHA256:2a5be90d03cdd0b6f1671b9ba07564f52a317c9df1d26fbebe26239ec264237f
'http://deb.debian.org/debian/pool/main/p/python-autobahn/python-autobahn_17.10.1%2bdfsg1.orig.tar.xz' python-autobahn_17.10.1+dfsg1.orig.tar.xz 1161340 SHA256:fd42fa43d6c10b176bd3da91924cc7e0d2ed4981976a35bf7b91361847a5be83
'http://deb.debian.org/debian/pool/main/p/python-autobahn/python-autobahn_17.10.1%2bdfsg1-3%2bdeb10u1.debian.tar.xz' python-autobahn_17.10.1+dfsg1-3+deb10u1.debian.tar.xz 5064 SHA256:dbb70d0bed08893a0dd61efc33abc4b508ddacc9d49d093d437ed48c2b7dc79c
```

Other potentially useful URLs:

- https://sources.debian.net/src/python-autobahn/17.10.1+dfsg1-3+deb10u1/ (for browsing the source)
- https://sources.debian.net/src/python-autobahn/17.10.1+dfsg1-3+deb10u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python-autobahn/17.10.1+dfsg1-3+deb10u1/ (for access to the source package after it no longer exists in the archive)
...
Licenses: (parsed from: `/usr/share/doc/python3-cbor/copyright`)
...
```console
$ apt-get source -qq --print-uris python-cbor=1.0.0-1
'http://deb.debian.org/debian/pool/main/p/python-cbor/python-cbor_1.0.0-1.dsc' python-cbor_1.0.0-1.dsc 2043 SHA256:4841beeaad67f15d07b9a495446a5eee542cdd46384e1308f03e31235d7593b0
'http://deb.debian.org/debian/pool/main/p/python-cbor/python-cbor_1.0.0.orig.tar.gz' python-cbor_1.0.0.orig.tar.gz 20096 SHA256:13225a262ddf5615cbd9fd55a76a0d53069d18b07d2e9f19c39e6acb8609bbb6
'http://deb.debian.org/debian/pool/main/p/python-cbor/python-cbor_1.0.0-1.debian.tar.xz' python-cbor_1.0.0-1.debian.tar.xz 3716 SHA256:4315602df1fcba45376d4968dbe8b5ed3cdf08e8387142aa6959371635fa023e
```

Other potentially useful URLs:

- https://sources.debian.net/src/python-cbor/1.0.0-1/ (for browsing the source)
- https://sources.debian.net/src/python-cbor/1.0.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python-cbor/1.0.0-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `python-lz4=1.1.0+dfsg-1`

Binary Packages:

- `python3-lz4=1.1.0+dfsg-1`

Licenses: (parsed from: `/usr/share/doc/python3-lz4/copyright`)
...
```console
$ apt-get source -qq --print-uris python-lz4=1.1.0+dfsg-1
'http://deb.debian.org/debian/pool/main/p/python-lz4/python-lz4_1.1.0%2bdfsg-1.dsc' python-lz4_1.1.0+dfsg-1.dsc 2321 SHA256:98af1baebf66f715be12f53bfa8e3f4ea7e61d176df3c133dc453aff04dc1acc
'http://deb.debian.org/debian/pool/main/p/python-lz4/python-lz4_1.1.0%2bdfsg.orig.tar.xz' python-lz4_1.1.0+dfsg.orig.tar.xz 39432 SHA256:4a087a24031128eb531d8bf3800e6508d9d797cd44bfb488e988e83739f21501
'http://deb.debian.org/debian/pool/main/p/python-lz4/python-lz4_1.1.0%2bdfsg-1.debian.tar.xz' python-lz4_1.1.0+dfsg-1.debian.tar.xz 3800 SHA256:d99a2ae72b21dfc0750ebb23e5567fc1f0754e9c2cde621180f38da7124975e7
```

Other potentially useful URLs:

- https://sources.debian.net/src/python-lz4/1.1.0+dfsg-1/ (for browsing the source)
- https://sources.debian.net/src/python-lz4/1.1.0+dfsg-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python-lz4/1.1.0+dfsg-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `python-pyqrcode=1.2.1-2`

Binary Packages:

- `python3-pyqrcode=1.2.1-2`

Licenses: (parsed from: `/usr/share/doc/python3-pyqrcode/copyright`)
...
```console
$ apt-get source -qq --print-uris python-pyqrcode=1.2.1-2
'http://deb.debian.org/debian/pool/main/p/python-pyqrcode/python-pyqrcode_1.2.1-2.dsc' python-pyqrcode_1.2.1-2.dsc 1760 SHA256:f4d1921e2884387aee36082441b7b1f18dfd70b0c667ef079ea69ea9b5c48159
'http://deb.debian.org/debian/pool/main/p/python-pyqrcode/python-pyqrcode_1.2.1.orig.tar.gz' python-pyqrcode_1.2.1.orig.tar.gz 36989 SHA256:fdbf7634733e56b72e27f9bce46e4550b75a3a2c420414035cae9d9d26b234d5
'http://deb.debian.org/debian/pool/main/p/python-pyqrcode/python-pyqrcode_1.2.1-2.debian.tar.xz' python-pyqrcode_1.2.1-2.debian.tar.xz 2432 SHA256:2921a5e592993d32b8f30bb71aaf07df9244a589b43053ab0c3a90a2c358d067
```

Other potentially useful URLs:

- https://sources.debian.net/src/python-pyqrcode/1.2.1-2/ (for browsing the source)
- https://sources.debian.net/src/python-pyqrcode/1.2.1-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python-pyqrcode/1.2.1-2/ (for access to the source package after it no longer exists in the archive)
...
Licenses: (parsed from: `/usr/share/doc/python3-service-identity/copyright`)
...
### `dpkg` source package: `python-snappy=0.5.3-1`

Binary Packages:

- `python3-snappy=0.5.3-1`

Licenses: (parsed from: `/usr/share/doc/python3-snappy/copyright`)
...
```console
$ apt-get source -qq --print-uris python-snappy=0.5.3-1
'http://deb.debian.org/debian/pool/main/p/python-snappy/python-snappy_0.5.3-1.dsc' python-snappy_0.5.3-1.dsc 1912 SHA256:2dee0cf61dece14fd792ca7b927632db6f8d4019b53b9c39c7c85d957d3bbebe
'http://deb.debian.org/debian/pool/main/p/python-snappy/python-snappy_0.5.3.orig.tar.xz' python-snappy_0.5.3.orig.tar.xz 15920 SHA256:7a5e519821b35c74f14681c0ffb992812867e982a0ae00c9664116efd6522ef4
'http://deb.debian.org/debian/pool/main/p/python-snappy/python-snappy_0.5.3-1.debian.tar.xz' python-snappy_0.5.3-1.debian.tar.xz 2700 SHA256:3cd2db61973ec417dd8d57bd672a12660475b4a2f9c380a419a84364861dd592
```

Other potentially useful URLs:

- https://sources.debian.net/src/python-snappy/0.5.3-1/ (for browsing the source)
- https://sources.debian.net/src/python-snappy/0.5.3-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python-snappy/0.5.3-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `python-trie=0.2+ds-1`

Binary Packages:

- `python3-trie=0.2+ds-1`

Licenses: (parsed from: `/usr/share/doc/python3-trie/copyright`)
...
```console
$ apt-get source -qq --print-uris python-trie=0.2+ds-1
'http://deb.debian.org/debian/pool/main/p/python-trie/python-trie_0.2%2bds-1.dsc' python-trie_0.2+ds-1.dsc 2145 SHA256:d5827956f951276ac7cac3721716d723a2daade4d438686f4f110f299bd02d3b
'http://deb.debian.org/debian/pool/main/p/python-trie/python-trie_0.2%2bds.orig.tar.gz' python-trie_0.2+ds.orig.tar.gz 11243 SHA256:178747e52fb61ce322a0d1dde8d8420d4c3d184d7b4c49b73c997c94dd97c8a0
'http://deb.debian.org/debian/pool/main/p/python-trie/python-trie_0.2%2bds-1.debian.tar.xz' python-trie_0.2+ds-1.debian.tar.xz 2584 SHA256:4f51ba6df078cea68819497d5a0e237d5f12771b61f044901e21221d6399afed
```

Other potentially useful URLs:

- https://sources.debian.net/src/python-trie/0.2+ds-1/ (for browsing the source)
- https://sources.debian.net/src/python-trie/0.2+ds-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python-trie/0.2+ds-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `python-txaio=2.10.0-1`

Binary Packages:

- `python3-txaio=2.10.0-1`

Licenses: (parsed from: `/usr/share/doc/python3-txaio/copyright`)
...
```console
$ apt-get source -qq --print-uris python-txaio=2.10.0-1
'http://deb.debian.org/debian/pool/main/p/python-txaio/python-txaio_2.10.0-1.dsc' python-txaio_2.10.0-1.dsc 2467 SHA256:4cafb84e7d41fae44d8dee4b01607754e0a5e0a080a70dd37788d01d62a9dd67
'http://deb.debian.org/debian/pool/main/p/python-txaio/python-txaio_2.10.0.orig.tar.xz' python-txaio_2.10.0.orig.tar.xz 37036 SHA256:cd7a8a0cec8adcc6e7d1395198d2af214f2fea99d79b7dce71a0cd5630358b4c
'http://deb.debian.org/debian/pool/main/p/python-txaio/python-txaio_2.10.0-1.debian.tar.xz' python-txaio_2.10.0-1.debian.tar.xz 4680 SHA256:5fe92649a306ca5cd46643a31cf05018053e01e1bf320c242c3b8a5b39367eca
```

Other potentially useful URLs:

- https://sources.debian.net/src/python-txaio/2.10.0-1/ (for browsing the source)
- https://sources.debian.net/src/python-txaio/2.10.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python-txaio/2.10.0-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `python-wsaccel=0.6.2-1`

Binary Packages:

- `python3-wsaccel=0.6.2-1+b1`

Licenses: (parsed from: `/usr/share/doc/python3-wsaccel/copyright`)
...
```console
$ apt-get source -qq --print-uris python-wsaccel=0.6.2-1
'http://deb.debian.org/debian/pool/main/p/python-wsaccel/python-wsaccel_0.6.2-1.dsc' python-wsaccel_0.6.2-1.dsc 2197 SHA256:efcaf283ed2a20831e724ada60aeee4e306782b3e0f14f4f7cc16fb384b65f12
'http://deb.debian.org/debian/pool/main/p/python-wsaccel/python-wsaccel_0.6.2.orig.tar.xz' python-wsaccel_0.6.2.orig.tar.xz 8968 SHA256:8cb8d740bb84044eb27eb8f4ea6e569a9965b69229c59bb4d0830ac537205f53
'http://deb.debian.org/debian/pool/main/p/python-wsaccel/python-wsaccel_0.6.2-1.debian.tar.xz' python-wsaccel_0.6.2-1.debian.tar.xz 2132 SHA256:5d57982369e5c62ecb462b44b6db276d4de5c1897caab7b97bb55204440ebdb8
```

Other potentially useful URLs:

- https://sources.debian.net/src/python-wsaccel/0.6.2-1/ (for browsing the source)
...
- `libpython3.7-dev:amd64=3.7.3-2+deb10u3`
...
'http://deb.debian.org/debian/pool/main/q/qhull/qhull_2015.2-4.dsc' qhull_2015.2-4.dsc 2270 SHA256:58fd067a3e3fc3f3f97714de599e687886ef42f0085bd786d66a1de960f9936b
...
'http://deb.debian.org/debian/pool/main/q/qhull/qhull_2015.2-4.debian.tar.xz' qhull_2015.2-4.debian.tar.xz 10816 SHA256:b1135fff216f4cf256690a8a2ecec6a775bec656d38ec12cbfda936360e4e0bb
```

Other potentially useful URLs:

- https://sources.debian.net/src/qhull/2015.2-4/ (for browsing the source)
- https://sources.debian.net/src/qhull/2015.2-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/qhull/2015.2-4/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `qtbase-opensource-src=5.11.3+dfsg1-1+deb10u4`

Binary Packages:

- `libqt5concurrent5:amd64=5.11.3+dfsg1-1+deb10u4`
- `libqt5core5a:amd64=5.11.3+dfsg1-1+deb10u4`
- `libqt5dbus5:amd64=5.11.3+dfsg1-1+deb10u4`
- `libqt5gui5:amd64=5.11.3+dfsg1-1+deb10u4`
- `libqt5network5:amd64=5.11.3+dfsg1-1+deb10u4`
- `libqt5opengl5:amd64=5.11.3+dfsg1-1+deb10u4`
- `libqt5opengl5-dev:amd64=5.11.3+dfsg1-1+deb10u4`
- `libqt5printsupport5:amd64=5.11.3+dfsg1-1+deb10u4`
- `libqt5sql5:amd64=5.11.3+dfsg1-1+deb10u4`
- `libqt5sql5-sqlite:amd64=5.11.3+dfsg1-1+deb10u4`
- `libqt5test5:amd64=5.11.3+dfsg1-1+deb10u4`
- `libqt5widgets5:amd64=5.11.3+dfsg1-1+deb10u4`
- `libqt5xml5:amd64=5.11.3+dfsg1-1+deb10u4`
- `qt5-qmake:amd64=5.11.3+dfsg1-1+deb10u4`
- `qt5-qmake-bin=5.11.3+dfsg1-1+deb10u4`
- `qtbase5-dev:amd64=5.11.3+dfsg1-1+deb10u4`
...
```console
$ apt-get source -qq --print-uris qtbase-opensource-src=5.11.3+dfsg1-1+deb10u4
'http://deb.debian.org/debian/pool/main/q/qtbase-opensource-src/qtbase-opensource-src_5.11.3%2bdfsg1-1%2bdeb10u4.dsc' qtbase-opensource-src_5.11.3+dfsg1-1+deb10u4.dsc 5206 SHA256:68d2c3c114cecd6e18b68650d02acc954a31f709a0b9dec4c4df98811b2f20a0
'http://deb.debian.org/debian/pool/main/q/qtbase-opensource-src/qtbase-opensource-src_5.11.3%2bdfsg1.orig.tar.xz' qtbase-opensource-src_5.11.3+dfsg1.orig.tar.xz 45155472 SHA256:fb6707c7f9f65b7160879d3bf6d05b3a9a796172c1fc47962b79f5a45c375a22
'http://deb.debian.org/debian/pool/main/q/qtbase-opensource-src/qtbase-opensource-src_5.11.3%2bdfsg1-1%2bdeb10u4.debian.tar.xz' qtbase-opensource-src_5.11.3+dfsg1-1+deb10u4.debian.tar.xz 244416 SHA256:2742b480117f231a585ec352f25929c942ae7b443acfd615b696094cc750d4c6
```

Other potentially useful URLs:

- https://sources.debian.net/src/qtbase-opensource-src/5.11.3+dfsg1-1+deb10u4/ (for browsing the source)
- https://sources.debian.net/src/qtbase-opensource-src/5.11.3+dfsg1-1+deb10u4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/qtbase-opensource-src/5.11.3+dfsg1-1+deb10u4/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `qtchooser=66-2`
...
```console
$ apt-get source -qq --print-uris qtchooser=66-2
'http://deb.debian.org/debian/pool/main/q/qtchooser/qtchooser_66-2.dsc' qtchooser_66-2.dsc 2123 SHA256:f66fe338edb8d9e4d3bea3d850cc7bf6d5aaa1c853108c24b0130fd2e0e92378
'http://deb.debian.org/debian/pool/main/q/qtchooser/qtchooser_66.orig.tar.xz' qtchooser_66.orig.tar.xz 32008 SHA256:b22c21df135d48fc775d26d771170c2c70555704d4625605383be2cd149c7cea
'http://deb.debian.org/debian/pool/main/q/qtchooser/qtchooser_66-2.debian.tar.xz' qtchooser_66-2.debian.tar.xz 6308 SHA256:50890b26cf85b5132b76a571989101b2f9e05b116f2f58e458525286d6c55e52
```

Other potentially useful URLs:

- https://sources.debian.net/src/qtchooser/66-2/ (for browsing the source)
- https://sources.debian.net/src/qtchooser/66-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/qtchooser/66-2/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `qtdeclarative-opensource-src=5.11.3-4`

Binary Packages:

- `libqt5qml5:amd64=5.11.3-4`
- `libqt5quick5:amd64=5.11.3-4`
- `libqt5quickparticles5:amd64=5.11.3-4`
- `libqt5quicktest5:amd64=5.11.3-4`
- `libqt5quickwidgets5:amd64=5.11.3-4`
- `qt5-qmltooling-plugins:amd64=5.11.3-4`
- `qtdeclarative5-dev:amd64=5.11.3-4`
- `qtdeclarative5-dev-tools=5.11.3-4`

Licenses: (parsed from: `/usr/share/doc/libqt5qml5/copyright`, `/usr/share/doc/libqt5quick5/copyright`, `/usr/share/doc/libqt5quickparticles5/copyright`, `/usr/share/doc/libqt5quicktest5/copyright`, `/usr/share/doc/libqt5quickwidgets5/copyright`, `/usr/share/doc/qt5-qmltooling-plugins/copyright`, `/usr/share/doc/qtdeclarative5-dev/copyright`, `/usr/share/doc/qtdeclarative5-dev-tools/copyright`)
...
```console
$ apt-get source -qq --print-uris qtdeclarative-opensource-src=5.11.3-4
'http://deb.debian.org/debian/pool/main/q/qtdeclarative-opensource-src/qtdeclarative-opensource-src_5.11.3-4.dsc' qtdeclarative-opensource-src_5.11.3-4.dsc 4697 SHA256:a3528068cd30e2d180c7fb26ffa303f7d83776da549b87d29902ed472ca8fa54
'http://deb.debian.org/debian/pool/main/q/qtdeclarative-opensource-src/qtdeclarative-opensource-src_5.11.3.orig.tar.xz' qtdeclarative-opensource-src_5.11.3.orig.tar.xz 22233024 SHA256:8e263621d706f1c4def5d71212a6ae37b0d3c378da89d9e3e5fc0b5557721ae6
'http://deb.debian.org/debian/pool/main/q/qtdeclarative-opensource-src/qtdeclarative-opensource-src_5.11.3-4.debian.tar.xz' qtdeclarative-opensource-src_5.11.3-4.debian.tar.xz 92680 SHA256:8bfd9695e61956611759f73da2d8c79db5e25d931be0dafcc9eb39059e679917
```

Other potentially useful URLs:

- https://sources.debian.net/src/qtdeclarative-opensource-src/5.11.3-4/ (for browsing the source)
- https://sources.debian.net/src/qtdeclarative-opensource-src/5.11.3-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/qtdeclarative-opensource-src/5.11.3-4/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `qtlocation-opensource-src=5.11.3+dfsg-2`
...
```console
$ apt-get source -qq --print-uris qtlocation-opensource-src=5.11.3+dfsg-2
'http://deb.debian.org/debian/pool/main/q/qtlocation-opensource-src/qtlocation-opensource-src_5.11.3%2bdfsg-2.dsc' qtlocation-opensource-src_5.11.3+dfsg-2.dsc 3455 SHA256:b241ce91c466eed961593d3292ecd0de4b3bbae41f19c160377dcfc213a6177f
'http://deb.debian.org/debian/pool/main/q/qtlocation-opensource-src/qtlocation-opensource-src_5.11.3%2bdfsg.orig.tar.xz' qtlocation-opensource-src_5.11.3+dfsg.orig.tar.xz 3422344 SHA256:ffdc5e66bfe323a732e86c1a57f00911f8bc1544600495ce36f11e43579b74e7
'http://deb.debian.org/debian/pool/main/q/qtlocation-opensource-src/qtlocation-opensource-src_5.11.3%2bdfsg-2.debian.tar.xz' qtlocation-opensource-src_5.11.3+dfsg-2.debian.tar.xz 35780 SHA256:761f100ef1e83745470833c28383a9f7d3036c6bf5548aa39496859c23781059
```

Other potentially useful URLs:

- https://sources.debian.net/src/qtlocation-opensource-src/5.11.3+dfsg-2/ (for browsing the source)
- https://sources.debian.net/src/qtlocation-opensource-src/5.11.3+dfsg-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/qtlocation-opensource-src/5.11.3+dfsg-2/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `qtsensors-opensource-src=5.11.3-2`
...
```console
$ apt-get source -qq --print-uris qtsensors-opensource-src=5.11.3-2
'http://deb.debian.org/debian/pool/main/q/qtsensors-opensource-src/qtsensors-opensource-src_5.11.3-2.dsc' qtsensors-opensource-src_5.11.3-2.dsc 2842 SHA256:9ef3d1a198a96f5ed555715c33e471729493871b3eabcd4ab875ce4e5976c005
'http://deb.debian.org/debian/pool/main/q/qtsensors-opensource-src/qtsensors-opensource-src_5.11.3.orig.tar.xz' qtsensors-opensource-src_5.11.3.orig.tar.xz 2031168 SHA256:a75753d1d5607d4cb27b1849ea9612a65bb3a5271bb31bf0817edd143b620859
'http://deb.debian.org/debian/pool/main/q/qtsensors-opensource-src/qtsensors-opensource-src_5.11.3-2.debian.tar.xz' qtsensors-opensource-src_5.11.3-2.debian.tar.xz 12156 SHA256:4021a86b3cca6202ded5d68d598997d1891f25be483bb719923017951a4867b8
```

Other potentially useful URLs:

- https://sources.debian.net/src/qtsensors-opensource-src/5.11.3-2/ (for browsing the source)
- https://sources.debian.net/src/qtsensors-opensource-src/5.11.3-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/qtsensors-opensource-src/5.11.3-2/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `qttools-opensource-src=5.11.3-4`

Binary Packages:

- `libqt5designer5:amd64=5.11.3-4`
- `libqt5designercomponents5:amd64=5.11.3-4`
- `libqt5help5:amd64=5.11.3-4`
- `qdoc-qt5=5.11.3-4`
- `qt5-assistant=5.11.3-4`
- `qttools5-dev:amd64=5.11.3-4`
- `qttools5-dev-tools=5.11.3-4`
- `qttools5-private-dev:amd64=5.11.3-4`

Licenses: (parsed from: `/usr/share/doc/libqt5designer5/copyright`, `/usr/share/doc/libqt5designercomponents5/copyright`, `/usr/share/doc/libqt5help5/copyright`, `/usr/share/doc/qdoc-qt5/copyright`, `/usr/share/doc/qt5-assistant/copyright`, `/usr/share/doc/qttools5-dev/copyright`, `/usr/share/doc/qttools5-dev-tools/copyright`, `/usr/share/doc/qttools5-private-dev/copyright`)
...
```console
$ apt-get source -qq --print-uris qttools-opensource-src=5.11.3-4
'http://deb.debian.org/debian/pool/main/q/qttools-opensource-src/qttools-opensource-src_5.11.3-4.dsc' qttools-opensource-src_5.11.3-4.dsc 3633 SHA256:1d5d31d84e83e4742b02014413ccb3813c463430d9fcff62987ce454b9f61d15
'http://deb.debian.org/debian/pool/main/q/qttools-opensource-src/qttools-opensource-src_5.11.3.orig.tar.xz' qttools-opensource-src_5.11.3.orig.tar.xz 9705920 SHA256:c205e81bba9b87c6186604a05ab48e4e6cac0cd511525749dfd00b107b6f9f8e
'http://deb.debian.org/debian/pool/main/q/qttools-opensource-src/qttools-opensource-src_5.11.3-4.debian.tar.xz' qttools-opensource-src_5.11.3-4.debian.tar.xz 46256 SHA256:6448a6efc40478bbfb967ae853422eaed4ae7e5de838c16779a9f6d84db72c13
```

Other potentially useful URLs:

- https://sources.debian.net/src/qttools-opensource-src/5.11.3-4/ (for browsing the source)
- https://sources.debian.net/src/qttools-opensource-src/5.11.3-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/qttools-opensource-src/5.11.3-4/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `qtwebchannel-opensource-src=5.11.3-2`
...
```console
$ apt-get source -qq --print-uris qtwebchannel-opensource-src=5.11.3-2
'http://deb.debian.org/debian/pool/main/q/qtwebchannel-opensource-src/qtwebchannel-opensource-src_5.11.3-2.dsc' qtwebchannel-opensource-src_5.11.3-2.dsc 2888 SHA256:d2ee6ceecc7eeeea2b5be75d7640d58f0291616091a07589933dae8743f24030
'http://deb.debian.org/debian/pool/main/q/qtwebchannel-opensource-src/qtwebchannel-opensource-src_5.11.3.orig.tar.xz' qtwebchannel-opensource-src_5.11.3.orig.tar.xz 177328 SHA256:3c254fa41b1af09c1e951131f3a1336dee70a15cbb8a82112488b38d29572df3
'http://deb.debian.org/debian/pool/main/q/qtwebchannel-opensource-src/qtwebchannel-opensource-src_5.11.3-2.debian.tar.xz' qtwebchannel-opensource-src_5.11.3-2.debian.tar.xz 7088 SHA256:5101dad426576f3b05db5107579f8bd7ef2bbbdc8e21b70f02965fa119ad6300
```

Other potentially useful URLs:

- https://sources.debian.net/src/qtwebchannel-opensource-src/5.11.3-2/ (for browsing the source)
- https://sources.debian.net/src/qtwebchannel-opensource-src/5.11.3-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/qtwebchannel-opensource-src/5.11.3-2/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `qtwebkit-opensource-src=5.212.0~alpha2-21`

Binary Packages:

- `libqt5webkit5:amd64=5.212.0~alpha2-21`
- `libqt5webkit5-dev:amd64=5.212.0~alpha2-21`
...
```console
$ apt-get source -qq --print-uris qtwebkit-opensource-src=5.212.0~alpha2-21
'http://deb.debian.org/debian/pool/main/q/qtwebkit-opensource-src/qtwebkit-opensource-src_5.212.0%7ealpha2-21.dsc' qtwebkit-opensource-src_5.212.0~alpha2-21.dsc 3256 SHA256:5d7d72debd191cec311b8a0cf83cc6b9f0147728103813e6423b6f131b55dcb9
'http://deb.debian.org/debian/pool/main/q/qtwebkit-opensource-src/qtwebkit-opensource-src_5.212.0%7ealpha2.orig.tar.xz' qtwebkit-opensource-src_5.212.0~alpha2.orig.tar.xz 12456284 SHA256:f8f901de567e11fc5659402b6b827eac75505ff9c5072d8e919aa306003f8f8a
'http://deb.debian.org/debian/pool/main/q/qtwebkit-opensource-src/qtwebkit-opensource-src_5.212.0%7ealpha2-21.debian.tar.xz' qtwebkit-opensource-src_5.212.0~alpha2-21.debian.tar.xz 68792 SHA256:15963e7f8966fb2ff258ee7373a086040a69a53e480e775bda4efac6789e70ce
```

Other potentially useful URLs:

- https://sources.debian.net/src/qtwebkit-opensource-src/5.212.0~alpha2-21/ (for browsing the source)
- https://sources.debian.net/src/qtwebkit-opensource-src/5.212.0~alpha2-21/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/qtwebkit-opensource-src/5.212.0~alpha2-21/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `qtx11extras-opensource-src=5.11.3-2`

Binary Packages:

- `libqt5x11extras5:amd64=5.11.3-2`

Licenses: (parsed from: `/usr/share/doc/libqt5x11extras5/copyright`)
...
```console
$ apt-get source -qq --print-uris qtx11extras-opensource-src=5.11.3-2
'http://deb.debian.org/debian/pool/main/q/qtx11extras-opensource-src/qtx11extras-opensource-src_5.11.3-2.dsc' qtx11extras-opensource-src_5.11.3-2.dsc 2741 SHA256:70b5f4ad27d08ef56a98427dbcfe017796fbab32bf0cb5afecdd389dbb615669
'http://deb.debian.org/debian/pool/main/q/qtx11extras-opensource-src/qtx11extras-opensource-src_5.11.3.orig.tar.xz' qtx11extras-opensource-src_5.11.3.orig.tar.xz 109496 SHA256:f99eebe685f7cdbb71cd62903c2b2511548345535841bcc3f6b662205815cd85
'http://deb.debian.org/debian/pool/main/q/qtx11extras-opensource-src/qtx11extras-opensource-src_5.11.3-2.debian.tar.xz' qtx11extras-opensource-src_5.11.3-2.debian.tar.xz 6424 SHA256:c3496cb3c98c2b5ee8aed24ff6e7bdfa3fb50fd467b6a7f3210483fc36d9752c
```

Other potentially useful URLs:

- https://sources.debian.net/src/qtx11extras-opensource-src/5.11.3-2/ (for browsing the source)
- https://sources.debian.net/src/qtx11extras-opensource-src/5.11.3-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/qtx11extras-opensource-src/5.11.3-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `ros-noetic-actionlib-msgs=1.13.1-1buster.20210424.000602`

Binary Packages:

- `ros-noetic-actionlib-msgs=1.13.1-1buster.20210424.000602`
...
### `dpkg` source package: `ros-noetic-actionlib=1.13.2-1buster.20220107.020159`

Binary Packages:

- `ros-noetic-actionlib=1.13.2-1buster.20220107.020159`
...
### `dpkg` source package: `ros-noetic-bond-core=1.8.6-1buster.20220107.015037`

Binary Packages:

- `ros-noetic-bond-core=1.8.6-1buster.20220107.015037`
...
### `dpkg` source package: `ros-noetic-bond=1.8.6-1buster.20210424.000656`

Binary Packages:

- `ros-noetic-bond=1.8.6-1buster.20210424.000656`
...
### `dpkg` source package: `ros-noetic-bondcpp=1.8.6-1buster.20220107.010047`

Binary Packages:

- `ros-noetic-bondcpp=1.8.6-1buster.20220107.010047`
...
### `dpkg` source package: `ros-noetic-bondpy=1.8.6-1buster.20220107.012356`

Binary Packages:

- `ros-noetic-bondpy=1.8.6-1buster.20220107.012356`
...
### `dpkg` source package: `ros-noetic-camera-calibration-parsers=1.12.0-1buster.20220107.022053`

Binary Packages:

- `ros-noetic-camera-calibration-parsers=1.12.0-1buster.20220107.022053`
...
### `dpkg` source package: `ros-noetic-camera-calibration=1.16.0-1buster.20220107.031138`

Binary Packages:

- `ros-noetic-camera-calibration=1.16.0-1buster.20220107.031138`
...
### `dpkg` source package: `ros-noetic-camera-info-manager=1.12.0-1buster.20220107.024511`

Binary Packages:

- `ros-noetic-camera-info-manager=1.12.0-1buster.20220107.024511`
...
### `dpkg` source package: `ros-noetic-common-msgs=1.13.1-1buster.20220107.031908`

Binary Packages:

- `ros-noetic-common-msgs=1.13.1-1buster.20220107.031908`
...
### `dpkg` source package: `ros-noetic-compressed-depth-image-transport=1.14.0-1buster.20220107.030000`

Binary Packages:

- `ros-noetic-compressed-depth-image-transport=1.14.0-1buster.20220107.030000`
...
### `dpkg` source package: `ros-noetic-compressed-image-transport=1.14.0-1buster.20220107.030007`

Binary Packages:

- `ros-noetic-compressed-image-transport=1.14.0-1buster.20220107.030007`
...
### `dpkg` source package: `ros-noetic-cv-bridge=1.16.0-1buster.20220107.025036`

Binary Packages:

- `ros-noetic-cv-bridge=1.16.0-1buster.20220107.025036`
...
### `dpkg` source package: `ros-noetic-depth-image-proc=1.16.0-1buster.20220107.031152`

Binary Packages:

- `ros-noetic-depth-image-proc=1.16.0-1buster.20220107.031152`
...
### `dpkg` source package: `ros-noetic-diagnostic-msgs=1.13.1-1buster.20210424.005249`

Binary Packages:

- `ros-noetic-diagnostic-msgs=1.13.1-1buster.20210424.005249`
...
### `dpkg` source package: `ros-noetic-dynamic-reconfigure=1.7.1-1buster.20220107.015959`

Binary Packages:

- `ros-noetic-dynamic-reconfigure=1.7.1-1buster.20220107.015959`
...
### `dpkg` source package: `ros-noetic-eigen-conversions=1.13.2-1buster.20210424.004818`

Binary Packages:

- `ros-noetic-eigen-conversions=1.13.2-1buster.20210424.004818`
...
### `dpkg` source package: `ros-noetic-filters=1.9.1-1buster.20220107.011553`

Binary Packages:

- `ros-noetic-filters=1.9.1-1buster.20220107.011553`
...
### `dpkg` source package: `ros-noetic-gencpp=0.6.5-1buster.20210423.230731`

Binary Packages:

- `ros-noetic-gencpp=0.6.5-1buster.20210423.230731`
...
### `dpkg` source package: `ros-noetic-geneus=3.0.0-1buster.20210423.230726`

Binary Packages:

- `ros-noetic-geneus=3.0.0-1buster.20210423.230726`
...
### `dpkg` source package: `ros-noetic-genlisp=0.4.18-1buster.20210423.230738`

Binary Packages:

- `ros-noetic-genlisp=0.4.18-1buster.20210423.230738`
...
### `dpkg` source package: `ros-noetic-genmsg=0.5.16-1buster.20210423.230449`

Binary Packages:

- `ros-noetic-genmsg=0.5.16-1buster.20210423.230449`
...
### `dpkg` source package: `ros-noetic-gennodejs=2.0.2-1buster.20210423.230739`

Binary Packages:

- `ros-noetic-gennodejs=2.0.2-1buster.20210423.230739`
...
### `dpkg` source package: `ros-noetic-genpy=0.6.15-1buster.20210423.230752`

Binary Packages:

- `ros-noetic-genpy=0.6.15-1buster.20210423.230752`
...
### `dpkg` source package: `ros-noetic-geometry-msgs=1.13.1-1buster.20210424.000451`

Binary Packages:

- `ros-noetic-geometry-msgs=1.13.1-1buster.20210424.000451`
...
### `dpkg` source package: `ros-noetic-image-common=1.12.0-1buster.20220107.030619`

Binary Packages:

- `ros-noetic-image-common=1.12.0-1buster.20220107.030619`
...
### `dpkg` source package: `ros-noetic-image-geometry=1.16.0-1buster.20220107.030432`

Binary Packages:

- `ros-noetic-image-geometry=1.16.0-1buster.20220107.030432`
...
### `dpkg` source package: `ros-noetic-image-pipeline=1.16.0-1buster.20220107.035528`

Binary Packages:

- `ros-noetic-image-pipeline=1.16.0-1buster.20220107.035528`
...
### `dpkg` source package: `ros-noetic-image-proc=1.16.0-1buster.20220107.030921`

Binary Packages:

- `ros-noetic-image-proc=1.16.0-1buster.20220107.030921`
...
### `dpkg` source package: `ros-noetic-image-publisher=1.16.0-1buster.20220107.025645`

Binary Packages:

- `ros-noetic-image-publisher=1.16.0-1buster.20220107.025645`
...
### `dpkg` source package: `ros-noetic-image-rotate=1.16.0-1buster.20220107.025711`

Binary Packages:

- `ros-noetic-image-rotate=1.16.0-1buster.20220107.025711`
...
### `dpkg` source package: `ros-noetic-image-transport-plugins=1.14.0-1buster.20220107.035542`

Binary Packages:

- `ros-noetic-image-transport-plugins=1.14.0-1buster.20220107.035542`
...
### `dpkg` source package: `ros-noetic-image-transport=1.12.0-1buster.20220107.024009`

Binary Packages:

- `ros-noetic-image-transport=1.12.0-1buster.20220107.024009`
...
### `dpkg` source package: `ros-noetic-image-view=1.16.0-1buster.20220107.030807`

Binary Packages:

- `ros-noetic-image-view=1.16.0-1buster.20220107.030807`
...
### `dpkg` source package: `ros-noetic-laser-assembler=1.7.8-1buster.20220107.023454`

Binary Packages:

- `ros-noetic-laser-assembler=1.7.8-1buster.20220107.023454`
...
### `dpkg` source package: `ros-noetic-laser-filters=1.9.0-1buster.20220107.023409`

Binary Packages:

- `ros-noetic-laser-filters=1.9.0-1buster.20220107.023409`
...
### `dpkg` source package: `ros-noetic-laser-geometry=1.6.7-1buster.20220107.023132`

Binary Packages:

- `ros-noetic-laser-geometry=1.6.7-1buster.20220107.023132`
...
### `dpkg` source package: `ros-noetic-laser-pipeline=1.6.4-1buster.20220107.033040`

Binary Packages:

- `ros-noetic-laser-pipeline=1.6.4-1buster.20220107.033040`
...
### `dpkg` source package: `ros-noetic-message-filters=1.15.14-1buster.20220107.014603`

Binary Packages:

- `ros-noetic-message-filters=1.15.14-1buster.20220107.014603`
...
### `dpkg` source package: `ros-noetic-message-generation=0.4.1-1buster.20210423.231814`

Binary Packages:

- `ros-noetic-message-generation=0.4.1-1buster.20210423.231814`
...
### `dpkg` source package: `ros-noetic-message-runtime=0.4.13-1buster.20210423.233310`

Binary Packages:

- `ros-noetic-message-runtime=0.4.13-1buster.20210423.233310`
...
### `dpkg` source package: `ros-noetic-mk=1.15.8-1buster.20210726.192959`

Binary Packages:

- `ros-noetic-mk=1.15.8-1buster.20210726.192959`
...
### `dpkg` source package: `ros-noetic-nav-msgs=1.13.1-1buster.20210424.004932`

Binary Packages:

- `ros-noetic-nav-msgs=1.13.1-1buster.20210424.004932`
...
### `dpkg` source package: `ros-noetic-nodelet-core=1.10.2-1buster.20220107.021209`

Binary Packages:

- `ros-noetic-nodelet-core=1.10.2-1buster.20220107.021209`
...
### `dpkg` source package: `ros-noetic-nodelet-topic-tools=1.10.2-1buster.20220107.020505`

Binary Packages:

- `ros-noetic-nodelet-topic-tools=1.10.2-1buster.20220107.020505`
...
### `dpkg` source package: `ros-noetic-nodelet=1.10.2-1buster.20220107.010459`

Binary Packages:

- `ros-noetic-nodelet=1.10.2-1buster.20220107.010459`
...
### `dpkg` source package: `ros-noetic-pcl-conversions=1.7.3-1buster.20220107.030806`

Binary Packages:

- `ros-noetic-pcl-conversions=1.7.3-1buster.20220107.030806`
...
### `dpkg` source package: `ros-noetic-pcl-msgs=0.3.0-1buster.20220107.030502`

Binary Packages:

- `ros-noetic-pcl-msgs=0.3.0-1buster.20220107.030502`
...
### `dpkg` source package: `ros-noetic-pcl-ros=1.7.3-1buster.20220107.031416`

Binary Packages:

- `ros-noetic-pcl-ros=1.7.3-1buster.20220107.031416`
...
### `dpkg` source package: `ros-noetic-perception-pcl=1.7.3-1buster.20220107.035618`

Binary Packages:

- `ros-noetic-perception-pcl=1.7.3-1buster.20220107.035618`
...
### `dpkg` source package: `ros-noetic-perception=1.5.0-1buster.20220107.035848`

Binary Packages:

- `ros-noetic-perception=1.5.0-1buster.20220107.035848`
...
### `dpkg` source package: `ros-noetic-pluginlib=1.13.0-1buster.20210726.194106`

Binary Packages:

- `ros-noetic-pluginlib=1.13.0-1buster.20210726.194106`
...
### `dpkg` source package: `ros-noetic-polled-camera=1.12.0-1buster.20220107.024603`

Binary Packages:

- `ros-noetic-polled-camera=1.12.0-1buster.20220107.024603`
...
### `dpkg` source package: `ros-noetic-ros-base=1.5.0-1buster.20220107.032709`

Binary Packages:

- `ros-noetic-ros-base=1.5.0-1buster.20220107.032709`
...
### `dpkg` source package: `ros-noetic-ros-comm=1.15.14-1buster.20220107.020401`

Binary Packages:

- `ros-noetic-ros-comm=1.15.14-1buster.20220107.020401`
...
### `dpkg` source package: `ros-noetic-ros-core=1.5.0-1buster.20220107.032134`

Binary Packages:

- `ros-noetic-ros-core=1.5.0-1buster.20220107.032134`
...
### `dpkg` source package: `ros-noetic-ros=1.15.8-1buster.20210726.193447`

Binary Packages:

- `ros-noetic-ros=1.15.8-1buster.20210726.193447`
...
### `dpkg` source package: `ros-noetic-rosbag-storage=1.15.14-1buster.20220107.014608`

Binary Packages:

- `ros-noetic-rosbag-storage=1.15.14-1buster.20220107.014608`
...
### `dpkg` source package: `ros-noetic-rosbag=1.15.14-1buster.20220107.015038`

Binary Packages:

- `ros-noetic-rosbag=1.15.14-1buster.20220107.015038`
...
### `dpkg` source package: `ros-noetic-rosbuild=1.15.8-1buster.20210726.192745`

Binary Packages:

- `ros-noetic-rosbuild=1.15.8-1buster.20210726.192745`
...
### `dpkg` source package: `ros-noetic-rosconsole-bridge=0.5.4-1buster.20210726.193839`

Binary Packages:

- `ros-noetic-rosconsole-bridge=0.5.4-1buster.20210726.193839`
...
### `dpkg` source package: `ros-noetic-rosconsole=1.14.3-1buster.20210726.193615`

Binary Packages:

- `ros-noetic-rosconsole=1.14.3-1buster.20210726.193615`
...
### `dpkg` source package: `ros-noetic-roscpp=1.15.14-1buster.20220107.000714`

Binary Packages:

- `ros-noetic-roscpp=1.15.14-1buster.20220107.000714`
...
### `dpkg` source package: `ros-noetic-rosgraph-msgs=1.11.3-1buster.20210424.005733`

Binary Packages:

- `ros-noetic-rosgraph-msgs=1.11.3-1buster.20210424.005733`
...
### `dpkg` source package: `ros-noetic-rosgraph=1.15.14-1buster.20220107.001020`

Binary Packages:

- `ros-noetic-rosgraph=1.15.14-1buster.20220107.001020`
...
### `dpkg` source package: `ros-noetic-roslang=1.15.8-1buster.20210726.192801`

Binary Packages:

- `ros-noetic-roslang=1.15.8-1buster.20210726.192801`
...
### `dpkg` source package: `ros-noetic-roslaunch=1.15.14-1buster.20220107.002251`

Binary Packages:

- `ros-noetic-roslaunch=1.15.14-1buster.20220107.002251`
...
### `dpkg` source package: `ros-noetic-roslisp=1.9.24-1buster.20210726.193035`

Binary Packages:

- `ros-noetic-roslisp=1.9.24-1buster.20210726.193035`
...
### `dpkg` source package: `ros-noetic-roslz4=1.15.14-1buster.20220106.234007`

Binary Packages:

- `ros-noetic-roslz4=1.15.14-1buster.20220106.234007`
...
### `dpkg` source package: `ros-noetic-rosmaster=1.15.14-1buster.20220107.001222`

Binary Packages:

- `ros-noetic-rosmaster=1.15.14-1buster.20220107.001222`
...
### `dpkg` source package: `ros-noetic-rosmsg=1.15.14-1buster.20220107.015438`

Binary Packages:

- `ros-noetic-rosmsg=1.15.14-1buster.20220107.015438`
...
### `dpkg` source package: `ros-noetic-rosnode=1.15.14-1buster.20220107.015754`

Binary Packages:

- `ros-noetic-rosnode=1.15.14-1buster.20220107.015754`
...
### `dpkg` source package: `ros-noetic-rosout=1.15.14-1buster.20220107.002010`

Binary Packages:

- `ros-noetic-rosout=1.15.14-1buster.20220107.002010`
...
### `dpkg` source package: `ros-noetic-rosparam=1.15.14-1buster.20220107.001422`

Binary Packages:

- `ros-noetic-rosparam=1.15.14-1buster.20220107.001422`
...
### `dpkg` source package: `ros-noetic-rospy=1.15.14-1buster.20220107.002222`

Binary Packages:

- `ros-noetic-rospy=1.15.14-1buster.20220107.002222`
...
### `dpkg` source package: `ros-noetic-rosservice=1.15.14-1buster.20220107.015737`

Binary Packages:

- `ros-noetic-rosservice=1.15.14-1buster.20220107.015737`
...
### `dpkg` source package: `ros-noetic-rostest=1.15.14-1buster.20220107.003456`

Binary Packages:

- `ros-noetic-rostest=1.15.14-1buster.20220107.003456`
...
### `dpkg` source package: `ros-noetic-rostopic=1.15.14-1buster.20220107.015453`

Binary Packages:

- `ros-noetic-rostopic=1.15.14-1buster.20220107.015453`
...
### `dpkg` source package: `ros-noetic-roswtf=1.15.14-1buster.20220107.020059`

Binary Packages:

- `ros-noetic-roswtf=1.15.14-1buster.20220107.020059`
...
### `dpkg` source package: `ros-noetic-sensor-msgs=1.13.1-1buster.20220107.021709`

Binary Packages:

- `ros-noetic-sensor-msgs=1.13.1-1buster.20220107.021709`
...
### `dpkg` source package: `ros-noetic-shape-msgs=1.13.1-1buster.20210424.005009`

Binary Packages:

- `ros-noetic-shape-msgs=1.13.1-1buster.20210424.005009`
...
### `dpkg` source package: `ros-noetic-std-msgs=0.5.13-1buster.20210424.000159`

Binary Packages:

- `ros-noetic-std-msgs=0.5.13-1buster.20210424.000159`
...
### `dpkg` source package: `ros-noetic-std-srvs=1.11.3-1buster.20210424.000312`

Binary Packages:

- `ros-noetic-std-srvs=1.11.3-1buster.20210424.000312`
...
### `dpkg` source package: `ros-noetic-stereo-image-proc=1.16.0-1buster.20220107.031632`

Binary Packages:

- `ros-noetic-stereo-image-proc=1.16.0-1buster.20220107.031632`
...
### `dpkg` source package: `ros-noetic-stereo-msgs=1.13.1-1buster.20220107.030504`

Binary Packages:

- `ros-noetic-stereo-msgs=1.13.1-1buster.20220107.030504`
...
### `dpkg` source package: `ros-noetic-tf2-eigen=0.7.5-1buster.20210424.005527`

Binary Packages:

- `ros-noetic-tf2-eigen=0.7.5-1buster.20210424.005527`
...
### `dpkg` source package: `ros-noetic-tf2-geometry-msgs=0.7.5-1buster.20220107.021100`

Binary Packages:

- `ros-noetic-tf2-geometry-msgs=0.7.5-1buster.20220107.021100`
...
### `dpkg` source package: `ros-noetic-tf2-msgs=0.7.5-1buster.20210424.005035`

Binary Packages:

- `ros-noetic-tf2-msgs=0.7.5-1buster.20210424.005035`
...
### `dpkg` source package: `ros-noetic-tf2-py=0.7.5-1buster.20220107.012352`

Binary Packages:

- `ros-noetic-tf2-py=0.7.5-1buster.20220107.012352`
...
### `dpkg` source package: `ros-noetic-tf2-ros=0.7.5-1buster.20220107.020555`

Binary Packages:

- `ros-noetic-tf2-ros=0.7.5-1buster.20220107.020555`
...
### `dpkg` source package: `ros-noetic-tf2=0.7.5-1buster.20210424.005253`

Binary Packages:

- `ros-noetic-tf2=0.7.5-1buster.20210424.005253`
...
### `dpkg` source package: `ros-noetic-tf=1.13.2-1buster.20220107.022424`

Binary Packages:

- `ros-noetic-tf=1.13.2-1buster.20220107.022424`
...
### `dpkg` source package: `ros-noetic-theora-image-transport=1.14.0-1buster.20220107.025933`

Binary Packages:

- `ros-noetic-theora-image-transport=1.14.0-1buster.20220107.025933`
...
### `dpkg` source package: `ros-noetic-topic-tools=1.15.14-1buster.20220107.014649`

Binary Packages:

- `ros-noetic-topic-tools=1.15.14-1buster.20220107.014649`
...
### `dpkg` source package: `ros-noetic-trajectory-msgs=1.13.1-1buster.20210424.005041`

Binary Packages:

- `ros-noetic-trajectory-msgs=1.13.1-1buster.20210424.005041`
...
### `dpkg` source package: `ros-noetic-vision-opencv=1.16.0-1buster.20220107.035504`

Binary Packages:

- `ros-noetic-vision-opencv=1.16.0-1buster.20220107.035504`
...
### `dpkg` source package: `ros-noetic-visualization-msgs=1.13.1-1buster.20210424.005116`

Binary Packages:

- `ros-noetic-visualization-msgs=1.13.1-1buster.20210424.005116`
...
### `dpkg` source package: `ros-noetic-xmlrpcpp=1.15.14-1buster.20220107.000417`

Binary Packages:

- `ros-noetic-xmlrpcpp=1.15.14-1buster.20220107.000417`
...
### `dpkg` source package: `socket++=1.12.13-10`

Binary Packages:

- `libsocket++1:amd64=1.12.13-10`
...
```console
$ apt-get source -qq --print-uris socket++=1.12.13-10
'http://deb.debian.org/debian/pool/main/s/socket%2b%2b/socket%2b%2b_1.12.13-10.dsc' socket++_1.12.13-10.dsc 2056 SHA256:96c6cda404c90483437c9a4397530dad20ae3e63b418971a26eb3f3c4736abac
'http://deb.debian.org/debian/pool/main/s/socket%2b%2b/socket%2b%2b_1.12.13.orig.tar.gz' socket++_1.12.13.orig.tar.gz 64263 SHA256:755cdcac06d40fcca2b221f840e05f89a86298bc3bfc518b51a57b42f0512b19
'http://deb.debian.org/debian/pool/main/s/socket%2b%2b/socket%2b%2b_1.12.13-10.debian.tar.xz' socket++_1.12.13-10.debian.tar.xz 4272 SHA256:bc949582d3b5679ef080d55f321078c20c61c79d7be27b6d757d1d2291108e24
```

Other potentially useful URLs:

- https://sources.debian.net/src/socket++/1.12.13-10/ (for browsing the source)
- https://sources.debian.net/src/socket++/1.12.13-10/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/socket++/1.12.13-10/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `spatialite=4.3.0a-5`

Binary Packages:

- `libspatialite-dev:amd64=4.3.0a-5+b2`
...
'http://deb.debian.org/debian/pool/main/s/speex/speex_1.2%7erc1.2-1.dsc' speex_1.2~rc1.2-1.dsc 1540 SHA256:faf1fa4e640bf3ba153ebe58f8f40824437ef303b276e04ef15b3841199dce43
...
'http://deb.debian.org/debian/pool/main/s/speex/speex_1.2%7erc1.2-1.diff.gz' speex_1.2~rc1.2-1.diff.gz 9750 SHA256:6c549549a9a8d1b24f12ddbfa706f1e078ad5d9fed9a9fe584f9d08b47458930
```
...
'http://deb.debian.org/debian/pool/main/s/sudo/sudo_1.8.27-1%2bdeb10u3.dsc' sudo_1.8.27-1+deb10u3.dsc 2130 SHA256:fa25a83685cb69b0313e3f6c775c0f2a2878d77ab901d3c0778f17ce9d530cc1
...
'http://deb.debian.org/debian/pool/main/s/sudo/sudo_1.8.27-1%2bdeb10u3.debian.tar.xz' sudo_1.8.27-1+deb10u3.debian.tar.xz 30836 SHA256:9ed1562303725a5d307c637cca3dbb65020b308b082f714b2d86cb2848c26d14
```
...
'http://deb.debian.org/debian/pool/main/s/superlu/superlu_5.2.1%2bdfsg1-4.dsc' superlu_5.2.1+dfsg1-4.dsc 2241 SHA256:63364ece2f9220ab8ab15b25511a88b837fa1d8b1313abf9ec312b164db61ec5
'http://deb.debian.org/debian/pool/main/s/superlu/superlu_5.2.1%2bdfsg1.orig.tar.xz' superlu_5.2.1+dfsg1.orig.tar.xz 702616 SHA256:6b09d9ad5f384300e9d2c85ccabb88e748405fbf768c79d7325bf1b8aba9d5e1
'http://deb.debian.org/debian/pool/main/s/superlu/superlu_5.2.1%2bdfsg1-4.debian.tar.xz' superlu_5.2.1+dfsg1-4.debian.tar.xz 6436 SHA256:3f4af1a6931b6a2d0e5fad02aa57af8c2d9773bcfbdf2230fd866184242b69f6
```

Other potentially useful URLs:

- https://sources.debian.net/src/superlu/5.2.1+dfsg1-4/ (for browsing the source)
- https://sources.debian.net/src/superlu/5.2.1+dfsg1-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/superlu/5.2.1+dfsg1-4/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `tbb=2018~U6-4`

Binary Packages:

- `libtbb-dev:amd64=2018~U6-4`
- `libtbb2:amd64=2018~U6-4`
...
```console
$ apt-get source -qq --print-uris tbb=2018~U6-4
'http://deb.debian.org/debian/pool/main/t/tbb/tbb_2018%7eU6-4.dsc' tbb_2018~U6-4.dsc 2175 SHA256:1d4c4c2bf30d0eee5a7a788c39aaa26bf451c413c16523b9714f403099b39528
'http://deb.debian.org/debian/pool/main/t/tbb/tbb_2018%7eU6.orig.tar.gz' tbb_2018~U6.orig.tar.gz 2922715 SHA256:d3e5fbca3cc643d03bf332d576ff85e19aa774b483f148f95cd7d09958372109
'http://deb.debian.org/debian/pool/main/t/tbb/tbb_2018%7eU6-4.debian.tar.xz' tbb_2018~U6-4.debian.tar.xz 53484 SHA256:7388365461fe52b9d75eee63d3369dd5bca80b17baeaba80fce4abc811100255
```

Other potentially useful URLs:

- https://sources.debian.net/src/tbb/2018~U6-4/ (for browsing the source)
- https://sources.debian.net/src/tbb/2018~U6-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/tbb/2018~U6-4/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `tesseract=4.0.0-2`
...
```console
$ apt-get source -qq --print-uris tesseract=4.0.0-2
'http://deb.debian.org/debian/pool/main/t/tesseract/tesseract_4.0.0-2.dsc' tesseract_4.0.0-2.dsc 2316 SHA256:89916e8d6424f4e4680858f995b56cf0e707a226218370fd58aaccfb516cf84b
'http://deb.debian.org/debian/pool/main/t/tesseract/tesseract_4.0.0.orig.tar.xz' tesseract_4.0.0.orig.tar.xz 6896044 SHA256:b3976b2a2994b23088147d2bd80f9e1e64d4cec0d9c73c6a211f262a5d540d10
'http://deb.debian.org/debian/pool/main/t/tesseract/tesseract_4.0.0-2.debian.tar.xz' tesseract_4.0.0-2.debian.tar.xz 37712 SHA256:657c2093d9e15f2398107c1c49b8f01e86e0f4e8e163dd72ff858a91ef3a6abc
```

Other potentially useful URLs:

- https://sources.debian.net/src/tesseract/4.0.0-2/ (for browsing the source)
- https://sources.debian.net/src/tesseract/4.0.0-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/tesseract/4.0.0-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `twisted=18.9.0-3`

Binary Packages:

- `python3-twisted=18.9.0-3`
- `python3-twisted-bin:amd64=18.9.0-3`
...
```console
$ apt-get source -qq --print-uris twisted=18.9.0-3
'http://deb.debian.org/debian/pool/main/t/twisted/twisted_18.9.0-3.dsc' twisted_18.9.0-3.dsc 3552 SHA256:4a4761a794575ea04ada2935f3ffe8f7f97cd7c37676832d87f3e3c8261d469d
'http://deb.debian.org/debian/pool/main/t/twisted/twisted_18.9.0.orig.tar.bz2' twisted_18.9.0.orig.tar.bz2 3088398 SHA256:294be2c6bf84ae776df2fc98e7af7d6537e1c5e60a46d33c3ce2a197677da395
'http://deb.debian.org/debian/pool/main/t/twisted/twisted_18.9.0-3.debian.tar.xz' twisted_18.9.0-3.debian.tar.xz 21508 SHA256:4f8937be00db1ebe98f2a62aeda3f1d7771ece998a0b64ab59396e71cd0af387
```

Other potentially useful URLs:

- https://sources.debian.net/src/twisted/18.9.0-3/ (for browsing the source)
- https://sources.debian.net/src/twisted/18.9.0-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/twisted/18.9.0-3/ (for access to the source package after it no longer exists in the archive)
...
Licenses: (parsed from: `/usr/share/doc/python3-u-msgpack/copyright`)
...
```console
$ apt-get source -qq --print-uris u-msgpack-python=2.1-1
'http://deb.debian.org/debian/pool/main/u/u-msgpack-python/u-msgpack-python_2.1-1.dsc' u-msgpack-python_2.1-1.dsc 2124 SHA256:e651bce5ed857cf43547a6644c2801158f9c3b3eb842070b29a1ae046c0285f0
'http://deb.debian.org/debian/pool/main/u/u-msgpack-python/u-msgpack-python_2.1.orig.tar.gz' u-msgpack-python_2.1.orig.tar.gz 6128 SHA256:66a39ddc6830be29b6d304dee9d4ab37104550ac4565eab1aa4c2bd3d34d759f
'http://deb.debian.org/debian/pool/main/u/u-msgpack-python/u-msgpack-python_2.1-1.debian.tar.xz' u-msgpack-python_2.1-1.debian.tar.xz 2048 SHA256:76eb60f0ac1b131d00b8a1b2587f2e2bb0dbc370b25e440b4a5244fa553fb6ef
```

Other potentially useful URLs:

- https://sources.debian.net/src/u-msgpack-python/2.1-1/ (for browsing the source)
- https://sources.debian.net/src/u-msgpack-python/2.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/u-msgpack-python/2.1-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `uriparser=0.9.1-1+deb10u1`
...
```console
$ apt-get source -qq --print-uris uriparser=0.9.1-1+deb10u1
'http://security.debian.org/debian-security/pool/updates/main/u/uriparser/uriparser_0.9.1-1%2bdeb10u1.dsc' uriparser_0.9.1-1+deb10u1.dsc 2258 SHA256:59371fa82d1d0e9b418897fdb45be805270b2e5d6c9f0c2928d1ff2bd65873e0
'http://security.debian.org/debian-security/pool/updates/main/u/uriparser/uriparser_0.9.1.orig.tar.bz2' uriparser_0.9.1.orig.tar.bz2 372722 SHA256:75248f3de3b7b13c8c9735ff7b86ebe72cbb8ad043291517d7d53488e0893abe
'http://security.debian.org/debian-security/pool/updates/main/u/uriparser/uriparser_0.9.1-1%2bdeb10u1.debian.tar.xz' uriparser_0.9.1-1+deb10u1.debian.tar.xz 8328 SHA256:72bfc8d5c992cb783a8595b8e3c6a0cf1f7579313b2b860cae1b46fc598a460a
```

Other potentially useful URLs:

- https://sources.debian.net/src/uriparser/0.9.1-1+deb10u1/ (for browsing the source)
- https://sources.debian.net/src/uriparser/0.9.1-1+deb10u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/uriparser/0.9.1-1+deb10u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `vtk6=6.3.0+dfsg2-2`

Binary Packages:

- `libvtk6.3=6.3.0+dfsg2-2+b5`

Licenses: (parsed from: `/usr/share/doc/libvtk6.3/copyright`)
...
```console
$ apt-get source -qq --print-uris vtk6=6.3.0+dfsg2-2
'http://deb.debian.org/debian/pool/main/v/vtk6/vtk6_6.3.0%2bdfsg2-2.dsc' vtk6_6.3.0+dfsg2-2.dsc 3311 SHA256:0886bd4ed88185335b35d35669d41ea673e4ed18f0fe06313448ece36b7cacfb
'http://deb.debian.org/debian/pool/main/v/vtk6/vtk6_6.3.0%2bdfsg2.orig.tar.gz' vtk6_6.3.0+dfsg2.orig.tar.gz 18165661 SHA256:0c823748d66d36678a59c534ec9c919c9188d1176bbf31a511d6f53d503bc4f0
'http://deb.debian.org/debian/pool/main/v/vtk6/vtk6_6.3.0%2bdfsg2-2.debian.tar.xz' vtk6_6.3.0+dfsg2-2.debian.tar.xz 32308 SHA256:5770adb4f283d5100a92ea3447eaa9f7dd1500daffa0a3e86701f4f455a2a9fe
```

Other potentially useful URLs:

- https://sources.debian.net/src/vtk6/6.3.0+dfsg2-2/ (for browsing the source)
- https://sources.debian.net/src/vtk6/6.3.0+dfsg2-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/vtk6/6.3.0+dfsg2-2/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `vtk7=7.1.1+dfsg1-12`
...
Licenses: (parsed from: `/usr/share/doc/libvtk7-dev/copyright`, `/usr/share/doc/libvtk7-java/copyright`, `/usr/share/doc/libvtk7-jni/copyright`, `/usr/share/doc/libvtk7-qt-dev/copyright`, `/usr/share/doc/libvtk7.1/copyright`, `/usr/share/doc/libvtk7.1-qt/copyright`, `/usr/share/doc/python3-vtk7/copyright`, `/usr/share/doc/tcl-vtk7/copyright`, `/usr/share/doc/vtk7/copyright`)
...
```console
$ apt-get source -qq --print-uris vtk7=7.1.1+dfsg1-12
'http://deb.debian.org/debian/pool/main/v/vtk7/vtk7_7.1.1%2bdfsg1-12.dsc' vtk7_7.1.1+dfsg1-12.dsc 3661 SHA256:7e4052bf97f888c059feecebfd4292b3b26b96bc81d76951c8adfb7a17340e74
'http://deb.debian.org/debian/pool/main/v/vtk7/vtk7_7.1.1%2bdfsg1.orig.tar.gz' vtk7_7.1.1+dfsg1.orig.tar.gz 19576902 SHA256:0b33f346bae08f27fb097fd318605ed92d3cfefbe3df1fd96d9a16b388d734e0
'http://deb.debian.org/debian/pool/main/v/vtk7/vtk7_7.1.1%2bdfsg1-12.debian.tar.xz' vtk7_7.1.1+dfsg1-12.debian.tar.xz 26256 SHA256:a61d2802643c4a13684279bf1e80a9042ccb3c36f1059e1633270eeec881bfbe
```

Other potentially useful URLs:

- https://sources.debian.net/src/vtk7/7.1.1+dfsg1-12/ (for browsing the source)
- https://sources.debian.net/src/vtk7/7.1.1+dfsg1-12/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/vtk7/7.1.1+dfsg1-12/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `vulkan-loader=1.1.97-2`

Binary Packages:

- `libvulkan-dev:amd64=1.1.97-2`
...
```console
$ apt-get source -qq --print-uris vulkan-loader=1.1.97-2
'http://deb.debian.org/debian/pool/main/v/vulkan-loader/vulkan-loader_1.1.97-2.dsc' vulkan-loader_1.1.97-2.dsc 2138 SHA256:4b5fd529132811c486b463f44499de5412ebd87f76512da57adc87d31946b526
'http://deb.debian.org/debian/pool/main/v/vulkan-loader/vulkan-loader_1.1.97.orig.tar.xz' vulkan-loader_1.1.97.orig.tar.xz 1601220 SHA256:6f0c72fe0cee28c7b126d3196ed32023c71b113b5fdb424460d2b4094644dafb
'http://deb.debian.org/debian/pool/main/v/vulkan-loader/vulkan-loader_1.1.97-2.debian.tar.xz' vulkan-loader_1.1.97-2.debian.tar.xz 5336 SHA256:b999cf1bd2d48cdde109e49f73222b614d85460e06d9c688dbc6fed3dbfe40b8
```

Other potentially useful URLs:

- https://sources.debian.net/src/vulkan-loader/1.1.97-2/ (for browsing the source)
- https://sources.debian.net/src/vulkan-loader/1.1.97-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/vulkan-loader/1.1.97-2/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/x/x264/x264_0.155.2917%2bgit0a84d98-2.dsc' x264_0.155.2917+git0a84d98-2.dsc 2407 SHA256:b296d3069efcbbf6a7a9c3a6bfd1ec99fa559ece8c5959158859e47e0092a393
'http://deb.debian.org/debian/pool/main/x/x264/x264_0.155.2917%2bgit0a84d98.orig.tar.gz' x264_0.155.2917+git0a84d98.orig.tar.gz 934501 SHA256:814e8d233a7a98a66b4c592bec60c531369bac453d679ba6c006bdcd2677e7e8
'http://deb.debian.org/debian/pool/main/x/x264/x264_0.155.2917%2bgit0a84d98-2.debian.tar.xz' x264_0.155.2917+git0a84d98-2.debian.tar.xz 23260 SHA256:9058a14889abcb6e28e1219ba3b5a78c00125f91877a1ecf3ac7d3aa352b19c3
```
...
'http://deb.debian.org/debian/pool/main/x/xcb-util-wm/xcb-util-wm_0.4.1-1.1.dsc' xcb-util-wm_0.4.1-1.1.dsc 2296 SHA256:88bf7032902d2576daba7735c7b2c5c5107b1bfe3679f46aadfce03852fae07b
...
'http://deb.debian.org/debian/pool/main/x/xcb-util-wm/xcb-util-wm_0.4.1-1.1.debian.tar.xz' xcb-util-wm_0.4.1-1.1.debian.tar.xz 4444 SHA256:48b920004150d181018dec3c10438d166017bfc66794c15bb819a45384f5821b
```

Other potentially useful URLs:

- https://sources.debian.net/src/xcb-util-wm/0.4.1-1.1/ (for browsing the source)
- https://sources.debian.net/src/xcb-util-wm/0.4.1-1.1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/xcb-util-wm/0.4.1-1.1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `xerces-c=3.2.2+debian-1+deb10u1`

Binary Packages:

- `libxerces-c-dev=3.2.2+debian-1+deb10u1`
- `libxerces-c3.2:amd64=3.2.2+debian-1+deb10u1`
...
```console
$ apt-get source -qq --print-uris xerces-c=3.2.2+debian-1+deb10u1
'http://deb.debian.org/debian/pool/main/x/xerces-c/xerces-c_3.2.2%2bdebian-1%2bdeb10u1.dsc' xerces-c_3.2.2+debian-1+deb10u1.dsc 1944 SHA256:9494673a337d1da333df70f37a6d7c501df6b38f6cd0d05346f853ffbb4ac8d6
'http://deb.debian.org/debian/pool/main/x/xerces-c/xerces-c_3.2.2%2bdebian.orig.tar.gz' xerces-c_3.2.2+debian.orig.tar.gz 2513427 SHA256:98f9ece846b7858aad8243b066d3bf726abd72ccb93735b858a1b927fc7cdaca
'http://deb.debian.org/debian/pool/main/x/xerces-c/xerces-c_3.2.2%2bdebian-1%2bdeb10u1.debian.tar.xz' xerces-c_3.2.2+debian-1+deb10u1.debian.tar.xz 22700 SHA256:a5288c40614b28164ab7bcd24164f88d988791aafc8e1ee5b61d52132de229d1
```

Other potentially useful URLs:

- https://sources.debian.net/src/xerces-c/3.2.2+debian-1+deb10u1/ (for browsing the source)
- https://sources.debian.net/src/xerces-c/3.2.2+debian-1+deb10u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/xerces-c/3.2.2+debian-1+deb10u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `yaml-cpp=0.6.2-4`

Binary Packages:

- `libyaml-cpp-dev=0.6.2-4`
- `libyaml-cpp0.6:amd64=0.6.2-4`

Licenses: (parsed from: `/usr/share/doc/libyaml-cpp-dev/copyright`, `/usr/share/doc/libyaml-cpp0.6/copyright`)
...
```console
$ apt-get source -qq --print-uris yaml-cpp=0.6.2-4
'http://deb.debian.org/debian/pool/main/y/yaml-cpp/yaml-cpp_0.6.2-4.dsc' yaml-cpp_0.6.2-4.dsc 1904 SHA256:90fd0a60f8a88a5e6a367e69af560647e54a58223561ad8790a569a723b27786
'http://deb.debian.org/debian/pool/main/y/yaml-cpp/yaml-cpp_0.6.2.orig.tar.gz' yaml-cpp_0.6.2.orig.tar.gz 1396250 SHA256:e4d8560e163c3d875fd5d9e5542b5fd5bec810febdcba61481fe5fc4e6b1fd05
'http://deb.debian.org/debian/pool/main/y/yaml-cpp/yaml-cpp_0.6.2-4.debian.tar.xz' yaml-cpp_0.6.2-4.debian.tar.xz 7496 SHA256:7c60d96d5a91b492d8ba04663472aed3bd0f6938cb903bed72423a3aa3f4e9f9
```

Other potentially useful URLs:

- https://sources.debian.net/src/yaml-cpp/0.6.2-4/ (for browsing the source)
- https://sources.debian.net/src/yaml-cpp/0.6.2-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/yaml-cpp/0.6.2-4/ (for access to the source package after it no longer exists in the archive)
