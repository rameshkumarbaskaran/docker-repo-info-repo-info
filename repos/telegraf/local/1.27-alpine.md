...
- Created: `2023-09-29T03:25:30.094108926Z`
- Virtual Size: ~ 210.06 Mb  
...
```console
net-snmp-agent-libs-5.9.3-r3 description:
The NET-SNMP runtime agent libraries

net-snmp-agent-libs-5.9.3-r3 webpage:
http://www.net-snmp.org/

net-snmp-agent-libs-5.9.3-r3 installed size:
1704 KiB

net-snmp-agent-libs-5.9.3-r3 license:
Net-SNMP
...
```console
net-snmp-libs-5.9.3-r3 description:
The NET-SNMP runtime client libraries

net-snmp-libs-5.9.3-r3 webpage:
http://www.net-snmp.org/

net-snmp-libs-5.9.3-r3 installed size:
2504 KiB

net-snmp-libs-5.9.3-r3 license:
Net-SNMP
...
```console
net-snmp-tools-5.9.3-r3 description:
Network management utilities using SNMP

net-snmp-tools-5.9.3-r3 webpage:
http://www.net-snmp.org/

net-snmp-tools-5.9.3-r3 installed size:
516 KiB

net-snmp-tools-5.9.3-r3 license:
Net-SNMP
...
```console
sysfsutils-2.1.1-r2 description:
System Utilities Based on Sysfs

sysfsutils-2.1.1-r2 webpage:
https://github.com/linux-ras/sysfsutils

sysfsutils-2.1.1-r2 installed size:
88 KiB

sysfsutils-2.1.1-r2 license:
