...
- Created: `2020-06-30T22:40:24.136286284Z`
...
### `dpkg` source package: `net-snmp=5.7.3+dfsg-1.7+deb9u1`

Binary Packages:

- `libsnmp-base=5.7.3+dfsg-1.7+deb9u1`
- `libsnmp30:amd64=5.7.3+dfsg-1.7+deb9u1`
- `snmp=5.7.3+dfsg-1.7+deb9u1`
...
```console
$ apt-get source -qq --print-uris net-snmp=5.7.3+dfsg-1.7+deb9u1
'http://deb.debian.org/debian/pool/main/n/net-snmp/net-snmp_5.7.3+dfsg-1.7+deb9u1.dsc' net-snmp_5.7.3+dfsg-1.7+deb9u1.dsc 3316 SHA256:61687e824bca1d7cbfa0506c854f4cbcbbefaa0d0e1c012a7c88520e5139815d
...
'http://deb.debian.org/debian/pool/main/n/net-snmp/net-snmp_5.7.3+dfsg-1.7+deb9u1.debian.tar.xz' net-snmp_5.7.3+dfsg-1.7+deb9u1.debian.tar.xz 74236 SHA256:17d7cd84de728889aabec767eb8b616bb750a42a194eddbd66953dd6311eb88b
```

Other potentially useful URLs:

- https://sources.debian.net/src/net-snmp/5.7.3+dfsg-1.7+deb9u1/ (for browsing the source)
- https://sources.debian.net/src/net-snmp/5.7.3+dfsg-1.7+deb9u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/net-snmp/5.7.3+dfsg-1.7+deb9u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `telegraf=1.14.5-1`
