...
- Created: `2021-03-27T10:17:23.082200487Z`
- Virtual Size: ~ 201.50 Mb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Entrypoint: `["docker-varnish-entrypoint"]`
- Environment:
  - `PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin`
  - `VARNISH_VERSION=6.5.1~buster-1`
  - `VARNISH_SIZE=100M`
...
### `dpkg` source package: `varnish=6.5.1~buster-1`

Binary Packages:

- `varnish=6.5.1~buster-1`
