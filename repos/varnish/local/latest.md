...
- Created: `2023-10-11T21:30:01.857155627Z`
...
### `dpkg` source package: `dns-root-data=2023010101`

Binary Packages:

- `dns-root-data=2023010101`
...
```console
$ apt-get source -qq --print-uris dns-root-data=2023010101
'http://deb.debian.org/debian/pool/main/d/dns-root-data/dns-root-data_2023010101.dsc' dns-root-data_2023010101.dsc 1296 SHA256:838e938af088627dd9e4793ec3f947d06b377d52cb3552d0d163cd4cea1fe52b
'http://deb.debian.org/debian/pool/main/d/dns-root-data/dns-root-data_2023010101.tar.xz' dns-root-data_2023010101.tar.xz 15052 SHA256:1cefbcd914eb705360abb24e6bb9ecbd74c476b9bce999028519c8b04107c243
```

Other potentially useful URLs:

- https://sources.debian.net/src/dns-root-data/2023010101/ (for browsing the source)
- https://sources.debian.net/src/dns-root-data/2023010101/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/dns-root-data/2023010101/ (for access to the source package after it no longer exists in the archive)
