...
- Created: `2021-05-12T14:44:05.844581096Z`
- Virtual Size: ~ 201.90 Mb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Entrypoint: `["/usr/local/bin/docker-varnish-entrypoint"]`
- Environment:
  - `PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin`
  - `VARNISH_VERSION=6.6.0-1~buster`
  - `VARNISH_SIZE=100M`
...
### `dpkg` source package: `varnish=6.6.0-1~buster`

Binary Packages:

- `varnish=6.6.0-1~buster`
