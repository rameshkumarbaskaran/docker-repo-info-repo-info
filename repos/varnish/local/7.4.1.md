...
### `dpkg` source package: `unbound=1.17.1-2`

Binary Packages:

- `libunbound8:amd64=1.17.1-2`
...
```console
$ apt-get source -qq --print-uris unbound=1.17.1-2
'http://deb.debian.org/debian/pool/main/u/unbound/unbound_1.17.1-2.dsc' unbound_1.17.1-2.dsc 2843 SHA256:54d388fa1cc0085a039be08ac2b3789d2d674b773bc5e3340e933767a1ffa24d
...
'http://deb.debian.org/debian/pool/main/u/unbound/unbound_1.17.1-2.debian.tar.xz' unbound_1.17.1-2.debian.tar.xz 29820 SHA256:f6444edb7a6962f41458905210fc0f0a3f98ef6ef31fed72d066621fed8af57a
```

Other potentially useful URLs:

- https://sources.debian.net/src/unbound/1.17.1-2/ (for browsing the source)
- https://sources.debian.net/src/unbound/1.17.1-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/unbound/1.17.1-2/ (for access to the source package after it no longer exists in the archive)
