...
- Created: `2023-05-24T22:29:28.991254646Z`
- Virtual Size: ~ 89.55 Mb  
...
```console
liblksctp-1.0.19-r1 description:
User-space access to Linux Kernel SCTP (libraries)

liblksctp-1.0.19-r1 webpage:
https://lksctp.sourceforge.net/

liblksctp-1.0.19-r1 installed size:
52 KiB

liblksctp-1.0.19-r1 license:
...
```console
lksctp-tools-1.0.19-r1 description:
User-space access to Linux Kernel SCTP

lksctp-tools-1.0.19-r1 webpage:
https://lksctp.sourceforge.net/

lksctp-tools-1.0.19-r1 installed size:
140 KiB

lksctp-tools-1.0.19-r1 license:
GPL-2.0-only AND LGPL-2.1-or-later
