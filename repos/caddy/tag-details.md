...
```console
$ docker pull caddy@sha256:eda213ae0c643541db56aa1d310cb5d0ad78c5a57b9523b8a0385badd0636ccf
```
...
```console
$ docker pull caddy@sha256:938327ef9ee4587db653c7c356faeb7fa41822272f6c6433dcf8c3b3a67ef07f
```
