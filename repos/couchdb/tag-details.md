...
```console
$ docker pull couchdb@sha256:ed783920c79dc77a540cd781e2cb0b55f5cd3f73406248442d8b4861f0f7348b
```
...
```console
$ docker pull couchdb@sha256:22c2795e9c901edd0f70330cbc46db3b7c3b13016e6b526f745bcb0fe1f28288
```
