...
```console
$ docker pull adminer@sha256:b1252f3801f03fec726adffc65b0d282bc57a6dca452852d2c311dbd176099fc
```
...
```console
$ docker pull adminer@sha256:ff127a5b8e7bdc181b227ef1b2b860cb2286db905b0e985b0951f5541d7d6440
```
