...
```console
$ docker pull adminer@sha256:a71089fb10f9b130acdaa61cc0b7ff698028534667c6e6a5494e2e5d945cd34a
```
...
```console
$ docker pull adminer@sha256:ba0a6fd560ef080693ae7e95a590cd2cc7de6fa0b8a437ec516fa72353d217df
```
