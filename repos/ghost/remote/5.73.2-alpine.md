...
### `ghost:5.73.2-alpine` - linux; amd64
...
### `ghost:5.73.2-alpine` - unknown; unknown
...
### `ghost:5.73.2-alpine` - linux; arm variant v6
...
### `ghost:5.73.2-alpine` - linux; arm variant v7
...
### `ghost:5.73.2-alpine` - linux; arm64 variant v8
