...
```console
$ docker pull ghost@sha256:d078fc0822707c833820c144a8c9ba5606a0793006689045b0584fee0ef08ad8
```
...
### `ghost:5.46.1-alpine` - linux; amd64
...
### `ghost:5.46.1-alpine` - linux; arm variant v7
