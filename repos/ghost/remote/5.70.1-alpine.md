...
```console
$ docker pull ghost@sha256:2628ceadefa6edd81ba4c793340ca9d4b655a9b7cb715b52468fe8274d747524
```
...
### `ghost:5.70.1-alpine` - linux; amd64
...
### `ghost:5.70.1-alpine` - linux; arm variant v6
...
### `ghost:5.70.1-alpine` - linux; arm variant v7
...
### `ghost:5.70.1-alpine` - linux; arm64 variant v8
