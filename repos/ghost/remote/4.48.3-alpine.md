...
```console
$ docker pull ghost@sha256:5a8d1b9c3000156179aecd656398400f3870282b42ce22da1285cd89c47e8681
```
...
### `ghost:4.48.3-alpine` - linux; amd64
...
### `ghost:4.48.3-alpine` - linux; arm64 variant v8
