...
```console
$ docker pull eclipse-mosquitto@sha256:bf213a89580591182dfe05de5e2aa3de186c481ec21ef045befb57b0e89a20d6
```
...
```console
$ docker pull eclipse-mosquitto@sha256:41f331c4e263ec128bcf68c03192b70dd3a75a18385f768936a3fc27b3fcd3ff
```
