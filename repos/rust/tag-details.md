...
```console
$ docker pull rust@sha256:f84bc30748604a8db1ab033149c13ae92a56ab980fccf323eae0a48a16cdcf8c
```
...
```console
$ docker pull rust@sha256:194845c6e172f36f9b1bf335f61281f49d273e1189673942280b88952e30ab3f
```
