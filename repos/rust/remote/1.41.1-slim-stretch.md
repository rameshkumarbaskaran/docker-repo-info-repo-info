...
```console
$ docker pull rust@sha256:a958912c27a363c60134731ccc491617a504985586fa76dcc7e956f2d44b18de
```
...
### `rust:1.41.1-slim-stretch` - linux; amd64
...
### `rust:1.41.1-slim-stretch` - linux; 386
