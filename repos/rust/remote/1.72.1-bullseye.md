...
```console
$ docker pull rust@sha256:2b5e5db6d32812c2bfc141f7a4192a61c8ddf48a90aecf6491822b7a8fe2b76d
```
...
### `rust:1.72.1-bullseye` - linux; amd64
...
### `rust:1.72.1-bullseye` - linux; arm variant v7
...
### `rust:1.72.1-bullseye` - linux; 386
