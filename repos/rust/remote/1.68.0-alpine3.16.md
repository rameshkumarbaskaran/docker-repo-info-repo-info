## `rust:1.68.0-alpine3.16`

```console
$ docker pull rust@sha256:f363c3bc5b235301320822770f702af1e9f20451af245ef4e2904bac2ada249d
```
...
### `rust:1.68.0-alpine3.16` - linux; amd64
...
### `rust:1.68.0-alpine3.16` - linux; arm64 variant v8
