...
### `docker:25.0.0-beta.3-dind-rootless` - linux; amd64
...
### `docker:25.0.0-beta.3-dind-rootless` - unknown; unknown
...
### `docker:25.0.0-beta.3-dind-rootless` - linux; arm64 variant v8
