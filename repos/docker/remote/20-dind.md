...
```console
$ docker pull docker@sha256:3153fa63f54628783638632ace7aa3d0f4bfb9f04ae43400122451257f9c8990
```
...
```console
$ docker pull docker@sha256:080c36d444db2fb0e1aca56b6b94809095aedbdf05fdac61c62723be850e4384
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **109.0 MB (108956916 bytes)**  
