...
```console
$ docker pull docker@sha256:812ff1098c97878ae26ca8e0423e00aa157596a8b28d4bd52c120c4d087e8ae1
```
...
```console
$ docker pull docker@sha256:350c2dd857fb493199282b13ddc7f5ce68c56ef30460a9f4942c020cca427eea
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.1 MB (49100468 bytes)**  
