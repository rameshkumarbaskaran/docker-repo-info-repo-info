...
```console
$ docker pull docker@sha256:919061b7f4ec6cce50f40a6a7ee93c1f902812fabaede2fb5108a4e1d1601ab6
```
...
```console
$ docker pull docker@sha256:0505f183398c401b0de4564e89f77ebb5d3cbdbf9f4e6bb4540d5147bb42800c
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **45.6 MB (45557341 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:55f9f01760544e3236a20359239e7d3d3ab4bacf46711f930be5fdb9523caacb`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["sh"]`
