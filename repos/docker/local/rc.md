...
```console
e2fsprogs-1.47.0-r2 description:
Standard Ext2/3/4 filesystem utilities

e2fsprogs-1.47.0-r2 webpage:
https://e2fsprogs.sourceforge.net/

e2fsprogs-1.47.0-r2 installed size:
420 KiB

e2fsprogs-1.47.0-r2 license:
...
```console
e2fsprogs-extra-1.47.0-r2 description:
Ext2/3/4 filesystem extra utilities

e2fsprogs-extra-1.47.0-r2 webpage:
https://e2fsprogs.sourceforge.net/

e2fsprogs-extra-1.47.0-r2 installed size:
648 KiB

e2fsprogs-extra-1.47.0-r2 license:
GPL-2.0-or-later AND LGPL-2.0-or-later AND BSD-3-Clause AND MIT
...
```console
e2fsprogs-libs-1.47.0-r2 description:
Standard Ext2/3/4 filesystem utilities (libraries)

e2fsprogs-libs-1.47.0-r2 webpage:
https://e2fsprogs.sourceforge.net/

e2fsprogs-libs-1.47.0-r2 installed size:
460 KiB

e2fsprogs-libs-1.47.0-r2 license:
GPL-2.0-or-later AND LGPL-2.0-or-later AND BSD-3-Clause AND MIT
...
```console
eudev-libs-3.2.11-r8 description:
Dynamic library to access udev device information

eudev-libs-3.2.11-r8 webpage:
https://github.com/eudev-project/eudev

eudev-libs-3.2.11-r8 installed size:
132 KiB

eudev-libs-3.2.11-r8 license:
GPL-2.0-or-later
...
```console
ip6tables-1.8.9-r2 description:
Linux kernel firewall, NAT and packet mangling tools

ip6tables-1.8.9-r2 webpage:
https://www.netfilter.org/projects/iptables/index.html

ip6tables-1.8.9-r2 installed size:
292 KiB

ip6tables-1.8.9-r2 license:
GPL-2.0-or-later
...
```console
iptables-1.8.9-r2 description:
Linux kernel firewall, NAT and packet mangling tools

iptables-1.8.9-r2 webpage:
https://www.netfilter.org/projects/iptables/index.html

iptables-1.8.9-r2 installed size:
2132 KiB

iptables-1.8.9-r2 license:
GPL-2.0-or-later
...
```console
libmnl-1.0.5-r1 description:
Library for minimalistic netlink

libmnl-1.0.5-r1 webpage:
https://www.netfilter.org/projects/libmnl/

libmnl-1.0.5-r1 installed size:
40 KiB

libmnl-1.0.5-r1 license:
LGPL-2.1-or-later
...
```console
libnftnl-1.2.5-r1 description:
Netfilter library providing interface to the nf_tables subsystem

libnftnl-1.2.5-r1 webpage:
https://netfilter.org/projects/libnftnl

libnftnl-1.2.5-r1 installed size:
192 KiB

libnftnl-1.2.5-r1 license:
GPL-2.0-or-later
...
```console
linux-pam-1.5.2-r10 description:
Linux PAM (Pluggable Authentication Modules for Linux)

linux-pam-1.5.2-r10 webpage:
https://www.kernel.org/pub/linux/libs/pam

linux-pam-1.5.2-r10 installed size:
1076 KiB

linux-pam-1.5.2-r10 license:
BSD-3-Clause
...
```console
pigz-2.7-r3 description:
Parallel implementation of gzip

pigz-2.7-r3 webpage:
https://zlib.net/pigz/

pigz-2.7-r3 installed size:
260 KiB
...
```console
userspace-rcu-0.14.0-r1 description:
Userspace RCU (read-copy-update) library

userspace-rcu-0.14.0-r1 webpage:
https://liburcu.org/

userspace-rcu-0.14.0-r1 installed size:
268 KiB

userspace-rcu-0.14.0-r1 license:
LGPL-2.1-or-later
...
```console
xfsprogs-6.2.0-r2 description:
XFS filesystem utilities

xfsprogs-6.2.0-r2 webpage:
https://xfs.org/index.php/Main_Page

xfsprogs-6.2.0-r2 installed size:
988 KiB

xfsprogs-6.2.0-r2 license:
LGPL-2.1-or-later
