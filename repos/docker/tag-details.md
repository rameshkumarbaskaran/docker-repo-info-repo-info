...
-	[`docker:20.10.2`](#docker20102)
-	[`docker:20.10.2-dind`](#docker20102-dind)
-	[`docker:20.10.2-dind-rootless`](#docker20102-dind-rootless)
-	[`docker:20.10.2-git`](#docker20102-git)
...
### `docker:20.10.2` - linux; arm64 variant v8
...
### `docker:20.10.2-dind` - linux; amd64
...
### `docker:20.10.2-dind` - linux; arm64 variant v8
