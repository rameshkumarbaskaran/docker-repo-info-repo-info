...
-	[`docker:20.10.12-alpine3.14`](#docker201012-alpine314)
-	[`docker:20.10.12-dind`](#docker201012-dind)
-	[`docker:20.10.12-dind-alpine3.14`](#docker201012-dind-alpine314)
...
### `docker:20.10.12-alpine3.14` - linux; amd64
...
### `docker:20.10.12-alpine3.14` - linux; arm64 variant v8
...
### `docker:20.10.12-dind-alpine3.14` - linux; amd64
...
### `docker:20.10.12-dind-alpine3.14` - linux; arm64 variant v8
