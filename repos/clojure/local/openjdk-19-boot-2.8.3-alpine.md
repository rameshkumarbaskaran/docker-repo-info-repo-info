...
- Created: `2022-04-05T16:00:31.697106994Z`
- Virtual Size: ~ 397.92 Mb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Entrypoint: `["entrypoint"]`
- Command: `["repl"]`
- Environment:
  - `PATH=/opt/openjdk-19/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/bin/`
