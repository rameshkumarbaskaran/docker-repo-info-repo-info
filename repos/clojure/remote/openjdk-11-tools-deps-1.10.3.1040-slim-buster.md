...
```console
$ docker pull clojure@sha256:0651a9e8cbe2baa110b9d3c325354ffac9498ed6b548633049777d0037cecacc
```
...
### `clojure:openjdk-11-tools-deps-1.10.3.1040-slim-buster` - linux; arm64 variant v8
