...
```console
$ docker pull mediawiki@sha256:8b219c2212b8c9900f8897bf2aebda4716bd444024f8a10674e673ae47c809f3
```
...
```console
$ docker pull mediawiki@sha256:e0e321ff148b95a9fff0e1c05ed9a421d307794af02588d37eb3a403040cc6af
```
