...
```console
$ docker pull mediawiki@sha256:a0890d0ed66a44ac9924abf21b634f168d661bd0b9eff7e14db8c2a5f07d258c
```
...
```console
$ docker pull mediawiki@sha256:b75cda8a9351dab6946ba37f7b87dc494cdb0ab1bf61a38455dcdcb650694217
```
