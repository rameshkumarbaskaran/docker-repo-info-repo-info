...
```console
$ docker pull mediawiki@sha256:952649a999fe6550beb6625a5f3f8b31e9b6d48dc2527bc094fe427d5eb798d4
```
...
```console
$ docker pull mediawiki@sha256:2618f58512561c9c31aa76536b6d2e49add3eb66173f4a7b76cb2bc0c9ecbd40
```
