...
```console
$ docker pull golang@sha256:e154ec2a835763cf3b3edece50d37f3abc30d3c79cedfdff38d920dba2842fc7
```
...
### `golang:1.18.7-bullseye` - linux; amd64
...
### `golang:1.18.7-bullseye` - linux; arm variant v5
...
### `golang:1.18.7-bullseye` - linux; arm variant v7
...
### `golang:1.18.7-bullseye` - linux; arm64 variant v8
...
### `golang:1.18.7-bullseye` - linux; 386
...
### `golang:1.18.7-bullseye` - linux; mips64le
...
### `golang:1.18.7-bullseye` - linux; ppc64le
...
### `golang:1.18.7-bullseye` - linux; s390x
