...
```console
$ docker pull golang@sha256:f3c1b3d459e78ce277d43948d68bb8094953d2e36c92e63f14bc8a37c39131b9
```
...
### `golang:1.20.7-bookworm` - linux; amd64
...
### `golang:1.20.7-bookworm` - linux; arm variant v5
...
### `golang:1.20.7-bookworm` - linux; arm variant v7
...
### `golang:1.20.7-bookworm` - linux; arm64 variant v8
...
### `golang:1.20.7-bookworm` - linux; 386
...
### `golang:1.20.7-bookworm` - linux; mips64le
...
### `golang:1.20.7-bookworm` - linux; ppc64le
...
### `golang:1.20.7-bookworm` - linux; s390x
