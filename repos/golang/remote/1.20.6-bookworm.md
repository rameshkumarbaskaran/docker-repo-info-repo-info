...
```console
$ docker pull golang@sha256:b4f6e680dce89a5a9a08b6a6c441566dd93f6493d00973efa5858f8447987bd9
```
...
### `golang:1.20.6-bookworm` - linux; amd64
...
### `golang:1.20.6-bookworm` - linux; arm variant v5
...
### `golang:1.20.6-bookworm` - linux; arm variant v7
...
### `golang:1.20.6-bookworm` - linux; arm64 variant v8
...
### `golang:1.20.6-bookworm` - linux; 386
...
### `golang:1.20.6-bookworm` - linux; mips64le
...
### `golang:1.20.6-bookworm` - linux; ppc64le
...
### `golang:1.20.6-bookworm` - linux; s390x
