...
```console
$ docker pull golang@sha256:7576bd69bbca16aa5e45a993aea9f67e3a7beeaa3a37b9c25a7b664f8a99f5ce
```
...
### `golang:1.16.11-bullseye` - linux; amd64
...
### `golang:1.16.11-bullseye` - linux; arm variant v5
...
### `golang:1.16.11-bullseye` - linux; arm variant v7
...
### `golang:1.16.11-bullseye` - linux; arm64 variant v8
...
### `golang:1.16.11-bullseye` - linux; 386
...
### `golang:1.16.11-bullseye` - linux; mips64le
...
### `golang:1.16.11-bullseye` - linux; s390x
