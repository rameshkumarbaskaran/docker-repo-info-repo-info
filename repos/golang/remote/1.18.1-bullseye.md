...
```console
$ docker pull golang@sha256:3b1a72af045ad0fff9fe8e00736baae76d70ff51325ac5bb814fe4754044b972
```
...
### `golang:1.18.1-bullseye` - linux; amd64
...
### `golang:1.18.1-bullseye` - linux; arm variant v5
...
### `golang:1.18.1-bullseye` - linux; arm variant v7
...
### `golang:1.18.1-bullseye` - linux; arm64 variant v8
...
### `golang:1.18.1-bullseye` - linux; 386
...
### `golang:1.18.1-bullseye` - linux; mips64le
...
### `golang:1.18.1-bullseye` - linux; ppc64le
...
### `golang:1.18.1-bullseye` - linux; s390x
