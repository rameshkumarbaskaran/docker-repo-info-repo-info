...
```console
$ docker pull golang@sha256:75502c53ca292fcd9038dacdce508e774c544f807a62a316b762eefef2919b62
```
...
### `golang:1.14.13-alpine3.12` - linux; amd64
...
### `golang:1.14.13-alpine3.12` - linux; arm variant v6
...
### `golang:1.14.13-alpine3.12` - linux; arm64 variant v8
...
### `golang:1.14.13-alpine3.12` - linux; 386
...
### `golang:1.14.13-alpine3.12` - linux; ppc64le
...
### `golang:1.14.13-alpine3.12` - linux; s390x
