...
```console
$ docker pull golang@sha256:7120f8c1edc9333002ff9caa2f0bb0510d8228431387aac35c7739a47a663a70
```
...
### `golang:1.20.12-bullseye` - linux; amd64
...
### `golang:1.20.12-bullseye` - linux; arm variant v5
...
### `golang:1.20.12-bullseye` - linux; arm variant v7
...
### `golang:1.20.12-bullseye` - linux; arm64 variant v8
...
### `golang:1.20.12-bullseye` - linux; 386
...
### `golang:1.20.12-bullseye` - linux; mips64le
...
### `golang:1.20.12-bullseye` - linux; ppc64le
...
### `golang:1.20.12-bullseye` - linux; s390x
