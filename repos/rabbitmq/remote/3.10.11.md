...
```console
$ docker pull rabbitmq@sha256:3d8f54157b0fc5cc2692e729d7cb4ac4f8b7753708d86af350d10a8b7febe6cc
```
...
### `rabbitmq:3.10.11` - linux; arm64 variant v8
...
### `rabbitmq:3.10.11` - linux; ppc64le
...
### `rabbitmq:3.10.11` - linux; riscv64
