...
### `rabbitmq:3.10.7-management-alpine` - linux; arm variant v7
...
### `rabbitmq:3.10.7-management-alpine` - linux; 386
...
### `rabbitmq:3.10.7-management-alpine` - linux; ppc64le
...
### `rabbitmq:3.10.7-management-alpine` - linux; s390x
