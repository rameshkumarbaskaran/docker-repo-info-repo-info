...
### `rabbitmq:3.10.0-alpine` - linux; amd64
...
### `rabbitmq:3.10.0-alpine` - linux; arm variant v6
...
### `rabbitmq:3.10.0-alpine` - linux; arm variant v7
...
### `rabbitmq:3.10.0-alpine` - linux; arm64 variant v8
...
### `rabbitmq:3.10.0-alpine` - linux; 386
...
### `rabbitmq:3.10.0-alpine` - linux; ppc64le
...
### `rabbitmq:3.10.0-alpine` - linux; s390x
