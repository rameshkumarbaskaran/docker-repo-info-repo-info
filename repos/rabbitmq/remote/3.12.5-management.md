...
### `rabbitmq:3.12.5-management` - linux; amd64
...
### `rabbitmq:3.12.5-management` - unknown; unknown
...
### `rabbitmq:3.12.5-management` - linux; arm variant v7
...
### `rabbitmq:3.12.5-management` - linux; arm64 variant v8
...
### `rabbitmq:3.12.5-management` - linux; ppc64le
...
### `rabbitmq:3.12.5-management` - linux; s390x
