...
### `rabbitmq:3.12.5-alpine` - linux; amd64
...
### `rabbitmq:3.12.5-alpine` - unknown; unknown
...
### `rabbitmq:3.12.5-alpine` - linux; arm variant v6
...
### `rabbitmq:3.12.5-alpine` - linux; arm variant v7
...
### `rabbitmq:3.12.5-alpine` - linux; arm64 variant v8
...
### `rabbitmq:3.12.5-alpine` - linux; 386
...
### `rabbitmq:3.12.5-alpine` - linux; ppc64le
...
### `rabbitmq:3.12.5-alpine` - linux; s390x
