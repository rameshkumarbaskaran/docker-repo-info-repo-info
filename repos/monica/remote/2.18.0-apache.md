...
### `monica:2.18.0-apache` - linux; amd64
...
### `monica:2.18.0-apache` - linux; arm variant v5
...
### `monica:2.18.0-apache` - linux; arm variant v7
...
### `monica:2.18.0-apache` - linux; arm64 variant v8
...
### `monica:2.18.0-apache` - linux; 386
...
### `monica:2.18.0-apache` - linux; mips64le
...
### `monica:2.18.0-apache` - linux; ppc64le
...
### `monica:2.18.0-apache` - linux; s390x
