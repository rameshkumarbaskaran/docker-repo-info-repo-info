...
### `monica:2.18-fpm-alpine` - linux; amd64
...
### `monica:2.18-fpm-alpine` - linux; arm variant v6
...
### `monica:2.18-fpm-alpine` - linux; arm variant v7
...
### `monica:2.18-fpm-alpine` - linux; arm64 variant v8
...
### `monica:2.18-fpm-alpine` - linux; 386
...
### `monica:2.18-fpm-alpine` - linux; ppc64le
...
### `monica:2.18-fpm-alpine` - linux; s390x
