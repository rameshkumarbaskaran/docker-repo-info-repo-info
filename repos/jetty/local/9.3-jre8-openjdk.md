...
- Created: `2022-07-12T18:21:48.92934886Z`
- Virtual Size: ~ 296.32 Mb  
...
- Environment:
  ...
  - `LANG=C.UTF-8`
  - `JAVA_VERSION=8u332`
  - `JETTY_VERSION=9.3.30.v20211001`
  - `JETTY_HOME=/usr/local/jetty`
  - `JETTY_BASE=/var/lib/jetty`
  - `TMPDIR=/tmp/jetty`
  - `JETTY_TGZ_URL=https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-distribution/9.3.30.v20211001/jetty-distribution-9.3.30.v20211001.tar.gz`
