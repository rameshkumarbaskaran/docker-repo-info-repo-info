...
- Created: `2023-09-29T04:51:51.774630981Z`
- Virtual Size: ~ 343.15 Mb  
...
- Environment:
  ...
  - `JETTY_VERSION=12.0.1`
  - `JETTY_HOME=/usr/local/jetty`
  - `JETTY_BASE=/var/lib/jetty`
  - `TMPDIR=/tmp/jetty`
  - `JETTY_TGZ_URL=https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-home/12.0.1/jetty-home-12.0.1.tar.gz`
