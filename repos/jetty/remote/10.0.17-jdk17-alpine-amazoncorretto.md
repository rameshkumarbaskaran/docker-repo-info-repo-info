## `jetty:10.0.17-jdk17-alpine-amazoncorretto`
...
### `jetty:10.0.17-jdk17-alpine-amazoncorretto` - linux; amd64
...
### `jetty:10.0.17-jdk17-alpine-amazoncorretto` - linux; arm64 variant v8
