...
```console
$ docker pull jetty@sha256:097918d4eded508f50f06545248c8e3af48417a01969c0059157519128407b07
```
...
```console
$ docker pull jetty@sha256:5c65e046c42b0885ee6ff22144b6055547bdf1a512923c82aa7244cbf535009c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.8 MB (135759907 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cfb3428df895aed26082f5669d0d2411498e3b290c7f64e7bd7571d660c37eae`
...
# Thu, 21 Apr 2022 01:41:58 GMT
ENV JETTY_VERSION=9.3.30.v20211001
# Thu, 21 Apr 2022 01:41:58 GMT
ENV JETTY_HOME=/usr/local/jetty
# Thu, 21 Apr 2022 01:41:59 GMT
...
-	Layers:
	...
	-	`sha256:3811f4d5a35b1413e3e201c97e98ccbed53dbe4185273b45abdf27cbb0c40e18`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cdfe0cb448505a8d115d9d0bc2bce997e35ac826770a3fffb4563a54029b069d`  
		Last Modified: Thu, 21 Apr 2022 01:53:19 GMT  
		Size: 17.7 MB (17740892 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b059a8c3500e4718d5531d0bef891066998545161d0e36990428114e6ea89e1c`  
		Last Modified: Thu, 21 Apr 2022 01:53:17 GMT  
...
```console
$ docker pull jetty@sha256:f643de0087fe2ac9d3f9b3e85511bc5b52efd67fcd8a36498228629d6b7a2f63
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.3 MB (133274237 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:63a4df794f4533c99d6a01e25cac75cbced742288b871c23e8c4511c67ee1c11`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["java","-jar","\/usr\/local\/jetty\/start.jar"]`
...
RUN set -eux; 		arch="$(dpkg --print-architecture)"; 	case "$arch" in 		'amd64') 			downloadUrl='https://github.com/AdoptOpenJDK/openjdk8-upstream-binaries/releases/download/jdk8u322-b06/OpenJDK8U-jre_x64_linux_8u322b06.tar.gz'; 			;; 		'arm64') 			downloadUrl='https://github.com/AdoptOpenJDK/openjdk8-upstream-binaries/releases/download/jdk8u322-b06/OpenJDK8U-jre_aarch64_linux_8u322b06.tar.gz'; 			;; 		*) echo >&2 "error: unsupported architecture: '$arch'"; exit 1 ;; 	esac; 		wget --progress=dot:giga -O openjdk.tgz "$downloadUrl"; 	wget --progress=dot:giga -O openjdk.tgz.asc "$downloadUrl.sign"; 		export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys EAC843EBD3EFDB98CC772FADA5CD6035332FA671; 	gpg --batch --keyserver keyserver.ubuntu.com --keyserver-options no-self-sigs-only --recv-keys CA5F11C6CE22644D42C6AC4492EF8D39DC13168F; 	gpg --batch --list-sigs --keyid-format 0xLONG CA5F11C6CE22644D42C6AC4492EF8D39DC13168F 		| tee /dev/stderr 		| grep '0xA5CD6035332FA671' 		| grep 'Andrew Haley'; 	gpg --batch --verify openjdk.tgz.asc openjdk.tgz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME"; 		mkdir -p "$JAVA_HOME"; 	tar --extract 		--file openjdk.tgz 		--directory "$JAVA_HOME" 		--strip-components 1 		--no-same-owner 	; 	rm openjdk.tgz*; 		{ 		echo '#!/usr/bin/env bash'; 		echo 'set -Eeuo pipefail'; 		echo 'trust extract --overwrite --format=java-cacerts --filter=ca-anchors --purpose=server-auth "$JAVA_HOME/lib/security/cacerts"'; 	} > /etc/ca-certificates/update.d/docker-openjdk; 	chmod +x /etc/ca-certificates/update.d/docker-openjdk; 	/etc/ca-certificates/update.d/docker-openjdk; 		find "$JAVA_HOME/lib" -name '*.so' -exec dirname '{}' ';' | sort -u > /etc/ld.so.conf.d/docker-openjdk.conf; 	ldconfig; 		java -version
# Thu, 21 Apr 2022 04:20:12 GMT
ENV JETTY_VERSION=9.3.30.v20211001
# Thu, 21 Apr 2022 04:20:13 GMT
ENV JETTY_HOME=/usr/local/jetty
# Thu, 21 Apr 2022 04:20:14 GMT
ENV JETTY_BASE=/var/lib/jetty
# Thu, 21 Apr 2022 04:20:15 GMT
ENV TMPDIR=/tmp/jetty
# Thu, 21 Apr 2022 04:20:16 GMT
ENV PATH=/usr/local/jetty/bin:/usr/local/openjdk-8/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Thu, 21 Apr 2022 04:20:17 GMT
ENV JETTY_TGZ_URL=https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-distribution/9.3.30.v20211001/jetty-distribution-9.3.30.v20211001.tar.gz
# Thu, 21 Apr 2022 04:20:18 GMT
ENV JETTY_GPG_KEYS=AED5EE6C45D0FE8D5D1B164F27DED4BF6216DB8F 	2A684B57436A81FA8706B53C61C3351A438A3B7D 	5989BAF76217B843D66BE55B2D0E1FB8FE4B68B4 	B59B67FD7904984367F931800818D9D68FB67BAC 	BFBB21C246D7776836287A48A04E0C74ABB35FEA 	8B096546B1A8F02656B15D3B1677D141BCF3584D 	FBA2B18D238AB852DF95745C76157BDF03D0DCD6 	5C9579B3DB2E506429319AAEF33B071B29559E1E
# Thu, 21 Apr 2022 04:20:26 GMT
RUN set -xe 	&& mkdir /jetty-keys     && export GNUPGHOME=/jetty-keys;     	mkdir -p "$GNUPGHOME" ;     	for key in $JETTY_GPG_KEYS; do     		gpg --batch --keyserver "hkps://keyserver.ubuntu.com" --recv-keys "$key";     	done 	&& mkdir -p "$JETTY_HOME" 	&& cd $JETTY_HOME 	&& curl -SL "$JETTY_TGZ_URL" -o jetty.tar.gz 	&& curl -SL "$JETTY_TGZ_URL.asc" -o jetty.tar.gz.asc 	&& gpg --batch --verify jetty.tar.gz.asc jetty.tar.gz 	&& tar -xvf jetty.tar.gz --strip-components=1 	&& sed -i '/jetty-logging/d' etc/jetty.conf 	&& rm -fr jetty.tar.gz* 	&& mkdir -p "$JETTY_BASE" 	&& cd $JETTY_BASE 	&& modules="$(grep -- ^--module= "$JETTY_HOME/start.ini" | cut -d= -f2 | paste -d, -s)" 	&& java -jar "$JETTY_HOME/start.jar" --add-to-startd="$modules" 	&& mkdir -p "$TMPDIR" 	&& groupadd -r jetty && useradd -r -g jetty jetty 	&& chown -R jetty:jetty "$JETTY_HOME" "$JETTY_BASE" "$TMPDIR" 	&& rm -rf /tmp/hsperfdata_root
# Thu, 21 Apr 2022 04:20:27 GMT
WORKDIR /var/lib/jetty
# Thu, 21 Apr 2022 04:20:29 GMT
COPY multi:a6bf79f83e3ff0c7dc5946cd61ca0413cd3191ce9671725a647923d97a115fae in / 
# Thu, 21 Apr 2022 04:20:29 GMT
USER jetty
# Thu, 21 Apr 2022 04:20:30 GMT
EXPOSE 8080
# Thu, 21 Apr 2022 04:20:31 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Thu, 21 Apr 2022 04:20:32 GMT
CMD ["java" "-jar" "/usr/local/jetty/start.jar"]
```
...
-	Layers:
	...
	-	`sha256:84c5920902c15c039903a1feea0bad9ce94bc8651ec697b98e01216aa9f1dd3c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f7763aa0bf3d612e7d2777c9a98679bdd351d4593a8798bd88b12549b4fbda4`  
		Last Modified: Thu, 21 Apr 2022 04:41:35 GMT  
		Size: 17.7 MB (17740662 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09e3e6921d53f9f4b82d77c53e94488fbb78500e4e746174b13d06d4834335ba`  
		Last Modified: Thu, 21 Apr 2022 04:41:33 GMT  
