...
- Created: `2022-06-15T18:20:39.215515208Z`
- Virtual Size: ~ 792.88 Mb  
...
### `rpm` package: `binutils-2.30-113.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url binutils-2.30-113.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/binutils-2.30-113.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/binutils-2.30-113.0.1.el8.src.rpm
```
...
```console
$ dnf --quiet download --source --url git-core-2.31.1-2.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/git-2.31.1-2.el8.src.rpm
```

### `rpm` package: `git-core-doc-2.31.1-2.el8.noarch`
...
```console
$ dnf --quiet download --source --url git-core-doc-2.31.1-2.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/git-2.31.1-2.el8.src.rpm
```
...
### `rpm` package: `glibc-minimal-langpack-2.28-189.1.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-minimal-langpack-2.28-189.1.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-189.1.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-189.1.0.1.el8.src.rpm
```
...
### `rpm` package: `perl-Git-2.31.1-2.el8.noarch`
...
```console
$ dnf --quiet download --source --url perl-Git-2.31.1-2.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/git-2.31.1-2.el8.src.rpm
```
