...
- Created: `2021-01-25T21:30:08.191520469Z`
- Virtual Size: ~ 358.12 Mb  
...
```console
imagemagick6-6.9.11.48-r0 description:
A collection of tools and libraries for many image formats (legacy version 6)

imagemagick6-6.9.11.48-r0 webpage:
https://www.imagemagick.org/

imagemagick6-6.9.11.48-r0 installed size:
196608

imagemagick6-6.9.11.48-r0 license:
Apache-2.0
...
```console
imagemagick6-libs-6.9.11.48-r0 description:
A collection of tools and libraries for many image formats (legacy version 6) (libraries)

imagemagick6-libs-6.9.11.48-r0 webpage:
https://www.imagemagick.org/

imagemagick6-libs-6.9.11.48-r0 installed size:
6942720

imagemagick6-libs-6.9.11.48-r0 license:
Apache-2.0
...
```console
mercurial-5.4-r0 description:
Scalable distributed SCM tool

mercurial-5.4-r0 webpage:
https://www.mercurial-scm.org

mercurial-5.4-r0 installed size:
22462464

mercurial-5.4-r0 license:
GPL-2.0-or-later
...
```console
subversion-1.13.0-r2 description:
Replacement for CVS, another versioning system (svn)

subversion-1.13.0-r2 webpage:
https://subversion.apache.org/

subversion-1.13.0-r2 installed size:
1028096

subversion-1.13.0-r2 license:
Apache-2.0 BSD
...
```console
subversion-libs-1.13.0-r2 description:
Replacement for CVS, another versioning system (svn) (libraries)

subversion-libs-1.13.0-r2 webpage:
https://subversion.apache.org/

subversion-libs-1.13.0-r2 installed size:
3842048

subversion-libs-1.13.0-r2 license:
Apache-2.0 BSD
...
```console
wget-1.20.3-r1 description:
A network utility to retrieve files from the Web

wget-1.20.3-r1 webpage:
https://www.gnu.org/software/wget/wget.html

wget-1.20.3-r1 installed size:
483328

wget-1.20.3-r1 license:
GPL-3.0-or-later
