...
- Created: `2021-07-27T02:11:21.190499361Z`
...
### `dpkg` source package: `libgd2=2.2.5-4ubuntu0.4`
...
### `dpkg` source package: `libmagick10-zend=6.9.7.10`

Binary Packages:

- `libmagick10-zend=6.9.9.51+b7`
...
- `liboci-us-locales-zend=11.2.0.4+b4`
...
### `dpkg` source package: `libpq-zend-pe=1.0-1`

Binary Packages:

- `libpq-zend-server=1.0-1+b3`
...
- `lighttpd-zend-server=1.4.58+b4`
...
### `dpkg` source package: `nginx=1.14.0-0ubuntu1.9`

Binary Packages:

- `libnginx-mod-http-geoip=1.14.0-0ubuntu1.9`
- `libnginx-mod-http-image-filter=1.14.0-0ubuntu1.9`
- `libnginx-mod-http-xslt-filter=1.14.0-0ubuntu1.9`
- `libnginx-mod-mail=1.14.0-0ubuntu1.9`
- `libnginx-mod-stream=1.14.0-0ubuntu1.9`
...
```console
$ apt-get source -qq --print-uris nginx=1.14.0-0ubuntu1.9
'http://archive.ubuntu.com/ubuntu/pool/main/n/nginx/nginx_1.14.0-0ubuntu1.9.dsc' nginx_1.14.0-0ubuntu1.9.dsc 4305 SHA512:9339ac209f238d6dddc19331910e0051404370c445fce058dfeea8588fe6f1873cee9629c9a9c299466ea7ebfb215ba2961e63727b65dec042e7a252e7a325fe
...
'http://archive.ubuntu.com/ubuntu/pool/main/n/nginx/nginx_1.14.0-0ubuntu1.9.debian.tar.xz' nginx_1.14.0-0ubuntu1.9.debian.tar.xz 927300 SHA512:d12d9b6cbe436348c66153b1723f695fa048440fd13af789e53d9cadb70edbcfff2ab21e817505929a3847ed4f495bf95d5bba356b3e1e4a644ff80b5ff14828
```
...
### `dpkg` source package: `pdo-mysql=7.4.14`

Binary Packages:

- `php-pdo-mysql-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-bcmath=7.4.14`

Binary Packages:

- `php-bcmath-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-bin=7.4.14`

Binary Packages:

- `php-bin-zend-server=2021.0.0+b12`
...
### `dpkg` source package: `php-bz2=7.4.14`

Binary Packages:

- `php-bz2-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-calendar=7.4.14`

Binary Packages:

- `php-calendar-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-ctype=7.4.14`

Binary Packages:

- `php-ctype-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-curl=7.4.14`

Binary Packages:

- `php-curl-zend-server=2021.0.0+b12`
...
### `dpkg` source package: `php-dev-zend-pe=7.4.14`

Binary Packages:

- `php-dev-zend-server=2021.0.0`
...
### `dpkg` source package: `php-exif=7.4.14`

Binary Packages:

- `php-exif-zend-server=2021.0.0+b11`
...
- `php-fcgi-zend-server=2021.0.0+b13`
...
### `dpkg` source package: `php-ffi=7.4.14`

Binary Packages:

- `php-ffi-zend-server=2021.0.0+b6`
...
### `dpkg` source package: `php-fileinfo=7.4.14`

Binary Packages:

- `php-fileinfo-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-fpm=7.4.0`

Binary Packages:

- `php-fpm-zend-server=2021.0.0+b12`
...
### `dpkg` source package: `php-ftp=7.4.14`

Binary Packages:

- `php-ftp-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-gd=7.4.14`

Binary Packages:

- `php-gd-zend-server=2021.0.0+b13`
...
### `dpkg` source package: `php-gettext=7.4.14`

Binary Packages:

- `php-gettext-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-gmp=7.4.14`

Binary Packages:

- `php-gmp-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-imagick=7.4.14`

Binary Packages:

- `php-imagick-zend-server=2021.0.0+b14`
...
### `dpkg` source package: `php-imap=7.4.14`

Binary Packages:

- `php-imap-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-intl=7.4.14`

Binary Packages:

- `php-intl-zend-server=2021.0.0+b13`
...
### `dpkg` source package: `php-ldap=7.4.14`

Binary Packages:

- `php-ldap-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-mbstring=7.4.14`

Binary Packages:

- `php-mbstring-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-mcrypt=7.1.33`

Binary Packages:

- `php-mcrypt-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-memcached=7.4.14`

Binary Packages:

- `php-memcached-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-mongodb=7.4.14`

Binary Packages:

- `php-mongodb-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-mysqli=7.4.14`

Binary Packages:

- `php-mysqli-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-oci8=7.4.14`

Binary Packages:

- `php-oci8-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-odbc=7.4.14`

Binary Packages:

- `php-odbc-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-pcntl=7.4.14`

Binary Packages:

- `php-pcntl-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-pdo-dblib=7.4.14`

Binary Packages:

- `php-pdo-dblib-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-pdo-odbc=7.4.14`

Binary Packages:

- `php-pdo-odbc-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-pdo-pgsql=7.4.14`

Binary Packages:

- `php-pdo-pgsql-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-pgsql=7.4.14`

Binary Packages:

- `php-pgsql-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-phar=7.4.14`

Binary Packages:

- `php-phar-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-posix=7.4.14`

Binary Packages:

- `php-posix-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-redis=7.4.14`

Binary Packages:

- `php-redis-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-shmop=7.4.14`

Binary Packages:

- `php-shmop-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-soap=7.4.14`

Binary Packages:

- `php-soap-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-sockets=7.4.14`

Binary Packages:

- `php-sockets-zend-server=2021.0.0+b12`
...
### `dpkg` source package: `php-sqlsrv=7.4.14`

Binary Packages:

- `php-sqlsrv-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-ssh2=7.4.14`

Binary Packages:

- `php-ssh2-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-sysvmsg=7.4.14`

Binary Packages:

- `php-sysvmsg-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-sysvsem=7.4.14`

Binary Packages:

- `php-sysvsem-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-sysvshm=7.4.14`

Binary Packages:

- `php-sysvshm-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-tidy=7.4.14`

Binary Packages:

- `php-tidy-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-tokenizer=7.4.14`

Binary Packages:

- `php-tokenizer-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-wddx=7.4.14`

Binary Packages:

- `php-wddx-zend-server=2021.0.0+b12`
...
### `dpkg` source package: `php-xdebug=7.4.14`

Binary Packages:

- `php-xdebug-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-xmlrpc=7.4.14`

Binary Packages:

- `php-xmlrpc-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-xsl=7.4.14`

Binary Packages:

- `php-xsl-zend-server=2021.0.0+b11`
...
### `dpkg` source package: `php-zip=7.4.14`

Binary Packages:

- `php-zip-zend-server=2021.0.0+b12`
...
'http://security.ubuntu.com/ubuntu/pool/main/s/systemd/systemd_237-3ubuntu10.50.dsc' systemd_237-3ubuntu10.50.dsc 5187 SHA512:79be5b7150d97f5ab5e8cde9fc40917da27e20e478ff8675fe2dd2f2cf925f3a4c5ada3d52faef23142c698b4e46615c726c21d12c5d8d68a1a6f7d98f80fd89
'http://security.ubuntu.com/ubuntu/pool/main/s/systemd/systemd_237.orig.tar.gz' systemd_237.orig.tar.gz 6871350 SHA512:15ef4b92815a6dd9a6c51672dbc00fd7cd0f08068ef0cbeaca574f68d330b28bc67ba1946f24f75ef3d9e7b63843a73eea700db54688061dbf5c9f8470394c3b
'http://security.ubuntu.com/ubuntu/pool/main/s/systemd/systemd_237-3ubuntu10.50.debian.tar.xz' systemd_237-3ubuntu10.50.debian.tar.xz 295228 SHA512:6d3c1e595c36dc035c54a623a7a7a505cc6a678490cc038c8c16fbde7b63c557c77a12e788030308527717b83b548391e769f3b0d3ba207d2c6b7259367332f7
```
...
### `dpkg` source package: `zend-server-php-ce=2021.0.0`

Binary Packages:

- `php-common-extensions-zend-server=2021.0.0+b11`
- `php-extra-extensions-zend-server=2021.0.0+b11`
- `php-unix-extensions-zend-server=2021.0.0+b11`
- `zend-server-common=2021.0.0+b74`
