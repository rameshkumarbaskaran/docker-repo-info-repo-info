...
- Created: `2020-09-17T00:59:36.446785537Z`
- Virtual Size: ~ 824.02 Mb  
...
'http://archive.ubuntu.com/ubuntu/pool/main/a/apache2/apache2_2.4.18-2ubuntu3.17.dsc' apache2_2.4.18-2ubuntu3.17.dsc 2791 SHA256:0d47bc21dffbed9cf1665dc7d06a9565f4e6ab7647a44d5ee9a003de3ff5d35c
...
'http://archive.ubuntu.com/ubuntu/pool/main/a/apache2/apache2_2.4.18-2ubuntu3.17.debian.tar.xz' apache2_2.4.18-2ubuntu3.17.debian.tar.xz 415108 SHA256:e4797bf1be96feb669a2562dbfb4ff3f615466bb05b8e84b2d938ef30b8d9e70
```
...
'http://archive.ubuntu.com/ubuntu/pool/main/b/bind9/bind9_9.10.3.dfsg.P4-8ubuntu1.17.dsc' bind9_9.10.3.dfsg.P4-8ubuntu1.17.dsc 3873 SHA256:18eb541f3ce21877d15d94f8cd3a71dccf21e1fd83058beab370eee83286799d
...
'http://archive.ubuntu.com/ubuntu/pool/main/b/bind9/bind9_9.10.3.dfsg.P4-8ubuntu1.17.debian.tar.xz' bind9_9.10.3.dfsg.P4-8ubuntu1.17.debian.tar.xz 106040 SHA256:ca5d328899919672b286a07b9b14228172b9ba81f28e33de9a8a67fb5bcdcf68
```
...
'http://archive.ubuntu.com/ubuntu/pool/universe/libs/libssh2/libssh2_1.5.0-2ubuntu0.1.dsc' libssh2_1.5.0-2ubuntu0.1.dsc 1613 SHA256:070a45307295fe0c0715a86b827d72cbf4898375e351c131eb2237214de8a6d1
'http://archive.ubuntu.com/ubuntu/pool/universe/libs/libssh2/libssh2_1.5.0.orig.tar.gz' libssh2_1.5.0.orig.tar.gz 728222 SHA256:83196badd6868f5b926bdac8017a6f90fb8a90b16652d3bf02df0330d573d0fc
'http://archive.ubuntu.com/ubuntu/pool/universe/libs/libssh2/libssh2_1.5.0-2ubuntu0.1.debian.tar.xz' libssh2_1.5.0-2ubuntu0.1.debian.tar.xz 7124 SHA256:344a25d43835be3c5513b689fe40d078a6a5bf8e0abdfa1b6a3d6f78e9d2e34c
```
...
'http://br.archive.ubuntu.com/ubuntu/pool/main/m/mysql-5.5/mysql-5.5_5.5.35+dfsg-1ubuntu1.dsc' mysql-5.5_5.5.35+dfsg-1ubuntu1.dsc 3193 SHA256:7ce1f3b0b90b9a937f3e74713c38c157dd0683e73b36d7603d0a339ceda5de75
'http://br.archive.ubuntu.com/ubuntu/pool/main/m/mysql-5.5/mysql-5.5_5.5.35+dfsg.orig.tar.gz' mysql-5.5_5.5.35+dfsg.orig.tar.gz 21707804 SHA256:46f28f6907438f2abf97dfbf1124f1c0568d4c60fc370664755cf51c5dae664a
'http://br.archive.ubuntu.com/ubuntu/pool/main/m/mysql-5.5/mysql-5.5_5.5.35+dfsg-1ubuntu1.debian.tar.gz' mysql-5.5_5.5.35+dfsg-1ubuntu1.debian.tar.gz 314600 SHA256:8a058f93ff6371c2c3b5ba34e9e427054cd800a85b42b74486d9c7b6435bb4ca
```
...
- `php-5.6-pdo-mysql-zend-server=5.6.40.4+b6`
...
- `php-5.6-pdo-odbc-zend-server=5.6.40.4+b6`
...
- `php-5.6-bcmath-zend-server=5.6.40.4+b6`
...
- `php-5.6-bin-zend-server=5.6.40.4+b312`
...
- `php-5.6-bz2-zend-server=5.6.40.4+b6`
...
- `php-5.6-calendar-zend-server=5.6.40.4+b6`
...
- `php-5.6-ctype-zend-server=5.6.40.4+b6`
...
- `php-5.6-curl-zend-server=5.6.40.4+b6`
...
- `php-5.6-dev-zend-server=5.6.40.4+b301`
...
- `php-5.6-exif-zend-server=5.6.40.4+b6`
...
- `php-5.6-fcgi-zend-server=5.6.40.4+b6`
...
- `php-5.6-fileinfo-zend-server=5.6.40.4+b6`
...
- `php-5.6-ftp-zend-server=5.6.40.4+b6`
...
- `php-5.6-gd-zend-server=5.6.40.4+b6`
...
- `php-5.6-gettext-zend-server=5.6.40.4+b6`
...
- `php-5.6-gmp-zend-server=5.6.40.4+b6`
...
- `php-5.6-imagick-zend-server=5.6.40.4+b6`
...
- `php-5.6-imap-zend-server=5.6.40.4+b6`
...
- `php-5.6-intl-zend-server=5.6.40.4+b6`
...
- `php-5.6-ldap-zend-server=5.6.40.4+b6`
...
- `php-5.6-mbstring-zend-server=5.6.40.4+b6`
...
- `php-5.6-mcrypt-zend-server=5.6.40.4+b6`
...
- `php-5.6-memcache-zend-server=5.6.40.4+b6`
...
- `php-5.6-memcached-zend-server=5.6.40.4+b6`
...
- `php-5.6-mongo-zend-server=5.6.40.4+b6`
...
- `php-5.6-mssql-zend-server=5.6.40.4+b6`
...
- `php-5.6-mysql-zend-server=5.6.40.4+b6`
...
- `php-5.6-mysqli-zend-server=5.6.40.4+b6`
...
- `php-5.6-oci8-zend-server=5.6.40.4+b6`
...
- `php-5.6-odbc-zend-server=5.6.40.4+b6`
...
- `php-5.6-pcntl-zend-server=5.6.40.4+b6`
...
- `php-5.6-pdo-dblib-zend-server=5.6.40.4+b6`
...
- `php-5.6-pdo-pgsql-zend-server=5.6.40.4+b6`
...
- `php-5.6-pgsql-zend-server=5.6.40.4+b6`
...
- `php-5.6-phar-zend-server=5.6.40.4+b6`
...
- `php-5.6-posix-zend-server=5.6.40.4+b6`
...
- `php-5.6-redis-zend-server=5.6.40.4+b6`
...
- `php-5.6-shmop-zend-server=5.6.40.4+b6`
...
- `php-5.6-soap-zend-server=5.6.40.4+b6`
...
- `php-5.6-sockets-zend-server=5.6.40.4+b6`
...
- `php-5.6-ssh2-zend-server=5.6.40.4+b6`
...
- `php-5.6-sysvmsg-zend-server=5.6.40.4+b6`
...
- `php-5.6-sysvsem-zend-server=5.6.40.4+b6`
...
- `php-5.6-sysvshm-zend-server=5.6.40.4+b6`
...
- `php-5.6-tidy-zend-server=5.6.40.4+b6`
...
- `php-5.6-tokenizer-zend-server=5.6.40.4+b6`
...
- `php-5.6-wddx-zend-server=5.6.40.4+b6`
...
- `php-5.6-xdebug-zend-server=5.6.40.4+b6`
...
- `php-5.6-xmlrpc-zend-server=5.6.40.4+b6`
...
- `php-5.6-xsl-zend-server=5.6.40.4+b6`
...
- `php-5.6-zip-zend-server=5.6.40.4+b6`
...
- `zend-server-php-5.6-common=8.5.15+b8`
