...
- Created: `2022-03-24T22:29:20.496264931Z`
- Virtual Size: ~ 997.20 Mb  
...
### `rpm` package: `krb5-devel-1.18.2-14.el8.x86_64`
...
```console
$ dnf --quiet download --source --url krb5-devel-1.18.2-14.el8
...
### `rpm` package: `libkadm5-1.18.2-14.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libkadm5-1.18.2-14.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/krb5-1.18.2-14.el8.src.rpm
```
...
### `rpm` package: `openssl-devel-1.1.1k-5.0.1.el8_5.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-devel-1.1.1k-5.0.1.el8_5
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/openssl-1.1.1k-5.0.1.el8_5.src.rpm
```
