...
- Created: `2023-12-06T19:54:20.825653318Z`
- Virtual Size: ~ 645.58 Mb  
...
### `rpm` package: `device-mapper-1.02.181-13.0.1.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url device-mapper-1.02.181-13.0.1.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/lvm2-2.03.14-13.0.1.el8_9.src.rpm
```

### `rpm` package: `device-mapper-libs-1.02.181-13.0.1.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url device-mapper-libs-1.02.181-13.0.1.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/lvm2-2.03.14-13.0.1.el8_9.src.rpm
```
...
```console
$ dnf --quiet download --source --url jq-1.6-7.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/jq-1.6-7.el8.src.rpm
```
...
### `rpm` package: `systemd-239-78.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-239-78.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/systemd-239-78.0.1.el8.src.rpm
```

### `rpm` package: `systemd-libs-239-78.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-239-78.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/systemd-239-78.0.1.el8.src.rpm
```

### `rpm` package: `systemd-pam-239-78.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-239-78.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/systemd-239-78.0.1.el8.src.rpm
```
