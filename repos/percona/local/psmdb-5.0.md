...
- Created: `2023-12-20T23:21:48.117548277Z`
- Virtual Size: ~ 662.16 Mb  
...
- Environment:
  ...
  - `PSMDB_VERSION=5.0.18-15`
  - `OS_VER=el8`
  - `FULL_PERCONA_VERSION=5.0.18-15.el8`
...
### `rpm` package: `bind-export-libs-9.11.36-11.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url bind-export-libs-9.11.36-11.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/bind-9.11.36-11.el8_9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/bind-9.11.36-11.el8_9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/cryptsetup-2.3.7-7.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/cryptsetup-2.3.7-7.el8.src.rpm
```
...
### `rpm` package: `cyrus-sasl-gssapi-2.1.27-6.el8_5.x86_64`
...
```console
$ dnf --quiet download --source --url cyrus-sasl-gssapi-2.1.27-6.el8_5
...
### `rpm` package: `dbus-1.12.8-26.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url dbus-1.12.8-26.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dbus-1.12.8-26.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dbus-1.12.8-26.0.1.el8.src.rpm
```

### `rpm` package: `dbus-common-1.12.8-26.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url dbus-common-1.12.8-26.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dbus-1.12.8-26.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dbus-1.12.8-26.0.1.el8.src.rpm
```

### `rpm` package: `dbus-daemon-1.12.8-26.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url dbus-daemon-1.12.8-26.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dbus-1.12.8-26.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dbus-1.12.8-26.0.1.el8.src.rpm
```
...
### `rpm` package: `dbus-libs-1.12.8-26.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url dbus-libs-1.12.8-26.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dbus-1.12.8-26.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dbus-1.12.8-26.0.1.el8.src.rpm
```

### `rpm` package: `dbus-tools-1.12.8-26.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url dbus-tools-1.12.8-26.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dbus-1.12.8-26.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dbus-1.12.8-26.0.1.el8.src.rpm
```

### `rpm` package: `device-mapper-1.02.181-13.0.2.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url device-mapper-1.02.181-13.0.2.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/lvm2-2.03.14-13.0.2.el8_9.src.rpm
```

### `rpm` package: `device-mapper-event-1.02.181-13.0.2.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url device-mapper-event-1.02.181-13.0.2.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/lvm2-2.03.14-13.0.2.el8_9.src.rpm
```

### `rpm` package: `device-mapper-event-libs-1.02.181-13.0.2.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url device-mapper-event-libs-1.02.181-13.0.2.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/lvm2-2.03.14-13.0.2.el8_9.src.rpm
```

### `rpm` package: `device-mapper-libs-1.02.181-13.0.2.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url device-mapper-libs-1.02.181-13.0.2.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/lvm2-2.03.14-13.0.2.el8_9.src.rpm
```

### `rpm` package: `device-mapper-multipath-0.8.4-39.el8.x86_64`
...
```console
$ dnf --quiet download --source --url device-mapper-multipath-0.8.4-39.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/device-mapper-multipath-0.8.4-39.el8.src.rpm
```

### `rpm` package: `device-mapper-multipath-libs-0.8.4-39.el8.x86_64`
...
```console
$ dnf --quiet download --source --url device-mapper-multipath-libs-0.8.4-39.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/device-mapper-multipath-0.8.4-39.el8.src.rpm
```

### `rpm` package: `device-mapper-persistent-data-0.9.0-7.el8.x86_64`
...
```console
$ dnf --quiet download --source --url device-mapper-persistent-data-0.9.0-7.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/device-mapper-persistent-data-0.9.0-7.el8.src.rpm
```
...
### `rpm` package: `dnf-4.7.0-19.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url dnf-4.7.0-19.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dnf-4.7.0-19.0.1.el8.src.rpm
```

### `rpm` package: `dnf-data-4.7.0-19.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url dnf-data-4.7.0-19.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dnf-4.7.0-19.0.1.el8.src.rpm
```

### `rpm` package: `dnf-plugins-core-4.0.21-23.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url dnf-plugins-core-4.0.21-23.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.0.21-23.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dnf-plugins-core-4.0.21-23.0.1.el8.src.rpm
```
...
```console
$ dnf --quiet download --source --url elfutils-default-yama-scope-0.189-3.el8.noarch
...
```console
$ dnf --quiet download --source --url elfutils-libs-0.189-3.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/elfutils-0.189-3.el8.src.rpm
```
...
### `rpm` package: `glibc-langpack-en-2.28-236.0.1.el8.7.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-langpack-en-2.28-236.0.1.el8.7
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/glibc-2.28-236.0.1.el8.7.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/glibc-2.28-236.0.1.el8.7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/4/security/validation/x86_64/getPackageSource/gmp-6.1.2-10.el8.src.rpm
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/gnutls-3.6.16-7.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/gnutls-3.6.16-7.el8.src.rpm
```
...
### `rpm` package: `iproute-6.2.0-5.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url iproute-6.2.0-5.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/iproute-6.2.0-5.el8_9.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/iputils-20180629-11.el8.src.rpm
```

### `rpm` package: `jq-1.6-7.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url jq-1.6-7.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/jq-1.6-7.0.1.el8.src.rpm
```
...
### `rpm` package: `kmod-25-19.0.2.el8.x86_64`
...
```console
$ dnf --quiet download --source --url kmod-25-19.0.2.el8
...
### `rpm` package: `kpartx-0.8.4-39.el8.x86_64`
...
```console
$ dnf --quiet download --source --url kpartx-0.8.4-39.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/device-mapper-multipath-0.8.4-39.el8.src.rpm
```
...
### `rpm` package: `libfastjson-0.99.9-2.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libfastjson-0.99.9-2.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/libfastjson-0.99.9-2.el8.src.rpm
```

### `rpm` package: `libfdisk-2.32.1-43.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url libfdisk-2.32.1-43.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/util-linux-2.32.1-43.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/util-linux-2.32.1-43.0.1.el8.src.rpm
```
...
### `rpm` package: `lvm2-2.03.14-13.0.2.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url lvm2-2.03.14-13.0.2.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/lvm2-2.03.14-13.0.2.el8_9.src.rpm
```

### `rpm` package: `lvm2-libs-2.03.14-13.0.2.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url lvm2-libs-2.03.14-13.0.2.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/lvm2-2.03.14-13.0.2.el8_9.src.rpm
```
...
### `rpm` package: `ncurses-6.1-10.20180224.el8.x86_64`
...
```console
$ dnf --quiet download --source --url ncurses-6.1-10.20180224.el8
...
### `rpm` package: `openssh-8.0p1-19.el8_8.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-8.0p1-19.el8_8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/openssh-8.0p1-19.el8_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/openssh-8.0p1-19.el8_8.src.rpm
```

### `rpm` package: `openssh-clients-8.0p1-19.el8_8.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-clients-8.0p1-19.el8_8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/openssh-8.0p1-19.el8_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/openssh-8.0p1-19.el8_8.src.rpm
```

### `rpm` package: `openssh-server-8.0p1-19.el8_8.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-server-8.0p1-19.el8_8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/openssh-8.0p1-19.el8_8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/openssh-8.0p1-19.el8_8.src.rpm
```
...
```console
$ dnf --quiet download --source --url pam-1.3.1-27.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/pam-1.3.1-27.el8.src.rpm
```
...
### `rpm` package: `percona-server-mongodb-mongos-5.0.18-15.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-server-5.0.18-15.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-shell-5.0.18-15.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `percona-server-mongodb-tools-5.0.18-15.el8.x86_64`

Licenses (from `rpm --query`): SSPL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `platform-python-3.6.8-56.0.1.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url platform-python-3.6.8-56.0.1.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/python3-3.6.8-56.0.1.el8_9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/python3-3.6.8-56.0.1.el8_9.src.rpm
```
...
### `rpm` package: `procps-ng-3.3.15-14.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url procps-ng-3.3.15-14.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/procps-ng-3.3.15-14.0.1.el8.src.rpm
```
...
### `rpm` package: `python3-dnf-4.7.0-19.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-4.7.0-19.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dnf-4.7.0-19.0.1.el8.src.rpm
```

### `rpm` package: `python3-dnf-plugins-core-4.0.21-23.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-plugins-core-4.0.21-23.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.0.21-23.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dnf-plugins-core-4.0.21-23.0.1.el8.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.63.0-17.0.1.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.63.0-17.0.1.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libdnf-0.63.0-17.0.1.el8_9.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.63.0-17.0.1.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.63.0-17.0.1.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/libdnf-0.63.0-17.0.1.el8_9.src.rpm
```

### `rpm` package: `python3-libs-3.6.8-56.0.1.el8_9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libs-3.6.8-56.0.1.el8_9
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/python3-3.6.8-56.0.1.el8_9.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/python3-3.6.8-56.0.1.el8_9.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-pip-wheel-9.0.3-23.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/python-pip-9.0.3-23.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/python-pip-9.0.3-23.el8.src.rpm
```
...
### `rpm` package: `rsyslog-8.2102.0-15.el8.x86_64`
...
```console
$ dnf --quiet download --source --url rsyslog-8.2102.0-15.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/rsyslog-8.2102.0-15.el8.src.rpm
```
...
### `rpm` package: `systemd-239-78.0.3.el8.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-239-78.0.3.el8
...
### `rpm` package: `systemd-pam-239-78.0.3.el8.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-239-78.0.3.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/systemd-239-78.0.3.el8.src.rpm
```
...
```console
$ dnf --quiet download --source --url tpm2-tss-2.3.2-5.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/tpm2-tss-2.3.2-5.el8.src.rpm
```
...
### `rpm` package: `userspace-rcu-0.10.1-4.el8.x86_64`
...
```console
$ dnf --quiet download --source --url userspace-rcu-0.10.1-4.el8
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/userspace-rcu-0.10.1-4.el8.src.rpm
```

### `rpm` package: `util-linux-2.32.1-43.0.1.el8.x86_64`
...
```console
$ dnf --quiet download --source --url util-linux-2.32.1-43.0.1.el8
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/util-linux-2.32.1-43.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/util-linux-2.32.1-43.0.1.el8.src.rpm
```
...
### `rpm` package: `yum-4.7.0-19.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url yum-4.7.0-19.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dnf-4.7.0-19.0.1.el8.src.rpm
```

### `rpm` package: `yum-utils-4.0.21-23.0.1.el8.noarch`
...
```console
$ dnf --quiet download --source --url yum-utils-4.0.21-23.0.1.el8.noarch
https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64/getPackageSource/dnf-plugins-core-4.0.21-23.0.1.el8.src.rpm
https://yum.oracle.com/repo/OracleLinux/OL8/appstream/x86_64/getPackageSource/dnf-plugins-core-4.0.21-23.0.1.el8.src.rpm
```
