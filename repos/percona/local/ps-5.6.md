...
```console
$ dnf --quiet download --source --url numactl-libs-2.0.12-5.el7
...
```console
$ dnf --quiet download --source --url openssl-1.0.2k-22.el7_9
...
```console
$ dnf --quiet download --source --url openssl-libs-1.0.2k-22.el7_9
http://vault.centos.org/centos/7/updates/Source/SPackages/openssl-1.0.2k-22.el7_9.src.rpm
```
...
```console
$ dnf --quiet download --source --url perl-Data-Dumper-2.145-3.el7
...
```console
$ dnf --quiet download --source --url policycoreutils-2.5-34.el7
...
```console
$ dnf --quiet download --source --url which-2.20-7.el7
