...
-	[`debian:11.6`](#debian116)
-	[`debian:11.6-slim`](#debian116-slim)
-	[`debian:bookworm`](#debianbookworm)
-	[`debian:bookworm-20230320`](#debianbookworm-20230320)
-	[`debian:bookworm-20230320-slim`](#debianbookworm-20230320-slim)
-	[`debian:bookworm-backports`](#debianbookworm-backports)
-	[`debian:bookworm-slim`](#debianbookworm-slim)
-	[`debian:bullseye`](#debianbullseye)
-	[`debian:bullseye-20230320`](#debianbullseye-20230320)
-	[`debian:bullseye-20230320-slim`](#debianbullseye-20230320-slim)
-	[`debian:bullseye-backports`](#debianbullseye-backports)
-	[`debian:bullseye-slim`](#debianbullseye-slim)
-	[`debian:buster`](#debianbuster)
-	[`debian:buster-20230320`](#debianbuster-20230320)
-	[`debian:buster-20230320-slim`](#debianbuster-20230320-slim)
-	[`debian:buster-backports`](#debianbuster-backports)
-	[`debian:buster-slim`](#debianbuster-slim)
-	[`debian:experimental`](#debianexperimental)
-	[`debian:experimental-20230320`](#debianexperimental-20230320)
-	[`debian:latest`](#debianlatest)
-	[`debian:oldstable`](#debianoldstable)
-	[`debian:oldstable-20230320`](#debianoldstable-20230320)
-	[`debian:oldstable-20230320-slim`](#debianoldstable-20230320-slim)
...
-	[`debian:rc-buggy-20230320`](#debianrc-buggy-20230320)
-	[`debian:sid`](#debiansid)
-	[`debian:sid-20230320`](#debiansid-20230320)
-	[`debian:sid-20230320-slim`](#debiansid-20230320-slim)
-	[`debian:sid-slim`](#debiansid-slim)
-	[`debian:stable`](#debianstable)
-	[`debian:stable-20230320`](#debianstable-20230320)
-	[`debian:stable-20230320-slim`](#debianstable-20230320-slim)
-	[`debian:stable-backports`](#debianstable-backports)
-	[`debian:stable-slim`](#debianstable-slim)
-	[`debian:testing`](#debiantesting)
-	[`debian:testing-20230320`](#debiantesting-20230320)
-	[`debian:testing-20230320-slim`](#debiantesting-20230320-slim)
-	[`debian:testing-backports`](#debiantesting-backports)
-	[`debian:testing-slim`](#debiantesting-slim)
-	[`debian:unstable`](#debianunstable)
-	[`debian:unstable-20230320`](#debianunstable-20230320)
-	[`debian:unstable-20230320-slim`](#debianunstable-20230320-slim)
...
```console
$ docker pull debian@sha256:23bbbc008809a980480ddbef528deb4fb1611750d1c8672ad5bec71c09b61e12
```
...
### `debian:bookworm-20230320-slim` - linux; amd64
...
### `debian:bookworm-20230320-slim` - linux; arm variant v7
...
### `debian:bookworm-20230320-slim` - linux; arm64 variant v8
...
### `debian:bookworm-20230320-slim` - linux; 386
...
### `debian:bookworm-20230320-slim` - linux; ppc64le
...
### `debian:bookworm-20230320-slim` - linux; s390x
...
```console
$ docker pull debian@sha256:a34f2a7a07dd0854b2c2328cb9163836614780882643f0106b3db1d55a2db72d
```
...
```console
$ docker pull debian@sha256:8a8baa5ce98a1657b8aa1ea0bcfe613283cc7b8f60f3fcd19f7c3aec7da39f8b
```
...
```console
$ docker pull debian@sha256:5339bcc1f887a0ecbfc323cc98caa3bcbe0e1ef4a1e747393d6d179deeb2976c
```
...
### `debian:bullseye-20230320-slim` - linux; arm variant v5
...
### `debian:buster-20230320-slim` - linux; amd64
...
### `debian:buster-20230320-slim` - linux; arm variant v7
...
### `debian:buster-20230320-slim` - linux; arm64 variant v8
...
### `debian:buster-20230320-slim` - linux; 386
...
```console
$ docker pull debian@sha256:3aa4abe0c7d7eaa2f05f257023733e62f0092a7aefb62e0587fa80462f79d271
```
...
### `debian:oldstable-20230320-slim` - linux; amd64

```console
$ docker pull debian@sha256:391181fc86e7419c6a53dd4e2f385295a2dc5602c822985d598c1c8a2706047b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.1 MB (27139865 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f02114dbbb5a8ec6f4b01acafed15715ed1d562c47fbc621a44609ff7df8095e`
-	Default Command: `["bash"]`

```dockerfile
# Thu, 23 Mar 2023 01:31:14 GMT
ADD file:4a75122864626cd89a05bba8d10c111b73bad9ee6da21cfb1e0275920a65fcee in / 
# Thu, 23 Mar 2023 01:31:14 GMT
CMD ["bash"]
```

-	Layers:
	-	`sha256:7db57b0d9e9fab196a29a8e6451b36e152aea92eec2e61d81121f5325dfa7625`  
		Last Modified: Thu, 23 Mar 2023 01:35:38 GMT  
		Size: 27.1 MB (27139865 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `debian:oldstable-20230320-slim` - linux; arm64 variant v8

```console
$ docker pull debian@sha256:b9ae50d7c709d50620835bdeac179aaf2f0bb052d30b579f1b7645b1eeb7e7dd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.9 MB (25922667 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:253faa46025e1219c5fad0188ab750058062087882c4e4776d44cd36c9ceb4a6`
-	Default Command: `["bash"]`

```dockerfile
# Thu, 23 Mar 2023 00:45:36 GMT
ADD file:c8ee5da87ceb0661bc47466073385a5254bbf5072e810499a2f59fecce106bf7 in / 
# Thu, 23 Mar 2023 00:45:36 GMT
CMD ["bash"]
```

-	Layers:
	-	`sha256:078d2ec233bc494021a0c23454afbac1352f737f9c41abbc0fd2d165dec84653`  
		Last Modified: Thu, 23 Mar 2023 00:49:20 GMT  
		Size: 25.9 MB (25922667 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `debian:oldstable-20230320-slim` - linux; 386

```console
$ docker pull debian@sha256:03960ce1265cbbd57c060a59d5312b6550dbd2171999702c41855a95118c35a9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.8 MB (27798666 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e147fe9508509a442b8bb81de37aa5a6ce7da49238058e933a238b330319584`
-	Default Command: `["bash"]`

```dockerfile
# Thu, 23 Mar 2023 00:40:00 GMT
ADD file:1e090ce476b2aa10fd8416d71b098eca19915e89878a5bd67b92f0dbb6df0873 in / 
# Thu, 23 Mar 2023 00:40:00 GMT
CMD ["bash"]
```

-	Layers:
	-	`sha256:d1694fa7ef4af35d6960d6a77c43fced1e8040f377c399ef0a5d79da284797d4`  
		Last Modified: Thu, 23 Mar 2023 00:44:37 GMT  
		Size: 27.8 MB (27798666 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull debian@sha256:4a5fc7edf3c9a320992269c6e729a0cda97bdef58c52402c90d570fa0c32f0ae
```
...
```console
$ docker pull debian@sha256:5182ef7fd608b0e6306ce08c5ede918765d835a2d5fc5b4b87ad0e3d30d42bb1
```
...
### `debian:rc-buggy-20230320` - linux; arm variant v5
...
```console
$ docker pull debian@sha256:1263f65eb1fe859c6c8909b634b59664f76d7286baf3b83eda6859cf8c30bb38
```
...
```console
$ docker pull debian@sha256:5a3c5f0e6c5d332db9f2c5cb7c20e1d13fcb92b182acb6bfa95358b9e3740b66
```
...
```console
$ docker pull debian@sha256:6ec82f0904eeba7d0441fdbb787714878504449df4abefd3ca15493a223664a6
```
...
```console
$ docker pull debian@sha256:fdd44264f310426b6499eb09ff787f2787b2c354ac02552693326fb262d359e1
```
...
```console
$ docker pull debian@sha256:25cf41611753fd56074b4109475431d7f7fe9dbe62b5d1f0287c674b5ea0c60a
```
...
```console
$ docker pull debian@sha256:179bf0ccf6e5605cbc4a2e3873ea249f1792c2590302a4709b76bd12d383a5a9
```
...
### `debian:unstable-20230320` - linux; amd64
...
### `debian:unstable-20230320` - linux; arm variant v5
...
### `debian:unstable-20230320` - linux; arm variant v7
...
### `debian:unstable-20230320` - linux; ppc64le
...
### `debian:unstable-20230320` - linux; riscv64
