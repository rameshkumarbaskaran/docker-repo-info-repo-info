...
-	[`debian:bookworm-20211201`](#debianbookworm-20211201)
-	[`debian:bookworm-20211201-slim`](#debianbookworm-20211201-slim)
-	[`debian:bookworm-backports`](#debianbookworm-backports)
-	[`debian:bookworm-slim`](#debianbookworm-slim)
-	[`debian:bullseye`](#debianbullseye)
-	[`debian:bullseye-20211201`](#debianbullseye-20211201)
-	[`debian:bullseye-20211201-slim`](#debianbullseye-20211201-slim)
-	[`debian:bullseye-backports`](#debianbullseye-backports)
-	[`debian:bullseye-slim`](#debianbullseye-slim)
-	[`debian:buster`](#debianbuster)
-	[`debian:buster-20211201`](#debianbuster-20211201)
-	[`debian:buster-20211201-slim`](#debianbuster-20211201-slim)
-	[`debian:buster-backports`](#debianbuster-backports)
-	[`debian:buster-slim`](#debianbuster-slim)
-	[`debian:experimental`](#debianexperimental)
-	[`debian:experimental-20211201`](#debianexperimental-20211201)
-	[`debian:latest`](#debianlatest)
-	[`debian:oldoldstable`](#debianoldoldstable)
-	[`debian:oldoldstable-20211201`](#debianoldoldstable-20211201)
-	[`debian:oldoldstable-20211201-slim`](#debianoldoldstable-20211201-slim)
...
-	[`debian:oldstable-20211201`](#debianoldstable-20211201)
-	[`debian:oldstable-20211201-slim`](#debianoldstable-20211201-slim)
...
-	[`debian:rc-buggy-20211201`](#debianrc-buggy-20211201)
-	[`debian:sid`](#debiansid)
-	[`debian:sid-20211201`](#debiansid-20211201)
-	[`debian:sid-20211201-slim`](#debiansid-20211201-slim)
-	[`debian:sid-slim`](#debiansid-slim)
-	[`debian:stable`](#debianstable)
-	[`debian:stable-20211201`](#debianstable-20211201)
-	[`debian:stable-20211201-slim`](#debianstable-20211201-slim)
-	[`debian:stable-backports`](#debianstable-backports)
-	[`debian:stable-slim`](#debianstable-slim)
-	[`debian:stretch`](#debianstretch)
-	[`debian:stretch-20211201`](#debianstretch-20211201)
-	[`debian:stretch-20211201-slim`](#debianstretch-20211201-slim)
-	[`debian:stretch-backports`](#debianstretch-backports)
-	[`debian:stretch-slim`](#debianstretch-slim)
-	[`debian:testing`](#debiantesting)
-	[`debian:testing-20211201`](#debiantesting-20211201)
-	[`debian:testing-20211201-slim`](#debiantesting-20211201-slim)
-	[`debian:testing-backports`](#debiantesting-backports)
-	[`debian:testing-slim`](#debiantesting-slim)
-	[`debian:unstable`](#debianunstable)
-	[`debian:unstable-20211201`](#debianunstable-20211201)
-	[`debian:unstable-20211201-slim`](#debianunstable-20211201-slim)
...
```console
$ docker pull debian@sha256:54136769cdb6190e9610a683a366f1954e191cb4ac707857cd5a9c1dcc1ee034
```
...
```console
$ docker pull debian@sha256:6bc65dd3c9a6b12c5441d5d63c7be397ec18c1f5f32ac4c6c945a46b61b706d5
```
...
```console
$ docker pull debian@sha256:66a821f8d625a46531d51b9852f86433217aa336ec37aac1b6887e6fa5040dab
```
...
```console
$ docker pull debian@sha256:9c90120fff339ea7ffd9af4adad6686e154164920f10abda8c43d3c60eab9418
```
...
```console
$ docker pull debian@sha256:67c9db9cbc346ba3aaaa7a58e94b7cb796cfe903a75e4264c4432d4986aa98a2
```
...
```console
$ docker pull debian@sha256:2b34490cea3108320ff6e7c8feab4ff5beb37e93b3496de92410d1c744892424
```
...
```console
$ docker pull debian@sha256:5cd94a97f0def10e3796ecdb4735f5c665728b94a5c27b495629d42a25209174
```
...
### `debian:oldstable-20211201-slim` - linux; amd64
...
### `debian:oldstable-20211201-slim` - linux; arm variant v5
...
### `debian:oldstable-20211201-slim` - linux; arm64 variant v8
...
### `debian:oldstable-20211201-slim` - linux; 386
...
### `debian:oldstable-20211201-slim` - linux; mips64le
...
### `debian:oldstable-20211201-slim` - linux; ppc64le
...
### `debian:oldstable-20211201-slim` - linux; s390x
...
```console
$ docker pull debian@sha256:4a56f99e339188bf09f55764e7787bcd09e58189e16ff3e0f4cfd93626ab3dad
```
...
```console
$ docker pull debian@sha256:b716bd27b444484d2b947335f879569f398d64fba852c718cfa97d7c21c5be66
```
...
```console
$ docker pull debian@sha256:53d461599e68a332db074f7893f0a53e878a26ab7e17e32f328859f29aa0b009
```
...
```console
$ docker pull debian@sha256:dd0ca785b94d54830dfe12474f6aa3a202b6d9e8e96961b4d7d79ba9763f7153
```
...
```console
$ docker pull debian@sha256:7ca6e059abd5d067c55d25e9e83f82f514c74d0ef72496a1a7654b9bd6a4cebc
```
...
```console
$ docker pull debian@sha256:5bd3f912604280985a46779b34119f05a695837b94e43d9e11cbdcdc31547865
```
...
```console
$ docker pull debian@sha256:8d829b1521971382e274425f0003ab95495376f5b76dd827637d7865519b38a9
```
...
```console
$ docker pull debian@sha256:7266b90cf5fef3a81a7306cebe877ff17f60649d6353c2e75706122ba753a07d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50134145 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e136c687886529772f4b4202e0f6ba753009b8e7b7828b2fa9f08c432baaee88`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:45ff485d57582f6b9059a1b552befe1a23a0f686a8d6013f121e7a23fb129415
```
