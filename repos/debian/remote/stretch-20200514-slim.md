...
```console
$ docker pull debian@sha256:61948cda2ed4273e0b49002f5aa8f238f129342e599f4628d1619871e3125545
```
...
### `debian:stretch-20200514-slim` - linux; amd64
...
### `debian:stretch-20200514-slim` - linux; arm variant v5
...
### `debian:stretch-20200514-slim` - linux; arm variant v7
...
### `debian:stretch-20200514-slim` - linux; arm64 variant v8
...
### `debian:stretch-20200514-slim` - linux; 386
...
### `debian:stretch-20200514-slim` - linux; mips64le
...
### `debian:stretch-20200514-slim` - linux; s390x
