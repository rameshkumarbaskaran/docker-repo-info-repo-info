...
```console
$ docker pull debian@sha256:b10b4a9e2acda3283ea29c988493b58ea8472a16aae4640abc5a4cca37d4aa17
```
...
### `debian:testing-20230411` - linux; amd64
...
### `debian:testing-20230411` - linux; arm variant v5

```console
$ docker pull debian@sha256:c8aeac6a6f1d28a6a9c80f65b347fc6070af321b47afc21e1b04e456b2112f47
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.1 MB (48110880 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:14254f18e25b9cc9a088c531be6b3481b868627d505dad9661dbbe7526818653`
-	Default Command: `["bash"]`
...
### `debian:testing-20230411` - linux; arm variant v7
...
### `debian:testing-20230411` - linux; arm64 variant v8
...
### `debian:testing-20230411` - linux; 386
...
### `debian:testing-20230411` - linux; mips64le
...
### `debian:testing-20230411` - linux; ppc64le
...
### `debian:testing-20230411` - linux; s390x
