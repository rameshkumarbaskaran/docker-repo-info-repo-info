...
```console
$ docker pull postgres@sha256:221d7273a0d6bb3a25a4c193aa777b98e0f48741be4c4c762b9da47ea03f7d44
```
...
### `postgres:13-beta3-alpine` - linux; arm variant v7
...
### `postgres:13-beta3-alpine` - linux; arm64 variant v8
