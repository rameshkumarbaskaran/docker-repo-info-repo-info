...
```console
$ docker pull postgres@sha256:af0a23161d971c79fe9301d3d65e6970fe9f09c7771bdf51b1730beebc1da9cc
```
...
### `postgres:9.6.24-alpine3.15` - linux; amd64
...
### `postgres:9.6.24-alpine3.15` - linux; arm variant v6
...
### `postgres:9.6.24-alpine3.15` - linux; arm64 variant v8
...
### `postgres:9.6.24-alpine3.15` - linux; ppc64le
