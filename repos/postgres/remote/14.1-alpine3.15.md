...
```console
$ docker pull postgres@sha256:9340a9dd7859f8cd814802d263a1c34b9f2593be586399b96457f7592bdbd59e
```
...
### `postgres:14.1-alpine3.15` - linux; arm variant v6
...
### `postgres:14.1-alpine3.15` - linux; arm64 variant v8
...
### `postgres:14.1-alpine3.15` - linux; 386
...
### `postgres:14.1-alpine3.15` - linux; ppc64le
