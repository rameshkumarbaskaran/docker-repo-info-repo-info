...
### `postgres:16beta3-alpine3.18` - linux; amd64
...
### `postgres:16beta3-alpine3.18` - linux; arm variant v6
...
### `postgres:16beta3-alpine3.18` - linux; arm64 variant v8
...
### `postgres:16beta3-alpine3.18` - linux; ppc64le
...
### `postgres:16beta3-alpine3.18` - linux; s390x
