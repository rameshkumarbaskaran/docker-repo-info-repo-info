...
### `postgres:12.13-alpine3.16` - linux; amd64
...
### `postgres:12.13-alpine3.16` - linux; arm variant v6
...
### `postgres:12.13-alpine3.16` - linux; arm variant v7
...
### `postgres:12.13-alpine3.16` - linux; arm64 variant v8
...
### `postgres:12.13-alpine3.16` - linux; 386
...
### `postgres:12.13-alpine3.16` - linux; ppc64le
...
### `postgres:12.13-alpine3.16` - linux; s390x
