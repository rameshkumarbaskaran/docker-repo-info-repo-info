...
### `postgres:14rc1-bullseye` - linux; amd64
...
### `postgres:14rc1-bullseye` - linux; arm64 variant v8
...
### `postgres:14rc1-bullseye` - linux; 386
...
### `postgres:14rc1-bullseye` - linux; mips64le
...
### `postgres:14rc1-bullseye` - linux; s390x
