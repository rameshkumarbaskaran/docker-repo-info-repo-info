...
### `postgres:12.9-alpine3.15` - linux; amd64
...
### `postgres:12.9-alpine3.15` - linux; arm variant v6
...
### `postgres:12.9-alpine3.15` - linux; arm64 variant v8
...
### `postgres:12.9-alpine3.15` - linux; 386
...
### `postgres:12.9-alpine3.15` - linux; ppc64le
