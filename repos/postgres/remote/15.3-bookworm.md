...
### `postgres:15.3-bookworm` - linux; amd64
...
### `postgres:15.3-bookworm` - linux; arm variant v5
...
### `postgres:15.3-bookworm` - linux; arm variant v7
...
### `postgres:15.3-bookworm` - linux; arm64 variant v8
...
### `postgres:15.3-bookworm` - linux; 386
...
### `postgres:15.3-bookworm` - linux; mips64le
...
### `postgres:15.3-bookworm` - linux; ppc64le
...
### `postgres:15.3-bookworm` - linux; s390x
