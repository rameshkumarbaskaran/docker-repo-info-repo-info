...
- Created: `2021-04-15T03:59:06.142187974Z`
- Virtual Size: ~ 158.17 Mb  
...
- Environment:
  ...
  - `PG_MAJOR=12`
  - `PG_VERSION=12.6`
  - `PG_SHA256=df7dd98d5ccaf1f693c7e1d0d084e9fed7017ee248bba5be0167c42ad2d70a09`
...
```console
llvm10-libs-10.0.1-r1 description:
LLVM 10 runtime library

llvm10-libs-10.0.1-r1 webpage:
https://llvm.org/

llvm10-libs-10.0.1-r1 installed size:
63205376

llvm10-libs-10.0.1-r1 license:
Apache-2.0
