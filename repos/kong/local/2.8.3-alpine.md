...
- Created: `2023-02-11T14:00:29.651271269Z`
- Virtual Size: ~ 139.26 Mb  
...
```console
git-perl-2.36.4-r0 description:
Additional Git commands that requires perl

git-perl-2.36.4-r0 webpage:
https://www.git-scm.com/

git-perl-2.36.4-r0 installed size:
132 KiB

git-perl-2.36.4-r0 license:
GPL-2.0-or-later
...
```console
perl-git-2.36.4-r0 description:
Perl interface to Git

perl-git-2.36.4-r0 webpage:
https://www.git-scm.com/

perl-git-2.36.4-r0 installed size:
152 KiB

perl-git-2.36.4-r0 license:
GPL-2.0-or-later
