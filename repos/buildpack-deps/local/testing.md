...
### `dpkg` source package: `gobject-introspection=1.66.0-1`

Binary Packages:

- `gir1.2-freedesktop:amd64=1.66.0-1`
- `gir1.2-glib-2.0:amd64=1.66.0-1`
- `libgirepository-1.0-1:amd64=1.66.0-1`
...
- http://snapshot.debian.org/package/libxml2/2.9.10+dfsg-6/
...
### `dpkg` source package: `linux=5.8.10-1`

Binary Packages:

- `linux-libc-dev:amd64=5.8.10-1`
...
```console
$ apt-get source -qq --print-uris linux=5.8.10-1
'http://deb.debian.org/debian/pool/main/l/linux/linux_5.8.10-1.dsc' linux_5.8.10-1.dsc 194661 SHA256:671a122e8b6f6ec5c1291edd36f9d7e137a8c941a58624009f8ecca28edb10b0
'http://deb.debian.org/debian/pool/main/l/linux/linux_5.8.10.orig.tar.xz' linux_5.8.10.orig.tar.xz 119171992 SHA256:d335b9d4bc23de37899643f64686bda8b576b42bddfa5483d3d3e2532e8d95f6
'http://deb.debian.org/debian/pool/main/l/linux/linux_5.8.10-1.debian.tar.xz' linux_5.8.10-1.debian.tar.xz 1244292 SHA256:2acd74018207cd75c57dcdaaac19d7bee87d08ee431af6e7e1190553af4ce51e
```

Other potentially useful URLs:

- https://sources.debian.net/src/linux/5.8.10-1/ (for browsing the source)
- https://sources.debian.net/src/linux/5.8.10-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/linux/5.8.10-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `postgresql-13=13.0-3`
