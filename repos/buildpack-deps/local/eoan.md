...
- Created: `2020-06-17T02:02:36.092487004Z`
- Virtual Size: ~ 678.18 Mb  
...
### `dpkg` source package: `ca-certificates=20190110ubuntu0.19.10.1`
...
```console
$ apt-get source -qq --print-uris ca-certificates=20190110ubuntu0.19.10.1
'http://archive.ubuntu.com/ubuntu/pool/main/c/ca-certificates/ca-certificates_20190110ubuntu0.19.10.1.dsc' ca-certificates_20190110ubuntu0.19.10.1.dsc 1944 SHA256:9bfeef8434191dc93010ddb60a464baea5b0c71a81856965b13b0043d2f5b175
'http://archive.ubuntu.com/ubuntu/pool/main/c/ca-certificates/ca-certificates_20190110ubuntu0.19.10.1.tar.xz' ca-certificates_20190110ubuntu0.19.10.1.tar.xz 243720 SHA256:2455d2e86ca3df4d03763108dd4b36d293180f078d2263f3dfa3b2b7b7bef375
```
...
- `comerr-dev:amd64=2.1-1.45.3-4ubuntu2.1`
...
- `libc-dev-bin=2.30-0ubuntu2.1`
- `libc6:amd64=2.30-0ubuntu2.1`
- `libc6-dev:amd64=2.30-0ubuntu2.1`
...
### `dpkg` source package: `icu=63.2-2ubuntu0.1`

Binary Packages:

- `icu-devtools=63.2-2ubuntu0.1`
- `libicu-dev:amd64=63.2-2ubuntu0.1`
- `libicu63:amd64=63.2-2ubuntu0.1`
...
```console
$ apt-get source -qq --print-uris icu=63.2-2ubuntu0.1
'http://archive.ubuntu.com/ubuntu/pool/main/i/icu/icu_63.2-2ubuntu0.1.dsc' icu_63.2-2ubuntu0.1.dsc 2080 SHA256:48e0eb7001cf84cd1dbfd87b07e7d08400fb9dc1c3a25b64f216e2ad3ff52216
...
'http://archive.ubuntu.com/ubuntu/pool/main/i/icu/icu_63.2-2ubuntu0.1.debian.tar.xz' icu_63.2-2ubuntu0.1.debian.tar.xz 35612 SHA256:b457182e272e40004917a61dfa32e552888c32eb83ddde7121f30fc8263befa5
```
...
### `dpkg` source package: `libexif=0.6.21-5.1ubuntu0.5`

Binary Packages:

- `libexif-dev:amd64=0.6.21-5.1ubuntu0.5`
- `libexif12:amd64=0.6.21-5.1ubuntu0.5`
...
```console
$ apt-get source -qq --print-uris libexif=0.6.21-5.1ubuntu0.5
'http://archive.ubuntu.com/ubuntu/pool/main/libe/libexif/libexif_0.6.21-5.1ubuntu0.5.dsc' libexif_0.6.21-5.1ubuntu0.5.dsc 2232 SHA256:76dac86437d39db33607d674b98966e2139d0954c4f1a60227fab150cd3d0005
...
'http://archive.ubuntu.com/ubuntu/pool/main/libe/libexif/libexif_0.6.21-5.1ubuntu0.5.debian.tar.xz' libexif_0.6.21-5.1ubuntu0.5.debian.tar.xz 18868 SHA256:5ee7562425f2daf007fab469710d6db8a09d07dae1ea00bddfa78e2acab2219e
```
...
### `dpkg` source package: `libjpeg-turbo=2.0.3-0ubuntu1.19.10.1`

Binary Packages:

- `libjpeg-turbo8:amd64=2.0.3-0ubuntu1.19.10.1`
- `libjpeg-turbo8-dev:amd64=2.0.3-0ubuntu1.19.10.1`
...
```console
$ apt-get source -qq --print-uris libjpeg-turbo=2.0.3-0ubuntu1.19.10.1
'http://archive.ubuntu.com/ubuntu/pool/main/libj/libjpeg-turbo/libjpeg-turbo_2.0.3-0ubuntu1.19.10.1.dsc' libjpeg-turbo_2.0.3-0ubuntu1.19.10.1.dsc 2337 SHA256:a4493afd6da1ea968ae20c74cb25e017154eac3724c5bebe2523e5f94586d734
...
'http://archive.ubuntu.com/ubuntu/pool/main/libj/libjpeg-turbo/libjpeg-turbo_2.0.3-0ubuntu1.19.10.1.debian.tar.xz' libjpeg-turbo_2.0.3-0ubuntu1.19.10.1.debian.tar.xz 18224 SHA256:96907ad4fb7635b6946d190a9f28f99e81214334b87ec88024e46344ff04fb88
```
...
### `dpkg` source package: `libxml2=2.9.4+dfsg1-7ubuntu3.1`

Binary Packages:

- `libxml2:amd64=2.9.4+dfsg1-7ubuntu3.1`
- `libxml2-dev:amd64=2.9.4+dfsg1-7ubuntu3.1`
...
```console
$ apt-get source -qq --print-uris libxml2=2.9.4+dfsg1-7ubuntu3.1
'http://archive.ubuntu.com/ubuntu/pool/main/libx/libxml2/libxml2_2.9.4+dfsg1-7ubuntu3.1.dsc' libxml2_2.9.4+dfsg1-7ubuntu3.1.dsc 3075 SHA256:f735b42edb01ee2b72ff027348790832b5738f0d4676999a7f95cd023713a600
...
'http://archive.ubuntu.com/ubuntu/pool/main/libx/libxml2/libxml2_2.9.4+dfsg1-7ubuntu3.1.debian.tar.xz' libxml2_2.9.4+dfsg1-7ubuntu3.1.debian.tar.xz 39572 SHA256:9720f877298981ef8d5b4ca153a8dee22d1489691076a82c34c1fd4a6952d428
```
...
### `dpkg` source package: `linux=5.3.0-59.53`

Binary Packages:

- `linux-libc-dev:amd64=5.3.0-59.53`
...
### `dpkg` source package: `mysql-8.0=8.0.20-0ubuntu0.19.10.1`

Binary Packages:

- `libmysqlclient-dev=8.0.20-0ubuntu0.19.10.1`
- `libmysqlclient21:amd64=8.0.20-0ubuntu0.19.10.1`
...
```console
$ apt-get source -qq --print-uris mysql-8.0=8.0.20-0ubuntu0.19.10.1
'http://archive.ubuntu.com/ubuntu/pool/main/m/mysql-8.0/mysql-8.0_8.0.20-0ubuntu0.19.10.1.dsc' mysql-8.0_8.0.20-0ubuntu0.19.10.1.dsc 3434 SHA256:cd5948e38aff975f6dd9bd4c0c986a442625f02649f4c8484abc7613144a9346
...
'http://archive.ubuntu.com/ubuntu/pool/main/m/mysql-8.0/mysql-8.0_8.0.20-0ubuntu0.19.10.1.debian.tar.xz' mysql-8.0_8.0.20-0ubuntu0.19.10.1.debian.tar.xz 156868 SHA256:5fe8ccb069768ba061342eb608f692b35d330ae395d5542ded9b8b60c0a1ec39
```
...
### `dpkg` source package: `openexr=2.2.1-4.1ubuntu1.1`

Binary Packages:

- `libopenexr-dev=2.2.1-4.1ubuntu1.1`
- `libopenexr23:amd64=2.2.1-4.1ubuntu1.1`
...
- `libldap-2.4-2:amd64=2.4.48+dfsg-1ubuntu1.1`
- `libldap-common=2.4.48+dfsg-1ubuntu1.1`
...
### `dpkg` source package: `openssl=1.1.1c-1ubuntu4.1`

Binary Packages:

- `libssl-dev:amd64=1.1.1c-1ubuntu4.1`
- `libssl1.1:amd64=1.1.1c-1ubuntu4.1`
- `openssl=1.1.1c-1ubuntu4.1`
...
```console
$ apt-get source -qq --print-uris openssl=1.1.1c-1ubuntu4.1
'http://archive.ubuntu.com/ubuntu/pool/main/o/openssl/openssl_1.1.1c-1ubuntu4.1.dsc' openssl_1.1.1c-1ubuntu4.1.dsc 2732 SHA256:fea989a1aeb3975f0aa72286cd1aaecf64f1c778717e3d76a0262fcdaf49bbef
...
'http://archive.ubuntu.com/ubuntu/pool/main/o/openssl/openssl_1.1.1c-1ubuntu4.1.debian.tar.xz' openssl_1.1.1c-1ubuntu4.1.debian.tar.xz 130816 SHA256:c837ed6258e75b8a132dc041416c546d1ba6caf1d586b785078f76fbc126c7bc
```
...
### `dpkg` source package: `postgresql-11=11.7-0ubuntu0.19.10.1`

Binary Packages:

- `libpq-dev=11.7-0ubuntu0.19.10.1`
- `libpq5:amd64=11.7-0ubuntu0.19.10.1`
...
```console
$ apt-get source -qq --print-uris postgresql-11=11.7-0ubuntu0.19.10.1
'http://archive.ubuntu.com/ubuntu/pool/main/p/postgresql-11/postgresql-11_11.7-0ubuntu0.19.10.1.dsc' postgresql-11_11.7-0ubuntu0.19.10.1.dsc 3855 SHA256:d7d76cf5a9678f7c3942a934b0005f972f2250b4ec954197c0292d6f4a053c18
'http://archive.ubuntu.com/ubuntu/pool/main/p/postgresql-11/postgresql-11_11.7.orig.tar.bz2' postgresql-11_11.7.orig.tar.bz2 19890063 SHA256:324ae93a8846fbb6a25d562d271bc441ffa8794654c5b2839384834de220a313
'http://archive.ubuntu.com/ubuntu/pool/main/p/postgresql-11/postgresql-11_11.7-0ubuntu0.19.10.1.debian.tar.xz' postgresql-11_11.7-0ubuntu0.19.10.1.debian.tar.xz 25688 SHA256:647dc7b11929d6afbee3085217dfbbf19857ad0916dec25a764a1b5e3867b6af
```
...
### `dpkg` source package: `sqlite3=3.29.0-2ubuntu0.3`

Binary Packages:

- `libsqlite3-0:amd64=3.29.0-2ubuntu0.3`
- `libsqlite3-dev:amd64=3.29.0-2ubuntu0.3`
...
```console
$ apt-get source -qq --print-uris sqlite3=3.29.0-2ubuntu0.3
'http://archive.ubuntu.com/ubuntu/pool/main/s/sqlite3/sqlite3_3.29.0-2ubuntu0.3.dsc' sqlite3_3.29.0-2ubuntu0.3.dsc 2513 SHA256:2d583db830f03cf6e639009f262d4c73a8dacac288d6e503e29c922c7d47ead2
...
'http://archive.ubuntu.com/ubuntu/pool/main/s/sqlite3/sqlite3_3.29.0-2ubuntu0.3.debian.tar.xz' sqlite3_3.29.0-2ubuntu0.3.debian.tar.xz 40272 SHA256:1a6fd193ef954aa9f9c827d6598c99be5c293acae6d2bdb26dfe147a7e0aec24
```
