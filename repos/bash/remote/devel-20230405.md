...
### `bash:devel-20230405` - linux; amd64
...
### `bash:devel-20230405` - linux; arm variant v6
...
### `bash:devel-20230405` - linux; arm variant v7
...
### `bash:devel-20230405` - linux; arm64 variant v8
...
### `bash:devel-20230405` - linux; ppc64le
...
### `bash:devel-20230405` - linux; s390x
