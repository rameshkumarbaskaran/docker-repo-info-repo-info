...
### `bash:devel-20230120-alpine3.16` - linux; amd64
...
### `bash:devel-20230120-alpine3.16` - linux; arm variant v7
...
### `bash:devel-20230120-alpine3.16` - linux; arm64 variant v8
...
### `bash:devel-20230120-alpine3.16` - linux; 386
