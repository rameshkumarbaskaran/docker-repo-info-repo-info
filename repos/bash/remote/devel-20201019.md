...
### `bash:devel-20201019` - linux; amd64
...
### `bash:devel-20201019` - linux; arm64 variant v8
...
### `bash:devel-20201019` - linux; ppc64le
...
### `bash:devel-20201019` - linux; s390x
