...
### `bash:devel-20200615` - linux; amd64
...
### `bash:devel-20200615` - linux; arm variant v6
...
### `bash:devel-20200615` - linux; arm variant v7
...
### `bash:devel-20200615` - linux; arm64 variant v8
...
### `bash:devel-20200615` - linux; ppc64le
...
### `bash:devel-20200615` - linux; s390x
