...
```console
$ docker pull bash@sha256:ee184db32761b823b65ebeff93e7e5f722ef1b7a4bfa350db29ac483fc6af482
```
...
### `bash:devel-20230120` - linux; amd64
...
### `bash:devel-20230120` - linux; arm variant v6
...
### `bash:devel-20230120` - linux; arm variant v7
...
### `bash:devel-20230120` - linux; arm64 variant v8
...
### `bash:devel-20230120` - linux; s390x
