...
```console
$ docker pull bash@sha256:2928cc84d0735b235aafa3305f5a6f03a9b8f868891dac8664ca917a97690f14
```
...
### `bash:devel-20200605` - linux; arm variant v7
...
### `bash:devel-20200605` - linux; arm64 variant v8
