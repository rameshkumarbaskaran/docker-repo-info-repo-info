...
### `bash:devel-20230626` - linux; amd64
...
### `bash:devel-20230626` - linux; arm variant v6
...
### `bash:devel-20230626` - linux; arm variant v7
...
### `bash:devel-20230626` - linux; arm64 variant v8
...
### `bash:devel-20230626` - linux; ppc64le
