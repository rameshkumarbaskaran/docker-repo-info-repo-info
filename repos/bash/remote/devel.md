...
```console
$ docker pull bash@sha256:f55a907bca6a45a7b42d6646cd84013db657f126518815a18d61650da758f42d
```
...
```console
$ docker pull bash@sha256:379e21396544900c6cd7a59820440f70070ec73f5ab204e59bc5b5b380de8604
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.2 MB (6244129 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74302bc50f7f9dfc76971d9f2acbd903b1e2e4d06afd316439c8ff18f489712e`
...
-	Layers:
	...
	-	`sha256:65581be2a1fd844452cb4d2b118dd864cd2e2264eadb009b527ae387257cb462`  
		Last Modified: Thu, 28 Sep 2023 22:40:19 GMT  
		Size: 2.8 MB (2841823 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d86b264a1971ef55984ba5b93e171fabd43eed83ad6bc64097475bb5edbc2994`  
		Last Modified: Thu, 28 Sep 2023 22:40:18 GMT  
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull bash@sha256:47c05ba59a98c42869b9b6fea2e1b7d2f3217e673e9f1603786ae27d628f4ed6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.4 MB (6422996 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec01b79f3c76943da6285c6439afa4f3105bac956c9d2ca552ccdbfaa0fcd663`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["bash"]`
...
CMD ["/bin/sh"]
# Thu, 28 Sep 2023 21:42:33 GMT
ENV _BASH_COMMIT=b3958b3ab44054a42f16bbc9ff9bc162eaf783b1
# Thu, 28 Sep 2023 21:42:34 GMT
ENV _BASH_VERSION=devel-20230925
# Thu, 28 Sep 2023 21:44:06 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		bison 		coreutils 		dpkg-dev dpkg 		gcc 		libc-dev 		make 		ncurses-dev 		patch 		tar 	; 		wget -O bash.tar.gz "https://git.savannah.gnu.org/cgit/bash.git/snapshot/bash-$_BASH_COMMIT.tar.gz"; 		mkdir -p /usr/src/bash; 	tar 		--extract 		--file=bash.tar.gz 		--strip-components=1 		--directory=/usr/src/bash 	; 	rm bash.tar.gz; 		if [ -d bash-patches ]; then 		apk add --no-cache --virtual .patch-deps patch; 		for p in bash-patches/*; do 			patch 				--directory=/usr/src/bash 				--input="$(readlink -f "$p")" 				--strip=0 			; 			rm "$p"; 		done; 		rmdir bash-patches; 		apk del --no-network .patch-deps; 	fi; 		{ echo '#include <unistd.h>'; echo; cat /usr/src/bash/lib/sh/strscpy.c; } > /usr/src/bash/lib/sh/strscpy.c.new; 	mv /usr/src/bash/lib/sh/strscpy.c.new /usr/src/bash/lib/sh/strscpy.c; 		cd /usr/src/bash; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	./configure 		--build="$gnuArch" 		--enable-readline 		--with-curses 		--without-bash-malloc 	|| { 		cat >&2 config.log; 		false; 	}; 	make -j "$(nproc)"; 	make install; 	cd /; 	rm -r /usr/src/bash; 		rm -rf 		/usr/local/share/doc/bash/*.html 		/usr/local/share/info 		/usr/local/share/locale 		/usr/local/share/man 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .bash-rundeps $runDeps; 	apk del --no-network .build-deps; 		[ "$(which bash)" = '/usr/local/bin/bash' ]; 	bash --version; 	bash -c 'help' > /dev/null
# Thu, 28 Sep 2023 21:44:06 GMT
COPY file:651b3bebeba8be9162c56b3eb561199905235f3e1c7811232b6c9f48ac333651 in /usr/local/bin/ 
# Thu, 28 Sep 2023 21:44:07 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 28 Sep 2023 21:44:08 GMT
CMD ["bash"]
```
...
-	Layers:
	-	`sha256:cd37f9856024d6685ac0233823aded690551c5872d6a27699a96c6a479d20f6f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e47583c8ba47cc0fa7ef5cc3af7a503d26ef4450820eabe3c0e617bf8b1867d1`  
		Last Modified: Thu, 28 Sep 2023 22:09:38 GMT  
		Size: 3.1 MB (3076146 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ca2cc8c8970ad8997ad2c13a0d934e597447f029cec00c3fd9de94861b148ef`  
		Last Modified: Thu, 28 Sep 2023 22:09:37 GMT  
		Size: 342.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
