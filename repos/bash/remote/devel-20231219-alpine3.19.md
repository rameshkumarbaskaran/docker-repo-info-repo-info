## `bash:devel-20231219-alpine3.19`
...
### `bash:devel-20231219-alpine3.19` - linux; amd64
...
### `bash:devel-20231219-alpine3.19` - unknown; unknown
...
### `bash:devel-20231219-alpine3.19` - linux; arm variant v6
...
### `bash:devel-20231219-alpine3.19` - linux; arm variant v7
...
### `bash:devel-20231219-alpine3.19` - linux; arm64 variant v8
...
### `bash:devel-20231219-alpine3.19` - linux; 386
...
### `bash:devel-20231219-alpine3.19` - linux; ppc64le
...
### `bash:devel-20231219-alpine3.19` - linux; s390x
