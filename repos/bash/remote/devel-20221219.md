...
### `bash:devel-20221219` - linux; amd64
...
### `bash:devel-20221219` - linux; arm variant v6
...
### `bash:devel-20221219` - linux; arm64 variant v8
...
### `bash:devel-20221219` - linux; s390x
