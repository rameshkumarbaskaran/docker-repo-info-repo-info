...
```console
$ docker pull bash@sha256:131bc6ace132fdeb59b246e17e2aba269481282084eb31365add23642502a9c9
```
...
### `bash:devel-20200306` - linux; arm variant v6
...
### `bash:devel-20200306` - linux; arm variant v7
...
### `bash:devel-20200306` - linux; arm64 variant v8
...
### `bash:devel-20200306` - linux; s390x
