...
```console
$ docker pull bash@sha256:0931ff646738d1303dc3a174dbc2ad28420a50f274979cd0f9df9ab3612205ea
```
...
### `bash:devel-20211101` - linux; amd64
...
### `bash:devel-20211101` - linux; arm variant v6
...
### `bash:devel-20211101` - linux; arm variant v7
...
### `bash:devel-20211101` - linux; arm64 variant v8
...
### `bash:devel-20211101` - linux; ppc64le
...
### `bash:devel-20211101` - linux; s390x
