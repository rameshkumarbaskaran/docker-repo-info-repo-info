...
### `bash:devel-20191219` - linux; amd64
...
### `bash:devel-20191219` - linux; arm variant v6
...
### `bash:devel-20191219` - linux; arm64 variant v8
...
### `bash:devel-20191219` - linux; ppc64le
...
### `bash:devel-20191219` - linux; s390x
