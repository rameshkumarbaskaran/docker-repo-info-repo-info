...
```console
$ dnf --quiet download --source --url kernel-debug-devel-3.10.0-1160.102.1.el7
http://vault.centos.org/centos/7/updates/Source/SPackages/kernel-3.10.0-1160.102.1.el7.src.rpm
```
