...
- Created: `2022-11-02T22:57:07.706484067Z`
...
```console
$ dnf --quiet download --source --url glibc-devel-2.17-326.el7_9
http://vault.centos.org/centos/7/updates/Source/SPackages/glibc-2.17-326.el7_9.src.rpm
```
...
```console
$ dnf --quiet download --source --url glibc-headers-2.17-326.el7_9
http://vault.centos.org/centos/7/updates/Source/SPackages/glibc-2.17-326.el7_9.src.rpm
```
...
```console
$ dnf --quiet download --source --url glibc-static-2.17-326.el7_9
http://vault.centos.org/centos/7/updates/Source/SPackages/glibc-2.17-326.el7_9.src.rpm
```
...
```console
$ dnf --quiet download --source --url libxml2-devel-2.9.1-6.el7_9.6
http://vault.centos.org/centos/7/updates/Source/SPackages/libxml2-2.9.1-6.el7_9.6.src.rpm
```
...
```console
$ dnf --quiet download --source --url unzip-6.0-24.el7_9
http://vault.centos.org/centos/7/updates/Source/SPackages/unzip-6.0-24.el7_9.src.rpm
```
...
```console
$ dnf --quiet download --source --url xz-devel-5.2.2-2.el7_9
http://vault.centos.org/centos/7/updates/Source/SPackages/xz-5.2.2-2.el7_9.src.rpm
```
