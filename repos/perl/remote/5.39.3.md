...
```console
$ docker pull perl@sha256:6e15dc3b785ec30b452ee253e11124ff50fedf49b30b335550ccfa4aa4de6029
```
...
### `perl:5.39.3` - linux; amd64

```console
$ docker pull perl@sha256:417c616de16410ad1e9568e5f791eac9ada17002539e5634e3f506ab7131e026
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **364.5 MB (364474187 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bbcd16e9590dc8e865e3a1a02e9b2aa613b969275a0dc330657d8064895e43b3`
...
-	Layers:
	...
	-	`sha256:76dfdf121c4328f5fc9d6981e9d483dba54775da092cf5fbfb676c06d6788007`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f1769fc3958d0edbf35b85b5ec98bf2e9fe19736d1f29275aa8adaa99292868`  
		Last Modified: Thu, 12 Oct 2023 13:56:41 GMT  
		Size: 15.6 MB (15646026 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58afa412a573df91c49ec03b712554fbca100a220c2cc831c430a88584e5c45c`  
		Last Modified: Thu, 12 Oct 2023 13:56:38 GMT  
		Size: 165.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.39.3` - linux; arm variant v5
...
### `perl:5.39.3` - linux; arm variant v7

```console
$ docker pull perl@sha256:f69d8bf7173a5e5502b4074e70b53d3f7f4c89ff3d5c4190ba88bbefb164ad7a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **316.2 MB (316171942 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:917dd962f3ebc68085a3fa3f992081de9a75a63314b32036a298ab3c048c8f21`
-	Default Command: `["perl5.39.3","-de0"]`
...
# Thu, 12 Oct 2023 09:37:41 GMT
WORKDIR /usr/src/perl
# Thu, 12 Oct 2023 11:14:32 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.39.3.tar.xz -o perl-5.39.3.tar.xz     && echo '93c38a6ff969e3930d7eb08e69a883204a4d835c7122df47c4903950e6fc758a *perl-5.39.3.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.39.3.tar.xz -C /usr/src/perl     && rm perl-5.39.3.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local -Dusedevel -Dversiononly=undef -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7047.tar.gz     && echo '963e63c6e1a8725ff2f624e9086396ae150db51dd0a337c3781d09a994af05a5 *App-cpanminus-1.7047.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7047.tar.gz && cd App-cpanminus-1.7047 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7047* /tmp/*     && cpanm --version && cpm --version
# Thu, 12 Oct 2023 11:14:33 GMT
WORKDIR /usr/src/app
# Thu, 12 Oct 2023 11:14:33 GMT
CMD ["perl5.39.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:44cbbc4df52893fc8379a0f23eee7e36aa55776c1146fb531225656efd7e28ea`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e19ff5043ae1b53d1e8de81d5e4b996bdd210aaa1f671b8c84f0698e1eea0eef`  
		Last Modified: Thu, 12 Oct 2023 11:38:42 GMT  
		Size: 14.7 MB (14722377 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d73fef1790336ca5c5388a0693d7309656add9234260d037811aa2ef0869f5d1`  
		Last Modified: Thu, 12 Oct 2023 11:38:38 GMT  
		Size: 165.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.39.3` - linux; arm64 variant v8
...
### `perl:5.39.3` - linux; mips64le

```console
$ docker pull perl@sha256:efb4f824d2bb9d6fa5e1fbaa29cd2d017f76ec4efbfcc01bed9e83bd2bdf72f9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **340.5 MB (340486202 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7cb9d5e699ddced531be43f0d1308dc5576f415fa6737a0ff8a385396237a3ac`
-	Default Command: `["perl5.39.3","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 12 Oct 2023 08:42:03 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.39.3.tar.xz -o perl-5.39.3.tar.xz     && echo '93c38a6ff969e3930d7eb08e69a883204a4d835c7122df47c4903950e6fc758a *perl-5.39.3.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.39.3.tar.xz -C /usr/src/perl     && rm perl-5.39.3.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local -Dusedevel -Dversiononly=undef -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7047.tar.gz     && echo '963e63c6e1a8725ff2f624e9086396ae150db51dd0a337c3781d09a994af05a5 *App-cpanminus-1.7047.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7047.tar.gz && cd App-cpanminus-1.7047 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7047* /tmp/*     && cpanm --version && cpm --version
# Thu, 12 Oct 2023 08:42:10 GMT
WORKDIR /usr/src/app
# Thu, 12 Oct 2023 08:42:16 GMT
CMD ["perl5.39.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:65ceba017f5edd97a35e5355987efbe73d1856feeed43bad3685a02ed4950217`  
		...
		Size: 135.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad7aa421313991090978ce15240e491d130a172b023c6947de06d7f3b9dd5297`  
		Last Modified: Thu, 12 Oct 2023 11:47:51 GMT  
		Size: 14.9 MB (14861611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5f0bd5c78383fcfb30a7066a1094814a06de8e69f26a1fb8c7bfbd87d8d612a`  
		Last Modified: Thu, 12 Oct 2023 11:47:38 GMT  
		Size: 132.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.39.3` - linux; ppc64le
