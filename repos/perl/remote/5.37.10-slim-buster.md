...
```console
$ docker pull perl@sha256:0806b17c920a4691d999189d5a75a06acc2778dc3525e295ad50ca71b86ad8c6
```
...
### `perl:5.37.10-slim-buster` - linux; amd64
...
### `perl:5.37.10-slim-buster` - linux; arm variant v7
...
### `perl:5.37.10-slim-buster` - linux; arm64 variant v8
