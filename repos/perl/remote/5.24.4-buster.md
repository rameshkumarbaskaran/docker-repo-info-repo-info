...
### `perl:5.24.4-buster` - linux; amd64
...
### `perl:5.24.4-buster` - linux; arm variant v7
...
### `perl:5.24.4-buster` - linux; arm64 variant v8
...
### `perl:5.24.4-buster` - linux; ppc64le
...
### `perl:5.24.4-buster` - linux; s390x
