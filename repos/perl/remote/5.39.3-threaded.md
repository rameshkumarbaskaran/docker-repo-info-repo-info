...
### `perl:5.39.3-threaded` - linux; amd64
...
### `perl:5.39.3-threaded` - linux; arm variant v5
...
### `perl:5.39.3-threaded` - linux; arm variant v7
...
### `perl:5.39.3-threaded` - linux; arm64 variant v8
...
### `perl:5.39.3-threaded` - linux; 386
...
### `perl:5.39.3-threaded` - linux; mips64le
...
### `perl:5.39.3-threaded` - linux; ppc64le
...
### `perl:5.39.3-threaded` - linux; s390x
