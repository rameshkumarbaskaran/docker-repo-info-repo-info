...
```console
$ docker pull perl@sha256:f3434ef2f40546faa292d3f6b8ed29d919cece4335f39a4bfbdff05e4ee635eb
```
...
### `perl:5.37.8-threaded-bullseye` - linux; amd64
...
### `perl:5.37.8-threaded-bullseye` - linux; arm variant v5
...
### `perl:5.37.8-threaded-bullseye` - linux; arm variant v7
...
### `perl:5.37.8-threaded-bullseye` - linux; arm64 variant v8
...
### `perl:5.37.8-threaded-bullseye` - linux; 386
...
### `perl:5.37.8-threaded-bullseye` - linux; mips64le
...
### `perl:5.37.8-threaded-bullseye` - linux; ppc64le
...
### `perl:5.37.8-threaded-bullseye` - linux; s390x
