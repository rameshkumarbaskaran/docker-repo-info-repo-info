...
### `perl:5.39.4-slim-threaded-bookworm` - linux; amd64
...
### `perl:5.39.4-slim-threaded-bookworm` - linux; arm variant v5
...
### `perl:5.39.4-slim-threaded-bookworm` - linux; arm64 variant v8
...
### `perl:5.39.4-slim-threaded-bookworm` - linux; 386
...
### `perl:5.39.4-slim-threaded-bookworm` - linux; mips64le
...
### `perl:5.39.4-slim-threaded-bookworm` - linux; ppc64le
...
### `perl:5.39.4-slim-threaded-bookworm` - linux; s390x
