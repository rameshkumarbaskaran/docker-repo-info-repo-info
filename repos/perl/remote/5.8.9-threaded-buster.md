...
### `perl:5.8.9-threaded-buster` - linux; amd64
...
### `perl:5.8.9-threaded-buster` - linux; arm variant v7
...
### `perl:5.8.9-threaded-buster` - linux; arm64 variant v8
...
### `perl:5.8.9-threaded-buster` - linux; 386
...
### `perl:5.8.9-threaded-buster` - linux; ppc64le
...
### `perl:5.8.9-threaded-buster` - linux; s390x
