...
```console
$ docker pull perl@sha256:63f1991d0101252b338fa85bc1713827295bea65331e3fefa216853b3ee0cdec
```
...
```console
$ docker pull perl@sha256:7437c2bce9348d2321708137161e777d7e5e6c00062fc8d8a7c30782ffd77c62
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.8 MB (291831671 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d4d3aa6bb66ee15fb02faf67241bd08a9672724153baaa730adfae48a8bdd417`
-	Default Command: `["perl5.34.1","-de0"]`
