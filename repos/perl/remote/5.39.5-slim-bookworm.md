...
```console
$ docker pull perl@sha256:5b17076dca94ce2863750d7117cbc202c270aa66ccd68d874155622f8f4c9f93
```
...
### `perl:5.39.5-slim-bookworm` - linux; amd64
...
### `perl:5.39.5-slim-bookworm` - linux; arm variant v5
...
### `perl:5.39.5-slim-bookworm` - linux; arm variant v7
...
### `perl:5.39.5-slim-bookworm` - linux; arm64 variant v8
...
### `perl:5.39.5-slim-bookworm` - linux; 386
...
### `perl:5.39.5-slim-bookworm` - linux; ppc64le
...
### `perl:5.39.5-slim-bookworm` - linux; s390x
