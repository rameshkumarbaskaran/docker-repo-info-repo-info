...
```console
$ docker pull perl@sha256:f0f4b8c03245531ccc785ba66d03e8ef965143cb30d14feed78aa21f093eea84
```
...
### `perl:5.37.10-slim` - linux; arm variant v7
...
### `perl:5.37.10-slim` - linux; arm64 variant v8
...
### `perl:5.37.10-slim` - linux; mips64le
...
### `perl:5.37.10-slim` - linux; ppc64le
