## `tomcat:10.0.12-jdk17-openjdk-buster`

```console
$ docker pull tomcat@sha256:33e12f4b53f8ca7ffa7197678393586b713052824f0faa59f7d7717b6474420d
```
...
### `tomcat:10.0.12-jdk17-openjdk-buster` - linux; amd64
...
### `tomcat:10.0.12-jdk17-openjdk-buster` - linux; arm64 variant v8
