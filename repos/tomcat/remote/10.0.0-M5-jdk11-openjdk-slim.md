...
```console
$ docker pull tomcat@sha256:e7d99fae604c781040edfbd9d73273f5bd7f668855596f1638d02856d3a7341a
```
...
### `tomcat:10.0.0-M5-jdk11-openjdk-slim` - linux; amd64
...
### `tomcat:10.0.0-M5-jdk11-openjdk-slim` - linux; arm64 variant v8
