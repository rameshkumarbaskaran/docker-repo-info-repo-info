...
```console
$ docker pull tomcat@sha256:0d4d6d6c6f57a3f383c973f892f337edb484c18ea315ef23b9f3575a3b76e9d3
```
...
### `tomcat:8.5.63-jdk15-openjdk-buster` - linux; amd64
...
### `tomcat:8.5.63-jdk15-openjdk-buster` - linux; arm64 variant v8
