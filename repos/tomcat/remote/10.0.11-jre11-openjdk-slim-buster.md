## `tomcat:10.0.11-jre11-openjdk-slim-buster`
...
### `tomcat:10.0.11-jre11-openjdk-slim-buster` - linux; amd64
...
### `tomcat:10.0.11-jre11-openjdk-slim-buster` - linux; arm64 variant v8
