...
```console
$ docker pull tomcat@sha256:abbd0c1cbdd6deea8f46462fc026cc8bd8730ead080d6d2de0390e5cbd7b96bb
```
...
### `tomcat:10.1.0-M8-jdk17-openjdk-bullseye` - linux; amd64
...
### `tomcat:10.1.0-M8-jdk17-openjdk-bullseye` - linux; arm64 variant v8
