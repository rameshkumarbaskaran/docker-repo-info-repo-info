...
```console
$ docker pull tomcat@sha256:35a00a656bf20b8621b218653b5cb0036b398bcb4908646a6b40d639aee60ad2
```
...
```console
$ docker pull tomcat@sha256:c1b2537d332b22ada0352581019a1e5fbeecabc32ecebc6ca62159612eaaa99a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **342.5 MB (342495208 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:723cb933702de16cdcd91a7cc86c8998b322ba550980cc20f21243e07b3e8134`
-	Default Command: `["catalina.sh","run"]`
