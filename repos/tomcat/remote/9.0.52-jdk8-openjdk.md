...
```console
$ docker pull tomcat@sha256:9ad4d2e46f0d7a2b354bf5d2db1f1bf79738b1f9fd8a63ce2dbb708d797768e3
```
...
### `tomcat:9.0.52-jdk8-openjdk` - linux; amd64
...
### `tomcat:9.0.52-jdk8-openjdk` - linux; arm64 variant v8
