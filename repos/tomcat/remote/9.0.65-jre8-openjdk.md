## `tomcat:9.0.65-jre8-openjdk`

```console
$ docker pull tomcat@sha256:3f6bf667d857dd226edef5e89fbb0a7a9763ab1c6dfe9bb42265d759e39b88b9
```
...
### `tomcat:9.0.65-jre8-openjdk` - linux; amd64
...
### `tomcat:9.0.65-jre8-openjdk` - linux; arm64 variant v8
