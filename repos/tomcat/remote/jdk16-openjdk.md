...
```console
$ docker pull tomcat@sha256:76bace562ec0c96979a4da70a9346d88dd98184b82fcb7186267f6a5554002d5
```
...
### `tomcat:jdk16-openjdk` - linux; amd64
...
### `tomcat:jdk16-openjdk` - linux; arm64 variant v8
