...
```console
$ docker pull tomcat@sha256:7af0e44bbfc821d7b2a13bf3e3572191b1dc777ea0d24ff7b4c135bc1289ef9c
```
...
### `tomcat:9.0.52-jdk8-corretto` - linux; amd64
...
### `tomcat:9.0.52-jdk8-corretto` - linux; arm64 variant v8
