## `tomcat:10.1.0-M10-jre11-openjdk-bullseye`
...
### `tomcat:10.1.0-M10-jre11-openjdk-bullseye` - linux; amd64
...
### `tomcat:10.1.0-M10-jre11-openjdk-bullseye` - linux; arm64 variant v8
