...
```console
$ docker pull tomcat@sha256:ded82296f65ff10cf0ac19de796a004b8a13b615eed555b0d5d8388f0740d475
```
...
### `tomcat:jdk21-openjdk-slim-bookworm` - linux; amd64
...
### `tomcat:jdk21-openjdk-slim-bookworm` - linux; arm64 variant v8
