## `tomcat:10.0.12-jdk8-corretto`

```console
$ docker pull tomcat@sha256:4002828f56353abb0116daf4b4820aa7fa9969d62da63a48313032aa2bd396da
```
...
### `tomcat:10.0.12-jdk8-corretto` - linux; amd64
...
### `tomcat:10.0.12-jdk8-corretto` - linux; arm64 variant v8
