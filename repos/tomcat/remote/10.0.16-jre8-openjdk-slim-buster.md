## `tomcat:10.0.16-jre8-openjdk-slim-buster`
...
### `tomcat:10.0.16-jre8-openjdk-slim-buster` - linux; amd64
...
### `tomcat:10.0.16-jre8-openjdk-slim-buster` - linux; arm64 variant v8
