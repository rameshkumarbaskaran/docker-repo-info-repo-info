...
### `haproxy:2.7.5-bullseye` - linux; arm variant v5
...
### `haproxy:2.7.5-bullseye` - linux; arm variant v7
...
### `haproxy:2.7.5-bullseye` - linux; mips64le
...
### `haproxy:2.7.5-bullseye` - linux; ppc64le
