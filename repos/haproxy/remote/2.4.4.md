...
```console
$ docker pull haproxy@sha256:7508bded99549e15d01e83281d496199150a1387a612efed89a6561ac7f15405
```
...
### `haproxy:2.4.4` - linux; arm variant v5
...
### `haproxy:2.4.4` - linux; arm variant v7
...
### `haproxy:2.4.4` - linux; arm64 variant v8
