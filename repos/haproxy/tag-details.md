...
```console
$ docker pull haproxy@sha256:fb81eea1e651d890e49407b2d5c600b59a3312d50da6e49094cbb03693a7cdb8
```
...
```console
$ docker pull haproxy@sha256:daedc8b8275055d6643e2b09bab66c7e4c5522b2a40484a90d8db92e77085bc5
```
