...
```console
$ docker pull haproxy@sha256:e5ef74e1de5f59ef3350fbdcf3de85eeeca80dbb97135ee3e7ae85d010fc8bd8
```
...
```console
$ docker pull haproxy@sha256:10163029a42617758da1c495685dfd8d820154d8b27957be61b10956d8425557
```
