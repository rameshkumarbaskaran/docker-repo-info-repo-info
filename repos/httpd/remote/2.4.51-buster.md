...
### `httpd:2.4.51-buster` - linux; amd64
...
### `httpd:2.4.51-buster` - linux; arm variant v5
...
### `httpd:2.4.51-buster` - linux; arm variant v7
...
### `httpd:2.4.51-buster` - linux; arm64 variant v8
...
### `httpd:2.4.51-buster` - linux; mips64le
...
### `httpd:2.4.51-buster` - linux; ppc64le
...
### `httpd:2.4.51-buster` - linux; s390x
