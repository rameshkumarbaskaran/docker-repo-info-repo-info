...
```console
$ docker pull httpd@sha256:c42fef1a89b083cc46183c99f7e7012136ae0d3f49db6c28150dac1d3c335cd0
```
...
### `httpd:2.4.57-alpine3.17` - linux; amd64
...
### `httpd:2.4.57-alpine3.17` - linux; arm variant v6
...
### `httpd:2.4.57-alpine3.17` - linux; arm variant v7
...
### `httpd:2.4.57-alpine3.17` - linux; arm64 variant v8
...
### `httpd:2.4.57-alpine3.17` - linux; 386
...
### `httpd:2.4.57-alpine3.17` - linux; ppc64le
...
### `httpd:2.4.57-alpine3.17` - linux; s390x
