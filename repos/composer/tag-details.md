...
```console
$ docker pull composer@sha256:fa6068ccb13894083a46592ba2ec04e3757ca589f47f92ffa3d8aa7ffd4a129a
```
...
```console
$ docker pull composer@sha256:b504a9c534ae427f9879fd6da5ec6157be3963ec6b9af3c600caf6d5a8023174
```
