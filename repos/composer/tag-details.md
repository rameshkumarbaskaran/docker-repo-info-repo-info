...
```console
$ docker pull composer@sha256:fa7ac7377012c44a886216a777bc1d9cc843406358e715eac99d0603b2c94cf1
```
...
```console
$ docker pull composer@sha256:feeba183e0e1c0c07a3426cea4e0479c437fc9b064f3f056ec525f5650041903
```
...
```console
$ docker pull composer@sha256:228a5a989a744b9dd76d694459d3cc0cf88b02cb645be651d5df2cb81fa2fd68
```
