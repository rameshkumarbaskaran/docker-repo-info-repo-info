...
```console
$ docker pull composer@sha256:dd92d8ad36714a3339b52445166219ac044d7dc9c7a13ecf1bfbd21e6db4fcfc
```
...
```console
$ docker pull composer@sha256:8243c6a5aec2dc7163c6ad7a8a83b7e3e30f54ba748dfdf0159d3ec48fcff2bf
```
