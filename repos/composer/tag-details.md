...
```console
$ docker pull composer@sha256:f805ef7b33d0ffa9dfe5276c7cb93193e11053082918d7d660320b81ee98d1a5
```
...
```console
$ docker pull composer@sha256:6c6333f08668feeb1c2bc0adb6026b8242faa604384347c932c2137b6e193eec
```
