...
```console
$ docker pull composer@sha256:9e987509ad8a63b3875a0f905142f90e00b8894a4c601da93538e080ba4b5bea
```
...
### `composer:2.0.10` - linux; amd64

```console
$ docker pull composer@sha256:80db084da601a37a62c3399b8c0e4f3194c252bbf5b20ca050b84681b256fbd2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **62.1 MB (62055508 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bb8e07905df40e5e4fdbf780857cdaf3471dd774383830af0f6f5f76ae289b05`
...
# Wed, 24 Feb 2021 18:19:41 GMT
ENV COMPOSER_VERSION=2.0.10
# Wed, 24 Feb 2021 18:19:43 GMT
...
-	Layers:
	...
	-	`sha256:7c09b8345bc22b39e07a81d44d0655fcbf5f6849f4f85e9ad1b8c0eb69467f79`  
		...
		Size: 258.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2660706fbf938c3d2e2038af0d1befad6e460d239cfdd70ae17d2aa9a4691c48`  
		Last Modified: Wed, 24 Feb 2021 18:20:08 GMT  
		Size: 554.1 KB (554052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:deb011d226c7f2f88b9e701dff0aba26a5d7f7b7add2326cc086938e6d6d3502`  
		Last Modified: Wed, 24 Feb 2021 18:20:08 GMT  
		Size: 406.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54b7be2e3044b4cdaac6a04db270c16defd4ef75d3cb6c9452c0e5c09d3337ed`  
		Last Modified: Wed, 24 Feb 2021 18:20:08 GMT  
		Size: 92.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `composer:2.0.10` - linux; arm64 variant v8

```console
$ docker pull composer@sha256:1c1d2fc170da7cbb2f692d1ba7c3f231cf4dfa2d6f179928b207a4309ea1dc50
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **61.6 MB (61589775 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0d96e79c4686701231bddc63e195282dc28a1170d090bd3da7fd86d44bc94883`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["composer"]`
...
ENV COMPOSER_HOME=/tmp
# Wed, 24 Feb 2021 19:08:22 GMT
ENV COMPOSER_VERSION=2.0.10
# Wed, 24 Feb 2021 19:08:47 GMT
RUN set -eux;   curl     --silent     --fail     --location     --retry 3     --output /tmp/keys.dev.pub     --url https://raw.githubusercontent.com/composer/composer.github.io/e7f28b7200249f8e5bc912b42837d4598c74153a/snapshots.pub   ;   php -r "     \$signature = '4ac45767e5ec22652f0c1167cbbb8a2b0c708369153e328cad90147dafe50952';     \$hash = hash('sha256', preg_replace('{\s}', '', file_get_contents('/tmp/keys.dev.pub')));     if (!hash_equals(\$signature, \$hash)) {       echo 'Integrity check failed, dev public key is either corrupt or worse.' . PHP_EOL;       exit(1);     }"   ;   curl     --silent     --fail     --location     --retry 3     --output /tmp/keys.tags.pub     --url https://raw.githubusercontent.com/composer/composer.github.io/e7f28b7200249f8e5bc912b42837d4598c74153a/releases.pub   ;   php -r "     \$signature = '57815ba27e54dc317ecc7cc5573090d087719ba68f3bb7234e5d42d084a14642';     \$hash = hash('sha256', preg_replace('{\s}', '', file_get_contents('/tmp/keys.tags.pub')));     if (!hash_equals(\$signature, \$hash)) {       echo 'Integrity check failed, tags public key is either corrupt or worse.' . PHP_EOL;       exit(1);     }"   ;   curl     --silent     --fail     --location     --retry 3     --output /tmp/installer.php     --url https://raw.githubusercontent.com/composer/getcomposer.org/cb19f2aa3aeaa2006c0cd69a7ef011eb31463067/web/installer   ;   php -r "     \$signature = '48e3236262b34d30969dca3c37281b3b4bbe3221bda826ac6a9a62d6444cdb0dcd0615698a5cbe587c3f0fe57a54d8f5';     \$hash = hash('sha384', file_get_contents('/tmp/installer.php'));     if (!hash_equals(\$signature, \$hash)) {       echo 'Integrity check failed, installer is either corrupt or worse.' . PHP_EOL;       exit(1);     }"   ;   php /tmp/installer.php --no-ansi --install-dir=/usr/bin --filename=composer --version=${COMPOSER_VERSION};   composer --ansi --version --no-interaction;   composer diagnose;   rm -f /tmp/installer.php;   find /tmp -type d -exec chmod -v 1777 {} +
...
-	Layers:
	...
	-	`sha256:9c2f17854b3847029975d1e8e1a417c689e7cc9de4a05e2ab3848c82044a0e8d`  
		...
		Size: 258.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:928ad38e4df30cdb072314fa52928bb7c6a8b5835a431064f6ba1db389967d27`  
		Last Modified: Wed, 24 Feb 2021 19:09:29 GMT  
		Size: 554.1 KB (554101 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b48b15dfdb56a969adbfa7d8d6d0b77c62f945a8bed61c83e7ce827f4c87abb5`  
		Last Modified: Wed, 24 Feb 2021 19:09:30 GMT  
		Size: 408.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0beef3aab2e6cd9c70b3f6956e34b93b261687893e76889c18ca34c46ba1e7b`  
		Last Modified: Wed, 24 Feb 2021 19:09:29 GMT  
		Size: 124.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `composer:2.0.10` - linux; 386

```console
$ docker pull composer@sha256:7ae992aacff124633cb120ca030155793fb6be4376ac5ebeaf96142de8f9a0f1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **63.3 MB (63338034 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b891a3a0ac4fd5a429b34ea6496ef51065b9534af733d2710706c37b010d844f`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["composer"]`
...
ENV COMPOSER_HOME=/tmp
# Wed, 24 Feb 2021 18:38:31 GMT
ENV COMPOSER_VERSION=2.0.10
# Wed, 24 Feb 2021 18:38:33 GMT
RUN set -eux;   curl     --silent     --fail     --location     --retry 3     --output /tmp/keys.dev.pub     --url https://raw.githubusercontent.com/composer/composer.github.io/e7f28b7200249f8e5bc912b42837d4598c74153a/snapshots.pub   ;   php -r "     \$signature = '4ac45767e5ec22652f0c1167cbbb8a2b0c708369153e328cad90147dafe50952';     \$hash = hash('sha256', preg_replace('{\s}', '', file_get_contents('/tmp/keys.dev.pub')));     if (!hash_equals(\$signature, \$hash)) {       echo 'Integrity check failed, dev public key is either corrupt or worse.' . PHP_EOL;       exit(1);     }"   ;   curl     --silent     --fail     --location     --retry 3     --output /tmp/keys.tags.pub     --url https://raw.githubusercontent.com/composer/composer.github.io/e7f28b7200249f8e5bc912b42837d4598c74153a/releases.pub   ;   php -r "     \$signature = '57815ba27e54dc317ecc7cc5573090d087719ba68f3bb7234e5d42d084a14642';     \$hash = hash('sha256', preg_replace('{\s}', '', file_get_contents('/tmp/keys.tags.pub')));     if (!hash_equals(\$signature, \$hash)) {       echo 'Integrity check failed, tags public key is either corrupt or worse.' . PHP_EOL;       exit(1);     }"   ;   curl     --silent     --fail     --location     --retry 3     --output /tmp/installer.php     --url https://raw.githubusercontent.com/composer/getcomposer.org/cb19f2aa3aeaa2006c0cd69a7ef011eb31463067/web/installer   ;   php -r "     \$signature = '48e3236262b34d30969dca3c37281b3b4bbe3221bda826ac6a9a62d6444cdb0dcd0615698a5cbe587c3f0fe57a54d8f5';     \$hash = hash('sha384', file_get_contents('/tmp/installer.php'));     if (!hash_equals(\$signature, \$hash)) {       echo 'Integrity check failed, installer is either corrupt or worse.' . PHP_EOL;       exit(1);     }"   ;   php /tmp/installer.php --no-ansi --install-dir=/usr/bin --filename=composer --version=${COMPOSER_VERSION};   composer --ansi --version --no-interaction;   composer diagnose;   rm -f /tmp/installer.php;   find /tmp -type d -exec chmod -v 1777 {} +
# Wed, 24 Feb 2021 18:38:33 GMT
COPY file:fec7a37c0f859c3b5da390e40fa6f3ea8445ed26f54be61f4bce40efcaad57ee in /docker-entrypoint.sh 
# Wed, 24 Feb 2021 18:38:33 GMT
...
-	Layers:
	...
	-	`sha256:53bc5a717cec510d1ce521e3161d54ad9a913bdffccdb152e9a3dd5cf354312d`  
		...
		Size: 256.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a99f752a9e980e2a0c89d45e1fbdaf91d5984566ed55f51b5f0486759314595`  
		Last Modified: Wed, 24 Feb 2021 18:38:54 GMT  
		Size: 554.1 KB (554054 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff1d2cdce3e9ad793ffdb49ad906423ac5d133e2fe13efa0845ea71eca75aa62`  
		Last Modified: Wed, 24 Feb 2021 18:38:54 GMT  
		Size: 408.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e0d3f845ff2256988be1246867ac299b75298ba71a54165caf071d16980e55d`  
		Last Modified: Wed, 24 Feb 2021 18:38:54 GMT  
		Size: 92.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `composer:2.0.10` - linux; ppc64le

```console
$ docker pull composer@sha256:187f0f9d651db21f1758d94bc11564f4c874289aed8b75a8706556e31300ebf9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **63.7 MB (63671368 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dcab2c78c6404eb7f0ae630c5679473107e48618f6c84977cef2803714d0a4e6`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["composer"]`
...
ENV COMPOSER_HOME=/tmp
# Wed, 24 Feb 2021 18:19:08 GMT
ENV COMPOSER_VERSION=2.0.10
# Wed, 24 Feb 2021 18:19:31 GMT
RUN set -eux;   curl     --silent     --fail     --location     --retry 3     --output /tmp/keys.dev.pub     --url https://raw.githubusercontent.com/composer/composer.github.io/e7f28b7200249f8e5bc912b42837d4598c74153a/snapshots.pub   ;   php -r "     \$signature = '4ac45767e5ec22652f0c1167cbbb8a2b0c708369153e328cad90147dafe50952';     \$hash = hash('sha256', preg_replace('{\s}', '', file_get_contents('/tmp/keys.dev.pub')));     if (!hash_equals(\$signature, \$hash)) {       echo 'Integrity check failed, dev public key is either corrupt or worse.' . PHP_EOL;       exit(1);     }"   ;   curl     --silent     --fail     --location     --retry 3     --output /tmp/keys.tags.pub     --url https://raw.githubusercontent.com/composer/composer.github.io/e7f28b7200249f8e5bc912b42837d4598c74153a/releases.pub   ;   php -r "     \$signature = '57815ba27e54dc317ecc7cc5573090d087719ba68f3bb7234e5d42d084a14642';     \$hash = hash('sha256', preg_replace('{\s}', '', file_get_contents('/tmp/keys.tags.pub')));     if (!hash_equals(\$signature, \$hash)) {       echo 'Integrity check failed, tags public key is either corrupt or worse.' . PHP_EOL;       exit(1);     }"   ;   curl     --silent     --fail     --location     --retry 3     --output /tmp/installer.php     --url https://raw.githubusercontent.com/composer/getcomposer.org/cb19f2aa3aeaa2006c0cd69a7ef011eb31463067/web/installer   ;   php -r "     \$signature = '48e3236262b34d30969dca3c37281b3b4bbe3221bda826ac6a9a62d6444cdb0dcd0615698a5cbe587c3f0fe57a54d8f5';     \$hash = hash('sha384', file_get_contents('/tmp/installer.php'));     if (!hash_equals(\$signature, \$hash)) {       echo 'Integrity check failed, installer is either corrupt or worse.' . PHP_EOL;       exit(1);     }"   ;   php /tmp/installer.php --no-ansi --install-dir=/usr/bin --filename=composer --version=${COMPOSER_VERSION};   composer --ansi --version --no-interaction;   composer diagnose;   rm -f /tmp/installer.php;   find /tmp -type d -exec chmod -v 1777 {} +
# Wed, 24 Feb 2021 18:19:32 GMT
COPY file:fec7a37c0f859c3b5da390e40fa6f3ea8445ed26f54be61f4bce40efcaad57ee in /docker-entrypoint.sh 
# Wed, 24 Feb 2021 18:19:36 GMT
WORKDIR /app
# Wed, 24 Feb 2021 18:19:40 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Wed, 24 Feb 2021 18:19:44 GMT
CMD ["composer"]
```
...
-	Layers:
	...
	-	`sha256:975fbdbabff31bbbc1fb3302300c67f8a133db8797efea6b8ecefed1ad78ec02`  
		...
		Size: 257.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b5bd67f37ba0cd6a03c2442737012884e3c06c71706efdb91fe263cdaec0590`  
		Last Modified: Wed, 24 Feb 2021 18:20:28 GMT  
		Size: 554.1 KB (554106 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb971acd1287bb3080f4adc705b047b16503993eac3a5b7a866147a089cbdf45`  
		Last Modified: Wed, 24 Feb 2021 18:20:27 GMT  
		Size: 408.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9a0ad10e0afff063ea86aa4c6f42662edb0223e3a4d5ac7a2328beb7965e898`  
		Last Modified: Wed, 24 Feb 2021 18:20:27 GMT  
		Size: 126.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `composer:2.0.10` - linux; s390x
