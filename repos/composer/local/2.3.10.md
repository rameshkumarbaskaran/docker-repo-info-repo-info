...
- Image ID: `sha256:e9769c746a3d5d9228a64e2d6a3f88e13d845957a3db59198168f0e1c2900bda`
- Created: `2022-12-22T18:22:28.0875583Z`
- Virtual Size: ~ 193.53 Mb  
...
```console
coreutils-9.1-r0 description:
The basic file, shell and text manipulation utilities

coreutils-9.1-r0 webpage:
https://www.gnu.org/software/coreutils/

coreutils-9.1-r0 installed size:
1184 KiB

coreutils-9.1-r0 license:
GPL-3.0-or-later
...
```console
p7zip-17.04-r3 description:
Command-line port of the 7zip compression utility

p7zip-17.04-r3 webpage:
https://github.com/jinfeihan57/p7zip

p7zip-17.04-r3 installed size:
10 MiB

p7zip-17.04-r3 license:
LGPL-2.0-or-later
...
```console
patch-2.7.6-r8 description:
Utility to apply diffs to files

patch-2.7.6-r8 webpage:
https://www.gnu.org/software/patch/patch.html

patch-2.7.6-r8 installed size:
172 KiB

patch-2.7.6-r8 license:
GPL-3.0-or-later
...
```console
skalibs-2.12.0.1-r0 description:
Set of general-purpose C programming libraries for skarnet.org software.

skalibs-2.12.0.1-r0 webpage:
https://skarnet.org/software/skalibs/

skalibs-2.12.0.1-r0 installed size:
192 KiB

skalibs-2.12.0.1-r0 license:
ISC
...
```console
unzip-6.0-r13 description:
Extract PKZIP-compatible .zip files

unzip-6.0-r13 webpage:
http://www.info-zip.org/UnZip.html

unzip-6.0-r13 installed size:
320 KiB

unzip-6.0-r13 license:
custom
...
```console
utmps-libs-0.1.2.0-r1 description:
A secure utmp/wtmp implementation (libraries)

utmps-libs-0.1.2.0-r1 webpage:
https://skarnet.org/software/utmps/

utmps-libs-0.1.2.0-r1 installed size:
24 KiB

utmps-libs-0.1.2.0-r1 license:
ISC
