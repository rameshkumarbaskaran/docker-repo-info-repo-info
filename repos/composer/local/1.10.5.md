...
- Created: `2020-04-14T19:20:58.067028052Z`
...
```console
mercurial-5.3.1-r0 description:
Scalable distributed SCM tool

mercurial-5.3.1-r0 webpage:
https://www.mercurial-scm.org

mercurial-5.3.1-r0 installed size:
16756736

mercurial-5.3.1-r0 license:
GPL-2.0-or-later
