...
```console
$ docker pull registry@sha256:c934747f3a63b712a31d38e2a98d2eb1929ca97077a35d3315472c58544f588f
```
...
### `registry:2.8.0-beta.1` - linux; arm variant v7

```console
$ docker pull registry@sha256:80fd05c45b6024cb43fb1b7203520a25a74b7727fc9c51132d9e61a7df822370
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **8.4 MB (8377551 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1eced26d91978f7d1a94efaac9d5d70a7ecd2323388ddd5fbd01df1a422bebaa`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["\/etc\/docker\/registry\/config.yml"]`
...
RUN apk add --no-cache ca-certificates
# Tue, 25 Jan 2022 01:09:56 GMT
RUN set -eux; 	version='2.8.0-beta.1'; 	apkArch="$(apk --print-arch)"; 	case "$apkArch" in 		x86_64)  arch='amd64';   sha256='d69d68406a30466070d8e47c21fafaadae5c048239df41b50b28a79fa12945ab' ;; 		aarch64) arch='arm64';   sha256='2a080694ae2528a628245cf5177d4d2e55d430c5dd76cbbf61e5aee08e75abf6' ;; 		armhf)   arch='armv6';   sha256='b5092556fd196f59c7d2a8d4e4460c193588d9f7f39d825d17f299d7fc856ca1' ;; 		armv7)   arch='armv7';   sha256='f479d7d42a4c6086ee9a51f605386fcfb953198bf9ab48c515ffdde33ad46e5d' ;; 		ppc64le) arch='ppc64le'; sha256='dc0444e672511b4f8dc19fcec1624a33fdaf49a72ff3c1a69bae9bd3399cd074' ;; 		s390x)   arch='s390x';   sha256='4b814d1cb60ee7881e59c1ee52635755c2279196861892cface92e58aa6ac749' ;; 		*) echo >&2 "error: unsupported architecture: $apkArch"; exit 1 ;; 	esac; 	wget -O registry.tar.gz "https://github.com/distribution/distribution/releases/download/v${version}/registry_${version}_linux_${arch}.tar.gz"; 	echo "$sha256 *registry.tar.gz" | sha256sum -c -; 	tar --extract --verbose --file registry.tar.gz --directory /bin/ registry; 	rm registry.tar.gz; 	registry --version
# Tue, 25 Jan 2022 01:09:57 GMT
COPY file:4544cc1555469403b322faecc1cf1ca584667c43a6a60b17300f97840c04196e in /etc/docker/registry/config.yml 
# Tue, 25 Jan 2022 01:09:58 GMT
VOLUME [/var/lib/registry]
# Tue, 25 Jan 2022 01:09:58 GMT
EXPOSE 5000
# Tue, 25 Jan 2022 01:09:59 GMT
COPY file:507caa54f88c1f3862e5876e09a108b2083630ba24c57ad124e356a2de861d62 in /entrypoint.sh 
# Tue, 25 Jan 2022 01:09:59 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 25 Jan 2022 01:09:59 GMT
...
-	Layers:
	...
	-	`sha256:94f21e2af73375430a6481f93a61f3df4f9de38c985f83b27293f8aace16d6b5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:590270409c3417e3ab71ce59267e58019d58b60d8ac8cb62cfbab9c0e45970eb`  
		Last Modified: Tue, 25 Jan 2022 01:10:20 GMT  
		Size: 5.7 MB (5660926 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f5629af284fa2e783be47d11d123622e1f2a0e030e21a7e6462dc799a085656`  
		Last Modified: Tue, 25 Jan 2022 01:10:16 GMT  
		Size: 399.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51a8c7058a27dadca0719b92582ff9087bd1e592d62af2ec1564455e3c71a98f`  
		Last Modified: Tue, 25 Jan 2022 01:10:16 GMT  
		Size: 214.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `registry:2.8.0-beta.1` - linux; ppc64le

```console
$ docker pull registry@sha256:c8c46d96569f2025f74511b018fd846eb4eabf7c615f6c211015c0fc0f3bc323
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **8.4 MB (8409415 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0bca9cb18fffd0d206095755311681a67b7d71b5fa8368139024687b33e5ec55`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["\/etc\/docker\/registry\/config.yml"]`
...
RUN apk add --no-cache ca-certificates
# Tue, 25 Jan 2022 01:17:04 GMT
RUN set -eux; 	version='2.8.0-beta.1'; 	apkArch="$(apk --print-arch)"; 	case "$apkArch" in 		x86_64)  arch='amd64';   sha256='d69d68406a30466070d8e47c21fafaadae5c048239df41b50b28a79fa12945ab' ;; 		aarch64) arch='arm64';   sha256='2a080694ae2528a628245cf5177d4d2e55d430c5dd76cbbf61e5aee08e75abf6' ;; 		armhf)   arch='armv6';   sha256='b5092556fd196f59c7d2a8d4e4460c193588d9f7f39d825d17f299d7fc856ca1' ;; 		armv7)   arch='armv7';   sha256='f479d7d42a4c6086ee9a51f605386fcfb953198bf9ab48c515ffdde33ad46e5d' ;; 		ppc64le) arch='ppc64le'; sha256='dc0444e672511b4f8dc19fcec1624a33fdaf49a72ff3c1a69bae9bd3399cd074' ;; 		s390x)   arch='s390x';   sha256='4b814d1cb60ee7881e59c1ee52635755c2279196861892cface92e58aa6ac749' ;; 		*) echo >&2 "error: unsupported architecture: $apkArch"; exit 1 ;; 	esac; 	wget -O registry.tar.gz "https://github.com/distribution/distribution/releases/download/v${version}/registry_${version}_linux_${arch}.tar.gz"; 	echo "$sha256 *registry.tar.gz" | sha256sum -c -; 	tar --extract --verbose --file registry.tar.gz --directory /bin/ registry; 	rm registry.tar.gz; 	registry --version
# Tue, 25 Jan 2022 01:17:08 GMT
COPY file:4544cc1555469403b322faecc1cf1ca584667c43a6a60b17300f97840c04196e in /etc/docker/registry/config.yml 
# Tue, 25 Jan 2022 01:17:11 GMT
VOLUME [/var/lib/registry]
# Tue, 25 Jan 2022 01:17:13 GMT
EXPOSE 5000
# Tue, 25 Jan 2022 01:17:15 GMT
COPY file:507caa54f88c1f3862e5876e09a108b2083630ba24c57ad124e356a2de861d62 in /entrypoint.sh 
# Tue, 25 Jan 2022 01:17:17 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 25 Jan 2022 01:17:19 GMT
CMD ["/etc/docker/registry/config.yml"]
```
...
-	Layers:
	...
	-	`sha256:28be42a6852cc2108ddba1e4252671ae20275780a6ff73b1038699f59da2ac20`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96a64ef98ba5f028a056e652b11ed317658804f6087b5146757754ecd0234825`  
		Last Modified: Tue, 25 Jan 2022 01:17:34 GMT  
		Size: 5.3 MB (5310000 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83b17bb56531c9a7c9626aefbb1a246cf7ecfe3c0d632599a948e81285d21dbc`  
		Last Modified: Tue, 25 Jan 2022 01:17:33 GMT  
		Size: 401.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1143e17d10a6ff9959342cfa97712fba3f1c667eab461d101c184e847be604f`  
		Last Modified: Tue, 25 Jan 2022 01:17:32 GMT  
		Size: 214.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `registry:2.8.0-beta.1` - linux; s390x

```console
$ docker pull registry@sha256:6a35fddd5e71bc5d0322c7a897673f23b6d05c8e71a5bf546fba7a5ec9eebdc8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **8.7 MB (8698162 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8cead32ae36ba0fc35ab51833a048c9f25232bc4919d916a9ff87f8064321318`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["\/etc\/docker\/registry\/config.yml"]`
...
-	Layers:
	...
	-	`sha256:66787da5af638f8523e4694d81d38c2ca7c0a262f4cb8d78c46f7d64833bbaa0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30f8402395dcf998243d1a4e343a255536a687cbed9c412f76459b47aebe9089`  
		Last Modified: Tue, 25 Jan 2022 01:42:31 GMT  
		Size: 5.8 MB (5809227 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0149c5a3c0beb8c8bdb2387138932a85fe418ce32299446286e8d8e8f56908f3`  
		Last Modified: Tue, 25 Jan 2022 01:42:30 GMT  
		Size: 399.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7401254e54a4436bcc0cf222546ef1464ef5b60bce0d5b65f95c3e228f8289f7`  
		Last Modified: Tue, 25 Jan 2022 01:42:30 GMT  
		Size: 214.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
