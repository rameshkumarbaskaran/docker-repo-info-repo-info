...
```console
$ docker pull mono@sha256:c67a5c7612a4dbaf8d86836129627bf874a71aa904bcc8309bce191950375a5d
```
...
```console
$ docker pull mono@sha256:a4ea8cb14e4352744f62922be0fc13dcca9e74a6ce3094fb4245eb173fd6a8e3
```
