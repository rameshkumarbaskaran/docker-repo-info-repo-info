...
### `joomla:3.9.21-fpm-alpine` - linux; arm variant v6
...
### `joomla:3.9.21-fpm-alpine` - linux; arm variant v7
...
### `joomla:3.9.21-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:3.9.21-fpm-alpine` - linux; 386
...
### `joomla:3.9.21-fpm-alpine` - linux; s390x
