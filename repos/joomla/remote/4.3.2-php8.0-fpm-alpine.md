...
```console
$ docker pull joomla@sha256:a64c7860d308bdac3fd46665ae69b39f7016c419680c6979a395e972deffe715
```
...
### `joomla:4.3.2-php8.0-fpm-alpine` - linux; amd64
...
### `joomla:4.3.2-php8.0-fpm-alpine` - linux; arm variant v6
...
### `joomla:4.3.2-php8.0-fpm-alpine` - linux; arm variant v7
...
### `joomla:4.3.2-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:4.3.2-php8.0-fpm-alpine` - linux; 386
...
### `joomla:4.3.2-php8.0-fpm-alpine` - linux; ppc64le
...
### `joomla:4.3.2-php8.0-fpm-alpine` - linux; s390x
