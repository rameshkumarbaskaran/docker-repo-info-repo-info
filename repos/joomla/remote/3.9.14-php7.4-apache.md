...
```console
$ docker pull joomla@sha256:10d8e22f9fed00cace4811b3f897cceddf8a41e24b52059028c5e1b09b620a22
```
...
### `joomla:3.9.14-php7.4-apache` - linux; amd64
...
### `joomla:3.9.14-php7.4-apache` - linux; arm variant v5
...
### `joomla:3.9.14-php7.4-apache` - linux; arm variant v7
...
### `joomla:3.9.14-php7.4-apache` - linux; arm64 variant v8
...
### `joomla:3.9.14-php7.4-apache` - linux; 386
...
### `joomla:3.9.14-php7.4-apache` - linux; ppc64le
