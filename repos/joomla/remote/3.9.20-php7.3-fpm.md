...
```console
$ docker pull joomla@sha256:317b70b1c072376cc7f567c20efc5dd6437bfa360e90fff4194b3dfdc20d0b53
```
...
### `joomla:3.9.20-php7.3-fpm` - linux; amd64
...
### `joomla:3.9.20-php7.3-fpm` - linux; arm variant v5
...
### `joomla:3.9.20-php7.3-fpm` - linux; arm variant v7
...
### `joomla:3.9.20-php7.3-fpm` - linux; arm64 variant v8
...
### `joomla:3.9.20-php7.3-fpm` - linux; mips64le
...
### `joomla:3.9.20-php7.3-fpm` - linux; ppc64le
