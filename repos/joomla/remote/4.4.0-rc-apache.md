## `joomla:4.4.0-rc-apache`

```console
$ docker pull joomla@sha256:f82c7830abaac8e03e2b7c962d2cf30aa6204dcd2ac884d67acaf6f49589d9a2
```
...
### `joomla:4.4.0-rc-apache` - linux; amd64
...
### `joomla:4.4.0-rc-apache` - linux; arm variant v5
...
### `joomla:4.4.0-rc-apache` - linux; arm variant v7
...
### `joomla:4.4.0-rc-apache` - linux; arm64 variant v8
...
### `joomla:4.4.0-rc-apache` - linux; 386
...
### `joomla:4.4.0-rc-apache` - linux; mips64le
...
### `joomla:4.4.0-rc-apache` - linux; ppc64le
...
### `joomla:4.4.0-rc-apache` - linux; s390x
