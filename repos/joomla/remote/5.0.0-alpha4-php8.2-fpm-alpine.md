...
```console
$ docker pull joomla@sha256:c5e8f2168b7e767ac04ba153677edac997ffab9ce385f678f9fae4cd18a1d872
```
...
### `joomla:5.0.0-alpha4-php8.2-fpm-alpine` - linux; amd64
...
### `joomla:5.0.0-alpha4-php8.2-fpm-alpine` - linux; arm variant v6
...
### `joomla:5.0.0-alpha4-php8.2-fpm-alpine` - linux; arm variant v7
...
### `joomla:5.0.0-alpha4-php8.2-fpm-alpine` - linux; 386
...
### `joomla:5.0.0-alpha4-php8.2-fpm-alpine` - linux; ppc64le
...
### `joomla:5.0.0-alpha4-php8.2-fpm-alpine` - linux; s390x
