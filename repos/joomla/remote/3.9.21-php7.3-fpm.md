...
```console
$ docker pull joomla@sha256:2e8bb314a930461972e1c3fe9e87c18114464d348332b014f70244f49d8b4a7e
```
...
### `joomla:3.9.21-php7.3-fpm` - linux; arm variant v5
...
### `joomla:3.9.21-php7.3-fpm` - linux; arm variant v7
...
### `joomla:3.9.21-php7.3-fpm` - linux; arm64 variant v8
...
### `joomla:3.9.21-php7.3-fpm` - linux; mips64le
...
### `joomla:3.9.21-php7.3-fpm` - linux; s390x
