...
### `joomla:5.0.0-alpha-apache` - linux; amd64
...
### `joomla:5.0.0-alpha-apache` - linux; arm variant v5
...
### `joomla:5.0.0-alpha-apache` - linux; arm variant v7
...
### `joomla:5.0.0-alpha-apache` - linux; arm64 variant v8
...
### `joomla:5.0.0-alpha-apache` - linux; 386
...
### `joomla:5.0.0-alpha-apache` - linux; mips64le
...
### `joomla:5.0.0-alpha-apache` - linux; ppc64le
...
### `joomla:5.0.0-alpha-apache` - linux; s390x
