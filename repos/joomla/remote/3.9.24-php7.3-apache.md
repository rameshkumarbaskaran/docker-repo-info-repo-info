...
```console
$ docker pull joomla@sha256:fa15bb62a471ce263854e92b0ba61bb450c9e0236332f4dc9906606661b1711e
```
...
### `joomla:3.9.24-php7.3-apache` - linux; amd64
...
### `joomla:3.9.24-php7.3-apache` - linux; arm variant v5
...
### `joomla:3.9.24-php7.3-apache` - linux; arm variant v7
...
### `joomla:3.9.24-php7.3-apache` - linux; arm64 variant v8
...
### `joomla:3.9.24-php7.3-apache` - linux; mips64le
...
### `joomla:3.9.24-php7.3-apache` - linux; ppc64le
...
### `joomla:3.9.24-php7.3-apache` - linux; s390x
