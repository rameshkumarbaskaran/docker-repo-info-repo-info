...
```console
$ docker pull joomla@sha256:5a8d5a79421651b5bf75f3e8486dca1abe4d0b79b74869473ca408219e12f502
```
...
### `joomla:4.3.2-php8.2-fpm` - linux; amd64
...
### `joomla:4.3.2-php8.2-fpm` - linux; arm variant v5
...
### `joomla:4.3.2-php8.2-fpm` - linux; arm variant v7
...
### `joomla:4.3.2-php8.2-fpm` - linux; arm64 variant v8
...
### `joomla:4.3.2-php8.2-fpm` - linux; 386
...
### `joomla:4.3.2-php8.2-fpm` - linux; mips64le
...
### `joomla:4.3.2-php8.2-fpm` - linux; ppc64le
...
### `joomla:4.3.2-php8.2-fpm` - linux; s390x
