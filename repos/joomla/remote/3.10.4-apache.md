...
```console
$ docker pull joomla@sha256:c994f48d8c7115520955712a6b42a744d51650f46d899c59ceb03d02711e394f
```
...
### `joomla:3.10.4-apache` - linux; amd64
...
### `joomla:3.10.4-apache` - linux; arm variant v5
...
### `joomla:3.10.4-apache` - linux; arm64 variant v8
...
### `joomla:3.10.4-apache` - linux; 386
...
### `joomla:3.10.4-apache` - linux; mips64le
...
### `joomla:3.10.4-apache` - linux; s390x
