...
### `joomla:4.1.2-php7.4-fpm-alpine` - linux; amd64
...
### `joomla:4.1.2-php7.4-fpm-alpine` - linux; arm variant v6
...
### `joomla:4.1.2-php7.4-fpm-alpine` - linux; arm variant v7
...
### `joomla:4.1.2-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:4.1.2-php7.4-fpm-alpine` - linux; 386
...
### `joomla:4.1.2-php7.4-fpm-alpine` - linux; ppc64le
...
### `joomla:4.1.2-php7.4-fpm-alpine` - linux; s390x
