...
```console
$ docker pull joomla@sha256:0adc0e9b0551c4b0f91678c85724b21fbbbd30cad81fc819af49590f77fb250f
```
...
### `joomla:4.4.0-alpha4-php8.0-apache` - linux; amd64
...
### `joomla:4.4.0-alpha4-php8.0-apache` - linux; arm variant v5
...
### `joomla:4.4.0-alpha4-php8.0-apache` - linux; arm variant v7
...
### `joomla:4.4.0-alpha4-php8.0-apache` - linux; 386
...
### `joomla:4.4.0-alpha4-php8.0-apache` - linux; ppc64le
...
### `joomla:4.4.0-alpha4-php8.0-apache` - linux; s390x
