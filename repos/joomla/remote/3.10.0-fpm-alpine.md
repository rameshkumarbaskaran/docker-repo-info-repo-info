...
```console
$ docker pull joomla@sha256:1ccc2f705805ecf8fd71dd83b76f10835c50b3cd1dec6b6e3b3eacd9672a2f9e
```
...
### `joomla:3.10.0-fpm-alpine` - linux; amd64
...
### `joomla:3.10.0-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:3.10.0-fpm-alpine` - linux; 386
...
### `joomla:3.10.0-fpm-alpine` - linux; s390x
