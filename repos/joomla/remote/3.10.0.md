...
```console
$ docker pull joomla@sha256:4795afadcef077fe485943078f62bc237707c93480134aa0c4241f09792c7104
```
...
### `joomla:3.10.0` - linux; arm variant v5
...
### `joomla:3.10.0` - linux; arm64 variant v8
