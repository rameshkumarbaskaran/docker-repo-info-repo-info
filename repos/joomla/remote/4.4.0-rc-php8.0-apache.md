## `joomla:4.4.0-rc-php8.0-apache`

```console
$ docker pull joomla@sha256:3657ae272c1213635f27e6243d7fa98d701eb3eb192bf255bf5df6670083e7c5
```
...
### `joomla:4.4.0-rc-php8.0-apache` - linux; amd64
...
### `joomla:4.4.0-rc-php8.0-apache` - linux; arm variant v5
...
### `joomla:4.4.0-rc-php8.0-apache` - linux; arm variant v7
...
### `joomla:4.4.0-rc-php8.0-apache` - linux; arm64 variant v8
...
### `joomla:4.4.0-rc-php8.0-apache` - linux; 386
...
### `joomla:4.4.0-rc-php8.0-apache` - linux; mips64le
...
### `joomla:4.4.0-rc-php8.0-apache` - linux; ppc64le
...
### `joomla:4.4.0-rc-php8.0-apache` - linux; s390x
