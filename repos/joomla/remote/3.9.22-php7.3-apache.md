...
```console
$ docker pull joomla@sha256:c69a1a64d83792572de373917be1c02a7267e34696184ba33ec4008a65080cc5
```
...
### `joomla:3.9.22-php7.3-apache` - linux; amd64
...
### `joomla:3.9.22-php7.3-apache` - linux; arm variant v5
...
### `joomla:3.9.22-php7.3-apache` - linux; arm variant v7
...
### `joomla:3.9.22-php7.3-apache` - linux; arm64 variant v8
...
### `joomla:3.9.22-php7.3-apache` - linux; mips64le
...
### `joomla:3.9.22-php7.3-apache` - linux; ppc64le
...
### `joomla:3.9.22-php7.3-apache` - linux; s390x
