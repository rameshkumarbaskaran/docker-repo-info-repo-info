...
```console
$ docker pull joomla@sha256:cab6f17f5573dbfe84ae66dabf16092d5cef6113b612d85ded37d740f1ab544c
```
...
### `joomla:4.4.0-alpha4-php8.2-apache` - linux; arm64 variant v8
...
### `joomla:4.4.0-alpha4-php8.2-apache` - linux; mips64le
