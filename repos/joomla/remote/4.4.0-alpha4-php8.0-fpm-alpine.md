...
```console
$ docker pull joomla@sha256:958bbc75d3271188eef2840aca678aaaccb1b7bc0f957da53e656bd86f7616a4
```
...
### `joomla:4.4.0-alpha4-php8.0-fpm-alpine` - linux; amd64
...
### `joomla:4.4.0-alpha4-php8.0-fpm-alpine` - linux; arm variant v6
...
### `joomla:4.4.0-alpha4-php8.0-fpm-alpine` - linux; arm variant v7
...
### `joomla:4.4.0-alpha4-php8.0-fpm-alpine` - linux; 386
...
### `joomla:4.4.0-alpha4-php8.0-fpm-alpine` - linux; ppc64le
...
### `joomla:4.4.0-alpha4-php8.0-fpm-alpine` - linux; s390x
