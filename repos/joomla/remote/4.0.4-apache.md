...
```console
$ docker pull joomla@sha256:946e6c80f7d49426313e8fb540fc9db37f8f5faf3937e8811c3fe3e8ac55b429
```
...
### `joomla:4.0.4-apache` - linux; amd64
...
### `joomla:4.0.4-apache` - linux; arm variant v5
...
### `joomla:4.0.4-apache` - linux; arm variant v7
...
### `joomla:4.0.4-apache` - linux; arm64 variant v8
...
### `joomla:4.0.4-apache` - linux; mips64le
...
### `joomla:4.0.4-apache` - linux; ppc64le
...
### `joomla:4.0.4-apache` - linux; s390x
