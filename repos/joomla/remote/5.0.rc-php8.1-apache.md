## `joomla:5.0.rc-php8.1-apache`

```console
$ docker pull joomla@sha256:8e60be71a3741db7fab12894b33aad9a9c872fb002fbf281e15abaa8143c2201
```
...
### `joomla:5.0.rc-php8.1-apache` - linux; amd64
...
### `joomla:5.0.rc-php8.1-apache` - linux; arm variant v5
...
### `joomla:5.0.rc-php8.1-apache` - linux; arm variant v7
...
### `joomla:5.0.rc-php8.1-apache` - linux; arm64 variant v8

```console
$ docker pull joomla@sha256:5eef9b516b03b6f2e41c3adbb894160209db16d788eb50c9083dfb26bfd7b9fc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **222.8 MB (222818980 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ca82b47547a82482145ef26adedd399e45b64885b40422d8c7074f6ab392767`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 12 Oct 2023 17:52:23 GMT
VOLUME [/var/www/html]
# Thu, 12 Oct 2023 17:52:24 GMT
ENV JOOMLA_VERSION=5.0.0-rc1
# Thu, 12 Oct 2023 17:52:24 GMT
ENV JOOMLA_SHA512=23dd5e229c36d6e2f94582e515f7c6283e060eeb2ad3781055a409cc5891a2ea386d6a0980954710e6fc841dccfd87b01b75836e907a5b3164cc8daf78e8a252
# Thu, 12 Oct 2023 17:52:29 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/5.0.0-rc/Joomla_5.0.0-rc-Release_Candidate-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 12 Oct 2023 17:52:29 GMT
COPY file:75d4151822bf32487f27c3996faec3e2842350001f3cabdee80506df7825dc96 in /entrypoint.sh 
# Thu, 12 Oct 2023 17:52:29 GMT
...
-	Layers:
	...
	-	`sha256:9a43bb504b424e9e84fd84a554c76dd0279319c156aa770aae1f16d094731f5e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41c5df9ad6fde63889ad35fa6c075b740c7deb01483b312e37ad324bd16f1e2a`  
		Last Modified: Thu, 12 Oct 2023 18:12:11 GMT  
		Size: 22.3 MB (22326875 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8bb1d1b15ae2ef812cb0c430f8c171631b959a0722496b965223e2876cf91649`  
		Last Modified: Thu, 12 Oct 2023 18:12:08 GMT  
		Size: 2.6 KB (2617 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af65fca9a3ae87be909b9bf8a0dc69a43ca367a4731e3d5d13a45d740df4098a`  
		Last Modified: Thu, 12 Oct 2023 18:12:09 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `joomla:5.0.rc-php8.1-apache` - linux; 386
...
### `joomla:5.0.rc-php8.1-apache` - linux; mips64le
...
### `joomla:5.0.rc-php8.1-apache` - linux; ppc64le
...
### `joomla:5.0.rc-php8.1-apache` - linux; s390x
