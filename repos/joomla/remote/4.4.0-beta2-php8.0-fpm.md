...
```console
$ docker pull joomla@sha256:af5079fa8ff79c5512b92a9fdcf27de160c2962dce8850f7a136ccdff866dc4c
```
...
### `joomla:4.4.0-beta2-php8.0-fpm` - linux; amd64
...
### `joomla:4.4.0-beta2-php8.0-fpm` - linux; arm variant v7
...
### `joomla:4.4.0-beta2-php8.0-fpm` - linux; arm64 variant v8
...
### `joomla:4.4.0-beta2-php8.0-fpm` - linux; 386
...
### `joomla:4.4.0-beta2-php8.0-fpm` - linux; ppc64le
