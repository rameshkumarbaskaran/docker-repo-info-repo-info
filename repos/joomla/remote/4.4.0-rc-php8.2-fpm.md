## `joomla:4.4.0-rc-php8.2-fpm`

```console
$ docker pull joomla@sha256:f9407097f087192a4db6ed4da468e81256240efa2326cd4eae89e4a577b5349c
```
...
### `joomla:4.4.0-rc-php8.2-fpm` - linux; amd64
...
### `joomla:4.4.0-rc-php8.2-fpm` - linux; arm variant v5
...
### `joomla:4.4.0-rc-php8.2-fpm` - linux; arm variant v7
...
### `joomla:4.4.0-rc-php8.2-fpm` - linux; arm64 variant v8
...
### `joomla:4.4.0-rc-php8.2-fpm` - linux; 386
...
### `joomla:4.4.0-rc-php8.2-fpm` - linux; mips64le
...
### `joomla:4.4.0-rc-php8.2-fpm` - linux; ppc64le
...
### `joomla:4.4.0-rc-php8.2-fpm` - linux; s390x
