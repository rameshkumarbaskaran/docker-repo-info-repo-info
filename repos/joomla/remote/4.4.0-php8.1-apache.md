...
```console
$ docker pull joomla@sha256:8a67202758c59e193340fcc7bcdeb4e7d3be176c2bd8584b6871fcf1a67a179e
```
...
### `joomla:4.4.0-php8.1-apache` - linux; amd64
...
### `joomla:4.4.0-php8.1-apache` - linux; arm variant v5
...
### `joomla:4.4.0-php8.1-apache` - linux; arm variant v7
...
### `joomla:4.4.0-php8.1-apache` - linux; arm64 variant v8
...
### `joomla:4.4.0-php8.1-apache` - linux; 386
...
### `joomla:4.4.0-php8.1-apache` - linux; mips64le
...
### `joomla:4.4.0-php8.1-apache` - linux; ppc64le
...
### `joomla:4.4.0-php8.1-apache` - linux; s390x

```console
$ docker pull joomla@sha256:42856d3916253557c941221d571b2d8cbdf90e639df31002f57b280c6fc11c61
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.8 MB (207838386 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ad9315c222f5014d1eb6c36d428785c7bb0bfc1e86a04620f0891e70f2e9be3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 28 Oct 2023 06:10:03 GMT
ENV JOOMLA_SHA512=800e985b1aa99e0df329349779f3c0f2f29a5c4de5115a7804b118029cba6f8d726cbd09979e3ac5a13e6a518ff87f847e713be9fa38ee59b04a5e9102479838
# Sat, 28 Oct 2023 06:10:10 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.0/Joomla_4.4.0-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 28 Oct 2023 06:10:12 GMT
COPY file:75d4151822bf32487f27c3996faec3e2842350001f3cabdee80506df7825dc96 in /entrypoint.sh 
# Sat, 28 Oct 2023 06:10:12 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Sat, 28 Oct 2023 06:10:12 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 28 Oct 2023 06:10:13 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:cea5528ca8a079e02dfe905bd82e79eaad442d17c9555e8c3a8c5124b7d8e693`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:367b006662c87fe067e5ef35c623fdddd43935c45503f20cac41366f6d9e568b`  
		Last Modified: Sat, 28 Oct 2023 06:26:25 GMT  
		Size: 25.3 MB (25277627 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1bc976353a6f0a190c0147bd9fef7c195d5e0741951bffe0239a5cec57c0462`  
		Last Modified: Sat, 28 Oct 2023 06:26:21 GMT  
		Size: 2.6 KB (2618 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0998510741e1a229422032a94dbe2bfada96dacf93d46e631f875260fed51c6`  
		Last Modified: Sat, 28 Oct 2023 06:26:21 GMT  
		Size: 1.1 KB (1063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
