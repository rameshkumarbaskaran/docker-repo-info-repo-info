...
```console
$ docker pull joomla@sha256:dbdda770f0827094985d4ccff27eba879e0f8dd7541e6b2d1fcaa7490343880a
```
...
### `joomla:3.10.0-php7.4-fpm-alpine` - linux; amd64
...
### `joomla:3.10.0-php7.4-fpm-alpine` - linux; arm variant v6
...
### `joomla:3.10.0-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:3.10.0-php7.4-fpm-alpine` - linux; 386
...
### `joomla:3.10.0-php7.4-fpm-alpine` - linux; s390x
