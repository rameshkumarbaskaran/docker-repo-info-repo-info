...
- Created: `2022-02-04T04:46:07.935498424Z`
- Virtual Size: ~ 828.94 Mb  
...
- Environment:
  ...
  - `GN_VERSION=3.10.10`
  - `GN_DOWNLOAD_MD5=de09ba1a43d6f3a224ad5ff02b4c4fb3`
...
### `dpkg` source package: `postgresql-common=225`
...
```console
$ apt-get source -qq --print-uris postgresql-common=225
'http://deb.debian.org/debian/pool/main/p/postgresql-common/postgresql-common_225.dsc' postgresql-common_225.dsc 2430 SHA256:549154379518b014730be85aa2477bde4ebd495c0dbf2f157be56dd95ab66904
'http://deb.debian.org/debian/pool/main/p/postgresql-common/postgresql-common_225.tar.xz' postgresql-common_225.tar.xz 219440 SHA256:0a6d104d18a1da36136ea4498fe448c5fe00eedb75b29d68d0f9d21459ed7ffb
```

Other potentially useful URLs:

- https://sources.debian.net/src/postgresql-common/225/ (for browsing the source)
- https://sources.debian.net/src/postgresql-common/225/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/postgresql-common/225/ (for access to the source package after it no longer exists in the archive)
