...
```console
$ docker pull drupal@sha256:350a5ed772fd1f7c1340660c68153124a56adce87d8ceb7aeb4ef4fff87b76e0
```
...
### `drupal:9.3.18-php7.4-apache-bullseye` - linux; arm variant v7
...
### `drupal:9.3.18-php7.4-apache-bullseye` - linux; ppc64le
