...
```console
$ docker pull drupal@sha256:f878fd0fffcb0950fbd6e7621856219e9d35c6d265e9b9f1d51fe19a01fe6386
```
...
### `drupal:9.5.2-php8.1-apache-bullseye` - linux; amd64
...
### `drupal:9.5.2-php8.1-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:9.5.2-php8.1-apache-bullseye` - linux; 386
...
### `drupal:9.5.2-php8.1-apache-bullseye` - linux; ppc64le
...
### `drupal:9.5.2-php8.1-apache-bullseye` - linux; s390x
