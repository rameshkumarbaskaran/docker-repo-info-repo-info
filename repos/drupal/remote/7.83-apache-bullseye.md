...
```console
$ docker pull drupal@sha256:0314d3cb47e62b7051f426f95d08c26ef7f86c485a9344aebcb8865063a7b0ee
```
...
### `drupal:7.83-apache-bullseye` - linux; arm variant v5
...
### `drupal:7.83-apache-bullseye` - linux; 386
...
### `drupal:7.83-apache-bullseye` - linux; s390x
