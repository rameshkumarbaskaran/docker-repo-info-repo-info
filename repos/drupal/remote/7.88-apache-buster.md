...
### `drupal:7.88-apache-buster` - linux; amd64
...
### `drupal:7.88-apache-buster` - linux; arm variant v5
...
### `drupal:7.88-apache-buster` - linux; arm variant v7
...
### `drupal:7.88-apache-buster` - linux; arm64 variant v8
...
### `drupal:7.88-apache-buster` - linux; 386
...
### `drupal:7.88-apache-buster` - linux; mips64le
...
### `drupal:7.88-apache-buster` - linux; ppc64le
...
### `drupal:7.88-apache-buster` - linux; s390x
