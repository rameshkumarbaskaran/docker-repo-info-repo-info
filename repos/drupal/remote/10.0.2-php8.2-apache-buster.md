...
```console
$ docker pull drupal@sha256:7752a47023db5437d6fa15c2cfb0545edf60873f707fa93a8ac6e89ec50d32ae
```
...
### `drupal:10.0.2-php8.2-apache-buster` - linux; amd64
...
### `drupal:10.0.2-php8.2-apache-buster` - linux; arm64 variant v8
...
### `drupal:10.0.2-php8.2-apache-buster` - linux; 386
