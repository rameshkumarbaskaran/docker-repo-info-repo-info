...
```console
$ docker pull drupal@sha256:c8b7b7b815c6b4865b5b12e437a536b76a47696b9e041197f87b0c49b08396c7
```
...
### `drupal:10.1.7-php8.1-apache-bullseye` - linux; amd64
...
### `drupal:10.1.7-php8.1-apache-bullseye` - unknown; unknown
...
### `drupal:10.1.7-php8.1-apache-bullseye` - linux; arm variant v7
...
### `drupal:10.1.7-php8.1-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:10.1.7-php8.1-apache-bullseye` - linux; ppc64le
...
### `drupal:10.1.7-php8.1-apache-bullseye` - linux; s390x
