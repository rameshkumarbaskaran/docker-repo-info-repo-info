...
```console
$ docker pull drupal@sha256:e65b17ba6be8b69ae5b40f7a96be01b406b96d960c371f1248d8e424a18d0048
```
...
### `drupal:9.2.3-php8.0-fpm` - linux; amd64
...
### `drupal:9.2.3-php8.0-fpm` - linux; arm variant v7
...
### `drupal:9.2.3-php8.0-fpm` - linux; arm64 variant v8
...
### `drupal:9.2.3-php8.0-fpm` - linux; 386
...
### `drupal:9.2.3-php8.0-fpm` - linux; s390x
