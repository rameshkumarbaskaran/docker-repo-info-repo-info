...
```console
$ docker pull drupal@sha256:dbcb642a0df0f5f2c7c6bfac8b421e80cbb32a19edf337e7f718e10e2450364f
```
...
### `drupal:7.98-php8.0-apache` - linux; amd64
...
### `drupal:7.98-php8.0-apache` - linux; arm variant v5
...
### `drupal:7.98-php8.0-apache` - linux; arm variant v7
...
### `drupal:7.98-php8.0-apache` - linux; arm64 variant v8
...
### `drupal:7.98-php8.0-apache` - linux; ppc64le
...
### `drupal:7.98-php8.0-apache` - linux; s390x
