## `drupal:9.4.4-fpm-buster`

```console
$ docker pull drupal@sha256:e7e15093e7e961ce16dc0a4c5d4df853a24e3114c2473ef997560298fed19680
```
...
### `drupal:9.4.4-fpm-buster` - linux; amd64
...
### `drupal:9.4.4-fpm-buster` - linux; arm variant v7
...
### `drupal:9.4.4-fpm-buster` - linux; arm64 variant v8
...
### `drupal:9.4.4-fpm-buster` - linux; 386
...
### `drupal:9.4.4-fpm-buster` - linux; ppc64le
...
### `drupal:9.4.4-fpm-buster` - linux; s390x
