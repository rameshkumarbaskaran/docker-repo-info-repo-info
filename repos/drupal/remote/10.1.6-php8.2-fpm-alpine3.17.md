...
### `drupal:10.1.6-php8.2-fpm-alpine3.17` - linux; amd64
...
### `drupal:10.1.6-php8.2-fpm-alpine3.17` - unknown; unknown
...
### `drupal:10.1.6-php8.2-fpm-alpine3.17` - linux; arm variant v7
