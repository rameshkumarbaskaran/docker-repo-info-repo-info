...
```console
$ docker pull drupal@sha256:f316e568426f4cc06d64f2ca9fa8ac89dfe28057494e776732d85fd700af4f1c
```
...
### `drupal:10.1.4-php8.2-fpm-bullseye` - linux; amd64
...
### `drupal:10.1.4-php8.2-fpm-bullseye` - linux; arm variant v7
...
### `drupal:10.1.4-php8.2-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:10.1.4-php8.2-fpm-bullseye` - linux; 386
...
### `drupal:10.1.4-php8.2-fpm-bullseye` - linux; ppc64le
...
### `drupal:10.1.4-php8.2-fpm-bullseye` - linux; s390x
