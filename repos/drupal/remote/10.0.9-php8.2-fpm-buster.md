...
```console
$ docker pull drupal@sha256:da8bd68f3227f966bf1f300e2120a31cc2fea21cb357970f9e9afbd11b9910ea
```
...
### `drupal:10.0.9-php8.2-fpm-buster` - linux; amd64
...
### `drupal:10.0.9-php8.2-fpm-buster` - linux; arm variant v7
...
### `drupal:10.0.9-php8.2-fpm-buster` - linux; 386
