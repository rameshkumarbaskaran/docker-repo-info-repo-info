...
```console
$ docker pull drupal@sha256:80590826bbfa369cfe3090449251bdc3cf6d482dea59737469f3fb21d0a656ad
```
...
### `drupal:10.1.2-php8.2-fpm-bookworm` - linux; amd64
...
### `drupal:10.1.2-php8.2-fpm-bookworm` - linux; arm variant v7
...
### `drupal:10.1.2-php8.2-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:10.1.2-php8.2-fpm-bookworm` - linux; 386
...
### `drupal:10.1.2-php8.2-fpm-bookworm` - linux; ppc64le
