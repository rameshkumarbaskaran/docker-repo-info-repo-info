...
### `drupal:10.2-rc-apache` - linux; amd64
...
### `drupal:10.2-rc-apache` - unknown; unknown
...
### `drupal:10.2-rc-apache` - linux; arm variant v7
...
### `drupal:10.2-rc-apache` - linux; arm64 variant v8
...
### `drupal:10.2-rc-apache` - linux; 386
...
### `drupal:10.2-rc-apache` - linux; ppc64le
...
### `drupal:10.2-rc-apache` - linux; s390x
