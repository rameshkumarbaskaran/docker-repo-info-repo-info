...
```console
$ docker pull drupal@sha256:cd653019b1a5484adca8d700a48d699d7bbfd190776cc8a32e42725498d00388
```
...
### `drupal:9.5.2-php8.0-fpm-buster` - linux; amd64
...
### `drupal:9.5.2-php8.0-fpm-buster` - linux; arm64 variant v8
...
### `drupal:9.5.2-php8.0-fpm-buster` - linux; 386
