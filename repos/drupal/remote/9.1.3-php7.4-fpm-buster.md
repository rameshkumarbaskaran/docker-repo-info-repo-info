...
### `drupal:9.1.3-php7.4-fpm-buster` - linux; amd64
...
### `drupal:9.1.3-php7.4-fpm-buster` - linux; arm64 variant v8
...
### `drupal:9.1.3-php7.4-fpm-buster` - linux; 386
...
### `drupal:9.1.3-php7.4-fpm-buster` - linux; s390x
