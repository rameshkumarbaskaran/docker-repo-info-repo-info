...
### `drupal:9.1.3-php7.4-fpm-alpine3.12` - linux; amd64
...
### `drupal:9.1.3-php7.4-fpm-alpine3.12` - linux; arm variant v6
...
### `drupal:9.1.3-php7.4-fpm-alpine3.12` - linux; arm64 variant v8
...
### `drupal:9.1.3-php7.4-fpm-alpine3.12` - linux; 386
...
### `drupal:9.1.3-php7.4-fpm-alpine3.12` - linux; s390x
