...
```console
$ docker pull drupal@sha256:26a8eb00141cb7907d9a1a06a5237e03b6daa57f4cee1a668ee31c6862b28e85
```
...
### `drupal:9.3.17-php7.4-apache-bullseye` - linux; amd64
...
### `drupal:9.3.17-php7.4-apache-bullseye` - linux; arm variant v7
...
### `drupal:9.3.17-php7.4-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:9.3.17-php7.4-apache-bullseye` - linux; 386
...
### `drupal:9.3.17-php7.4-apache-bullseye` - linux; ppc64le
...
### `drupal:9.3.17-php7.4-apache-bullseye` - linux; s390x
