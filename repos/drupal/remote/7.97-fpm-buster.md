...
```console
$ docker pull drupal@sha256:7abb85f9978c95bc42967b32546297a18ba2b2e90e1112c97ec03f7aec903910
```
...
### `drupal:7.97-fpm-buster` - linux; amd64
...
### `drupal:7.97-fpm-buster` - linux; arm variant v7
...
### `drupal:7.97-fpm-buster` - linux; arm64 variant v8
...
### `drupal:7.97-fpm-buster` - linux; 386
