...
### `drupal:9.2.17-fpm-bullseye` - linux; amd64
...
### `drupal:9.2.17-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:9.2.17-fpm-bullseye` - linux; 386
...
### `drupal:9.2.17-fpm-bullseye` - linux; s390x
