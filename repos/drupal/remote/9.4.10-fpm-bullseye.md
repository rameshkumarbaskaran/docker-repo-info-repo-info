## `drupal:9.4.10-fpm-bullseye`

```console
$ docker pull drupal@sha256:ef066855f0348ec173d8735cc2baab977f6b2769c4f2a1de088dd3d1ad64c202
```
...
### `drupal:9.4.10-fpm-bullseye` - linux; amd64
...
### `drupal:9.4.10-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:9.4.10-fpm-bullseye` - linux; 386
...
### `drupal:9.4.10-fpm-bullseye` - linux; ppc64le
...
### `drupal:9.4.10-fpm-bullseye` - linux; s390x
