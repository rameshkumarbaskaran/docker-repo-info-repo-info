...
```console
$ docker pull drupal@sha256:38e26c80e28cf6fff8f905413567273e44d5a980280cdeb8f7f680502b6f3392
```
...
### `drupal:9.3.18-php8.0-fpm` - linux; amd64
...
### `drupal:9.3.18-php8.0-fpm` - linux; arm variant v7
...
### `drupal:9.3.18-php8.0-fpm` - linux; arm64 variant v8
...
### `drupal:9.3.18-php8.0-fpm` - linux; 386
...
### `drupal:9.3.18-php8.0-fpm` - linux; ppc64le
...
### `drupal:9.3.18-php8.0-fpm` - linux; s390x
