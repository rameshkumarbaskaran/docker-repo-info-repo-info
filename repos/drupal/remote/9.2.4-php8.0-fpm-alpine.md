...
```console
$ docker pull drupal@sha256:b9d8b458c449c9a5695e1a91a7b34d53a60588d5ee4e54791fdac5b00bb62ca4
```
...
### `drupal:9.2.4-php8.0-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.2.4-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.2.4-php8.0-fpm-alpine` - linux; ppc64le
