...
```console
$ docker pull drupal@sha256:9313ed4fff53095e66bd9ac88782ef2fc7c2170d0e1b43aa8571537e6b30715a
```
...
### `drupal:9.4.8-php8.0-fpm-alpine` - linux; amd64
...
### `drupal:9.4.8-php8.0-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.4.8-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.4.8-php8.0-fpm-alpine` - linux; 386
...
### `drupal:9.4.8-php8.0-fpm-alpine` - linux; ppc64le
...
### `drupal:9.4.8-php8.0-fpm-alpine` - linux; s390x
