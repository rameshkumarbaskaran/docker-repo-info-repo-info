...
```console
$ docker pull drupal@sha256:42d5933fb6d317f437412d77cdcfb8245b62f5a096d97486b15e090898b29cc8
```
...
### `drupal:7.85-fpm-bullseye` - linux; amd64
...
### `drupal:7.85-fpm-bullseye` - linux; mips64le
