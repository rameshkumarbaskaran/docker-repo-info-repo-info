...
### `drupal:10.1.7-fpm-bullseye` - linux; amd64
...
### `drupal:10.1.7-fpm-bullseye` - unknown; unknown
...
### `drupal:10.1.7-fpm-bullseye` - linux; arm variant v7
...
### `drupal:10.1.7-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:10.1.7-fpm-bullseye` - linux; 386
...
### `drupal:10.1.7-fpm-bullseye` - linux; ppc64le
...
### `drupal:10.1.7-fpm-bullseye` - linux; s390x
