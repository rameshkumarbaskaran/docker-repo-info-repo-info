## `drupal:9.2.18-php7.4-fpm-alpine`

```console
$ docker pull drupal@sha256:5cb267049fb7f578f8b438d4b5a14c0bca18553008c06ad933659a574bbbf895
```
...
### `drupal:9.2.18-php7.4-fpm-alpine` - linux; amd64
...
### `drupal:9.2.18-php7.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.2.18-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.2.18-php7.4-fpm-alpine` - linux; 386
...
### `drupal:9.2.18-php7.4-fpm-alpine` - linux; ppc64le
...
### `drupal:9.2.18-php7.4-fpm-alpine` - linux; s390x
