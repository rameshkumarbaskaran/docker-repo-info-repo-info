...
```console
$ docker pull drupal@sha256:1fc6e3831410a03382b65a9279aab676faa6e7c1fc92009f624dacc40acba810
```
...
### `drupal:9.3-php8.1-fpm-alpine3.14` - linux; arm variant v7
...
### `drupal:9.3-php8.1-fpm-alpine3.14` - linux; ppc64le
