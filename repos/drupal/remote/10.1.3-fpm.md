...
```console
$ docker pull drupal@sha256:cf5896f0b5763f7059cc9c420aeffc00c35b41a053502408e0ca0c032664d0f4
```
...
### `drupal:10.1.3-fpm` - linux; arm variant v7
...
### `drupal:10.1.3-fpm` - linux; ppc64le
