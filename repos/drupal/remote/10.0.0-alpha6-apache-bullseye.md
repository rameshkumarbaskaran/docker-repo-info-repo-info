...
```console
$ docker pull drupal@sha256:d045ccb78821de80327bf7175aad6b542120edecd0902d9cfee4c1b59e70ce44
```
...
### `drupal:10.0.0-alpha6-apache-bullseye` - linux; amd64
...
### `drupal:10.0.0-alpha6-apache-bullseye` - linux; arm variant v7
...
### `drupal:10.0.0-alpha6-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:10.0.0-alpha6-apache-bullseye` - linux; 386
...
### `drupal:10.0.0-alpha6-apache-bullseye` - linux; ppc64le
...
### `drupal:10.0.0-alpha6-apache-bullseye` - linux; s390x
