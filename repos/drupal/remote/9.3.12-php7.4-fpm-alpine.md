...
```console
$ docker pull drupal@sha256:abb0bb5986c3610cd429f986b5b1a97f5981ef923c049af07b47385672fd702e
```
...
### `drupal:9.3.12-php7.4-fpm-alpine` - linux; 386
...
### `drupal:9.3.12-php7.4-fpm-alpine` - linux; ppc64le
...
### `drupal:9.3.12-php7.4-fpm-alpine` - linux; s390x
