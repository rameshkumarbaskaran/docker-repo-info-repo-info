## `drupal:9.4.10-apache`

```console
$ docker pull drupal@sha256:c3af42a4ddbb1038c45e61cbfee7ddcd75b6a1d1fa9038a177727ada26f06d88
```
...
### `drupal:9.4.10-apache` - linux; amd64
...
### `drupal:9.4.10-apache` - linux; arm64 variant v8
...
### `drupal:9.4.10-apache` - linux; 386
...
### `drupal:9.4.10-apache` - linux; ppc64le
...
### `drupal:9.4.10-apache` - linux; s390x
