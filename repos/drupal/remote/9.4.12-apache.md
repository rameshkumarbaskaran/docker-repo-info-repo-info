...
### `drupal:9.4.12-apache` - linux; amd64
...
### `drupal:9.4.12-apache` - linux; arm variant v7
...
### `drupal:9.4.12-apache` - linux; arm64 variant v8
...
### `drupal:9.4.12-apache` - linux; 386
...
### `drupal:9.4.12-apache` - linux; ppc64le
...
### `drupal:9.4.12-apache` - linux; s390x
