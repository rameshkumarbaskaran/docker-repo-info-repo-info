...
```console
$ docker pull drupal@sha256:ae50d39689215d612752a2cbe8e06ac5e1c9ed8b8ee327f14aca445613eaf00d
```
...
### `drupal:9.1.9-apache` - linux; amd64
...
### `drupal:9.1.9-apache` - linux; arm variant v7
...
### `drupal:9.1.9-apache` - linux; ppc64le
...
### `drupal:9.1.9-apache` - linux; s390x
