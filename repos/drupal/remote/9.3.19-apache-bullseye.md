...
```console
$ docker pull drupal@sha256:c889701279fb2bbcd0d79dbc9febcd289c3131139a1387cb3d9bb143d48c86a8
```
...
### `drupal:9.3.19-apache-bullseye` - linux; amd64
...
### `drupal:9.3.19-apache-bullseye` - linux; arm variant v7
...
### `drupal:9.3.19-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:9.3.19-apache-bullseye` - linux; 386
...
### `drupal:9.3.19-apache-bullseye` - linux; ppc64le
...
### `drupal:9.3.19-apache-bullseye` - linux; s390x
