...
```console
$ docker pull drupal@sha256:2e022318fdf701a7a7782d9d4486f4defa34565f488ae1368a34a54e35e4f7a7
```
...
### `drupal:9.4.10-php8.0-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.4.10-php8.0-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.4.10-php8.0-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.4.10-php8.0-fpm-alpine3.16` - linux; 386
...
### `drupal:9.4.10-php8.0-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:9.4.10-php8.0-fpm-alpine3.16` - linux; s390x
