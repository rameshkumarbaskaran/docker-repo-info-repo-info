...
```console
$ docker pull drupal@sha256:a21c78efafe4b04b4bfc4c1ddfad1d9bc4de84b2fad5df53366b948626fc6a85
```
...
### `drupal:9.3.15-php7.4-apache-buster` - linux; arm variant v7
...
### `drupal:9.3.15-php7.4-apache-buster` - linux; ppc64le
