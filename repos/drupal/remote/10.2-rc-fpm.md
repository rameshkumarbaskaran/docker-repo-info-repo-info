...
### `drupal:10.2-rc-fpm` - linux; amd64
...
### `drupal:10.2-rc-fpm` - unknown; unknown
...
### `drupal:10.2-rc-fpm` - linux; arm variant v7
...
### `drupal:10.2-rc-fpm` - linux; arm64 variant v8
...
### `drupal:10.2-rc-fpm` - linux; ppc64le
...
### `drupal:10.2-rc-fpm` - linux; s390x
