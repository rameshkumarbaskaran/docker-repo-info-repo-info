...
```console
$ docker pull drupal@sha256:adb57965d41ff7b3ea4163a2145b57f1ca32f0ca989f2e69581f1e5148aad28f
```
...
### `drupal:9.2.9-php7.4-apache` - linux; arm64 variant v8
...
### `drupal:9.2.9-php7.4-apache` - linux; 386
...
### `drupal:9.2.9-php7.4-apache` - linux; s390x
