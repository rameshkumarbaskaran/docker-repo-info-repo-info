...
```console
$ docker pull drupal@sha256:03e6aec4b9a2828c347ee53b52a818550201cac6618cff78f75aff7c859c2517
```
...
### `drupal:9.2.0-php7.4-fpm-buster` - linux; amd64
...
### `drupal:9.2.0-php7.4-fpm-buster` - linux; arm variant v7
...
### `drupal:9.2.0-php7.4-fpm-buster` - linux; arm64 variant v8
...
### `drupal:9.2.0-php7.4-fpm-buster` - linux; 386
...
### `drupal:9.2.0-php7.4-fpm-buster` - linux; s390x
