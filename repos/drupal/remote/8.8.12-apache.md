...
### `drupal:8.8.12-apache` - linux; amd64
...
### `drupal:8.8.12-apache` - linux; arm variant v7
...
### `drupal:8.8.12-apache` - linux; arm64 variant v8
...
### `drupal:8.8.12-apache` - linux; 386
...
### `drupal:8.8.12-apache` - linux; ppc64le
...
### `drupal:8.8.12-apache` - linux; s390x
