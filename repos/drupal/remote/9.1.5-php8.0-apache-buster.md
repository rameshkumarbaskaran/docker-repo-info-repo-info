...
```console
$ docker pull drupal@sha256:80897d4e52e3c0de2186681dba6d5082768b9550fd09afc1a8b61398f0e3f486
```
...
### `drupal:9.1.5-php8.0-apache-buster` - linux; arm variant v7
...
### `drupal:9.1.5-php8.0-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.1.5-php8.0-apache-buster` - linux; ppc64le
...
### `drupal:9.1.5-php8.0-apache-buster` - linux; s390x
