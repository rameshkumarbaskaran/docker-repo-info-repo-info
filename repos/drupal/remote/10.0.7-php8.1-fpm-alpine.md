...
```console
$ docker pull drupal@sha256:b43f24be58cf0f89b6adb290e8070bc650eb98e695c3a2820a62ad096acdd16a
```
...
### `drupal:10.0.7-php8.1-fpm-alpine` - linux; amd64
...
### `drupal:10.0.7-php8.1-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.0.7-php8.1-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.0.7-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.0.7-php8.1-fpm-alpine` - linux; 386
...
### `drupal:10.0.7-php8.1-fpm-alpine` - linux; ppc64le
