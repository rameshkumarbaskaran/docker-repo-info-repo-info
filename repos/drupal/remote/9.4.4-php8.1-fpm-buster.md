## `drupal:9.4.4-php8.1-fpm-buster`

```console
$ docker pull drupal@sha256:93470f04886110f6f647385a0c1e082535808f80425c2ab3e65de308338d6886
```
...
### `drupal:9.4.4-php8.1-fpm-buster` - linux; amd64
...
### `drupal:9.4.4-php8.1-fpm-buster` - linux; arm variant v7
...
### `drupal:9.4.4-php8.1-fpm-buster` - linux; arm64 variant v8
...
### `drupal:9.4.4-php8.1-fpm-buster` - linux; 386
...
### `drupal:9.4.4-php8.1-fpm-buster` - linux; ppc64le
...
### `drupal:9.4.4-php8.1-fpm-buster` - linux; s390x
