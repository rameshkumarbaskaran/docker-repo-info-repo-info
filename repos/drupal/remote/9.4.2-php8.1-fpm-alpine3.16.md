...
```console
$ docker pull drupal@sha256:3a82bd1a674103074f91ae8dfac452d517f4c527094f08ec339183d85dc75a06
```
...
### `drupal:9.4.2-php8.1-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.4.2-php8.1-fpm-alpine3.16` - linux; arm variant v7
...
### `drupal:9.4.2-php8.1-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.4.2-php8.1-fpm-alpine3.16` - linux; 386
