...
```console
$ docker pull drupal@sha256:f71b0232181ce846bf2934e05d4f117a3115df801f2c9201cb667beab244c774
```
...
### `drupal:7.97-php8.0-fpm-bullseye` - linux; arm variant v7
...
### `drupal:7.97-php8.0-fpm-bullseye` - linux; 386
...
### `drupal:7.97-php8.0-fpm-bullseye` - linux; mips64le
...
### `drupal:7.97-php8.0-fpm-bullseye` - linux; s390x
