...
```console
$ docker pull drupal@sha256:653b078ea4d441e656cbb46d5caa66b4429c457cf6f0fca69c54d3b1ec2f1128
```
...
### `drupal:9.2.15-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.2.15-php7.4-fpm-alpine` - linux; s390x
