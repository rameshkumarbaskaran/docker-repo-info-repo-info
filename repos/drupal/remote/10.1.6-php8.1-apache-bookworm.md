...
### `drupal:10.1.6-php8.1-apache-bookworm` - linux; amd64
...
### `drupal:10.1.6-php8.1-apache-bookworm` - unknown; unknown
...
### `drupal:10.1.6-php8.1-apache-bookworm` - linux; arm variant v7
