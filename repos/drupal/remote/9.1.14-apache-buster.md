...
```console
$ docker pull drupal@sha256:4bdb3b47eae76ee1ce33cfee2f32b336b45525171c3d12ddbc4113f2df654b65
```
...
### `drupal:9.1.14-apache-buster` - linux; amd64
...
### `drupal:9.1.14-apache-buster` - linux; arm variant v7
...
### `drupal:9.1.14-apache-buster` - linux; ppc64le
