...
```console
$ docker pull drupal@sha256:80c5d77fa81ea339676b1f667d98b12e375374a22e8feaf9d271433a14482609
```
...
### `drupal:9.3.12-php7.4-apache-buster` - linux; amd64
...
### `drupal:9.3.12-php7.4-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.3.12-php7.4-apache-buster` - linux; 386
...
### `drupal:9.3.12-php7.4-apache-buster` - linux; ppc64le
...
### `drupal:9.3.12-php7.4-apache-buster` - linux; s390x
