...
```console
$ docker pull drupal@sha256:7293152c30ba193691a43289535d8a8df3441a99d4105b6ec3be65faafe5ec8f
```
...
### `drupal:10.0.0-beta2-apache-bullseye` - linux; amd64
...
### `drupal:10.0.0-beta2-apache-bullseye` - linux; arm variant v7
...
### `drupal:10.0.0-beta2-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:10.0.0-beta2-apache-bullseye` - linux; 386
...
### `drupal:10.0.0-beta2-apache-bullseye` - linux; ppc64le
...
### `drupal:10.0.0-beta2-apache-bullseye` - linux; s390x
