...
```console
$ docker pull drupal@sha256:09efb0bc27dec3070bd4323e8371f411c02dcded6337f7d053ec6b6f2841b9e0
```
...
### `drupal:9.3.17-php8.1-fpm-alpine` - linux; arm variant v7
...
### `drupal:9.3.17-php8.1-fpm-alpine` - linux; ppc64le
