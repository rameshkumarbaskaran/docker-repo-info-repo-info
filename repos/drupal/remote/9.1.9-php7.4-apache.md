...
### `drupal:9.1.9-php7.4-apache` - linux; amd64
...
### `drupal:9.1.9-php7.4-apache` - linux; arm variant v7
...
### `drupal:9.1.9-php7.4-apache` - linux; 386
...
### `drupal:9.1.9-php7.4-apache` - linux; ppc64le
...
### `drupal:9.1.9-php7.4-apache` - linux; s390x
