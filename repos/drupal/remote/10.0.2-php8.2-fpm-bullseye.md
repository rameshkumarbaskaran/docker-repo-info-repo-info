...
```console
$ docker pull drupal@sha256:2c303a98589f712537608ee2aaf2326076921b5c4e54d5c6d84b493980f1872d
```
...
### `drupal:10.0.2-php8.2-fpm-bullseye` - linux; amd64
...
### `drupal:10.0.2-php8.2-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:10.0.2-php8.2-fpm-bullseye` - linux; 386
...
### `drupal:10.0.2-php8.2-fpm-bullseye` - linux; ppc64le
...
### `drupal:10.0.2-php8.2-fpm-bullseye` - linux; s390x
