...
```console
$ docker pull drupal@sha256:a02f51a31486f536837e578f5306fdcf4648eccbc604c76618887e08bea75ed0
```
...
### `drupal:9.3.12-apache` - linux; amd64
...
### `drupal:9.3.12-apache` - linux; arm64 variant v8
...
### `drupal:9.3.12-apache` - linux; 386
...
### `drupal:9.3.12-apache` - linux; ppc64le
...
### `drupal:9.3.12-apache` - linux; s390x
