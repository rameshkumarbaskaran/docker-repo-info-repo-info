...
```console
$ docker pull drupal@sha256:b67b404abb403195b1e3227ad568fe704f7311ce013657c882ddf614a35510de
```
...
### `drupal:9.3.8-php7.4-fpm-alpine3.15` - linux; arm variant v6
...
### `drupal:9.3.8-php7.4-fpm-alpine3.15` - linux; arm64 variant v8
...
### `drupal:9.3.8-php7.4-fpm-alpine3.15` - linux; s390x
