...
```console
$ docker pull drupal@sha256:be4b97f326e0a33e7de215f5889fcee1511b3eed478e81c8f0101200079398c4
```
...
### `drupal:9.2.15-fpm-alpine3.14` - linux; arm variant v6
...
### `drupal:9.2.15-fpm-alpine3.14` - linux; arm64 variant v8
...
### `drupal:9.2.15-fpm-alpine3.14` - linux; s390x
