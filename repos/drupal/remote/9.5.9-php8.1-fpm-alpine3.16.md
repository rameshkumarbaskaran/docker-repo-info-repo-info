...
```console
$ docker pull drupal@sha256:ee16fdbb0ea407c78ad496fa3044f13b81c42849083cce393bb8224bc53be97a
```
...
### `drupal:9.5.9-php8.1-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.5.9-php8.1-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.5.9-php8.1-fpm-alpine3.16` - linux; arm variant v7
...
### `drupal:9.5.9-php8.1-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.5.9-php8.1-fpm-alpine3.16` - linux; 386
