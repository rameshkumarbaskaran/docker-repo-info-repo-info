## `drupal:10.1.3-php8.1-apache`

```console
$ docker pull drupal@sha256:8a973101bbef4a6fae4e737e31aa3b68519d4735ce83dd632f94e27dcf3a5ecf
```
...
### `drupal:10.1.3-php8.1-apache` - linux; amd64
...
### `drupal:10.1.3-php8.1-apache` - linux; arm variant v7
...
### `drupal:10.1.3-php8.1-apache` - linux; 386
...
### `drupal:10.1.3-php8.1-apache` - linux; ppc64le
...
### `drupal:10.1.3-php8.1-apache` - linux; s390x
