...
```console
$ docker pull drupal@sha256:55139c0d07504b2e9e5ce951cd656c42167df5877715701d06ceef6e376031ec
```
...
### `drupal:10.1.3-php8.1-fpm-alpine3.17` - linux; amd64
...
### `drupal:10.1.3-php8.1-fpm-alpine3.17` - linux; arm variant v6
...
### `drupal:10.1.3-php8.1-fpm-alpine3.17` - linux; arm variant v7
...
### `drupal:10.1.3-php8.1-fpm-alpine3.17` - linux; 386
...
### `drupal:10.1.3-php8.1-fpm-alpine3.17` - linux; ppc64le
...
### `drupal:10.1.3-php8.1-fpm-alpine3.17` - linux; s390x
