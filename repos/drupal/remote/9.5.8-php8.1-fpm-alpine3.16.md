...
```console
$ docker pull drupal@sha256:57cf673d6c98f7d3b5868c145f35a48f24e853f606d5d96ecb189314886f2215
```
...
### `drupal:9.5.8-php8.1-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.5.8-php8.1-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.5.8-php8.1-fpm-alpine3.16` - linux; arm variant v7
...
### `drupal:9.5.8-php8.1-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.5.8-php8.1-fpm-alpine3.16` - linux; 386
...
### `drupal:9.5.8-php8.1-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:9.5.8-php8.1-fpm-alpine3.16` - linux; s390x
