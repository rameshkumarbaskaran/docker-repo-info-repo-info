...
```console
$ docker pull drupal@sha256:416c35038a0548e4fdc8e5293fc58da46dd85e95460915e11ff3c690a178166e
```
...
### `drupal:10.0.0-rc3-php8.1-fpm` - linux; amd64
...
### `drupal:10.0.0-rc3-php8.1-fpm` - linux; arm64 variant v8
...
### `drupal:10.0.0-rc3-php8.1-fpm` - linux; 386
...
### `drupal:10.0.0-rc3-php8.1-fpm` - linux; ppc64le
...
### `drupal:10.0.0-rc3-php8.1-fpm` - linux; s390x
