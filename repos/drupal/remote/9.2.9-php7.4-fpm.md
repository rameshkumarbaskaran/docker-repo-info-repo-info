...
```console
$ docker pull drupal@sha256:c1fd7a290c347a9180293590ece31566d168bc769d814b3dd6fbb183000de088
```
...
### `drupal:9.2.9-php7.4-fpm` - linux; arm64 variant v8
...
### `drupal:9.2.9-php7.4-fpm` - linux; 386
...
### `drupal:9.2.9-php7.4-fpm` - linux; s390x
