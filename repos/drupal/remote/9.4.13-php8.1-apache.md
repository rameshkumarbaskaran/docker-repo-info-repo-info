...
```console
$ docker pull drupal@sha256:f69376ba727ca8b279f5a2f0947ef3b8b55438d245d0052354c9fb205c02d054
```
...
### `drupal:9.4.13-php8.1-apache` - linux; amd64
...
### `drupal:9.4.13-php8.1-apache` - linux; arm variant v7
...
### `drupal:9.4.13-php8.1-apache` - linux; arm64 variant v8
...
### `drupal:9.4.13-php8.1-apache` - linux; 386
...
### `drupal:9.4.13-php8.1-apache` - linux; ppc64le
...
### `drupal:9.4.13-php8.1-apache` - linux; s390x
