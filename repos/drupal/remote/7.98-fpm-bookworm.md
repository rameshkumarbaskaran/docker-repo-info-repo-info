...
```console
$ docker pull drupal@sha256:cfd661444882b5cd30b37f072db30ea45dceed76d196d1da097102529c953e06
```
...
### `drupal:7.98-fpm-bookworm` - linux; amd64
...
### `drupal:7.98-fpm-bookworm` - unknown; unknown
...
### `drupal:7.98-fpm-bookworm` - linux; arm variant v5
...
### `drupal:7.98-fpm-bookworm` - linux; arm variant v7
...
### `drupal:7.98-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:7.98-fpm-bookworm` - linux; mips64le
...
### `drupal:7.98-fpm-bookworm` - linux; ppc64le
...
### `drupal:7.98-fpm-bookworm` - linux; s390x
