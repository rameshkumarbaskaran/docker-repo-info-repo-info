## `drupal:10.0.2-php8.1-fpm-alpine3.16`

```console
$ docker pull drupal@sha256:4aec6293723c729c1a89089582c0c8b102a2dafaeacef3c26be6afa69fffde23
```
...
### `drupal:10.0.2-php8.1-fpm-alpine3.16` - linux; amd64
...
### `drupal:10.0.2-php8.1-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:10.0.2-php8.1-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:10.0.2-php8.1-fpm-alpine3.16` - linux; 386
...
### `drupal:10.0.2-php8.1-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:10.0.2-php8.1-fpm-alpine3.16` - linux; s390x
