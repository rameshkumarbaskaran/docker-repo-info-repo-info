...
### `drupal:9.5.8-php8.0-apache` - linux; amd64
...
### `drupal:9.5.8-php8.0-apache` - linux; arm variant v7
...
### `drupal:9.5.8-php8.0-apache` - linux; arm64 variant v8
...
### `drupal:9.5.8-php8.0-apache` - linux; 386
...
### `drupal:9.5.8-php8.0-apache` - linux; ppc64le
...
### `drupal:9.5.8-php8.0-apache` - linux; s390x
