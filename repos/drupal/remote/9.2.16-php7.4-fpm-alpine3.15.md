...
```console
$ docker pull drupal@sha256:32eb4148cfc07208db23949d5ef3493029d5edd8573e8ab25872808f682d12b7
```
...
### `drupal:9.2.16-php7.4-fpm-alpine3.15` - linux; amd64
...
### `drupal:9.2.16-php7.4-fpm-alpine3.15` - linux; arm variant v6
...
### `drupal:9.2.16-php7.4-fpm-alpine3.15` - linux; arm variant v7
...
### `drupal:9.2.16-php7.4-fpm-alpine3.15` - linux; arm64 variant v8
...
### `drupal:9.2.16-php7.4-fpm-alpine3.15` - linux; 386
...
### `drupal:9.2.16-php7.4-fpm-alpine3.15` - linux; ppc64le
...
### `drupal:9.2.16-php7.4-fpm-alpine3.15` - linux; s390x
