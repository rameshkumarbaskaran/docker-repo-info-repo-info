...
```console
$ docker pull drupal@sha256:929a5c73d7827329efa2df217bca37e38da2c8e1e75e0de6f3591068d1a6f07d
```
...
### `drupal:9.2.5-php7.4-apache` - linux; amd64
...
### `drupal:9.2.5-php7.4-apache` - linux; arm64 variant v8
...
### `drupal:9.2.5-php7.4-apache` - linux; 386
...
### `drupal:9.2.5-php7.4-apache` - linux; s390x
