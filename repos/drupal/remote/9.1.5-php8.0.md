...
```console
$ docker pull drupal@sha256:0aee042a37123aca5e8fc5f21c8f63b65d4b5e0c23f08c716209e46802d49148
```
...
### `drupal:9.1.5-php8.0` - linux; arm variant v7
...
### `drupal:9.1.5-php8.0` - linux; arm64 variant v8
...
### `drupal:9.1.5-php8.0` - linux; ppc64le
...
### `drupal:9.1.5-php8.0` - linux; s390x
