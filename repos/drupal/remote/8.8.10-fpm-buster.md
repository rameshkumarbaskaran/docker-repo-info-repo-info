...
```console
$ docker pull drupal@sha256:c3596849136fba325e8011745764627153ac49d091c8cb9434febf46d6c7ed83
```
...
```console
$ docker pull drupal@sha256:18f825a532ad2214531f85b16c407adb2fc0a5f02f1ed54e8d07e9008ecf2fb1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v1+json`
-	Total Size: **176.6 MB (176603675 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `ddaefc7f5ed74b8c0a03ed6a732cfd0bd1a191797d2f67fec8a5c4a240e931c1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
