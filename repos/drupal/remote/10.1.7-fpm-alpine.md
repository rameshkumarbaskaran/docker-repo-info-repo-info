...
### `drupal:10.1.7-fpm-alpine` - linux; amd64
...
### `drupal:10.1.7-fpm-alpine` - unknown; unknown
...
### `drupal:10.1.7-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.1.7-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.1.7-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.1.7-fpm-alpine` - linux; 386
...
### `drupal:10.1.7-fpm-alpine` - linux; ppc64le
...
### `drupal:10.1.7-fpm-alpine` - linux; s390x
