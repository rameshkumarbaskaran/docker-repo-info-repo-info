...
### `drupal:9.2.18-apache` - linux; amd64
...
### `drupal:9.2.18-apache` - linux; arm variant v7
...
### `drupal:9.2.18-apache` - linux; arm64 variant v8
...
### `drupal:9.2.18-apache` - linux; 386
...
### `drupal:9.2.18-apache` - linux; ppc64le
...
### `drupal:9.2.18-apache` - linux; s390x
