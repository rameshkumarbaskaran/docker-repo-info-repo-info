...
```console
$ docker pull drupal@sha256:f2d91cca5e19e800672422c9e86dd0667bc6c86aabb39cbf6275b835ce35d2f9
```
...
### `drupal:9.2.18-fpm-alpine` - linux; 386
...
### `drupal:9.2.18-fpm-alpine` - linux; ppc64le
...
### `drupal:9.2.18-fpm-alpine` - linux; s390x
