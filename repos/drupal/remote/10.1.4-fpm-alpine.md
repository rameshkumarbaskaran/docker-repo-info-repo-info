...
```console
$ docker pull drupal@sha256:9fd63f989a64c82f95ea5ca9847ec307c356211d2ab64234bf286e5e63359491
```
...
### `drupal:10.1.4-fpm-alpine` - linux; amd64
...
### `drupal:10.1.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.1.4-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.1.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.1.4-fpm-alpine` - linux; 386
...
### `drupal:10.1.4-fpm-alpine` - linux; ppc64le
...
### `drupal:10.1.4-fpm-alpine` - linux; s390x
