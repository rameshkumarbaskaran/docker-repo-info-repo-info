...
```console
$ docker pull drupal@sha256:a5eb1d9f06c8d22f5f7cb486c5882561076e2c3af8c98ab53e8d6130b7b638df
```
...
### `drupal:7.78-php7.4-apache-buster` - linux; amd64
...
### `drupal:7.78-php7.4-apache-buster` - linux; arm variant v5
...
### `drupal:7.78-php7.4-apache-buster` - linux; arm variant v7
...
### `drupal:7.78-php7.4-apache-buster` - linux; arm64 variant v8
...
### `drupal:7.78-php7.4-apache-buster` - linux; 386
...
### `drupal:7.78-php7.4-apache-buster` - linux; mips64le
...
### `drupal:7.78-php7.4-apache-buster` - linux; s390x
