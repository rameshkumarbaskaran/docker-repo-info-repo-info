...
```console
$ docker pull drupal@sha256:8635978bd3d0b80c9f366cb3a804d8875b1e4fc449911b0c97d00dcee87f8263
```
...
### `drupal:9.3.19-php8.0-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.3.19-php8.0-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.3.19-php8.0-fpm-alpine3.16` - linux; arm variant v7
...
### `drupal:9.3.19-php8.0-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.3.19-php8.0-fpm-alpine3.16` - linux; 386
...
### `drupal:9.3.19-php8.0-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:9.3.19-php8.0-fpm-alpine3.16` - linux; s390x
