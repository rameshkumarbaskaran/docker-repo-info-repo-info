...
### `drupal:7.98-apache-bookworm` - linux; amd64
...
### `drupal:7.98-apache-bookworm` - unknown; unknown
...
### `drupal:7.98-apache-bookworm` - linux; arm variant v5
...
### `drupal:7.98-apache-bookworm` - linux; arm variant v7
...
### `drupal:7.98-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:7.98-apache-bookworm` - linux; mips64le
...
### `drupal:7.98-apache-bookworm` - linux; ppc64le
...
### `drupal:7.98-apache-bookworm` - linux; s390x
