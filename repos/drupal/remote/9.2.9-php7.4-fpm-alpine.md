...
### `drupal:9.2.9-php7.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.2.9-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.2.9-php7.4-fpm-alpine` - linux; 386
...
### `drupal:9.2.9-php7.4-fpm-alpine` - linux; s390x
