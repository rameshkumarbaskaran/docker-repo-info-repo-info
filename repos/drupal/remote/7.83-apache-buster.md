...
```console
$ docker pull drupal@sha256:c18de6fb9df2a42189b32cec8de8fb26b0741d48441a57b336d17fb75dbdea57
```
...
### `drupal:7.83-apache-buster` - linux; arm variant v5
...
### `drupal:7.83-apache-buster` - linux; 386
