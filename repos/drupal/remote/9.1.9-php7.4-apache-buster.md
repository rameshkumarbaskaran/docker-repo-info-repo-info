...
```console
$ docker pull drupal@sha256:44995ffea3590416b046838bb2c5f57ffcaedc52531a6cd7a9ba84627aedba7e
```
...
### `drupal:9.1.9-php7.4-apache-buster` - linux; amd64
...
### `drupal:9.1.9-php7.4-apache-buster` - linux; arm variant v7
...
### `drupal:9.1.9-php7.4-apache-buster` - linux; 386
...
### `drupal:9.1.9-php7.4-apache-buster` - linux; ppc64le
...
### `drupal:9.1.9-php7.4-apache-buster` - linux; s390x
