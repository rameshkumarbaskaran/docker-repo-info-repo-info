...
```console
$ docker pull drupal@sha256:cb37a78e24d7937a7166b4057882beb0a2b7a023d0236da8f7165339e3e92127
```
...
### `drupal:7.84-php7.4-fpm` - linux; amd64
...
### `drupal:7.84-php7.4-fpm` - linux; arm variant v5
...
### `drupal:7.84-php7.4-fpm` - linux; arm64 variant v8
...
### `drupal:7.84-php7.4-fpm` - linux; 386
...
### `drupal:7.84-php7.4-fpm` - linux; ppc64le
...
### `drupal:7.84-php7.4-fpm` - linux; s390x
