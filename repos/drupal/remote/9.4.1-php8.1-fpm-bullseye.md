...
```console
$ docker pull drupal@sha256:a57d06f9970bb832485b131714f504cd1c05731d7d6aecd675bf736c0bd0d7b6
```
...
### `drupal:9.4.1-php8.1-fpm-bullseye` - linux; amd64
...
### `drupal:9.4.1-php8.1-fpm-bullseye` - linux; arm variant v7
...
### `drupal:9.4.1-php8.1-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:9.4.1-php8.1-fpm-bullseye` - linux; 386
...
### `drupal:9.4.1-php8.1-fpm-bullseye` - linux; ppc64le
...
### `drupal:9.4.1-php8.1-fpm-bullseye` - linux; s390x
