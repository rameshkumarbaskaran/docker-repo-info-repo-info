...
```console
$ docker pull drupal@sha256:9c25ffcb201f6e5aa9c60bc6c5c6c280049c462b94be815cd2d6d7cf5ee4c025
```
...
### `drupal:10.0.0-rc3-php8.1-fpm-alpine3.16` - linux; amd64
...
### `drupal:10.0.0-rc3-php8.1-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:10.0.0-rc3-php8.1-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:10.0.0-rc3-php8.1-fpm-alpine3.16` - linux; 386
...
### `drupal:10.0.0-rc3-php8.1-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:10.0.0-rc3-php8.1-fpm-alpine3.16` - linux; s390x
