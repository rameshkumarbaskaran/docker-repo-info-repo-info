## `drupal:9.1.7-php7.4-fpm`

```console
$ docker pull drupal@sha256:58315f14a659fcbb450087899642850c5335ad1a462d542544b8326ec7a9c9a1
```
...
### `drupal:9.1.7-php7.4-fpm` - linux; amd64
...
### `drupal:9.1.7-php7.4-fpm` - linux; arm variant v7
...
### `drupal:9.1.7-php7.4-fpm` - linux; arm64 variant v8
...
### `drupal:9.1.7-php7.4-fpm` - linux; 386
...
### `drupal:9.1.7-php7.4-fpm` - linux; ppc64le
...
### `drupal:9.1.7-php7.4-fpm` - linux; s390x
