## `drupal:10.1.3-apache`

```console
$ docker pull drupal@sha256:fa9053b0e7facccb9c5cd58a38b0eb161640178d61101faa75f15fbd9df9bfdc
```
...
### `drupal:10.1.3-apache` - linux; amd64
...
### `drupal:10.1.3-apache` - linux; arm variant v7
...
### `drupal:10.1.3-apache` - linux; 386
...
### `drupal:10.1.3-apache` - linux; ppc64le
...
### `drupal:10.1.3-apache` - linux; s390x
