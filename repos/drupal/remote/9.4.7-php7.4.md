...
```console
$ docker pull drupal@sha256:1ad43c3255cbf219f828c64477c118a9cc20e4ba5e3187c1d6a5957a7971fa97
```
...
### `drupal:9.4.7-php7.4` - linux; amd64
...
### `drupal:9.4.7-php7.4` - linux; arm64 variant v8
...
### `drupal:9.4.7-php7.4` - linux; ppc64le
...
### `drupal:9.4.7-php7.4` - linux; s390x
