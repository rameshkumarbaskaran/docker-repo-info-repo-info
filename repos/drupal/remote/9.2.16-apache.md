...
```console
$ docker pull drupal@sha256:2175c712c62ed93c1c8734aac5f071b372dfc38b84326b1170290ddf9ae16857
```
...
### `drupal:9.2.16-apache` - linux; amd64
...
### `drupal:9.2.16-apache` - linux; arm variant v7
...
### `drupal:9.2.16-apache` - linux; arm64 variant v8
...
### `drupal:9.2.16-apache` - linux; 386
...
### `drupal:9.2.16-apache` - linux; ppc64le
...
### `drupal:9.2.16-apache` - linux; s390x
