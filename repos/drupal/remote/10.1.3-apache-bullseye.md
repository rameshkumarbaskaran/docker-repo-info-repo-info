## `drupal:10.1.3-apache-bullseye`

```console
$ docker pull drupal@sha256:3585a27f636ea716692ac3fb15e4f4ec60f59858e6609fedb66dc412bc276fdd
```
...
### `drupal:10.1.3-apache-bullseye` - linux; amd64
...
### `drupal:10.1.3-apache-bullseye` - linux; arm variant v7
...
### `drupal:10.1.3-apache-bullseye` - linux; 386
...
### `drupal:10.1.3-apache-bullseye` - linux; ppc64le
...
### `drupal:10.1.3-apache-bullseye` - linux; s390x
