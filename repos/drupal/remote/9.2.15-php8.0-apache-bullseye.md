...
```console
$ docker pull drupal@sha256:e412f4ff596c9f8377749d61e0384a4c0cf4f6ed92a28783a37cecdc8b9e574a
```
...
### `drupal:9.2.15-php8.0-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:9.2.15-php8.0-apache-bullseye` - linux; s390x
