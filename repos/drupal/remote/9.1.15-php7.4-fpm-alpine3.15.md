...
### `drupal:9.1.15-php7.4-fpm-alpine3.15` - linux; amd64
...
### `drupal:9.1.15-php7.4-fpm-alpine3.15` - linux; arm variant v7
...
### `drupal:9.1.15-php7.4-fpm-alpine3.15` - linux; arm64 variant v8
...
### `drupal:9.1.15-php7.4-fpm-alpine3.15` - linux; ppc64le
