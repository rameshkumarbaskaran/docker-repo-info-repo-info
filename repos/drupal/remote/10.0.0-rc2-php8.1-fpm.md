...
```console
$ docker pull drupal@sha256:5ed4c046dba1c8425ac135db402184d33d06941582c0ea268a7abb3fddf823f6
```
...
### `drupal:10.0.0-rc2-php8.1-fpm` - linux; amd64
...
### `drupal:10.0.0-rc2-php8.1-fpm` - linux; arm64 variant v8
...
### `drupal:10.0.0-rc2-php8.1-fpm` - linux; 386
...
### `drupal:10.0.0-rc2-php8.1-fpm` - linux; ppc64le
...
### `drupal:10.0.0-rc2-php8.1-fpm` - linux; s390x
