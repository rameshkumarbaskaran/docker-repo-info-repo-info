...
```console
$ docker pull drupal@sha256:82e98ab52165a192f1e577c8ebb286161f2b6cf510962a9ff7187d2febed8f98
```
...
### `drupal:10.0.0-rc1-php8.1-fpm-buster` - linux; amd64
...
### `drupal:10.0.0-rc1-php8.1-fpm-buster` - linux; arm variant v7
...
### `drupal:10.0.0-rc1-php8.1-fpm-buster` - linux; arm64 variant v8
...
### `drupal:10.0.0-rc1-php8.1-fpm-buster` - linux; 386
