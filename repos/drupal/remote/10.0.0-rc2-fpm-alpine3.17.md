...
```console
$ docker pull drupal@sha256:9f00f9da2bf3a67017578810eaa069756f74381f8548febaaffad1b02e423cd6
```
...
### `drupal:10.0.0-rc2-fpm-alpine3.17` - linux; amd64
...
### `drupal:10.0.0-rc2-fpm-alpine3.17` - linux; arm variant v6
...
### `drupal:10.0.0-rc2-fpm-alpine3.17` - linux; arm64 variant v8
...
### `drupal:10.0.0-rc2-fpm-alpine3.17` - linux; 386
...
### `drupal:10.0.0-rc2-fpm-alpine3.17` - linux; ppc64le
...
### `drupal:10.0.0-rc2-fpm-alpine3.17` - linux; s390x
