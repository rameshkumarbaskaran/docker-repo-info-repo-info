...
```console
$ docker pull drupal@sha256:539737a8c70df2c05b848c1da57da5da866a6f48a995070882d1e805d2cb29e2
```
...
### `drupal:9.4.6-php7.4-apache` - linux; amd64
...
### `drupal:9.4.6-php7.4-apache` - linux; arm variant v7
...
### `drupal:9.4.6-php7.4-apache` - linux; arm64 variant v8
...
### `drupal:9.4.6-php7.4-apache` - linux; 386
...
### `drupal:9.4.6-php7.4-apache` - linux; ppc64le
