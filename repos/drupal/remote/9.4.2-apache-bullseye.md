...
```console
$ docker pull drupal@sha256:ff3bc2003f758bc5acc3f76918fea57744a3fd72f6de1cff19ea1d1f7c4e1392
```
...
### `drupal:9.4.2-apache-bullseye` - linux; amd64
...
### `drupal:9.4.2-apache-bullseye` - linux; arm variant v7
...
### `drupal:9.4.2-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:9.4.2-apache-bullseye` - linux; 386
...
### `drupal:9.4.2-apache-bullseye` - linux; s390x
