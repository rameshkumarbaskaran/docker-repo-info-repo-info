## `drupal:9.2.18-php8.0-apache`

```console
$ docker pull drupal@sha256:2edba242d0d43d1261c355473d6f4836e3754a24bfcc5b789624626c3e1bd8c6
```
...
### `drupal:9.2.18-php8.0-apache` - linux; amd64
...
### `drupal:9.2.18-php8.0-apache` - linux; arm64 variant v8
...
### `drupal:9.2.18-php8.0-apache` - linux; 386
...
### `drupal:9.2.18-php8.0-apache` - linux; ppc64le
...
### `drupal:9.2.18-php8.0-apache` - linux; s390x
