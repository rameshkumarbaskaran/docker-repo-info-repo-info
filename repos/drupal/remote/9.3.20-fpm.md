...
```console
$ docker pull drupal@sha256:c5e28db7e45c37468fb64e5f155061c2d8ec58a2e23d9414c7b4ef5ef7e38f98
```
...
### `drupal:9.3.20-fpm` - linux; arm variant v7
...
### `drupal:9.3.20-fpm` - linux; arm64 variant v8
...
### `drupal:9.3.20-fpm` - linux; ppc64le
