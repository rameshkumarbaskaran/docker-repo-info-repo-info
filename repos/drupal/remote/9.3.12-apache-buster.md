...
```console
$ docker pull drupal@sha256:b915353ecf434bc2676b7f6a3f5603da912ab9820b332538beabf5d1739235b7
```
...
### `drupal:9.3.12-apache-buster` - linux; 386
...
### `drupal:9.3.12-apache-buster` - linux; ppc64le
