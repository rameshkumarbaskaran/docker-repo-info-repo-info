...
```console
$ docker pull drupal@sha256:372aaa038b8f3db462e024fdb133b9b76fb8aa8766b23eb1f3ed59b669d9316e
```
...
### `drupal:9.5.2-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.5.2-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.5.2-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.5.2-fpm-alpine3.16` - linux; 386
...
### `drupal:9.5.2-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:9.5.2-fpm-alpine3.16` - linux; s390x
