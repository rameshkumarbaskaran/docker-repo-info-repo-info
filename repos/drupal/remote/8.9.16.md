...
```console
$ docker pull drupal@sha256:a59bcbe7fa0db51af8aa465f24a2007b0cfa0b820985da0b37d0fc613849831a
```
...
### `drupal:8.9.16` - linux; arm variant v7
