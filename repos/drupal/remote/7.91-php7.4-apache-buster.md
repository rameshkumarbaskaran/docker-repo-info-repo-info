...
```console
$ docker pull drupal@sha256:311fe95b79b0b0dfc0660af141807f316c5ddcf7f8dc3d77daeb22526b921f9d
```
...
### `drupal:7.91-php7.4-apache-buster` - linux; arm variant v7
...
### `drupal:7.91-php7.4-apache-buster` - linux; arm64 variant v8
...
### `drupal:7.91-php7.4-apache-buster` - linux; 386
...
### `drupal:7.91-php7.4-apache-buster` - linux; ppc64le
...
### `drupal:7.91-php7.4-apache-buster` - linux; s390x
