...
```console
$ docker pull drupal@sha256:12eff94d098ea707f3e906ff593f20e58358f281c7591de68121c42f9367fdcb
```
...
### `drupal:9.4.7-php8.1-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.4.7-php8.1-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.4.7-php8.1-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.4.7-php8.1-fpm-alpine3.16` - linux; 386
...
### `drupal:9.4.7-php8.1-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:9.4.7-php8.1-fpm-alpine3.16` - linux; s390x
