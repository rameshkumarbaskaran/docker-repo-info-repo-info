...
```console
$ docker pull drupal@sha256:952fc60b0affcec9b28adfa17b7988b840a90263fa34153f81029495b43b74b2
```
...
### `drupal:10.0.0-alpha1-php8.0-fpm-alpine3.15` - linux; amd64
...
### `drupal:10.0.0-alpha1-php8.0-fpm-alpine3.15` - linux; arm variant v6
...
### `drupal:10.0.0-alpha1-php8.0-fpm-alpine3.15` - linux; arm variant v7
...
### `drupal:10.0.0-alpha1-php8.0-fpm-alpine3.15` - linux; arm64 variant v8
...
### `drupal:10.0.0-alpha1-php8.0-fpm-alpine3.15` - linux; 386
...
### `drupal:10.0.0-alpha1-php8.0-fpm-alpine3.15` - linux; ppc64le
...
### `drupal:10.0.0-alpha1-php8.0-fpm-alpine3.15` - linux; s390x
