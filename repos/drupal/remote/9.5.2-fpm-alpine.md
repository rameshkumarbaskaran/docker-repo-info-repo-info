...
```console
$ docker pull drupal@sha256:e6963b1b23dc05ea91088c066a220f05a7209a6e8dadb396401721db1265c9f7
```
...
### `drupal:9.5.2-fpm-alpine` - linux; amd64
...
### `drupal:9.5.2-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.5.2-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.5.2-fpm-alpine` - linux; 386
...
### `drupal:9.5.2-fpm-alpine` - linux; ppc64le
...
### `drupal:9.5.2-fpm-alpine` - linux; s390x
