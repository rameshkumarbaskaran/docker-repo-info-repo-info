...
```console
$ docker pull drupal@sha256:9d748a8783074d7c401edb6547090877411dd8d7af8a95010fef6e1aa014baaf
```
...
### `drupal:10.1.2-fpm-alpine` - linux; amd64
...
### `drupal:10.1.2-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.1.2-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.1.2-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.1.2-fpm-alpine` - linux; 386
...
### `drupal:10.1.2-fpm-alpine` - linux; ppc64le
