...
### `drupal:9.5.10-apache-bookworm` - linux; amd64
...
### `drupal:9.5.10-apache-bookworm` - linux; arm variant v7
...
### `drupal:9.5.10-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:9.5.10-apache-bookworm` - linux; 386
...
### `drupal:9.5.10-apache-bookworm` - linux; ppc64le
...
### `drupal:9.5.10-apache-bookworm` - linux; s390x
