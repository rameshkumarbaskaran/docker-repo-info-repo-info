## `drupal:10.0.0-alpha6-php8.1-fpm-alpine`

```console
$ docker pull drupal@sha256:dda93fb3e913568b08eaeca9d996a857eda670f91052f43a847c9772180af7d2
```
...
### `drupal:10.0.0-alpha6-php8.1-fpm-alpine` - linux; amd64
...
### `drupal:10.0.0-alpha6-php8.1-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.0.0-alpha6-php8.1-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.0.0-alpha6-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.0.0-alpha6-php8.1-fpm-alpine` - linux; 386
...
### `drupal:10.0.0-alpha6-php8.1-fpm-alpine` - linux; s390x
