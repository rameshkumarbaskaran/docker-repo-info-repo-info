...
```console
$ docker pull drupal@sha256:c28789a6d11adb983caecb48ecb040662fed88c5d616eb7542ba08b7411e07ea
```
...
### `drupal:10.1.4-fpm-bookworm` - linux; amd64
...
### `drupal:10.1.4-fpm-bookworm` - linux; arm variant v7
...
### `drupal:10.1.4-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:10.1.4-fpm-bookworm` - linux; 386
...
### `drupal:10.1.4-fpm-bookworm` - linux; ppc64le
...
### `drupal:10.1.4-fpm-bookworm` - linux; s390x
