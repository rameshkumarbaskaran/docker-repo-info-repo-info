...
```console
$ docker pull drupal@sha256:df6d4fdf2923d998a85715a059ae468291e1bed65b5d9dab1dda1aaee3919c73
```
...
```console
$ docker pull drupal@sha256:81bff0650b5439e4b455f4eccb378ac2a2fbcce573ba7a9e9df87c4a58acbe7d
```
...
-	Image ID: `sha256:0a93a97223b05517ac03d394f66d8d4cdbc7fed9609c0e0313517c9723fcf853`
...
```console
$ docker pull drupal@sha256:7f7f9accc689e50747e9d9224cefae7ae54aa6b15a00b1990c695022bf730c04
```
...
-	Total Size: **53.2 MB (53220118 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd19f8be12f7419ae23876af57d077c92cb2d745489d02e49d95b2984c83d258`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull drupal@sha256:fbc66972145a1409fc78731764747d2ec03b61e002b1a354e4893e8295e6310b
```
...
-	Total Size: **52.0 MB (51953549 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fc1c16eb1ee8228af74d48b77e205651301dc024dd6dcca786be5972d8130ab8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull drupal@sha256:913fae17eefe2f2bf2bd19ec2b21222d9b9d7e615588d081dd856f8edd634985
```
...
-	Total Size: **54.5 MB (54511093 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:20706186f29494ab058e8a2ebc018893aa6e578cd940624085808cb30d7aec87`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull drupal@sha256:e04d89dae65864eacbd603d2f31faba004be845833ee2f65fb56a70f819486c4
```
...
-	Total Size: **55.4 MB (55428921 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb9406ce645f572c4fa9e5565a8efb10b00d82b35c2cdfa087c2c70f63dd3606`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull drupal@sha256:f2fb0bf9b6b6f4cce8fe990a2d59fc63a6cf31c4704b451143a2b75dacd19be2
```
...
-	Total Size: **55.9 MB (55929038 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:89a0f2089b0ba1ae7da8f1370388f22951ec537c359292e55f3ad44621595ca0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull drupal@sha256:28519e39c2d04760f233c500b6b62b7cc48e1b8ef164571adef49799a4aa0c05
```
...
-	Total Size: **53.7 MB (53733496 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fce9fbbfde6ba0806f58a353ce8f201d413697248c75c5bce850cf5e4885be5b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
