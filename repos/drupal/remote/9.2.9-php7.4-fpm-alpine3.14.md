...
```console
$ docker pull drupal@sha256:c76573466ce26e8733f8eae55dfaef66a4982beadbbc801afa842f288541a0b4
```
...
### `drupal:9.2.9-php7.4-fpm-alpine3.14` - linux; arm variant v6
...
### `drupal:9.2.9-php7.4-fpm-alpine3.14` - linux; arm64 variant v8
...
### `drupal:9.2.9-php7.4-fpm-alpine3.14` - linux; 386
...
### `drupal:9.2.9-php7.4-fpm-alpine3.14` - linux; s390x
