...
```console
$ docker pull drupal@sha256:2886b188d76cad6255b014656acf268c6ca98eeb62bf4231c7a50af0bd0021b6
```
...
### `drupal:9.4.2-php8.1-fpm-buster` - linux; amd64
...
### `drupal:9.4.2-php8.1-fpm-buster` - linux; arm variant v7
...
### `drupal:9.4.2-php8.1-fpm-buster` - linux; arm64 variant v8
...
### `drupal:9.4.2-php8.1-fpm-buster` - linux; 386
...
### `drupal:9.4.2-php8.1-fpm-buster` - linux; ppc64le
