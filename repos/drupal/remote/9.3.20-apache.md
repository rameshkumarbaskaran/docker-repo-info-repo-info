...
### `drupal:9.3.20-apache` - linux; arm variant v7
...
### `drupal:9.3.20-apache` - linux; arm64 variant v8
...
### `drupal:9.3.20-apache` - linux; 386
...
### `drupal:9.3.20-apache` - linux; ppc64le
...
### `drupal:9.3.20-apache` - linux; s390x
