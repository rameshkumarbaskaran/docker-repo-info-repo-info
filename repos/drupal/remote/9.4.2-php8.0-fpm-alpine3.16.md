...
```console
$ docker pull drupal@sha256:d81147e13c64a701da2b32bb18c9100431ac645d5fc1c24e8a48b3686272e5bd
```
...
### `drupal:9.4.2-php8.0-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.4.2-php8.0-fpm-alpine3.16` - linux; arm variant v7
...
### `drupal:9.4.2-php8.0-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.4.2-php8.0-fpm-alpine3.16` - linux; 386
