...
```console
$ docker pull drupal@sha256:8f1ed8267fb32e233611a612dd69cd3075e590fb626c051518296b22a243ac5e
```
...
### `drupal:9.3.17-php8.0-apache-bullseye` - linux; amd64
...
### `drupal:9.3.17-php8.0-apache-bullseye` - linux; arm variant v7
...
### `drupal:9.3.17-php8.0-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:9.3.17-php8.0-apache-bullseye` - linux; 386
...
### `drupal:9.3.17-php8.0-apache-bullseye` - linux; ppc64le
...
### `drupal:9.3.17-php8.0-apache-bullseye` - linux; s390x
