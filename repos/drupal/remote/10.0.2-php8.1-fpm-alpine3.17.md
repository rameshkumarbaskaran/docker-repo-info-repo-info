## `drupal:10.0.2-php8.1-fpm-alpine3.17`

```console
$ docker pull drupal@sha256:c1df01048a74b86bf1954b21300fc4e91be9b3fcefa9b3c75ed09858aad68f25
```
...
### `drupal:10.0.2-php8.1-fpm-alpine3.17` - linux; amd64
...
### `drupal:10.0.2-php8.1-fpm-alpine3.17` - linux; arm variant v6
...
### `drupal:10.0.2-php8.1-fpm-alpine3.17` - linux; arm64 variant v8
...
### `drupal:10.0.2-php8.1-fpm-alpine3.17` - linux; 386
...
### `drupal:10.0.2-php8.1-fpm-alpine3.17` - linux; ppc64le
...
### `drupal:10.0.2-php8.1-fpm-alpine3.17` - linux; s390x
