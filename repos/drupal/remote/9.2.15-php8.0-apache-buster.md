...
```console
$ docker pull drupal@sha256:3a74f302b4d2b87d9b0643e87c2ae634d1a733858c2888d1249f0dc6a4229545
```
...
### `drupal:9.2.15-php8.0-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.2.15-php8.0-apache-buster` - linux; s390x
