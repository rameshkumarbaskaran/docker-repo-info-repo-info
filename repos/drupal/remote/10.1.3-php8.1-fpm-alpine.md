## `drupal:10.1.3-php8.1-fpm-alpine`

```console
$ docker pull drupal@sha256:f52519b230ace6c14eaf500269269e88319239f1182d8e28558408145cf8bbc9
```
...
### `drupal:10.1.3-php8.1-fpm-alpine` - linux; amd64
...
### `drupal:10.1.3-php8.1-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.1.3-php8.1-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.1.3-php8.1-fpm-alpine` - linux; 386
...
### `drupal:10.1.3-php8.1-fpm-alpine` - linux; ppc64le
...
### `drupal:10.1.3-php8.1-fpm-alpine` - linux; s390x
