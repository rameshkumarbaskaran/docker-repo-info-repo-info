## `drupal:10.0.2-fpm-buster`

```console
$ docker pull drupal@sha256:74f7858ff4245c24d2148ff93b3df58d6a83ee8a39b28e94cab9c2896e320d44
```
...
### `drupal:10.0.2-fpm-buster` - linux; amd64
...
### `drupal:10.0.2-fpm-buster` - linux; arm64 variant v8
...
### `drupal:10.0.2-fpm-buster` - linux; 386
