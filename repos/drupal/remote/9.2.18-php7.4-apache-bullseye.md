## `drupal:9.2.18-php7.4-apache-bullseye`

```console
$ docker pull drupal@sha256:dfc7a9bdb774897af8fe4e45d0c2bb0b64b413caccbe627133040963a59851f3
```
...
### `drupal:9.2.18-php7.4-apache-bullseye` - linux; amd64
...
### `drupal:9.2.18-php7.4-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:9.2.18-php7.4-apache-bullseye` - linux; 386
...
### `drupal:9.2.18-php7.4-apache-bullseye` - linux; ppc64le
...
### `drupal:9.2.18-php7.4-apache-bullseye` - linux; s390x
