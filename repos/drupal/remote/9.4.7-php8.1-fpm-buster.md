...
```console
$ docker pull drupal@sha256:1c4e775a25e0670a67f6920c0cd4734695525021c52fd4de9ae820d8de8e786b
```
...
### `drupal:9.4.7-php8.1-fpm-buster` - linux; amd64
...
### `drupal:9.4.7-php8.1-fpm-buster` - linux; arm variant v7
...
### `drupal:9.4.7-php8.1-fpm-buster` - linux; arm64 variant v8
...
### `drupal:9.4.7-php8.1-fpm-buster` - linux; 386
