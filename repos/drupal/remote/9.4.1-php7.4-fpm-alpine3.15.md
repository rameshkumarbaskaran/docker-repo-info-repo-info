...
```console
$ docker pull drupal@sha256:baaade5a6f43b8c3778c5565bc9f65e61134b894a2f806c274d3846f4ce864b7
```
...
### `drupal:9.4.1-php7.4-fpm-alpine3.15` - linux; amd64
...
### `drupal:9.4.1-php7.4-fpm-alpine3.15` - linux; arm variant v6
...
### `drupal:9.4.1-php7.4-fpm-alpine3.15` - linux; arm variant v7
...
### `drupal:9.4.1-php7.4-fpm-alpine3.15` - linux; arm64 variant v8
...
### `drupal:9.4.1-php7.4-fpm-alpine3.15` - linux; 386
...
### `drupal:9.4.1-php7.4-fpm-alpine3.15` - linux; ppc64le
...
### `drupal:9.4.1-php7.4-fpm-alpine3.15` - linux; s390x
