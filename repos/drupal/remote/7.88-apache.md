...
### `drupal:7.88-apache` - linux; amd64
...
### `drupal:7.88-apache` - linux; arm variant v5
...
### `drupal:7.88-apache` - linux; arm variant v7
...
### `drupal:7.88-apache` - linux; arm64 variant v8
...
### `drupal:7.88-apache` - linux; mips64le
...
### `drupal:7.88-apache` - linux; ppc64le
...
### `drupal:7.88-apache` - linux; s390x
