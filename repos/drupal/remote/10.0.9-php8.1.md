...
```console
$ docker pull drupal@sha256:cb6391961cf6cba46f86db8ee1570cc2efb092136b1f92b9e179adaa0deb3061
```
...
### `drupal:10.0.9-php8.1` - linux; amd64
...
### `drupal:10.0.9-php8.1` - linux; arm variant v7
...
### `drupal:10.0.9-php8.1` - linux; arm64 variant v8
...
### `drupal:10.0.9-php8.1` - linux; 386
