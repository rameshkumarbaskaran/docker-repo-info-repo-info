## `drupal:10.0.2-php8.1`

```console
$ docker pull drupal@sha256:9f704ceb86789c380875d60083f83ee4acce48f6d4157df1e14a6914d4d6cd87
```
...
### `drupal:10.0.2-php8.1` - linux; amd64
...
### `drupal:10.0.2-php8.1` - linux; arm64 variant v8
...
### `drupal:10.0.2-php8.1` - linux; 386
...
### `drupal:10.0.2-php8.1` - linux; ppc64le
...
### `drupal:10.0.2-php8.1` - linux; s390x
