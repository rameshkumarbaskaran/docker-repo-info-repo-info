...
- Created: `2023-08-07T19:59:29.663170265Z`
...
### `rpm` package: `ca-certificates-2018.2.22-65.1.30.amzn1.noarch`
...
### `rpm` package: `libssh2-1.4.2-3.13.amzn1.x86_64`
...
### `rpm` package: `libxml2-2.9.1-6.6.42.amzn1.x86_64`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `libxml2-python27-2.9.1-6.6.42.amzn1.x86_64`
...
### `rpm` package: `openldap-2.4.40-16.36.amzn1.x86_64`

Licenses (from `rpm --query`): OpenLDAP

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `openssl-1.0.2k-16.163.amzn1.x86_64`
