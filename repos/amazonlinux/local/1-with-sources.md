...
- Created: `2021-11-10T01:20:22.486919234Z`
- Virtual Size: ~ 620.22 Mb  
...
### `rpm` package: `bash-4.2.46-34.43.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls bash-4.2.46-34.43.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/bash-4.2.46-34.43.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/ca-certificates-2018.2.22-65.1.24.amzn1.src.rpm
```
...
### `rpm` package: `curl-7.61.1-12.99.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls curl-7.61.1-12.99.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/curl-7.61.1-12.99.amzn1.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls expat-2.1.0-12.24.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/expat-2.1.0-12.24.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/file-5.37-8.49.amzn1.src.rpm
```
...
### `rpm` package: `glib2-2.36.3-5.22.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls glib2-2.36.3-5.22.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/glib2-2.36.3-5.22.amzn1.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls glibc-2.17-324.188.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/glibc-2.17-324.188.amzn1.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls glibc-common-2.17-324.188.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/glibc-2.17-324.188.amzn1.src.rpm
```
...
### `rpm` package: `gnupg2-2.0.28-2.34.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls gnupg2-2.0.28-2.34.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/gnupg2-2.0.28-2.34.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/krb5-1.15.1-46.48.amzn1.src.rpm
```
...
### `rpm` package: `libcom_err-1.43.5-2.44.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libcom_err-1.43.5-2.44.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/e2fsprogs-1.43.5-2.44.amzn1.src.rpm
```

### `rpm` package: `libcurl-7.61.1-12.99.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libcurl-7.61.1-12.99.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/curl-7.61.1-12.99.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/icu-50.2-4.0.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/libidn2-2.3.0-1.4.amzn1.src.rpm
```

### `rpm` package: `libnghttp2-1.33.0-1.1.6.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libnghttp2-1.33.0-1.1.6.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/nghttp2-1.33.0-1.1.6.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/libssh2-1.4.2-3.12.amzn1.src.rpm
```
...
### `rpm` package: `libxml2-2.9.1-6.4.41.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libxml2-2.9.1-6.4.41.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/libxml2-2.9.1-6.4.41.amzn1.src.rpm
```

### `rpm` package: `libxml2-python27-2.9.1-6.4.41.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libxml2-python27-2.9.1-6.4.41.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/libxml2-2.9.1-6.4.41.amzn1.src.rpm
```
...
### `rpm` package: `nspr-4.25.0-2.45.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls nspr-4.25.0-2.45.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/nspr-4.25.0-2.45.amzn1.src.rpm
```

### `rpm` package: `nss-3.53.1-7.85.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls nss-3.53.1-7.85.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/nss-3.53.1-7.85.amzn1.src.rpm
```
...
### `rpm` package: `nss-softokn-3.53.1-6.46.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls nss-softokn-3.53.1-6.46.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/nss-softokn-3.53.1-6.46.amzn1.src.rpm
```

### `rpm` package: `nss-softokn-freebl-3.53.1-6.46.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls nss-softokn-freebl-3.53.1-6.46.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/nss-softokn-3.53.1-6.46.amzn1.src.rpm
```

### `rpm` package: `nss-sysinit-3.53.1-7.85.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls nss-sysinit-3.53.1-7.85.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/nss-3.53.1-7.85.amzn1.src.rpm
```

### `rpm` package: `nss-tools-3.53.1-7.85.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls nss-tools-3.53.1-7.85.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/nss-3.53.1-7.85.amzn1.src.rpm
```

### `rpm` package: `nss-util-3.53.1-1.58.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls nss-util-3.53.1-1.58.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/nss-util-3.53.1-1.58.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/openldap-2.4.40-16.31.amzn1.src.rpm
```

### `rpm` package: `openssl-1.0.2k-16.154.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls openssl-1.0.2k-16.154.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/openssl-1.0.2k-16.154.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/pcre-8.21-7.8.amzn1.src.rpm
```
...
### `rpm` package: `python27-2.7.18-2.141.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls python27-2.7.18-2.141.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/python27-2.7.18-2.141.amzn1.src.rpm
```
...
### `rpm` package: `python27-libs-2.7.18-2.141.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls python27-libs-2.7.18-2.141.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/python27-2.7.18-2.141.amzn1.src.rpm
```
...
### `rpm` package: `python27-pyliblzma-0.5.3-11.7.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls python27-pyliblzma-0.5.3-11.7.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/python-pyliblzma-0.5.3-11.7.amzn1.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls rpm-4.11.3-40.79.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/rpm-4.11.3-40.79.amzn1.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls rpm-build-libs-4.11.3-40.79.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/rpm-4.11.3-40.79.amzn1.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls rpm-libs-4.11.3-40.79.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/rpm-4.11.3-40.79.amzn1.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls rpm-python27-4.11.3-40.79.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/rpm-4.11.3-40.79.amzn1.src.rpm
```
...
### `rpm` package: `system-release-2018.03-0.2.noarch`
...
```console
$ yumdownloader --quiet --source --urls system-release-2018.03-0.2.noarch
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/system-release-2018.03-0.2.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls tzdata-2021a-1.79.amzn1.noarch
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/tzdata-2021a-1.79.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/xz-5.2.2-1.13.amzn1.src.rpm
```
...
```console
$ yumdownloader --quiet --source --urls yum-3.4.3-150.72.amzn1.noarch
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/yum-3.4.3-150.72.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-east-1.amazonaws.com/2018.03/updates/e6f16cb117dd/SRPMS//Packages/yum-utils-1.1.31-46.30.amzn1.src.rpm
```
