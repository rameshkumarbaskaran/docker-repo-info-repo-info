...
- Created: `2023-06-15T04:22:19.899682572Z`
...
```console
libcrypto1.1-1.1.1u-r0 description:
Crypto library from openssl

libcrypto1.1-1.1.1u-r0 webpage:
https://www.openssl.org/

libcrypto1.1-1.1.1u-r0 installed size:
2692 KiB

libcrypto1.1-1.1.1u-r0 license:
OpenSSL
...
```console
libssl1.1-1.1.1u-r0 description:
SSL shared libraries

libssl1.1-1.1.1u-r0 webpage:
https://www.openssl.org/

libssl1.1-1.1.1u-r0 installed size:
528 KiB

libssl1.1-1.1.1u-r0 license:
OpenSSL
