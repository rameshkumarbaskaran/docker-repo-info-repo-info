...
```console
$ docker pull nextcloud@sha256:9da7212a1762682be7715c1d0045d3ca2cf3f38b21bb0abc46019263b075b6cb
```
...
### `nextcloud:21.0.0beta4-apache` - linux; amd64
...
### `nextcloud:21.0.0beta4-apache` - linux; arm variant v7
...
### `nextcloud:21.0.0beta4-apache` - linux; arm64 variant v8
...
### `nextcloud:21.0.0beta4-apache` - linux; 386
...
### `nextcloud:21.0.0beta4-apache` - linux; mips64le
...
### `nextcloud:21.0.0beta4-apache` - linux; ppc64le
