...
```console
$ docker pull nextcloud@sha256:3b4a730e84f8047693b2bdb3655155d6ed21ba148e709cdaba4b5c12614c19cd
```
...
### `nextcloud:17.0.10-rc-apache` - linux; amd64
...
### `nextcloud:17.0.10-rc-apache` - linux; arm variant v5
...
### `nextcloud:17.0.10-rc-apache` - linux; arm variant v7
...
### `nextcloud:17.0.10-rc-apache` - linux; arm64 variant v8
...
### `nextcloud:17.0.10-rc-apache` - linux; 386
...
### `nextcloud:17.0.10-rc-apache` - linux; mips64le
...
### `nextcloud:17.0.10-rc-apache` - linux; s390x
