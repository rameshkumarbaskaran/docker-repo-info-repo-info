...
### `nextcloud:20.0.0-beta-fpm` - linux; amd64
...
### `nextcloud:20.0.0-beta-fpm` - linux; arm variant v5
...
### `nextcloud:20.0.0-beta-fpm` - linux; arm variant v7
...
### `nextcloud:20.0.0-beta-fpm` - linux; arm64 variant v8
...
### `nextcloud:20.0.0-beta-fpm` - linux; ppc64le
