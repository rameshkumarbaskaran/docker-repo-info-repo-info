...
### `nextcloud:18.0.2-rc` - linux; amd64
...
### `nextcloud:18.0.2-rc` - linux; arm variant v5
...
### `nextcloud:18.0.2-rc` - linux; arm variant v7
...
### `nextcloud:18.0.2-rc` - linux; arm64 variant v8
...
### `nextcloud:18.0.2-rc` - linux; ppc64le
