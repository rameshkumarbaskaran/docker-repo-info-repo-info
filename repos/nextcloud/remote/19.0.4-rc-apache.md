...
### `nextcloud:19.0.4-rc-apache` - linux; amd64
...
### `nextcloud:19.0.4-rc-apache` - linux; arm variant v5
...
### `nextcloud:19.0.4-rc-apache` - linux; arm variant v7
...
### `nextcloud:19.0.4-rc-apache` - linux; arm64 variant v8
...
### `nextcloud:19.0.4-rc-apache` - linux; 386
...
### `nextcloud:19.0.4-rc-apache` - linux; mips64le
...
### `nextcloud:19.0.4-rc-apache` - linux; s390x
