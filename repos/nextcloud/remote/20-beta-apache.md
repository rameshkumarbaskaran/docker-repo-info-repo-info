...
### `nextcloud:20-beta-apache` - linux; amd64
...
### `nextcloud:20-beta-apache` - linux; arm variant v5
...
### `nextcloud:20-beta-apache` - linux; arm variant v7
...
### `nextcloud:20-beta-apache` - linux; arm64 variant v8
...
### `nextcloud:20-beta-apache` - linux; 386
...
### `nextcloud:20-beta-apache` - linux; mips64le
...
### `nextcloud:20-beta-apache` - linux; ppc64le
...
### `nextcloud:20-beta-apache` - linux; s390x
