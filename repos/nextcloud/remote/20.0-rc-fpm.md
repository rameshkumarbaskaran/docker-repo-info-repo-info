...
```console
$ docker pull nextcloud@sha256:3024bfe1aa31f6654b665d8ac420aba67ec5a9670d8c911152839a6452ef67fc
```
...
### `nextcloud:20.0-rc-fpm` - linux; arm variant v5
...
### `nextcloud:20.0-rc-fpm` - linux; arm64 variant v8
...
### `nextcloud:20.0-rc-fpm` - linux; 386
...
### `nextcloud:20.0-rc-fpm` - linux; ppc64le
...
### `nextcloud:20.0-rc-fpm` - linux; s390x
