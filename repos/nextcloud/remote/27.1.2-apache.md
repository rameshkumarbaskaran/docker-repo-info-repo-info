...
```console
$ docker pull nextcloud@sha256:75683ff8c41b2a4dcce3c4e56a42fc30c7548fec74ba4177cd3f85e0caa68de4
```
...
### `nextcloud:27.1.2-apache` - linux; amd64
...
### `nextcloud:27.1.2-apache` - linux; arm variant v5
...
### `nextcloud:27.1.2-apache` - linux; arm variant v7
...
### `nextcloud:27.1.2-apache` - linux; arm64 variant v8
...
### `nextcloud:27.1.2-apache` - linux; 386
...
### `nextcloud:27.1.2-apache` - linux; mips64le
...
### `nextcloud:27.1.2-apache` - linux; ppc64le
...
### `nextcloud:27.1.2-apache` - linux; s390x
