...
### `nextcloud:27.1.1-fpm` - linux; amd64
...
### `nextcloud:27.1.1-fpm` - linux; arm64 variant v8
...
### `nextcloud:27.1.1-fpm` - linux; 386
...
### `nextcloud:27.1.1-fpm` - linux; mips64le
...
### `nextcloud:27.1.1-fpm` - linux; ppc64le
