...
```console
$ docker pull nextcloud@sha256:03bdb92283bb8b075edcc99018db1e341d748516870daa55f427fafd1fb21755
```
...
### `nextcloud:26.0.0-fpm-alpine` - linux; amd64
...
### `nextcloud:26.0.0-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:26.0.0-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:26.0.0-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:26.0.0-fpm-alpine` - linux; 386
...
### `nextcloud:26.0.0-fpm-alpine` - linux; ppc64le
...
### `nextcloud:26.0.0-fpm-alpine` - linux; s390x
