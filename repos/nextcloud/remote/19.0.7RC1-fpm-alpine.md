...
```console
$ docker pull nextcloud@sha256:5e644424a8581940465d8067f41bfff2db5da6732287737ab6e61d1cff6c5ab1
```
...
### `nextcloud:19.0.7RC1-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:19.0.7RC1-fpm-alpine` - linux; ppc64le
