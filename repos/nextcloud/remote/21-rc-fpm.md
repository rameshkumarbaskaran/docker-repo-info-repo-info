...
### `nextcloud:21-rc-fpm` - linux; amd64
...
### `nextcloud:21-rc-fpm` - linux; arm variant v5
...
### `nextcloud:21-rc-fpm` - linux; arm variant v7
...
### `nextcloud:21-rc-fpm` - linux; arm64 variant v8
...
### `nextcloud:21-rc-fpm` - linux; mips64le
...
### `nextcloud:21-rc-fpm` - linux; s390x
