...
```console
$ docker pull nextcloud@sha256:584078468cada4e1a28cd9a949479b1c63fc283c361ebbd28bb2e96313becbd4
```
...
### `nextcloud:19.0.13-fpm-alpine` - linux; amd64
...
### `nextcloud:19.0.13-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:19.0.13-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:19.0.13-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:19.0.13-fpm-alpine` - linux; 386
