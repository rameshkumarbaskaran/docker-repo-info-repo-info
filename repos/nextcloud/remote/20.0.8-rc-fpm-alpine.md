...
### `nextcloud:20.0.8-rc-fpm-alpine` - linux; amd64
...
### `nextcloud:20.0.8-rc-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:20.0.8-rc-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:20.0.8-rc-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:20.0.8-rc-fpm-alpine` - linux; 386
...
### `nextcloud:20.0.8-rc-fpm-alpine` - linux; ppc64le
...
### `nextcloud:20.0.8-rc-fpm-alpine` - linux; s390x
