## `nextcloud:28.0.0-fpm-alpine`

```console
$ docker pull nextcloud@sha256:8d8620bff47ce83f803e7a0c2bdb889ef9661de24cfe6cb09601867d06a941e7
```
...
### `nextcloud:28.0.0-fpm-alpine` - linux; amd64
...
### `nextcloud:28.0.0-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:28.0.0-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:28.0.0-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:28.0.0-fpm-alpine` - linux; 386
...
### `nextcloud:28.0.0-fpm-alpine` - linux; ppc64le
...
### `nextcloud:28.0.0-fpm-alpine` - linux; s390x
