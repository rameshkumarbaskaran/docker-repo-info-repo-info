...
```console
$ docker pull nextcloud@sha256:1617a4aa364c39bb6f33f065c71496cf1fb402f12f9c87e377daa7eddad377c2
```
...
### `nextcloud:18.0.8-apache` - linux; amd64
...
### `nextcloud:18.0.8-apache` - linux; arm variant v5
...
### `nextcloud:18.0.8-apache` - linux; arm variant v7
...
### `nextcloud:18.0.8-apache` - linux; arm64 variant v8
...
### `nextcloud:18.0.8-apache` - linux; 386
...
### `nextcloud:18.0.8-apache` - linux; mips64le
...
### `nextcloud:18.0.8-apache` - linux; ppc64le
...
### `nextcloud:18.0.8-apache` - linux; s390x
