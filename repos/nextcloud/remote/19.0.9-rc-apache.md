...
```console
$ docker pull nextcloud@sha256:8a74648e06a0847759106c8e72ee2bd6050108b6df79a351464abf902ddb8456
```
...
### `nextcloud:19.0.9-rc-apache` - linux; amd64
...
### `nextcloud:19.0.9-rc-apache` - linux; arm variant v5
...
### `nextcloud:19.0.9-rc-apache` - linux; arm variant v7
...
### `nextcloud:19.0.9-rc-apache` - linux; arm64 variant v8
...
### `nextcloud:19.0.9-rc-apache` - linux; 386
...
### `nextcloud:19.0.9-rc-apache` - linux; mips64le
...
### `nextcloud:19.0.9-rc-apache` - linux; s390x
