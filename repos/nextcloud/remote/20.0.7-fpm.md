...
```console
$ docker pull nextcloud@sha256:ec49b5caab694782cf23e226a4d2a830ee54358febd1bfa746539a2b56f3d23b
```
...
### `nextcloud:20.0.7-fpm` - linux; amd64
...
### `nextcloud:20.0.7-fpm` - linux; arm variant v5
...
### `nextcloud:20.0.7-fpm` - linux; arm variant v7
...
### `nextcloud:20.0.7-fpm` - linux; arm64 variant v8
...
### `nextcloud:20.0.7-fpm` - linux; 386
...
### `nextcloud:20.0.7-fpm` - linux; mips64le
...
### `nextcloud:20.0.7-fpm` - linux; ppc64le
...
### `nextcloud:20.0.7-fpm` - linux; s390x
