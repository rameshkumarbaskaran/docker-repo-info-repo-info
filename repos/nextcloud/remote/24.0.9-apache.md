...
```console
$ docker pull nextcloud@sha256:bb857b0cb8f658e25e6ab45358473b8e9d2c145c342e1f632ce465b704867a01
```
...
### `nextcloud:24.0.9-apache` - linux; amd64
...
### `nextcloud:24.0.9-apache` - linux; arm variant v5
...
### `nextcloud:24.0.9-apache` - linux; arm variant v7
...
### `nextcloud:24.0.9-apache` - linux; arm64 variant v8
...
### `nextcloud:24.0.9-apache` - linux; 386
...
### `nextcloud:24.0.9-apache` - linux; mips64le
...
### `nextcloud:24.0.9-apache` - linux; ppc64le
...
### `nextcloud:24.0.9-apache` - linux; s390x
