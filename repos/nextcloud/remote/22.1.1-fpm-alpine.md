...
```console
$ docker pull nextcloud@sha256:f7737c8d5e57012e4e19eaac9773c6b7773216418b928f72b3098c745e163607
```
...
### `nextcloud:22.1.1-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:22.1.1-fpm-alpine` - linux; ppc64le
