...
```console
$ docker pull nextcloud@sha256:bc02bdd44a32f0add8530f36a142c9dc9d2652cc9557da85781849e74186705d
```
...
### `nextcloud:19.0.7RC1-fpm` - linux; amd64
...
### `nextcloud:19.0.7RC1-fpm` - linux; arm variant v7
...
### `nextcloud:19.0.7RC1-fpm` - linux; arm64 variant v8
...
### `nextcloud:19.0.7RC1-fpm` - linux; 386
