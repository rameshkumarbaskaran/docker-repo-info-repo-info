...
### `nextcloud:18.0.1RC1-fpm` - linux; amd64
...
### `nextcloud:18.0.1RC1-fpm` - linux; arm variant v7
...
### `nextcloud:18.0.1RC1-fpm` - linux; arm64 variant v8
...
### `nextcloud:18.0.1RC1-fpm` - linux; 386
...
### `nextcloud:18.0.1RC1-fpm` - linux; ppc64le
