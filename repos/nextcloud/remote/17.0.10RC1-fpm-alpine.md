...
```console
$ docker pull nextcloud@sha256:1fefd495731ebcfdf59158a18df2abab02362f81d90d5a91a893b4f022d5d668
```
...
### `nextcloud:17.0.10RC1-fpm-alpine` - linux; amd64
...
### `nextcloud:17.0.10RC1-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:17.0.10RC1-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:17.0.10RC1-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:17.0.10RC1-fpm-alpine` - linux; 386
...
### `nextcloud:17.0.10RC1-fpm-alpine` - linux; s390x
