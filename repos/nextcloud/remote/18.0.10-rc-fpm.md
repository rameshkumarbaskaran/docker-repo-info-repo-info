...
```console
$ docker pull nextcloud@sha256:e4ed06c99c4bad208f5b272ce3e1e9a110034eab4cdba4eb39c07a296cc8cbf7
```
...
### `nextcloud:18.0.10-rc-fpm` - linux; amd64
...
### `nextcloud:18.0.10-rc-fpm` - linux; arm variant v5
...
### `nextcloud:18.0.10-rc-fpm` - linux; arm variant v7
...
### `nextcloud:18.0.10-rc-fpm` - linux; arm64 variant v8
...
### `nextcloud:18.0.10-rc-fpm` - linux; 386
...
### `nextcloud:18.0.10-rc-fpm` - linux; mips64le
...
### `nextcloud:18.0.10-rc-fpm` - linux; s390x
