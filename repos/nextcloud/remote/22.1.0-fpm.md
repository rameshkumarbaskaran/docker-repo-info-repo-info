...
### `nextcloud:22.1.0-fpm` - linux; amd64
...
### `nextcloud:22.1.0-fpm` - linux; arm variant v5
...
### `nextcloud:22.1.0-fpm` - linux; arm variant v7
...
### `nextcloud:22.1.0-fpm` - linux; arm64 variant v8
...
### `nextcloud:22.1.0-fpm` - linux; 386
...
### `nextcloud:22.1.0-fpm` - linux; mips64le
...
### `nextcloud:22.1.0-fpm` - linux; ppc64le
...
### `nextcloud:22.1.0-fpm` - linux; s390x
