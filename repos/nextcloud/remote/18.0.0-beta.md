...
### `nextcloud:18.0.0-beta` - linux; amd64
...
### `nextcloud:18.0.0-beta` - linux; arm variant v5
...
### `nextcloud:18.0.0-beta` - linux; arm variant v7
...
### `nextcloud:18.0.0-beta` - linux; arm64 variant v8
...
### `nextcloud:18.0.0-beta` - linux; 386
...
### `nextcloud:18.0.0-beta` - linux; ppc64le
