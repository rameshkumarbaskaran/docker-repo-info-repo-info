...
### `nextcloud:27.1.1-apache` - linux; amd64
...
### `nextcloud:27.1.1-apache` - linux; arm64 variant v8
...
### `nextcloud:27.1.1-apache` - linux; 386
...
### `nextcloud:27.1.1-apache` - linux; mips64le
...
### `nextcloud:27.1.1-apache` - linux; ppc64le
