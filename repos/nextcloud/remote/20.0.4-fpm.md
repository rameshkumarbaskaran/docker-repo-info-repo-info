...
```console
$ docker pull nextcloud@sha256:5772622edd6fcdd0746aeb2583bb4e18c25f828dbe6e1ded097c648ef10f60a7
```
...
### `nextcloud:20.0.4-fpm` - linux; amd64
...
### `nextcloud:20.0.4-fpm` - linux; arm variant v7
...
### `nextcloud:20.0.4-fpm` - linux; arm64 variant v8
...
### `nextcloud:20.0.4-fpm` - linux; 386
...
### `nextcloud:20.0.4-fpm` - linux; ppc64le
...
### `nextcloud:20.0.4-fpm` - linux; s390x
