...
```console
$ docker pull nextcloud@sha256:1f86c0441fb963bf8ef608132a93cc224c91dcfa88faffe764c9fb3f405df48c
```
...
### `nextcloud:17.0.6-rc-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:17.0.6-rc-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:17.0.6-rc-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:17.0.6-rc-fpm-alpine` - linux; 386
...
### `nextcloud:17.0.6-rc-fpm-alpine` - linux; s390x
