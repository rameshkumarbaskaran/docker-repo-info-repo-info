...
### `nextcloud:21-rc` - linux; arm variant v5
...
### `nextcloud:21-rc` - linux; arm variant v7
...
### `nextcloud:21-rc` - linux; arm64 variant v8
...
### `nextcloud:21-rc` - linux; mips64le
