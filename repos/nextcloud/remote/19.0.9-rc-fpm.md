...
### `nextcloud:19.0.9-rc-fpm` - linux; amd64
...
### `nextcloud:19.0.9-rc-fpm` - linux; arm variant v7
...
### `nextcloud:19.0.9-rc-fpm` - linux; arm64 variant v8
...
### `nextcloud:19.0.9-rc-fpm` - linux; 386
...
### `nextcloud:19.0.9-rc-fpm` - linux; mips64le
...
### `nextcloud:19.0.9-rc-fpm` - linux; ppc64le
