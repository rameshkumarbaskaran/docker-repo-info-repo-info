...
```console
$ docker pull nextcloud@sha256:36525be7bd48afb6805966199e162685c952f3338705c53b3f5abe6c5b1deb8f
```
...
### `nextcloud:17.0.10RC1-fpm` - linux; amd64
...
### `nextcloud:17.0.10RC1-fpm` - linux; arm variant v5
...
### `nextcloud:17.0.10RC1-fpm` - linux; arm variant v7
...
### `nextcloud:17.0.10RC1-fpm` - linux; arm64 variant v8
...
### `nextcloud:17.0.10RC1-fpm` - linux; 386
...
### `nextcloud:17.0.10RC1-fpm` - linux; mips64le
...
### `nextcloud:17.0.10RC1-fpm` - linux; s390x
