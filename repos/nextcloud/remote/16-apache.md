...
```console
$ docker pull nextcloud@sha256:82e9ffde0db895553ddf9472772ae5d0279c222ecf092e518effc0e1b01dc5d0
```
...
### `nextcloud:16-apache` - linux; mips64le
...
### `nextcloud:16-apache` - linux; s390x
