...
### `nextcloud:18.0.1-rc-fpm-alpine` - linux; amd64
...
### `nextcloud:18.0.1-rc-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:18.0.1-rc-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:18.0.1-rc-fpm-alpine` - linux; 386
...
### `nextcloud:18.0.1-rc-fpm-alpine` - linux; ppc64le
