...
### `nextcloud:16.0.9RC1-fpm` - linux; amd64
...
### `nextcloud:16.0.9RC1-fpm` - linux; arm variant v5
...
### `nextcloud:16.0.9RC1-fpm` - linux; arm variant v7
...
### `nextcloud:16.0.9RC1-fpm` - linux; arm64 variant v8
...
### `nextcloud:16.0.9RC1-fpm` - linux; 386
...
### `nextcloud:16.0.9RC1-fpm` - linux; ppc64le
