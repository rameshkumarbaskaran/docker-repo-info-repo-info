...
```console
$ docker pull nextcloud@sha256:277921ecfe930720628f75b188929c1f94edb45a0e425e079438cc9e510aed33
```
...
### `nextcloud:18.0.10RC1-apache` - linux; amd64
...
### `nextcloud:18.0.10RC1-apache` - linux; arm variant v5
...
### `nextcloud:18.0.10RC1-apache` - linux; arm variant v7
...
### `nextcloud:18.0.10RC1-apache` - linux; arm64 variant v8
...
### `nextcloud:18.0.10RC1-apache` - linux; 386
...
### `nextcloud:18.0.10RC1-apache` - linux; mips64le
...
### `nextcloud:18.0.10RC1-apache` - linux; s390x
