...
```console
$ docker pull nextcloud@sha256:c1450bfe15cf6cc9733b096de7c2428d4dea2ac01b1f6fab06d02ae54673cab2
```
...
### `nextcloud:19.0.7-fpm-alpine` - linux; amd64
...
### `nextcloud:19.0.7-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:19.0.7-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:19.0.7-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:19.0.7-fpm-alpine` - linux; 386
...
### `nextcloud:19.0.7-fpm-alpine` - linux; ppc64le
...
### `nextcloud:19.0.7-fpm-alpine` - linux; s390x
