...
### `nextcloud:20.0.0-beta` - linux; amd64
...
### `nextcloud:20.0.0-beta` - linux; arm variant v5
...
### `nextcloud:20.0.0-beta` - linux; arm variant v7
...
### `nextcloud:20.0.0-beta` - linux; arm64 variant v8
...
### `nextcloud:20.0.0-beta` - linux; 386
...
### `nextcloud:20.0.0-beta` - linux; mips64le
...
### `nextcloud:20.0.0-beta` - linux; ppc64le
...
### `nextcloud:20.0.0-beta` - linux; s390x
