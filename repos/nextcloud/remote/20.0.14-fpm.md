...
```console
$ docker pull nextcloud@sha256:38f0c5fcfc96d457b8c50c12aab065cf0badfee83b7a389e7f67d3d020247c86
```
...
### `nextcloud:20.0.14-fpm` - linux; arm variant v7
...
### `nextcloud:20.0.14-fpm` - linux; arm64 variant v8
