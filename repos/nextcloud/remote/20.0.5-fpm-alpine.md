...
```console
$ docker pull nextcloud@sha256:8ec07d57ecc2512d1c24ebc7eb456e5a755c54ef12f8ecb8f3c042cf6d64ab5c
```
...
### `nextcloud:20.0.5-fpm-alpine` - linux; amd64
...
### `nextcloud:20.0.5-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:20.0.5-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:20.0.5-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:20.0.5-fpm-alpine` - linux; 386
...
### `nextcloud:20.0.5-fpm-alpine` - linux; ppc64le
...
### `nextcloud:20.0.5-fpm-alpine` - linux; s390x
