...
### `nextcloud:26.0.7-fpm` - linux; amd64
...
### `nextcloud:26.0.7-fpm` - linux; arm variant v5
...
### `nextcloud:26.0.7-fpm` - linux; arm variant v7
...
### `nextcloud:26.0.7-fpm` - linux; arm64 variant v8
...
### `nextcloud:26.0.7-fpm` - linux; 386
...
### `nextcloud:26.0.7-fpm` - linux; mips64le
...
### `nextcloud:26.0.7-fpm` - linux; ppc64le
...
### `nextcloud:26.0.7-fpm` - linux; s390x
