## `nextcloud:21.0.0beta7-fpm-alpine`

```console
$ docker pull nextcloud@sha256:8ff4736a2ae5fb88fcfaad61a8e1e18c4c7881f1b365ddb73e4af0246575d8e7
```
...
### `nextcloud:21.0.0beta7-fpm-alpine` - linux; amd64
...
### `nextcloud:21.0.0beta7-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:21.0.0beta7-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:21.0.0beta7-fpm-alpine` - linux; 386
...
### `nextcloud:21.0.0beta7-fpm-alpine` - linux; s390x
