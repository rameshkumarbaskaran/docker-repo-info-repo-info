...
```console
$ docker pull nextcloud@sha256:4d9b40ee9bd74e17e0cf4781f5c2b7455851e1b247461cdab0bc30535170bdb5
```
...
### `nextcloud:24.0.1-fpm-alpine` - linux; amd64
...
### `nextcloud:24.0.1-fpm-alpine` - linux; arm variant v7
...
### `nextcloud:24.0.1-fpm-alpine` - linux; ppc64le
