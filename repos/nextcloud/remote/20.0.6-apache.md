...
```console
$ docker pull nextcloud@sha256:f3798cb38377077405322dd8091131d61f08f2edfa564cdc5896515bf5c354ab
```
...
### `nextcloud:20.0.6-apache` - linux; amd64
...
### `nextcloud:20.0.6-apache` - linux; arm variant v5
...
### `nextcloud:20.0.6-apache` - linux; arm variant v7
...
### `nextcloud:20.0.6-apache` - linux; 386
...
### `nextcloud:20.0.6-apache` - linux; mips64le
...
### `nextcloud:20.0.6-apache` - linux; s390x
