...
### `nextcloud:19.0.0RC3-apache` - linux; amd64
...
### `nextcloud:19.0.0RC3-apache` - linux; arm variant v5
...
### `nextcloud:19.0.0RC3-apache` - linux; arm variant v7
...
### `nextcloud:19.0.0RC3-apache` - linux; arm64 variant v8
...
### `nextcloud:19.0.0RC3-apache` - linux; 386
...
### `nextcloud:19.0.0RC3-apache` - linux; mips64le
...
### `nextcloud:19.0.0RC3-apache` - linux; ppc64le
...
### `nextcloud:19.0.0RC3-apache` - linux; s390x
