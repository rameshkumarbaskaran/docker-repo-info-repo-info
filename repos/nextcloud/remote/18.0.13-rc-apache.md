...
```console
$ docker pull nextcloud@sha256:ab6f4d6316dd567603d804549d9c5b330ab0e99c1346ebc24a711ebd5f9397e4
```
...
### `nextcloud:18.0.13-rc-apache` - linux; amd64
...
### `nextcloud:18.0.13-rc-apache` - linux; arm variant v5
...
### `nextcloud:18.0.13-rc-apache` - linux; arm variant v7
...
### `nextcloud:18.0.13-rc-apache` - linux; arm64 variant v8
...
### `nextcloud:18.0.13-rc-apache` - linux; 386
...
### `nextcloud:18.0.13-rc-apache` - linux; mips64le
...
### `nextcloud:18.0.13-rc-apache` - linux; s390x
