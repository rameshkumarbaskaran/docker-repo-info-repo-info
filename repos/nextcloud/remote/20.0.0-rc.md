...
```console
$ docker pull nextcloud@sha256:a3370db7aaf4e16e331c70a4bdc4b0c1c7b13df5c16be91247b9e95444d26eec
```
...
### `nextcloud:20.0.0-rc` - linux; amd64
...
### `nextcloud:20.0.0-rc` - linux; arm variant v5
...
### `nextcloud:20.0.0-rc` - linux; arm variant v7
...
### `nextcloud:20.0.0-rc` - linux; arm64 variant v8
...
### `nextcloud:20.0.0-rc` - linux; mips64le
...
### `nextcloud:20.0.0-rc` - linux; ppc64le
...
### `nextcloud:20.0.0-rc` - linux; s390x

```console
$ docker pull nextcloud@sha256:fe588bcb511ba55251649238fd5f6392171c77e1c95f51d1e09e747700589e7b
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **279.3 MB (279334574 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f66695ad1ca23237d8b092552f3dca7ff3faed3ffcaa942162ed87cb21b53ce5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:bd23c4fd939326f5930e6d3dfe2df66f46c484501712564025df05cc66d26eaa`  
		...
		Size: 2.5 KB (2524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eee2a0cb55a01cb14033a29721e2165857aae9206039fc6cb755077105b0c1b0`  
		Last Modified: Thu, 24 Sep 2020 22:01:41 GMT  
		Size: 2.0 KB (1958 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
