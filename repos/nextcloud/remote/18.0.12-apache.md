...
### `nextcloud:18.0.12-apache` - linux; amd64
...
### `nextcloud:18.0.12-apache` - linux; arm variant v5
...
### `nextcloud:18.0.12-apache` - linux; arm variant v7
...
### `nextcloud:18.0.12-apache` - linux; arm64 variant v8
...
### `nextcloud:18.0.12-apache` - linux; 386
...
### `nextcloud:18.0.12-apache` - linux; mips64le
...
### `nextcloud:18.0.12-apache` - linux; ppc64le
...
### `nextcloud:18.0.12-apache` - linux; s390x
