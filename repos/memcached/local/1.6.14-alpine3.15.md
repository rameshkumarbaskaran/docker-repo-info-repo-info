...
- Created: `2022-02-11T23:47:45.414009944Z`
...
```console
libevent-2.1.12-r4 description:
An event notification library

libevent-2.1.12-r4 webpage:
https://libevent.org/

libevent-2.1.12-r4 installed size:
688 KiB

libevent-2.1.12-r4 license:
BSD-3-Clause
