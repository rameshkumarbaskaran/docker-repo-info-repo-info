...
### `matomo:4.0.5-fpm-alpine` - linux; amd64
...
### `matomo:4.0.5-fpm-alpine` - linux; arm variant v6
...
### `matomo:4.0.5-fpm-alpine` - linux; ppc64le
...
### `matomo:4.0.5-fpm-alpine` - linux; s390x
