...
### `matomo:4.10.0-apache` - linux; arm variant v5
...
### `matomo:4.10.0-apache` - linux; arm64 variant v8
...
### `matomo:4.10.0-apache` - linux; 386
...
### `matomo:4.10.0-apache` - linux; ppc64le
...
### `matomo:4.10.0-apache` - linux; s390x
