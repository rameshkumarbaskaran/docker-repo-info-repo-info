...
- Created: `2020-03-26T09:02:22.595714831Z`
- Virtual Size: ~ 813.46 Mb  
...
### `rpm` package: `java-11-openjdk-11.0.6.10-1.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-11-openjdk-11.0.6.10-1.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-11-openjdk-11.0.6.10-1.el7_7.src.rpm
```

### `rpm` package: `java-11-openjdk-devel-11.0.6.10-1.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-11-openjdk-devel-11.0.6.10-1.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-11-openjdk-11.0.6.10-1.el7_7.src.rpm
...
### `rpm` package: `java-11-openjdk-headless-11.0.6.10-1.el7_7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-11-openjdk-headless-11.0.6.10-1.el7_7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-11-openjdk-11.0.6.10-1.el7_7.src.rpm
