...
- Created: `2020-10-16T12:36:02.532127629Z`
- Virtual Size: ~ 734.90 Mb  
...
### `rpm` package: `java-11-openjdk-11.0.8.10-0.el7_8.x86_64`
...
### `rpm` package: `java-11-openjdk-devel-11.0.8.10-0.el7_8.x86_64`

Licenses (from `rpm --query`): ASL 1.1 and ASL 2.0 and BSD and BSD with advertising and GPL+ and GPLv2 and GPLv2 with exceptions and IJG and LGPLv2+ and MIT and MPLv2.0 and Public Domain and W3C and zlib and ISC and FTL and RSA

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `java-11-openjdk-headless-11.0.8.10-0.el7_8.x86_64`
