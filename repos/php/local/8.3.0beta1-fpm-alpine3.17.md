...
- Created: `2023-07-20T21:23:08.431998382Z`
...
```console
libcrypto3-3.0.9-r3 description:
Crypto library from openssl

libcrypto3-3.0.9-r3 webpage:
https://www.openssl.org/

libcrypto3-3.0.9-r3 installed size:
4108 KiB

libcrypto3-3.0.9-r3 license:
Apache-2.0
...
```console
libssl3-3.0.9-r3 description:
SSL shared libraries

libssl3-3.0.9-r3 webpage:
https://www.openssl.org/

libssl3-3.0.9-r3 installed size:
608 KiB

libssl3-3.0.9-r3 license:
Apache-2.0
...
```console
openssl-3.0.9-r3 description:
Toolkit for Transport Layer Security (TLS)

openssl-3.0.9-r3 webpage:
https://www.openssl.org/

openssl-3.0.9-r3 installed size:
872 KiB

openssl-3.0.9-r3 license:
Apache-2.0
