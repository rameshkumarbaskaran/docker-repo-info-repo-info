...
```console
$ docker pull php@sha256:324c194d3090a6abb29f78d14ee4fbd3ff3733605cb9793db061c6c9c9f04f4d
```
...
### `php:8.0.23-apache-buster` - linux; arm variant v7

```console
$ docker pull php@sha256:44df8ca9fc995b6c1050e696186d5beeb0f2aabc6f4dd077d9a385b80c4ddc6f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **120.6 MB (120578584 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5014c68302b9eba0e185a69f98d0ab1a1ed53fe1a243429f46ef44c1ef2590fa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
