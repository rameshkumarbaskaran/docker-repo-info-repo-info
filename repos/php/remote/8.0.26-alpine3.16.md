...
```console
$ docker pull php@sha256:a015e01c252b9d04657e23c549dc8a6254d90919cf6aef7a8338b3584450909e
```
...
### `php:8.0.26-alpine3.16` - linux; amd64
...
### `php:8.0.26-alpine3.16` - linux; arm variant v6
...
### `php:8.0.26-alpine3.16` - linux; arm64 variant v8
...
### `php:8.0.26-alpine3.16` - linux; 386
...
### `php:8.0.26-alpine3.16` - linux; ppc64le
...
### `php:8.0.26-alpine3.16` - linux; s390x
