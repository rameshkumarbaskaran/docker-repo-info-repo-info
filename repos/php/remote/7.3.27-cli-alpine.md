## `php:7.3.27-cli-alpine`

```console
$ docker pull php@sha256:4b54c1ea343f04a6619f031712cc6370846cdfdd1dc115c2d2c9d317a759910e
```
...
### `php:7.3.27-cli-alpine` - linux; amd64
...
### `php:7.3.27-cli-alpine` - linux; arm variant v6
...
### `php:7.3.27-cli-alpine` - linux; arm variant v7
...
### `php:7.3.27-cli-alpine` - linux; arm64 variant v8
...
### `php:7.3.27-cli-alpine` - linux; 386

```console
$ docker pull php@sha256:367b0c500d1bb52654840c8b2fc41fe2fd36539baa06964dd7483525c2c224a1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.6 MB (31570912 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24c8453b87fe4f3cd9dfaad4b49a3d6138d3aee0140445c27020b1c463be09c9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:7.3.27-cli-alpine` - linux; ppc64le
...
### `php:7.3.27-cli-alpine` - linux; s390x
