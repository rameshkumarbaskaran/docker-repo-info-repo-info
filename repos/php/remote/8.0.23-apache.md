...
```console
$ docker pull php@sha256:db045a3837b76eb13a2f2a054ab79ba4d2de4c57c636a8ea24940b007a7698ec
```
...
### `php:8.0.23-apache` - linux; arm variant v5
...
### `php:8.0.23-apache` - linux; arm64 variant v8
