...
### `php:7.4.33-fpm-alpine3.15` - linux; amd64
...
### `php:7.4.33-fpm-alpine3.15` - linux; arm variant v7
...
### `php:7.4.33-fpm-alpine3.15` - linux; 386
...
### `php:7.4.33-fpm-alpine3.15` - linux; ppc64le
...
### `php:7.4.33-fpm-alpine3.15` - linux; s390x
