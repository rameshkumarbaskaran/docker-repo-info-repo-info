...
```console
$ docker pull php@sha256:73b47cec7da6455e3dfffe95a3bb2aa909089bc1cb938066ed5cd32ed5c97a0b
```
...
### `php:8.1.4-fpm-alpine3.14` - linux; amd64
...
### `php:8.1.4-fpm-alpine3.14` - linux; arm variant v7
...
### `php:8.1.4-fpm-alpine3.14` - linux; arm64 variant v8
...
### `php:8.1.4-fpm-alpine3.14` - linux; 386
...
### `php:8.1.4-fpm-alpine3.14` - linux; ppc64le
...
### `php:8.1.4-fpm-alpine3.14` - linux; s390x
