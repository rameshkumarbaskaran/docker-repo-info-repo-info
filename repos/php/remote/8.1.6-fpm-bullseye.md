...
```console
$ docker pull php@sha256:0cb64efb1f36d9945d10c519d9c67662b05c45707ca961331481969be0ab6fc9
```
...
### `php:8.1.6-fpm-bullseye` - linux; amd64
...
### `php:8.1.6-fpm-bullseye` - linux; arm variant v5
...
### `php:8.1.6-fpm-bullseye` - linux; arm variant v7
...
### `php:8.1.6-fpm-bullseye` - linux; arm64 variant v8

```console
$ docker pull php@sha256:2a12cd657c3a735328340d7bce596bc5f6279224fff155eb8b4719f23165d534
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.6 MB (154646978 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ffcbf5e2288149f61b4faf2a2e9d0f153374afe552ffe04c403e2f8699ec222`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.1.6-fpm-bullseye` - linux; 386
...
### `php:8.1.6-fpm-bullseye` - linux; mips64le
...
### `php:8.1.6-fpm-bullseye` - linux; ppc64le
...
### `php:8.1.6-fpm-bullseye` - linux; s390x
