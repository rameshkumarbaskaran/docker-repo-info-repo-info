...
```console
$ docker pull php@sha256:9afd168b23e328bd65db84ff31a1c8daa1fe75f45450e7f68b1f1d7e827be277
```
...
```console
$ docker pull php@sha256:c9d8cf972b0d4235c2d0aa96171663371063cf305427a6b4e3a85abf96540de0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.0 MB (29959122 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb6e780f407e3683319952de3a5b9bac503350fa168eb46eee237d2ddc35e92f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
