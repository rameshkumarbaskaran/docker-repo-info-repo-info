...
### `php:8.0.17-zts-bullseye` - linux; amd64
...
### `php:8.0.17-zts-bullseye` - linux; arm variant v5
...
### `php:8.0.17-zts-bullseye` - linux; arm variant v7
...
### `php:8.0.17-zts-bullseye` - linux; arm64 variant v8
...
### `php:8.0.17-zts-bullseye` - linux; 386
...
### `php:8.0.17-zts-bullseye` - linux; mips64le
...
### `php:8.0.17-zts-bullseye` - linux; ppc64le
...
### `php:8.0.17-zts-bullseye` - linux; s390x
