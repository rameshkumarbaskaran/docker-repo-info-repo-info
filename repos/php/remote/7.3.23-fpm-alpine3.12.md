...
```console
$ docker pull php@sha256:c24c9976a91cb66d894d4b0ca0aefd8c491351eda22a2c416bf95bab1335ec3e
```
...
### `php:7.3.23-fpm-alpine3.12` - linux; arm variant v6
...
### `php:7.3.23-fpm-alpine3.12` - linux; arm variant v7
...
### `php:7.3.23-fpm-alpine3.12` - linux; arm64 variant v8
...
### `php:7.3.23-fpm-alpine3.12` - linux; ppc64le
...
### `php:7.3.23-fpm-alpine3.12` - linux; s390x
