...
```console
$ docker pull php@sha256:13d5f14e2977b925e5bd68f0f6cd47e666095ef5ed8729cad3d5c32779fa941f
```
...
### `php:7.4.4-zts-alpine` - linux; arm variant v7
...
### `php:7.4.4-zts-alpine` - linux; arm64 variant v8
...
### `php:7.4.4-zts-alpine` - linux; ppc64le
