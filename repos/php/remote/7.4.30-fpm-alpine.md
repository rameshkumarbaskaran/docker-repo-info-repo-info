...
```console
$ docker pull php@sha256:067036e0eba8ef7caebccb7122796564ec7502e25de0717087b44f33b9245bd0
```
...
### `php:7.4.30-fpm-alpine` - linux; amd64
...
### `php:7.4.30-fpm-alpine` - linux; arm variant v6
...
### `php:7.4.30-fpm-alpine` - linux; arm variant v7
...
### `php:7.4.30-fpm-alpine` - linux; arm64 variant v8
...
### `php:7.4.30-fpm-alpine` - linux; 386
...
### `php:7.4.30-fpm-alpine` - linux; ppc64le
...
### `php:7.4.30-fpm-alpine` - linux; s390x
