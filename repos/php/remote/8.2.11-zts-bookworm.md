...
### `php:8.2.11-zts-bookworm` - linux; amd64
...
### `php:8.2.11-zts-bookworm` - linux; arm variant v5
...
### `php:8.2.11-zts-bookworm` - linux; arm variant v7
...
### `php:8.2.11-zts-bookworm` - linux; arm64 variant v8
...
### `php:8.2.11-zts-bookworm` - linux; 386
...
### `php:8.2.11-zts-bookworm` - linux; mips64le
...
### `php:8.2.11-zts-bookworm` - linux; ppc64le
...
### `php:8.2.11-zts-bookworm` - linux; s390x
