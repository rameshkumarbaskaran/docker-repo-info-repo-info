...
```console
$ docker pull php@sha256:dc8b6fa099502592840411bb07c5adc264ff55f2dcb77eab462c6c0d229caf44
```
...
### `php:8.1.1-alpine` - linux; arm variant v6
...
### `php:8.1.1-alpine` - linux; arm variant v7
...
### `php:8.1.1-alpine` - linux; arm64 variant v8
...
### `php:8.1.1-alpine` - linux; ppc64le
