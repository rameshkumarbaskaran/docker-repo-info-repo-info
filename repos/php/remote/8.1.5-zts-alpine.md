...
```console
$ docker pull php@sha256:956524f28f758f624b0b544920d69b40e7881a029842d3b436de590e5ee44bc8
```
...
### `php:8.1.5-zts-alpine` - linux; amd64
...
### `php:8.1.5-zts-alpine` - linux; arm variant v6
...
### `php:8.1.5-zts-alpine` - linux; arm64 variant v8
...
### `php:8.1.5-zts-alpine` - linux; 386
...
### `php:8.1.5-zts-alpine` - linux; s390x
