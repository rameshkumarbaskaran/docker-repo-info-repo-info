...
### `php:7.4.7-alpine3.12` - linux; arm variant v6
...
### `php:7.4.7-alpine3.12` - linux; arm variant v7
...
### `php:7.4.7-alpine3.12` - linux; arm64 variant v8
...
### `php:7.4.7-alpine3.12` - linux; ppc64le
...
### `php:7.4.7-alpine3.12` - linux; s390x
