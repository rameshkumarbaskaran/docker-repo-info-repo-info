...
```console
$ docker pull php@sha256:b74c534bea814bbfdfd80e272e9d7e2ba5b696723aa7838a7708bf97d30dffbb
```
...
### `php:7-fpm-alpine3.15` - linux; amd64

```console
$ docker pull php@sha256:7f285bba310b0eddc36e19a2c246fa90fa4f79bfea106e900df1eade9c5207bb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.4 MB (26423664 bytes)**  
...
### `php:7-fpm-alpine3.15` - linux; arm variant v6
...
### `php:7-fpm-alpine3.15` - linux; arm variant v7

```console
$ docker pull php@sha256:7b5e726cc09985d19b11453b31bfac537e36e134f5af098cce94495b7c61a132
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **24.5 MB (24515898 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:43d73370f574fb7fc56658bf813a63fd5fa08bb6504b9aa045ff7b21236d8a9e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7-fpm-alpine3.15` - linux; arm64 variant v8

```console
$ docker pull php@sha256:a62c9d3bb15d68bb679d9e7b9e11446e2b538fa1753ad237fe6384e8c8d72bf5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.1 MB (26146168 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:caff0ec7f9a4dc50643592e43967c5ed05dd3629f30143617a34a94cb03b2b7e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7-fpm-alpine3.15` - linux; 386

```console
$ docker pull php@sha256:5be1daa95cdaca92c55b8a5b5a3e5a9347f91a5edcdc25ecc7400863c0456260
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.8 MB (26817324 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2fda2d2511103ba45b3f7038dbd9ce6870981d53f644c393fde0db5a4114bf59`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7-fpm-alpine3.15` - linux; ppc64le

```console
$ docker pull php@sha256:97097e8b6d322c95eec474ab334af1a61ac6a3417775421e3d1d307c3f683836
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.2 MB (27176504 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0dbcf1d302dec1bcd210d23966ec6ca6ca2f889fb86a0af94b95ed79728a0304`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7-fpm-alpine3.15` - linux; s390x

```console
$ docker pull php@sha256:21caa41d0d4089407e0f36d71f857df5a0129601590c84bb20f5cac21ada6abc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.9 MB (25852974 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7fd0e00690ba0be63bf4d88c4887c68854232ee112d9d5b8985873446be1494d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
