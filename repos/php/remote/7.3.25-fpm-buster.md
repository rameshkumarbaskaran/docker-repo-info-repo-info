...
```console
$ docker pull php@sha256:b7d11cf724239cb18cd04fd94f475ee35bb2936a350146889f8e0f048603e9f8
```
...
### `php:7.3.25-fpm-buster` - linux; amd64
...
### `php:7.3.25-fpm-buster` - linux; arm variant v5
...
### `php:7.3.25-fpm-buster` - linux; arm variant v7
...
### `php:7.3.25-fpm-buster` - linux; arm64 variant v8
...
### `php:7.3.25-fpm-buster` - linux; 386
...
### `php:7.3.25-fpm-buster` - linux; mips64le
...
### `php:7.3.25-fpm-buster` - linux; ppc64le
...
### `php:7.3.25-fpm-buster` - linux; s390x
