...
```console
$ docker pull php@sha256:b322994b9956dd23b07d1acc401e8c9c43db66cf775599b60f17a8b8e4a1834e
```
...
### `php:8.0.12-zts-bullseye` - linux; amd64
...
### `php:8.0.12-zts-bullseye` - linux; arm variant v5
...
### `php:8.0.12-zts-bullseye` - linux; arm variant v7
...
### `php:8.0.12-zts-bullseye` - linux; arm64 variant v8
...
### `php:8.0.12-zts-bullseye` - linux; 386
...
### `php:8.0.12-zts-bullseye` - linux; mips64le
...
### `php:8.0.12-zts-bullseye` - linux; ppc64le
...
### `php:8.0.12-zts-bullseye` - linux; s390x
