...
```console
$ docker pull php@sha256:e0c9c511e45c50415920dfa4c61296e3131070ea909a04bfa4edc6c7287a776e
```
...
### `php:8.1.19-apache-buster` - linux; arm64 variant v8
...
### `php:8.1.19-apache-buster` - linux; 386
