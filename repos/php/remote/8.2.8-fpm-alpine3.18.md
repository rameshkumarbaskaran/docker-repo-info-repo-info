...
```console
$ docker pull php@sha256:d40497902735781803fe19aa0b6c89351b508ffc933cb3b87f93cf19aeb2ad8b
```
...
### `php:8.2.8-fpm-alpine3.18` - linux; amd64
...
### `php:8.2.8-fpm-alpine3.18` - linux; arm variant v6
...
### `php:8.2.8-fpm-alpine3.18` - linux; arm variant v7
...
### `php:8.2.8-fpm-alpine3.18` - linux; arm64 variant v8
...
### `php:8.2.8-fpm-alpine3.18` - linux; 386
...
### `php:8.2.8-fpm-alpine3.18` - linux; ppc64le
...
### `php:8.2.8-fpm-alpine3.18` - linux; s390x
