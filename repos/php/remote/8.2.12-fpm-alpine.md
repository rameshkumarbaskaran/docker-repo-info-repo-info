...
```console
$ docker pull php@sha256:b07dcd4cc0acaae19745165dd5731ba617d3e090d0320b6a699b634170027595
```
...
### `php:8.2.12-fpm-alpine` - linux; amd64
...
### `php:8.2.12-fpm-alpine` - linux; arm variant v7
...
### `php:8.2.12-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.2.12-fpm-alpine` - linux; ppc64le
...
### `php:8.2.12-fpm-alpine` - linux; s390x
