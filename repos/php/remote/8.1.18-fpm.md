...
```console
$ docker pull php@sha256:740c203a93ec67458bd7adb1e0edcd53b89967c13cf7dab40b3987fc3ed3c868
```
...
### `php:8.1.18-fpm` - linux; arm variant v7
...
### `php:8.1.18-fpm` - linux; arm64 variant v8
