...
```console
$ docker pull php@sha256:bdc88d71be81150a98ac089a7e9d8e81cf79909f39b4c9e007a3097cc03a5102
```
...
### `php:8.2.12-cli-alpine3.17` - linux; amd64
...
### `php:8.2.12-cli-alpine3.17` - linux; arm variant v6
...
### `php:8.2.12-cli-alpine3.17` - linux; arm variant v7
...
### `php:8.2.12-cli-alpine3.17` - linux; arm64 variant v8
...
### `php:8.2.12-cli-alpine3.17` - linux; ppc64le
...
### `php:8.2.12-cli-alpine3.17` - linux; s390x
