...
```console
$ docker pull php@sha256:cc3e50aca7b0678114afde75c9b921d79792c7fa828f1f37b5c2345c40e85bf2
```
...
### `php:7.4.7-fpm-buster` - linux; arm variant v7
...
### `php:7.4.7-fpm-buster` - linux; arm64 variant v8
...
### `php:7.4.7-fpm-buster` - linux; mips64le
...
### `php:7.4.7-fpm-buster` - linux; ppc64le
