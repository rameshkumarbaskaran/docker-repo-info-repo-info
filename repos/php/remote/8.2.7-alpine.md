...
```console
$ docker pull php@sha256:b6f6c96bf6c41fa3a12250d03ebd6333105517ee5b12e6d8b11d35e8f7af2473
```
...
### `php:8.2.7-alpine` - linux; arm variant v6
...
### `php:8.2.7-alpine` - linux; arm64 variant v8
...
### `php:8.2.7-alpine` - linux; ppc64le
