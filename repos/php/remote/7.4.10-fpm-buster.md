...
```console
$ docker pull php@sha256:20bc67be9b37c4740ead4633b5f8aafff015a9188745f3c2d5ba9bab94c82078
```
...
### `php:7.4.10-fpm-buster` - linux; amd64
...
### `php:7.4.10-fpm-buster` - linux; arm variant v5
...
### `php:7.4.10-fpm-buster` - linux; arm variant v7
...
### `php:7.4.10-fpm-buster` - linux; arm64 variant v8
...
### `php:7.4.10-fpm-buster` - linux; 386
...
### `php:7.4.10-fpm-buster` - linux; mips64le
...
### `php:7.4.10-fpm-buster` - linux; ppc64le
...
### `php:7.4.10-fpm-buster` - linux; s390x
