## `php:7.3.20-alpine3.12`

```console
$ docker pull php@sha256:3bdd4bbce8602e734fd5659b8efad75dd95f30af96231bbb1b21c137e0a25da2
```
...
### `php:7.3.20-alpine3.12` - linux; arm variant v6
...
### `php:7.3.20-alpine3.12` - linux; arm variant v7
...
### `php:7.3.20-alpine3.12` - linux; arm64 variant v8
...
### `php:7.3.20-alpine3.12` - linux; s390x
