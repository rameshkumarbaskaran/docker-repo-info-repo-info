...
```console
$ docker pull php@sha256:60098ccab40cc2aea0c4c42816204a9c7481ebeeece96a3b060cd34794283e6c
```
...
### `php:8.1.13-alpine3.16` - linux; amd64
...
### `php:8.1.13-alpine3.16` - linux; arm variant v6
...
### `php:8.1.13-alpine3.16` - linux; arm64 variant v8
...
### `php:8.1.13-alpine3.16` - linux; 386
...
### `php:8.1.13-alpine3.16` - linux; ppc64le
...
### `php:8.1.13-alpine3.16` - linux; s390x
