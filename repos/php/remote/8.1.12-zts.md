...
```console
$ docker pull php@sha256:f43c70e3feec716823d2e141bbb9e1fad94978ac7842aa4c655afcda4080c779
```
...
### `php:8.1.12-zts` - linux; arm variant v5
...
### `php:8.1.12-zts` - linux; arm variant v7
...
### `php:8.1.12-zts` - linux; arm64 variant v8
