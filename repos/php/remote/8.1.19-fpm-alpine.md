...
```console
$ docker pull php@sha256:4500b61ba30a436f9af9289c637b275b119effe8f9d34060626d1bbd23bc12dd
```
...
### `php:8.1.19-fpm-alpine` - linux; amd64
...
### `php:8.1.19-fpm-alpine` - linux; arm variant v6
...
### `php:8.1.19-fpm-alpine` - linux; arm variant v7
...
### `php:8.1.19-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.1.19-fpm-alpine` - linux; 386
...
### `php:8.1.19-fpm-alpine` - linux; ppc64le
...
### `php:8.1.19-fpm-alpine` - linux; s390x

```console
$ docker pull php@sha256:84d4b561548a247cc7b5f9bf00bb44616604e650371ce6044754758c1b10b58e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.5 MB (29454281 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eeabef4ac68c752213b1a7fdc54e920f43619938822788bbc4bc8afee2ed0b09`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
