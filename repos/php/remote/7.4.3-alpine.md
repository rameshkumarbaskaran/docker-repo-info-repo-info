...
```console
$ docker pull php@sha256:1864a86da5eaf37f69d193006eda5181a89d4186a2e91e914e87db57e6e51dd1
```
...
### `php:7.4.3-alpine` - linux; arm variant v6
...
### `php:7.4.3-alpine` - linux; arm variant v7
...
### `php:7.4.3-alpine` - linux; arm64 variant v8
...
### `php:7.4.3-alpine` - linux; ppc64le

```console
$ docker pull php@sha256:36d2c0bf207ea2ab1a893e68af62a3ad53eda6945946952492c14619b1200f85
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.1 MB (30120392 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:058bd7432abf1b3d4316e0bef31e63f19a62278e9af26b5a589bbf36979bc086`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
