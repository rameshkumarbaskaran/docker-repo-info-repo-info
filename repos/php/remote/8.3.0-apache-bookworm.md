...
### `php:8.3.0-apache-bookworm` - linux; amd64
...
### `php:8.3.0-apache-bookworm` - linux; arm variant v5
...
### `php:8.3.0-apache-bookworm` - linux; arm variant v7
...
### `php:8.3.0-apache-bookworm` - linux; arm64 variant v8
...
### `php:8.3.0-apache-bookworm` - linux; 386
...
### `php:8.3.0-apache-bookworm` - linux; mips64le
...
### `php:8.3.0-apache-bookworm` - linux; ppc64le
...
### `php:8.3.0-apache-bookworm` - linux; s390x
