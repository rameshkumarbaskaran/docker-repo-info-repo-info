...
```console
$ docker pull php@sha256:d270c028eb38cba280b94385362d3a69bcb6b2166b424831a10421cc11954fdf
```
...
### `php:7.3.13-fpm` - linux; arm variant v5
...
### `php:7.3.13-fpm` - linux; arm variant v7

```console
$ docker pull php@sha256:9441f24183122e8f34ebaa9e45ee6081f1f27775a5e16d46b890a7f352217483
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **121.0 MB (120982627 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df4cc87181a9c33bde8e980b914ac693531accb9ccac59eb021e4b00647636a6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7.3.13-fpm` - linux; arm64 variant v8
