...
```console
$ docker pull php@sha256:c1d7a133bdc8618253be7cf3ef014551d24e15095277d4bef18807edd0da70d2
```
...
### `php:8.1.13-fpm-alpine3.16` - linux; amd64
...
### `php:8.1.13-fpm-alpine3.16` - linux; arm variant v6
...
### `php:8.1.13-fpm-alpine3.16` - linux; arm64 variant v8
...
### `php:8.1.13-fpm-alpine3.16` - linux; 386
...
### `php:8.1.13-fpm-alpine3.16` - linux; ppc64le
...
### `php:8.1.13-fpm-alpine3.16` - linux; s390x
