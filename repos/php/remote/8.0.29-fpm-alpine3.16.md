...
```console
$ docker pull php@sha256:57b4b804c89fe49234197c5ae372510b101580684561ad43cd8bd669df3a243a
```
...
### `php:8.0.29-fpm-alpine3.16` - linux; amd64
...
### `php:8.0.29-fpm-alpine3.16` - linux; arm variant v6
...
### `php:8.0.29-fpm-alpine3.16` - linux; arm variant v7

```console
$ docker pull php@sha256:3c23eea5ab4e8acb065deb8012a630123a8eabd76775e15ee8c6ba94258c1e76
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.2 MB (25228561 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a8d104341d6a85d8d0106af6795456b7f7d9aeccabd4b63372c7f96ff3f9ccf3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.0.29-fpm-alpine3.16` - linux; arm64 variant v8
...
### `php:8.0.29-fpm-alpine3.16` - linux; 386
...
### `php:8.0.29-fpm-alpine3.16` - linux; ppc64le
...
### `php:8.0.29-fpm-alpine3.16` - linux; s390x
