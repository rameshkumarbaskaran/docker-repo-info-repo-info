...
### `php:8.2.12-alpine3.18` - linux; amd64
...
### `php:8.2.12-alpine3.18` - linux; arm variant v7
...
### `php:8.2.12-alpine3.18` - linux; arm64 variant v8
...
### `php:8.2.12-alpine3.18` - linux; ppc64le
...
### `php:8.2.12-alpine3.18` - linux; s390x
