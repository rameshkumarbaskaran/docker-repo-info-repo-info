...
```console
$ docker pull php@sha256:bf5b1250b844353d87aefe4289e4acf023c11bb42aa7e8170e28e7bf4be6df89
```
...
### `php:8.2.10-fpm` - linux; arm variant v5
...
### `php:8.2.10-fpm` - linux; arm variant v7
...
### `php:8.2.10-fpm` - linux; arm64 variant v8
