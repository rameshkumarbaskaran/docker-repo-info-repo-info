...
### `php:8.0.2-apache` - linux; arm variant v7
...
### `php:8.0.2-apache` - linux; arm64 variant v8
...
### `php:8.0.2-apache` - linux; mips64le
...
### `php:8.0.2-apache` - linux; ppc64le
