...
### `php:7.3.15-apache-buster` - linux; amd64
...
### `php:7.3.15-apache-buster` - linux; arm64 variant v8
...
### `php:7.3.15-apache-buster` - linux; 386
...
### `php:7.3.15-apache-buster` - linux; ppc64le
