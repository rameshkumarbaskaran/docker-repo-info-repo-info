...
```console
$ docker pull php@sha256:42b216afdc62e24d2f16fba4621158d56be2a65248d779e5f7187747ff38f48d
```
...
### `php:8.2.0beta1-apache-buster` - linux; arm variant v7
...
### `php:8.2.0beta1-apache-buster` - linux; mips64le
...
### `php:8.2.0beta1-apache-buster` - linux; ppc64le
