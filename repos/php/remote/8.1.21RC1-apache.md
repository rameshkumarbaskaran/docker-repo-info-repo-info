...
```console
$ docker pull php@sha256:2700d353cd81c6e663308cb29ae724d6538dd62a41082f70449e354d637a486e
```
...
### `php:8.1.21RC1-apache` - linux; 386
...
### `php:8.1.21RC1-apache` - linux; mips64le
