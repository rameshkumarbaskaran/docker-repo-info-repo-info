...
### `php:8.0.29-apache` - linux; arm variant v5
...
### `php:8.0.29-apache` - linux; arm variant v7
...
### `php:8.0.29-apache` - linux; arm64 variant v8
...
### `php:8.0.29-apache` - linux; mips64le
...
### `php:8.0.29-apache` - linux; ppc64le
