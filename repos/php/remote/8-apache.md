...
```console
$ docker pull php@sha256:c7e5eb67e3f8a2fa92033cdce54209ac5ff16942ed398f22681a4ea83c9020f1
```
...
```console
$ docker pull php@sha256:2bd488afab2e1eabcaf869311750522ca487d54aaf565943c5215d3f177be8bc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.1 MB (182129078 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a1e5e9eb40ba5db36964fda407c25600811d78e3a27d986eab560b5d0a504d5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
