...
```console
$ docker pull php@sha256:27d2a1075bb59c126e5e423b87c1baa11eb25b4d8a332467667b15d9116160ef
```
...
### `php:7.4.20-fpm-alpine` - linux; amd64
...
### `php:7.4.20-fpm-alpine` - linux; arm variant v6
...
### `php:7.4.20-fpm-alpine` - linux; arm variant v7
...
### `php:7.4.20-fpm-alpine` - linux; arm64 variant v8
...
### `php:7.4.20-fpm-alpine` - linux; 386
...
### `php:7.4.20-fpm-alpine` - linux; ppc64le
...
### `php:7.4.20-fpm-alpine` - linux; s390x
