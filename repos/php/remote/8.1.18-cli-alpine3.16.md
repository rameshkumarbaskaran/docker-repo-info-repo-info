...
```console
$ docker pull php@sha256:b2ed12c7c99d3f9dafd6169b0a67b5f80267e77eee5f000d3868317b314dbc3c
```
...
### `php:8.1.18-cli-alpine3.16` - linux; amd64
...
### `php:8.1.18-cli-alpine3.16` - linux; arm variant v6
...
### `php:8.1.18-cli-alpine3.16` - linux; arm variant v7
...
### `php:8.1.18-cli-alpine3.16` - linux; arm64 variant v8
...
### `php:8.1.18-cli-alpine3.16` - linux; ppc64le
...
### `php:8.1.18-cli-alpine3.16` - linux; s390x
