...
```console
$ docker pull php@sha256:e49eb038586d5ef7e4b350b7c01189aab832dd733c7d7eb8f4ad768d8c23edfd
```
...
### `php:7.4.4-cli` - linux; arm variant v5
...
### `php:7.4.4-cli` - linux; arm variant v7
...
### `php:7.4.4-cli` - linux; arm64 variant v8
