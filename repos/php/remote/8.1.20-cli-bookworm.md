...
### `php:8.1.20-cli-bookworm` - linux; amd64
...
### `php:8.1.20-cli-bookworm` - linux; arm variant v7
...
### `php:8.1.20-cli-bookworm` - linux; ppc64le
...
### `php:8.1.20-cli-bookworm` - linux; s390x
