...
```console
$ docker pull php@sha256:9d18ffe794c56a6041659270e5eef1bda89ee1e2ec9d1d9a91b43823c73e7777
```
...
### `php:8.1.16-bullseye` - linux; amd64
...
### `php:8.1.16-bullseye` - linux; arm variant v5
...
### `php:8.1.16-bullseye` - linux; arm variant v7
...
### `php:8.1.16-bullseye` - linux; arm64 variant v8
...
### `php:8.1.16-bullseye` - linux; mips64le
...
### `php:8.1.16-bullseye` - linux; ppc64le
...
### `php:8.1.16-bullseye` - linux; s390x
