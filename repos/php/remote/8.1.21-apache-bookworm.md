...
```console
$ docker pull php@sha256:cebb16b5f02bc009539cfa3bd117949b293dc51995d0ec35d995a340a4fae025
```
...
### `php:8.1.21-apache-bookworm` - linux; amd64
...
### `php:8.1.21-apache-bookworm` - linux; arm variant v5
...
### `php:8.1.21-apache-bookworm` - linux; arm variant v7
...
### `php:8.1.21-apache-bookworm` - linux; arm64 variant v8
...
### `php:8.1.21-apache-bookworm` - linux; 386
...
### `php:8.1.21-apache-bookworm` - linux; mips64le
...
### `php:8.1.21-apache-bookworm` - linux; ppc64le
