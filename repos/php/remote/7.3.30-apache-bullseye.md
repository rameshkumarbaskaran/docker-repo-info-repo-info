...
```console
$ docker pull php@sha256:23d092a04bf4a1a5c333c7e7fe54e55ffc5fd8b068346e2193595a740b21cd27
```
...
### `php:7.3.30-apache-bullseye` - linux; amd64
...
### `php:7.3.30-apache-bullseye` - linux; arm variant v7
...
### `php:7.3.30-apache-bullseye` - linux; arm64 variant v8
...
### `php:7.3.30-apache-bullseye` - linux; 386
...
### `php:7.3.30-apache-bullseye` - linux; mips64le
...
### `php:7.3.30-apache-bullseye` - linux; ppc64le
