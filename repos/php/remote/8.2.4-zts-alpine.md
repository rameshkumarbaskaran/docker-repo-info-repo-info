...
```console
$ docker pull php@sha256:d2208ce484f50a284ed2728f092b09850f4f0e9276bdc8d27140af55e2a05cfc
```
...
### `php:8.2.4-zts-alpine` - linux; arm variant v7
...
### `php:8.2.4-zts-alpine` - linux; 386
...
### `php:8.2.4-zts-alpine` - linux; s390x
