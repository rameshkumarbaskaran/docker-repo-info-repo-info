...
```console
$ docker pull php@sha256:98e7d20de6271fd0338bd26ddb929cccc2c6fe55eeda231dd080449678509692
```
...
### `php:8.2.4-zts-alpine` - linux; amd64
...
### `php:8.2.4-zts-alpine` - linux; arm variant v6
...
### `php:8.2.4-zts-alpine` - linux; arm64 variant v8
...
### `php:8.2.4-zts-alpine` - linux; ppc64le
