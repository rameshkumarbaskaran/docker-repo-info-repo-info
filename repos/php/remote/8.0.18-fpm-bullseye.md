...
```console
$ docker pull php@sha256:02cffc74fa97ee061eab0609c1021fdf8bf9dd96f423a1ec754c6989e0df0c11
```
...
### `php:8.0.18-fpm-bullseye` - linux; amd64
...
### `php:8.0.18-fpm-bullseye` - linux; arm variant v5

```console
$ docker pull php@sha256:cbcc5475efbb03031bb3bd7dc82d3409f843c38cf325364cbb70dc7a9c85ac1b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.3 MB (138349236 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:66e8ca8a02fd77f421d561043e109fee743bb097c35f129b8e9d509e1952ceac`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.0.18-fpm-bullseye` - linux; arm variant v7

```console
$ docker pull php@sha256:f8f2a8f5cbda7f4e50e94990ab66a2a8ccf54b869b44d5ac9effe5984656e137
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.8 MB (130845776 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67147f4f826aceeaad94d564f9719233eaa13186ce62467bfeeb6f3775c3e3a0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.0.18-fpm-bullseye` - linux; arm64 variant v8

```console
$ docker pull php@sha256:bf8b2fe818d2a2a3a932b3c86d1d39a7b5c43f6e85945cc7cafcfe3fd753d4c9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.9 MB (152941688 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5bbc9c9774b272da97cecc470100cb8e00bf5b2e54b497075471899b1ba3aeda`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.0.18-fpm-bullseye` - linux; 386
...
### `php:8.0.18-fpm-bullseye` - linux; mips64le
...
### `php:8.0.18-fpm-bullseye` - linux; ppc64le
...
### `php:8.0.18-fpm-bullseye` - linux; s390x

```console
$ docker pull php@sha256:1534fe256312f528c1fcdce37c35070760c201738dea2815a2067bfc9a59fc56
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.5 MB (137513091 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2913c73c8c80043b3c46d3176c669ae1f7a01eabcb5c309393198fdaf8ac7b5f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
