...
```console
$ docker pull php@sha256:055ee36dcef00ee38fcb6b9d72547978562f97faa272a1be75959f2a60bdbbef
```
...
### `php:8.1.8-cli-alpine3.16` - linux; amd64
...
### `php:8.1.8-cli-alpine3.16` - linux; arm variant v7
...
### `php:8.1.8-cli-alpine3.16` - linux; arm64 variant v8
...
### `php:8.1.8-cli-alpine3.16` - linux; 386
