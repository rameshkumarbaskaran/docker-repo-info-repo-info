...
```console
$ docker pull php@sha256:ba7681c8ed747a13f66aac88a61356be2c0110580219d2d30414120ab931fbec
```
...
### `php:7.3.26-fpm-alpine3.12` - linux; amd64
...
### `php:7.3.26-fpm-alpine3.12` - linux; arm variant v6

```console
$ docker pull php@sha256:10a6a8f6d097959ad94ce554db7a57df8cba62311ce8005be2d3f2e93b899e1b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.5 MB (29516154 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d83826598b0603f87215c72992e49469a37b35011c5eca7fb69987634e0af04`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7.3.26-fpm-alpine3.12` - linux; arm variant v7

```console
$ docker pull php@sha256:58b8bd918ee3a1e804ccf0985d3238b4044d9132d4ae0e94449ac95835ca0f05
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.4 MB (28370006 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b893950e373d9416479320c8c1b44f3e9573a552676aa2d226d4e727a626939a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7.3.26-fpm-alpine3.12` - linux; arm64 variant v8
...
### `php:7.3.26-fpm-alpine3.12` - linux; 386
...
### `php:7.3.26-fpm-alpine3.12` - linux; ppc64le
...
### `php:7.3.26-fpm-alpine3.12` - linux; s390x
