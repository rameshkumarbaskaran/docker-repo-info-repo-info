...
```console
$ docker pull php@sha256:9c06338c7e0b614a3cc16c07089b27d8bf0b1ecf814a599f9648f918087457ee
```
...
```console
$ docker pull php@sha256:9e11d2cc73040fc4c7ec28e6aaf3c33681922795fec130e2f24c13f6a85ea876
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.1 MB (160110284 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aff5ae96d5b7db272c684e47b8c06ccfff207cd558a13fa4e87f63db7dbedeaf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
