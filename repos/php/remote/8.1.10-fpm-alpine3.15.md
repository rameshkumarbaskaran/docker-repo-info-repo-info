...
```console
$ docker pull php@sha256:a71e51e326f99b9e35458899db5e74bbd534ee9dfa4ae6711936f43b14d49db9
```
...
### `php:8.1.10-fpm-alpine3.15` - linux; arm variant v6
...
### `php:8.1.10-fpm-alpine3.15` - linux; arm64 variant v8
