...
### `php:7.4.26-apache-buster` - linux; amd64
...
### `php:7.4.26-apache-buster` - linux; arm variant v7
...
### `php:7.4.26-apache-buster` - linux; 386
...
### `php:7.4.26-apache-buster` - linux; mips64le
...
### `php:7.4.26-apache-buster` - linux; ppc64le
