...
```console
$ docker pull php@sha256:ed31b696e34d15d2d3d9812828d2d18909b2a78f0686c3b545b7955777a9c5cd
```
...
### `php:8.1.19-alpine` - linux; arm variant v6
...
### `php:8.1.19-alpine` - linux; arm variant v7
...
### `php:8.1.19-alpine` - linux; arm64 variant v8
...
### `php:8.1.19-alpine` - linux; ppc64le
