...
```console
$ docker pull php@sha256:99940b3296bb88c11223b5309e5a0fc46fb30e9d6e8ca44577498a71ebf36ec5
```
...
### `php:7.4.6-fpm-alpine3.10` - linux; amd64
...
### `php:7.4.6-fpm-alpine3.10` - linux; arm variant v7
...
### `php:7.4.6-fpm-alpine3.10` - linux; arm64 variant v8
...
### `php:7.4.6-fpm-alpine3.10` - linux; 386
