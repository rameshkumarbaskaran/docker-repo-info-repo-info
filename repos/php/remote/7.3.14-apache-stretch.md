...
### `php:7.3.14-apache-stretch` - linux; amd64
...
### `php:7.3.14-apache-stretch` - linux; arm64 variant v8
...
### `php:7.3.14-apache-stretch` - linux; 386
...
### `php:7.3.14-apache-stretch` - linux; ppc64le
