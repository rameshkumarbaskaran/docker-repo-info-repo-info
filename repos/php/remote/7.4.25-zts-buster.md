...
```console
$ docker pull php@sha256:f39b97076b0a50a62c0ba637676aa1f7d74ffeed48976d70425a886ac2fa68f5
```
...
### `php:7.4.25-zts-buster` - linux; arm variant v7
...
### `php:7.4.25-zts-buster` - linux; 386
...
### `php:7.4.25-zts-buster` - linux; mips64le
...
### `php:7.4.25-zts-buster` - linux; ppc64le
