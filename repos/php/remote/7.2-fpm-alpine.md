...
```console
$ docker pull php@sha256:bd35ba0d58c71a3e8735e20ad49896e259f3484f659d5ce4daba7b21aeafef24
```
...
```console
$ docker pull php@sha256:0c31939db669f1bda0cf3e3d7361aa4e13526c896c8cecca6438b008588d2b1e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.7 MB (28704420 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:465d4d097b9b0be8a5e902040ed9d3492cfcc84f637cdbc9a488048725762efa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
