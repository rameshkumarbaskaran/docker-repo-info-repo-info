...
```console
$ docker pull php@sha256:76e98125012f25aaeab50c1943692d56de1e595fb081afbf874ca27b57e8496e
```
...
### `php:7.3.33-fpm-alpine` - linux; amd64
...
### `php:7.3.33-fpm-alpine` - linux; arm variant v6
...
### `php:7.3.33-fpm-alpine` - linux; arm variant v7
...
### `php:7.3.33-fpm-alpine` - linux; arm64 variant v8
...
### `php:7.3.33-fpm-alpine` - linux; 386
...
### `php:7.3.33-fpm-alpine` - linux; ppc64le
...
### `php:7.3.33-fpm-alpine` - linux; s390x
