...
```console
$ docker pull php@sha256:a9e550b0264af28d72428bf08b56a784e333524cac5ff04018c53acc8942a5ad
```
...
### `php:8.1.11-cli-alpine` - linux; amd64
...
### `php:8.1.11-cli-alpine` - linux; arm variant v6
...
### `php:8.1.11-cli-alpine` - linux; arm64 variant v8
...
### `php:8.1.11-cli-alpine` - linux; 386
...
### `php:8.1.11-cli-alpine` - linux; ppc64le
...
### `php:8.1.11-cli-alpine` - linux; s390x
