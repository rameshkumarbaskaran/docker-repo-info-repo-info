...
```console
$ docker pull php@sha256:45bdce9a594d23ab6e779a1706b7bb2ef34a4e3357136ca13dd50df25cc1c5be
```
...
### `php:7.2.31-fpm-alpine3.12` - linux; arm variant v7
...
### `php:7.2.31-fpm-alpine3.12` - linux; arm64 variant v8
...
### `php:7.2.31-fpm-alpine3.12` - linux; ppc64le
