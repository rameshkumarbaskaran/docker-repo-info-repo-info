...
```console
$ docker pull php@sha256:51b20f1bf6c39d5a4c503e4a1756786f617d20ec0d4fe025d461acc60fe1c8ad
```
...
```console
$ docker pull php@sha256:2e958fdfaef5fe1cb9cf1d71ea967ff2b60205a34ea43b77020f11e024b6cdda
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.5 MB (32532438 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb69d29a22a33ef52b41543c5b2fa8a52ec02b2a510486943c20fd93f108977d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
