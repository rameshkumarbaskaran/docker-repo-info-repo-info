...
```console
$ docker pull php@sha256:5f484bf472e5ecc8ceb244fcc60b35a2075896dc503ef362d2a0ba6eb62677ea
```
...
### `php:8.1.25-zts-alpine` - linux; amd64
...
### `php:8.1.25-zts-alpine` - linux; arm variant v6
...
### `php:8.1.25-zts-alpine` - linux; arm variant v7
...
### `php:8.1.25-zts-alpine` - linux; arm64 variant v8
...
### `php:8.1.25-zts-alpine` - linux; ppc64le
...
### `php:8.1.25-zts-alpine` - linux; s390x
