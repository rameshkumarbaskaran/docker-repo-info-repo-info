...
```console
$ docker pull php@sha256:383a71e8483ebbf9e1516ee8fb714502b5f565b8189203625d43218176c2eb70
```
...
### `php:7.4.23-apache-buster` - linux; amd64
...
### `php:7.4.23-apache-buster` - linux; 386
...
### `php:7.4.23-apache-buster` - linux; ppc64le
