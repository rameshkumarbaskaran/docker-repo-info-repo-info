...
```console
$ docker pull php@sha256:2d728b99fed73c8bfef2c15119b882d38b87dcdd627dec920b7a6cc59a8cd547
```
...
### `php:8.0.21-fpm` - linux; arm variant v5
...
### `php:8.0.21-fpm` - linux; arm variant v7
...
### `php:8.0.21-fpm` - linux; arm64 variant v8
