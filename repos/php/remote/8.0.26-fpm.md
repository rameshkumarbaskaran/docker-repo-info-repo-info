...
```console
$ docker pull php@sha256:d440fdd10b406a1379f2cdc95288190979927fe25347ee75ad2560ff1e5710c4
```
...
### `php:8.0.26-fpm` - linux; arm variant v5
...
### `php:8.0.26-fpm` - linux; arm variant v7
...
### `php:8.0.26-fpm` - linux; arm64 variant v8
