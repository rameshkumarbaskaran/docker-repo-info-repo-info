...
```console
$ docker pull php@sha256:3a4f2d7895289b15a69be6a3b23c1ef7d99bae5af250ffdd9d658e3dd4633a22
```
...
### `php:8.0.0rc1-fpm-alpine3.12` - linux; amd64
...
### `php:8.0.0rc1-fpm-alpine3.12` - linux; arm variant v6
...
### `php:8.0.0rc1-fpm-alpine3.12` - linux; arm64 variant v8
...
### `php:8.0.0rc1-fpm-alpine3.12` - linux; 386
...
### `php:8.0.0rc1-fpm-alpine3.12` - linux; ppc64le
...
### `php:8.0.0rc1-fpm-alpine3.12` - linux; s390x
