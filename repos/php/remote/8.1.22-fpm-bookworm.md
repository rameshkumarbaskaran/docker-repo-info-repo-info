...
```console
$ docker pull php@sha256:bde482789a6d1fea323e3d29c5f2e01c19f0d84c7eb897661e991ce8b8757b9e
```
...
### `php:8.1.22-fpm-bookworm` - linux; amd64
...
### `php:8.1.22-fpm-bookworm` - linux; arm variant v5
...
### `php:8.1.22-fpm-bookworm` - linux; arm variant v7
...
### `php:8.1.22-fpm-bookworm` - linux; arm64 variant v8
...
### `php:8.1.22-fpm-bookworm` - linux; 386
...
### `php:8.1.22-fpm-bookworm` - linux; mips64le

```console
$ docker pull php@sha256:ffd27b9b19c1dc28fab2b700966caab7c1bd53d1b1fd82a6f2e57c91f64b9317
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.1 MB (148134306 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c10cf20c01914cf266cd2f1f20402dbf2a767670f83b8e8c3417d96030e21483`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.1.22-fpm-bookworm` - linux; ppc64le

```console
$ docker pull php@sha256:2a1faaea45221fc92e403795fb1ac6636645e9e5adcc75b4f90df765e9cdcb07
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.1 MB (177100452 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3485093bff85ac00050794c4bb90021a31a1779ee3f89d95b12d8cc1a750aedb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.1.22-fpm-bookworm` - linux; s390x

```console
$ docker pull php@sha256:89fb0e74696aebe87ee48168184c3367875486dccbc940aca01d06ae26add0cd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.9 MB (146893809 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a4e25813d1f618b6c17991a64eccd0b70a31bf7707199b7b76f087f9e56a774`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
