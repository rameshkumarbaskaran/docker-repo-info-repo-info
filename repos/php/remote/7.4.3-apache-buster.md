...
```console
$ docker pull php@sha256:6a1ac05c6be41bd4f32a4a94fd1e48bb9443be1ca63461d1c81d36eae39c5b96
```
...
### `php:7.4.3-apache-buster` - linux; amd64
...
### `php:7.4.3-apache-buster` - linux; arm64 variant v8
...
### `php:7.4.3-apache-buster` - linux; ppc64le
