...
```console
$ docker pull php@sha256:6bdcb67dace5f2c8b4d382afaec2889891425faa184e8eaa098425b5e1d3ad70
```
...
### `php:8.1.5-fpm-buster` - linux; arm variant v7
...
### `php:8.1.5-fpm-buster` - linux; mips64le
...
### `php:8.1.5-fpm-buster` - linux; ppc64le
