...
```console
$ docker pull php@sha256:73ed6aae7a51a6f75ff7a240209349cc511c6426fed8a3c5453a553000675a68
```
...
### `php:8.1.10-apache` - linux; arm variant v5
...
### `php:8.1.10-apache` - linux; arm64 variant v8
...
### `php:8.1.10-apache` - linux; mips64le
...
### `php:8.1.10-apache` - linux; ppc64le
