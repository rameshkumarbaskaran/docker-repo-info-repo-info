...
```console
$ docker pull php@sha256:f5a8489d6ce2bb5d1bde2ccd4fe27ecfdc87b01235503eda5d9dd7c4fa5de8aa
```
...
### `php:7.3.13-fpm-stretch` - linux; amd64
...
### `php:7.3.13-fpm-stretch` - linux; 386
