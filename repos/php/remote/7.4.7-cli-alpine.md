...
```console
$ docker pull php@sha256:c74886fbb8b1f5e2700aa769113429753ac5048ba9c142594753d9f017a319b8
```
...
### `php:7.4.7-cli-alpine` - linux; arm variant v6
...
### `php:7.4.7-cli-alpine` - linux; arm variant v7
...
### `php:7.4.7-cli-alpine` - linux; arm64 variant v8
...
### `php:7.4.7-cli-alpine` - linux; ppc64le
...
### `php:7.4.7-cli-alpine` - linux; s390x
