...
```console
$ docker pull php@sha256:3581789b3712531acb150eeb68f476f8882380a37820b5e8aa11f37295cda173
```
...
### `php:7.4.25-fpm-bullseye` - linux; amd64
...
### `php:7.4.25-fpm-bullseye` - linux; arm variant v5
...
### `php:7.4.25-fpm-bullseye` - linux; arm variant v7
...
### `php:7.4.25-fpm-bullseye` - linux; arm64 variant v8
...
### `php:7.4.25-fpm-bullseye` - linux; 386
...
### `php:7.4.25-fpm-bullseye` - linux; mips64le
...
### `php:7.4.25-fpm-bullseye` - linux; ppc64le
...
### `php:7.4.25-fpm-bullseye` - linux; s390x

```console
$ docker pull php@sha256:2502436865730f11522813e8914f3429ecd08aaca9037af7344eff4c00506a4e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.2 MB (140224760 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7e6485c45bffed7647257cb0cbb171496cfec3398af584200fef30b0be234e4a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
