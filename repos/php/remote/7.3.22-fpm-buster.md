...
```console
$ docker pull php@sha256:5c9d0887bf3968d02ffac6080da05872c9145cede561b5463a139f4abc2f4fa7
```
...
### `php:7.3.22-fpm-buster` - linux; amd64
...
### `php:7.3.22-fpm-buster` - linux; arm variant v7
...
### `php:7.3.22-fpm-buster` - linux; 386
...
### `php:7.3.22-fpm-buster` - linux; ppc64le
