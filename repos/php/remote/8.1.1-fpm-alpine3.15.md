...
```console
$ docker pull php@sha256:4f4073e52768a45ce3e48a1423c32a9158ce8a8e224520cd97df38e31533c0c6
```
...
### `php:8.1.1-fpm-alpine3.15` - linux; arm variant v6
...
### `php:8.1.1-fpm-alpine3.15` - linux; arm variant v7
...
### `php:8.1.1-fpm-alpine3.15` - linux; arm64 variant v8
...
### `php:8.1.1-fpm-alpine3.15` - linux; ppc64le
...
### `php:8.1.1-fpm-alpine3.15` - linux; s390x
