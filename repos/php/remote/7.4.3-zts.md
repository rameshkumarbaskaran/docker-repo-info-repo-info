...
```console
$ docker pull php@sha256:b68c5db8b9849e4098d09127f59dfb7014e034c4b306c03209e7950ca66a04e8
```
...
### `php:7.4.3-zts` - linux; arm variant v5
...
### `php:7.4.3-zts` - linux; arm variant v7
...
### `php:7.4.3-zts` - linux; arm64 variant v8
