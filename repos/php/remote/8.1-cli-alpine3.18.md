...
```console
$ docker pull php@sha256:7e14d7da4f4fda0becc3e9e9323a1804bca148dc78ddbe431286d8fb57a37007
```
...
```console
$ docker pull php@sha256:4fbc7f5fa931268986364d43908595cc0a8f42b1e141cbbac371bbe9093df6f1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.1 MB (33060634 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:783ec8270a1882ce4911dc3dd21e8b44f2ca3ebb9cff330b0fd9f14d07a8dce2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
