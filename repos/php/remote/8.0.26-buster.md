...
```console
$ docker pull php@sha256:5521409e70313f9e8bb4a40f3a3347c585e2c56e2b74bdc8d6f78c86adc212cc
```
...
### `php:8.0.26-buster` - linux; arm variant v7
...
### `php:8.0.26-buster` - linux; arm64 variant v8
