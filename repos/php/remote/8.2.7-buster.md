...
```console
$ docker pull php@sha256:aaf76c2ee06110bf121d179de29fadae5a228951f5bc8417a7ac4ba3f8afd8e1
```
...
### `php:8.2.7-buster` - linux; arm64 variant v8
