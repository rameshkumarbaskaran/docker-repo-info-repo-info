...
```console
$ docker pull php@sha256:a5f715f08e0ea56ccff78729cd78845a2480aebf62a77756158b9e407957bb37
```
...
### `php:7.3.26-cli-alpine` - linux; amd64
...
### `php:7.3.26-cli-alpine` - linux; arm variant v6

```console
$ docker pull php@sha256:cfa1aae41022a2c6ccdf1454ae89f2f288f9c8e902bb052c89acd3b23a0b73be
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.3 MB (30265486 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c38ab07166c6c7835413bb7c38ea3aea8f8c489e20f4bee6f79c6294cdffc9a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:7.3.26-cli-alpine` - linux; arm variant v7
...
### `php:7.3.26-cli-alpine` - linux; arm64 variant v8
...
### `php:7.3.26-cli-alpine` - linux; 386
...
### `php:7.3.26-cli-alpine` - linux; ppc64le
...
### `php:7.3.26-cli-alpine` - linux; s390x
