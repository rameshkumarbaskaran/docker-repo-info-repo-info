...
### `php:8.1.6-alpine3.14` - linux; amd64
...
### `php:8.1.6-alpine3.14` - linux; arm variant v7
...
### `php:8.1.6-alpine3.14` - linux; arm64 variant v8
...
### `php:8.1.6-alpine3.14` - linux; 386
...
### `php:8.1.6-alpine3.14` - linux; ppc64le
...
### `php:8.1.6-alpine3.14` - linux; s390x
