...
```console
$ docker pull php@sha256:9aa326eb49d8669f60a0b388b16385cac024ebafadeeed9a7b9f48931b770afe
```
...
### `php:7.4.4-fpm` - linux; arm variant v5
...
### `php:7.4.4-fpm` - linux; arm variant v7
...
### `php:7.4.4-fpm` - linux; arm64 variant v8
