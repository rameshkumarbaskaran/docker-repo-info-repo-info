...
```console
$ docker pull php@sha256:bc982e9616c28806c88da860fb5eb9966de1baefef8347bdc0fccbf9f27e97a9
```
...
### `php:7.4.4-cli-alpine3.11` - linux; arm variant v7
...
### `php:7.4.4-cli-alpine3.11` - linux; arm64 variant v8
...
### `php:7.4.4-cli-alpine3.11` - linux; ppc64le
