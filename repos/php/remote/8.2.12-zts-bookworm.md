...
```console
$ docker pull php@sha256:7a18a3bfe4e27aeab633663eaf53adcaa9cee470d2a08c505d17e78ac8804e13
```
...
### `php:8.2.12-zts-bookworm` - linux; amd64
...
### `php:8.2.12-zts-bookworm` - linux; arm variant v7
...
### `php:8.2.12-zts-bookworm` - linux; arm64 variant v8
...
### `php:8.2.12-zts-bookworm` - linux; s390x
