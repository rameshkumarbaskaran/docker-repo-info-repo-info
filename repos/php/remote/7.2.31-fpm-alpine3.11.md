...
```console
$ docker pull php@sha256:850d8c7c326f65e1ce98dd85a5c2351bf3778185a469461580c8c877d972706d
```
...
### `php:7.2.31-fpm-alpine3.11` - linux; amd64
...
### `php:7.2.31-fpm-alpine3.11` - linux; 386
