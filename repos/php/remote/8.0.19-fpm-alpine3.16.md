...
```console
$ docker pull php@sha256:6a6ffaf32f8cc153202764f3085461d7116a92bb874c0faa24b30e97628662d7
```
...
### `php:8.0.19-fpm-alpine3.16` - linux; arm variant v6

```console
$ docker pull php@sha256:5b228d6fc52cceb01e8ef9dc1dc57259deb0c54e3bd372babacaa4cdd7b65b71
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.1 MB (26113043 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ef77b8b569398dffbc98ce2b4303db0707366668bf925241c0493bf7a897d88d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
