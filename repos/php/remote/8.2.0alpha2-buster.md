...
```console
$ docker pull php@sha256:450209c4ee29e071f4113b8ca733fbc80afe88f7494de4089f0c2ea38f4bfbe9
```
...
### `php:8.2.0alpha2-buster` - linux; 386
...
### `php:8.2.0alpha2-buster` - linux; s390x
