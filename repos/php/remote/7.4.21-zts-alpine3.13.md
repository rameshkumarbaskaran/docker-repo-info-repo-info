...
```console
$ docker pull php@sha256:ef5aaa71039e046dcfd421e167b1771a8d3892b22b472aaa139a82ec1d793428
```
...
### `php:7.4.21-zts-alpine3.13` - linux; amd64
...
### `php:7.4.21-zts-alpine3.13` - linux; 386
...
### `php:7.4.21-zts-alpine3.13` - linux; s390x
