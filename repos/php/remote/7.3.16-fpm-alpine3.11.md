...
```console
$ docker pull php@sha256:dfd4217f8bfd42ec63102dd7d126b877d6859fc7a231418fe9794a195d2d11eb
```
...
### `php:7.3.16-fpm-alpine3.11` - linux; arm variant v7
...
### `php:7.3.16-fpm-alpine3.11` - linux; arm64 variant v8
...
### `php:7.3.16-fpm-alpine3.11` - linux; ppc64le
