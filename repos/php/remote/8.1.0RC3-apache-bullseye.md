...
```console
$ docker pull php@sha256:e05781c84f81391a6ddca52aa4a45d2a1186e25a4174ee1aeb615f923a95dbd5
```
...
### `php:8.1.0RC3-apache-bullseye` - linux; amd64
...
### `php:8.1.0RC3-apache-bullseye` - linux; arm variant v5
...
### `php:8.1.0RC3-apache-bullseye` - linux; arm variant v7
...
### `php:8.1.0RC3-apache-bullseye` - linux; arm64 variant v8
...
### `php:8.1.0RC3-apache-bullseye` - linux; 386
...
### `php:8.1.0RC3-apache-bullseye` - linux; mips64le
...
### `php:8.1.0RC3-apache-bullseye` - linux; ppc64le
...
### `php:8.1.0RC3-apache-bullseye` - linux; s390x
