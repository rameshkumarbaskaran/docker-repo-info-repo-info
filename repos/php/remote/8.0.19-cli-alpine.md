...
```console
$ docker pull php@sha256:758e36f1996a6cc49159c441ab767a735a6bc67521452d64d85614b803f367ad
```
...
### `php:8.0.19-cli-alpine` - linux; amd64
...
```console
$ docker pull php@sha256:e41fdaa3db0533a622290f8d2ba5d2b0493777252ccfe55449fcd1962f18d2f2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.5 MB (29519895 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cfa4d432d0b775bd5fd283b6e890b09a7cb843168fdb1bb56279c6a58b818426`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:8.0.19-cli-alpine` - linux; arm variant v7
...
### `php:8.0.19-cli-alpine` - linux; arm64 variant v8
...
### `php:8.0.19-cli-alpine` - linux; 386
...
### `php:8.0.19-cli-alpine` - linux; ppc64le
...
### `php:8.0.19-cli-alpine` - linux; s390x
