...
```console
$ docker pull php@sha256:4dfcb10fced59075c1fc9e7bb2f0e425f975314f3bb40cff9f3560ceb5ca9040
```
...
### `php:8.2.10-fpm-alpine3.18` - linux; amd64
...
### `php:8.2.10-fpm-alpine3.18` - linux; arm variant v6
...
### `php:8.2.10-fpm-alpine3.18` - linux; arm variant v7
...
### `php:8.2.10-fpm-alpine3.18` - linux; arm64 variant v8
...
### `php:8.2.10-fpm-alpine3.18` - linux; 386

```console
$ docker pull php@sha256:b654d8eed4a450fdc2fbb940df77cbb9aa2e0f10d5c13cfb243fb17df4150331
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.9 MB (30946780 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a625a1169eb920cf7ffdd7232bda616e0349217b84fdb37053df95b42c726fd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:8.2.10-fpm-alpine3.18` - linux; ppc64le
...
### `php:8.2.10-fpm-alpine3.18` - linux; s390x
