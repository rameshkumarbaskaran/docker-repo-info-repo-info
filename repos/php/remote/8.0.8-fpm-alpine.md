...
### `php:8.0.8-fpm-alpine` - linux; amd64
...
### `php:8.0.8-fpm-alpine` - linux; arm variant v6
...
### `php:8.0.8-fpm-alpine` - linux; arm variant v7
...
### `php:8.0.8-fpm-alpine` - linux; arm64 variant v8
...
### `php:8.0.8-fpm-alpine` - linux; 386
