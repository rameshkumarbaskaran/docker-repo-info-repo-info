...
```console
$ docker pull php@sha256:b0b687b0b3d52bb5b9da5f0642444d78e0bc03f68bd7ee33b6a4acecc034e762
```
...
### `php:8.2.12-cli-alpine3.18` - linux; amd64
...
### `php:8.2.12-cli-alpine3.18` - linux; arm variant v6
...
### `php:8.2.12-cli-alpine3.18` - linux; arm variant v7
...
### `php:8.2.12-cli-alpine3.18` - linux; arm64 variant v8
...
### `php:8.2.12-cli-alpine3.18` - linux; ppc64le
...
### `php:8.2.12-cli-alpine3.18` - linux; s390x
