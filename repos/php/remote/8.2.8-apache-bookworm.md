...
```console
$ docker pull php@sha256:343502e63044abdf588cbf50989bcb9b8524fb1c12a99aca799abcfbe79a92ab
```
...
### `php:8.2.8-apache-bookworm` - linux; mips64le
...
### `php:8.2.8-apache-bookworm` - linux; ppc64le
