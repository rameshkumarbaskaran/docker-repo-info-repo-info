...
```console
$ docker pull php@sha256:7aebaa2212312bcfbd601a75166cad0260e47301369c3fa2b7383e6d93e75eee
```
...
### `php:8.1.26-fpm` - linux; arm variant v5
...
### `php:8.1.26-fpm` - linux; arm variant v7
...
### `php:8.1.26-fpm` - linux; arm64 variant v8
...
### `php:8.1.26-fpm` - linux; 386

```console
$ docker pull php@sha256:070aea82fbcf57d5774a32b567460744ba2270089fbde4966c2585d8bee601c0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.9 MB (171873301 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:63c49126dab1689e41152ce53e15e5f5334ae4beb1aed4ad876802b3c25664da`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
