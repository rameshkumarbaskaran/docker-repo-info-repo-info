...
```console
$ docker pull php@sha256:d6ee8800a535a994be6b2ad6489d64436815aa1da2ff6a96a43929751bd88071
```
...
### `php:8.1.13-cli-bullseye` - linux; amd64
...
### `php:8.1.13-cli-bullseye` - linux; arm variant v5
...
### `php:8.1.13-cli-bullseye` - linux; arm64 variant v8
...
### `php:8.1.13-cli-bullseye` - linux; 386
...
### `php:8.1.13-cli-bullseye` - linux; ppc64le
...
### `php:8.1.13-cli-bullseye` - linux; s390x
