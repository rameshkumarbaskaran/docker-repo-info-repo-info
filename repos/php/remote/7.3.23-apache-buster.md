...
```console
$ docker pull php@sha256:6c1707c8ab244bfae6e12331a81a53341032d156ae020161ed89c264f63a67d2
```
...
### `php:7.3.23-apache-buster` - linux; arm variant v5
...
### `php:7.3.23-apache-buster` - linux; arm variant v7
...
### `php:7.3.23-apache-buster` - linux; arm64 variant v8
...
### `php:7.3.23-apache-buster` - linux; mips64le
...
### `php:7.3.23-apache-buster` - linux; ppc64le
...
### `php:7.3.23-apache-buster` - linux; s390x
