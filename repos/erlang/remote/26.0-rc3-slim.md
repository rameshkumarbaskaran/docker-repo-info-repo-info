...
```console
$ docker pull erlang@sha256:d305022fa21eb5aba614b22d5e3f9426507feb3093c6100021bdad77328f8b55
```
...
### `erlang:26.0-rc3-slim` - linux; amd64
...
### `erlang:26.0-rc3-slim` - linux; 386
...
### `erlang:26.0-rc3-slim` - linux; mips64le
