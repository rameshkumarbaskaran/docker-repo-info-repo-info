...
### `erlang:24.1.6-alpine` - linux; amd64
...
### `erlang:24.1.6-alpine` - linux; arm variant v7
...
### `erlang:24.1.6-alpine` - linux; arm64 variant v8
...
### `erlang:24.1.6-alpine` - linux; ppc64le
...
### `erlang:24.1.6-alpine` - linux; s390x
