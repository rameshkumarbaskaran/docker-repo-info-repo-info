...
```console
$ docker pull erlang@sha256:2e6f17ee6e9a81ddd300ca1cc070373380f411dd2c274095f644201f8198bcde
```
...
### `erlang:22.3.4.7-slim` - linux; arm variant v7
...
### `erlang:22.3.4.7-slim` - linux; 386
