...
```console
$ docker pull erlang@sha256:733422f8a6cd3c0c7171f31178532bef45482c4b7511d68967b04503b099b0b0
```
...
### `erlang:23.1.4.0` - linux; arm variant v7
...
### `erlang:23.1.4.0` - linux; arm64 variant v8
