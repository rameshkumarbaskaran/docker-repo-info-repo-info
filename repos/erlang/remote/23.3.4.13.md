...
```console
$ docker pull erlang@sha256:e1bc01edede4288dd6dbc3a088169f8d8e83a42016b70c5230d7c3e32e1d7ad5
```
...
### `erlang:23.3.4.13` - linux; arm variant v7
...
### `erlang:23.3.4.13` - linux; arm64 variant v8
...
### `erlang:23.3.4.13` - linux; ppc64le
