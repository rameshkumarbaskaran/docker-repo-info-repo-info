...
```console
$ docker pull erlang@sha256:f957d47bf17d80adbcaa1a3d757a74c468314dac947c877478e7ce7fb51701d7
```
...
### `erlang:24.2.1-slim` - linux; arm64 variant v8
...
### `erlang:24.2.1-slim` - linux; ppc64le
