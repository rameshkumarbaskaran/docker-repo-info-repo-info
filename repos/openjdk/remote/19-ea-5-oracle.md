## `openjdk:19-ea-5-oracle`

```console
$ docker pull openjdk@sha256:68b01b9f9d7e77f9d8550bdc1fd41743dd1cb0788c1485aba870d560872632bc
```
...
### `openjdk:19-ea-5-oracle` - linux; amd64
...
### `openjdk:19-ea-5-oracle` - linux; arm64 variant v8
