...
### `openjdk:18-ea-1-jdk` - linux; amd64
...
### `openjdk:18-ea-1-jdk` - linux; arm64 variant v8
...
### `openjdk:18-ea-1-jdk` - windows version 10.0.17763.1999; amd64
...
### `openjdk:18-ea-1-jdk` - windows version 10.0.14393.4467; amd64
