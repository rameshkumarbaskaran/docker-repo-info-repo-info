## `openjdk:20-ea-18-jdk-oraclelinux8`

```console
$ docker pull openjdk@sha256:de0027d370697932592e5f1ce795324b3027058a524911c8a19add27cff3b850
```
...
### `openjdk:20-ea-18-jdk-oraclelinux8` - linux; amd64
