...
### `openjdk:22-ea-30-jdk-slim` - linux; amd64
...
### `openjdk:22-ea-30-jdk-slim` - unknown; unknown
...
### `openjdk:22-ea-30-jdk-slim` - linux; arm64 variant v8
