## `openjdk:19-ea-2-bullseye`

```console
$ docker pull openjdk@sha256:0c61ad3d22b4ffb47e68df4954b3fd0f9a262aef89b7d38fd51eb366a250b840
```
...
### `openjdk:19-ea-2-bullseye` - linux; amd64
...
### `openjdk:19-ea-2-bullseye` - linux; arm64 variant v8
