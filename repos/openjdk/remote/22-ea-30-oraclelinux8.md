...
### `openjdk:22-ea-30-oraclelinux8` - linux; amd64
...
### `openjdk:22-ea-30-oraclelinux8` - unknown; unknown
...
### `openjdk:22-ea-30-oraclelinux8` - linux; arm64 variant v8
