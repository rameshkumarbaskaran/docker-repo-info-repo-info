...
```console
$ docker pull openjdk@sha256:f0ca4a2eec8c9d1f7d002a5a15cfa6b93095ee61c2345b6c3835f4d6f03e4be6
```
...
### `openjdk:17-jdk` - windows version 10.0.17763.1817; amd64
...
### `openjdk:17-jdk` - windows version 10.0.14393.4283; amd64
