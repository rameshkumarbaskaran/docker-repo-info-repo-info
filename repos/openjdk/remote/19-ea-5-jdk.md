...
### `openjdk:19-ea-5-jdk` - linux; amd64
...
### `openjdk:19-ea-5-jdk` - linux; arm64 variant v8
...
### `openjdk:19-ea-5-jdk` - windows version 10.0.20348.473; amd64
...
### `openjdk:19-ea-5-jdk` - windows version 10.0.17763.2458; amd64
