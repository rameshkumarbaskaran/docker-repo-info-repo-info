...
### `openjdk:22-ea-28-jdk-oracle` - linux; amd64
...
### `openjdk:22-ea-28-jdk-oracle` - unknown; unknown
...
### `openjdk:22-ea-28-jdk-oracle` - linux; arm64 variant v8
