...
```console
$ docker pull openjdk@sha256:d4575200c8db3b356d747d8df6c2d727e10a927265a0ff3735975c9a5856dda5
```
...
### `openjdk:11.0.14-jdk-buster` - linux; amd64

```console
$ docker pull openjdk@sha256:c167eecdb8398599160dfc18cbc0a6c2c3f3e8e9c48a2b842fed14e8be15ac93
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **328.7 MB (328659526 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e1da0613075b9cd4324489e7c296add7f5bad57c70f4e45c4af359023e5cb665`
...
### `openjdk:11.0.14-jdk-buster` - linux; arm64 variant v8
