...
```console
$ docker pull openjdk@sha256:cdd9ee72d8fee867cb7e5d68911d8be61193eff4de3bc4b754d7b15fc31d3ccd
```
...
### `openjdk:21-ea-14-jdk-buster` - linux; amd64
...
### `openjdk:21-ea-14-jdk-buster` - linux; arm64 variant v8
