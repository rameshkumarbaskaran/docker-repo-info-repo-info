...
```console
$ docker pull openjdk@sha256:5e8a40974238bed3a5ffd5913f769aa5820d90188d45744652e13cc991fccd2a
```
...
### `openjdk:8-jdk-windowsservercore` - windows version 10.0.20348.587; amd64
...
### `openjdk:8-jdk-windowsservercore` - windows version 10.0.17763.2686; amd64
