...
### `openjdk:23-ea-4-jdk-oracle` - linux; amd64
...
### `openjdk:23-ea-4-jdk-oracle` - unknown; unknown
...
### `openjdk:23-ea-4-jdk-oracle` - linux; arm64 variant v8
