...
```console
$ docker pull openjdk@sha256:f0fa647ee718ccfe7b96944afb0cdb42e947a4038d04484ccb73df152ef0ac79
```
...
```console
$ docker pull openjdk@sha256:fb00f9799928940f3d504fbb9b9275240d377376688e576011784866a4ef09c8
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **71.9 MB (71947850 bytes)**  
