## `openjdk:15-ea-30-jdk`

```console
$ docker pull openjdk@sha256:503bfd916d2ddb2550bebe73a7f66d8a02b90f4c4f4c394e931decf3dd408d69
```
...
### `openjdk:15-ea-30-jdk` - linux; amd64
...
### `openjdk:15-ea-30-jdk` - linux; arm64 variant v8
...
### `openjdk:15-ea-30-jdk` - windows version 10.0.17763.1282; amd64
...
### `openjdk:15-ea-30-jdk` - windows version 10.0.14393.3750; amd64
