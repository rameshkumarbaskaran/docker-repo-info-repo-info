...
```console
$ docker pull openjdk@sha256:a1c0966d3dbb7c286832d376549a4c637bbb11576b5fe6a66df6100336f9b007
```
...
```console
$ docker pull openjdk@sha256:850fb066eff35cf8e4cd4488605b85e40048a65bffb177c4217cffe6d422014a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **80.1 MB (80052599 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9713f19b5ec5c3936ab4dd5846643589c9f01edb31b11c53487727b742587d5d`
