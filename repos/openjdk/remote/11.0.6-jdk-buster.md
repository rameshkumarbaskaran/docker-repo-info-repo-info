...
```console
$ docker pull openjdk@sha256:62365213aee3c6a177a0319cddfefbcfe8f0b8caed1df58914fb8dca7d3ee115
```
...
### `openjdk:11.0.6-jdk-buster` - linux; amd64
...
### `openjdk:11.0.6-jdk-buster` - linux; arm64 variant v8
