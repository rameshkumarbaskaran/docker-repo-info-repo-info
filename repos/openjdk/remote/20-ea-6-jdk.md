...
### `openjdk:20-ea-6-jdk` - linux; amd64
...
### `openjdk:20-ea-6-jdk` - linux; arm64 variant v8
...
### `openjdk:20-ea-6-jdk` - windows version 10.0.20348.825; amd64
...
### `openjdk:20-ea-6-jdk` - windows version 10.0.17763.3165; amd64
