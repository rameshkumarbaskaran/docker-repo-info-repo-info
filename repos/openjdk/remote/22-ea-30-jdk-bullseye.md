...
### `openjdk:22-ea-30-jdk-bullseye` - linux; amd64
...
### `openjdk:22-ea-30-jdk-bullseye` - unknown; unknown
...
### `openjdk:22-ea-30-jdk-bullseye` - linux; arm64 variant v8
