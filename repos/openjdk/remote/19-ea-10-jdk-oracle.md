...
```console
$ docker pull openjdk@sha256:bf98a4dcba81906ff95764eabd441db503a0c303019ba3ff0aa7fe2ccfce8d9f
```
...
### `openjdk:19-ea-10-jdk-oracle` - linux; amd64
...
### `openjdk:19-ea-10-jdk-oracle` - linux; arm64 variant v8
