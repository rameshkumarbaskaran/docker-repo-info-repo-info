...
```console
$ docker pull openjdk@sha256:b74901b6c85c40e582aac91c96d2f800b79c61cb25eb9dcb9c55c48effefbc6f
```
...
### `openjdk:19-ea-12-oracle` - linux; amd64
...
### `openjdk:19-ea-12-oracle` - linux; arm64 variant v8
