...
```console
$ docker pull openjdk@sha256:2d418fe8494eb8dd600a65c94590b1173eb8396e59e1eb90a384aedaa6073a0d
```
...
### `openjdk:11.0.14-jdk-bullseye` - linux; amd64
...
### `openjdk:11.0.14-jdk-bullseye` - linux; arm64 variant v8
