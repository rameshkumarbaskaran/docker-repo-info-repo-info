...
```console
$ docker pull openjdk@sha256:30a0b6c5b8db7e8962e026365746e8f1bd6d7356c407ad05fadb11680e16af26
```
...
```console
$ docker pull openjdk@sha256:34f62969c08687fd9ccae2becadd88b6f59ea2cab4bc85fb7e76fe1b3fe26c3f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **222.0 MB (221959704 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:792de7f55611c2275ecb4e029d732fd0033b5ab0645822dc80c69f1c48913812`
...
```console
$ docker pull openjdk@sha256:af3b2a569d8becbfc25f53c50a6a70ba05256d884eb9cc0b2d830f52f25843d8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **219.4 MB (219356541 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d33434f214d1782b0804d2c8166ce25135a9cab515337695e0b808a8963d127b`
-	Default Command: `["jshell"]`
