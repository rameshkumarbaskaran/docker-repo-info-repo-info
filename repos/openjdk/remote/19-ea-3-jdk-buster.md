## `openjdk:19-ea-3-jdk-buster`

```console
$ docker pull openjdk@sha256:a71139d35217b1e949778b2513711a9e4840b5857511aa3d184359fb008124e9
```
...
### `openjdk:19-ea-3-jdk-buster` - linux; arm64 variant v8
