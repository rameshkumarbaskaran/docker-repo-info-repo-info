## `openjdk:11.0.11-9-buster`

```console
$ docker pull openjdk@sha256:cc352834dc0c9d48787957e4e293dd9ffabbaca4a1b9e1d0e2fe9381235dc5fd
```
...
### `openjdk:11.0.11-9-buster` - linux; amd64
...
### `openjdk:11.0.11-9-buster` - linux; arm64 variant v8
