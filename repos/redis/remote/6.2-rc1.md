...
```console
$ docker pull redis@sha256:2cced0550c9773d2a3cba78b47810a2d6f46dd247438ab4e72729cc913d2b617
```
...
### `redis:6.2-rc1` - linux; arm variant v5
...
### `redis:6.2-rc1` - linux; arm64 variant v8
