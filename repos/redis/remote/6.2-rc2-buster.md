...
```console
$ docker pull redis@sha256:849eb13cdf63be6d77a32a89b2c9479b7d9317584b09de487901745b9176086b
```
...
### `redis:6.2-rc2-buster` - linux; amd64
...
### `redis:6.2-rc2-buster` - linux; arm64 variant v8
...
### `redis:6.2-rc2-buster` - linux; s390x
