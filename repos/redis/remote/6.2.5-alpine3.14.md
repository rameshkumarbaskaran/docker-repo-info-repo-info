...
```console
$ docker pull redis@sha256:846a4ad00695f0b6d3270d0c698e0a581943c5e303c0759b6e2eeec34839a202
```
...
### `redis:6.2.5-alpine3.14` - linux; amd64
...
### `redis:6.2.5-alpine3.14` - linux; arm64 variant v8
...
### `redis:6.2.5-alpine3.14` - linux; 386
