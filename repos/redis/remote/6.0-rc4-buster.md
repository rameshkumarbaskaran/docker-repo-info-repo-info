...
### `redis:6.0-rc4-buster` - linux; arm variant v5
...
### `redis:6.0-rc4-buster` - linux; arm variant v7
...
### `redis:6.0-rc4-buster` - linux; mips64le
...
### `redis:6.0-rc4-buster` - linux; ppc64le
...
### `redis:6.0-rc4-buster` - linux; s390x
