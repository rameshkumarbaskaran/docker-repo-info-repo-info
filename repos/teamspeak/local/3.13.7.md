...
- Created: `2022-08-10T01:22:25.959369114Z`
- Virtual Size: ~ 26.94 Mb  
...
```console
libpq-13.7-r0 description:
PostgreSQL libraries

libpq-13.7-r0 webpage:
https://www.postgresql.org/

libpq-13.7-r0 installed size:
328 KiB

libpq-13.7-r0 license:
PostgreSQL
